...
description: "ESG Greenwashing Klimaklagen Verbandsklage: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# ESG Greenwashing Klimaklagen Verbandsklage

## Arbeitsbereich

Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **ESG Greenwashing Klimaklagen Verbandsklage** im Plugin Umweltrecht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.

## Prüffelder

| Prüffeld | Fokus |
| --- | --- |
| `esg-greenwashing-csrd` | Prüffeld für esg greenwashing csrd: prüft Normtext, Nutzerangaben, Fristen, Belege und verifizierte Rechtsprechung mit Gericht, Datum, Aktenzeichen und frei prüfbarer Quelle. |
| `klimaklagen-verbandsklage-umwrg` | Prüffeld für klimaklagen verbandsklage umwrg: prüft Normtext, Nutzerangaben, Fristen, Belege und verifizierte Rechtsprechung mit Gericht, Datum, Aktenzeichen und frei prüfbarer Quelle. |
...
Im Plugin Umweltrecht gilt für **ESG Greenwashing Klimaklagen Verbandsklage**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
**Fokus:** Prüffeld für esg greenwashing csrd: prüft Normtext, Nutzerangaben, Fristen, Belege und verifizierte Rechtsprechung mit Gericht, Datum, Aktenzeichen und frei prüfbarer Quelle.
...
- Mandant (Berichtspflichtiger? Wettbewerbs-Beklagter? Investor?)
- Werbe-Aussagen / Berichts-Inhalt
- Substantiierung der Klimabehauptung (Audit Zertifikat Methodik)
- Bisherige Verfahren (Wettbewerbszentrale Bundeskartellamt)
- Geschäftsmodell (Branche Größe Umsatz)

## Schritt 1 — CSRD-Anwendungsbereich

### Phasen-Plan CSRD

| Geschäftsjahr | Anwendungsbereich |
|---|---|
| 2024 | Bisherige NFRD-Adressaten (große kapitalmarktorientierte Unternehmen >500 Mitarbeiter) |
| 2025 | Große Unternehmen (>250 MA und >EUR 50 Mio Umsatz oder >EUR 25 Mio Bilanzsumme) |
| 2026 | Kleine und mittlere kapitalmarktorientierte Unternehmen |
| 2028 | Drittstaaten-Mütter mit EU-Umsatz |
...
- Aber konzernweite Konsolidierung

## Schritt 2 — Inhalts-Anforderungen CSRD
...
5. Vermeidung Verschmutzung
6. Schutz Ökosysteme und Biodiversität
...
| Artikel | Bezeichnung | Inhalt |
|---|---|---|
| Art. 6 | Standard | Keine Nachhaltigkeits-Eigenschaft |
| Art. 8 | "Hellgrün" | Bewerbung Nachhaltigkeit |
| Art. 9 | "Dunkelgrün" | Nachhaltigkeits-Ziel als Anlage-Ziel |
...
- **Sanktionen** in Verbraucherschutz-Recht

### Vorbereitung

- Methodik-Audit jetzt
- Substantiierungs-Dokumentation aufbauen
- Kommunikations-Compliance schulen

## Schritt 7 — Verteidigung bei Greenwashing-Vorwurf
...
- Vor LG Wettbewerbskammer
- Streitwert nach Marktbedeutung
- Eilantrag häufig

## Schritt 8 — Argumentations-Linien

### Substantiierung mit konkreter Methodik

- ISO 14064 (Carbon Footprint)
- ISO 14067 (Produkt-Carbon-Footprint)
- GHG-Protocol
- Science Based Targets Initiative (SBTi)
- Reduktions- vs. Kompensations-Anteile transparent

### Audit-Nachweise

- Drittstellen-Verifizierung
- Zertifikate (TÜV Klima neutral z.B.)
- Update-Frequenz

### Vergleichende Werbung

- §6 UWG Voraussetzungen
- Objektive Vergleichsbasis
- Wesentliche Eigenschaften

## Schritt 9 — Praktische Compliance-Bausteine

### Klima-Behauptungs-Manual

- Erlaubte Behauptungen mit Substantiierungs-Anforderung
- Verbotene Behauptungen
- Disclaimer-Templates
- Visualisierung-Regeln (Farb-Wahl Symbole)

### Pre-Publication Review

- Marketing-Compliance-Check vor Veröffentlichung
- Rechtsabteilungs-Freigabe
- Externer Berater bei zweifelhaften Aussagen

### Beschwerden-Management

- Webform Verbraucher-Beschwerden
- Schnelle Reaktion
- Dokumentation

## Schritt 10 — Sektorale Spezialitäten

### Finanzsektor

- SFDR Art. 8/9
- ESG-Fonds-Bezeichnung
- BaFin-Aufsicht

### Bau und Immobilien

- DGNB BREEAM LEED Zertifikate
- Energieeffizienz-Klassen
- Sanierungs-Pflichten
...
- E-Auto-Klima-Behauptungen
- Lebenszyklus-Betrachtung
- Batterie-Herkunft

### Mode und Textil

- Recycling-Anteil-Aussagen
- Fair-Trade
- Mikroplastik

## Schritt 11 — Verzahnung mit anderen Skills

- **klimaklagen-verbandsklage-umwrg** — Verbandsklagen zu Klima-Bezug
- **lksg-csddd-lieferkettensorgfalt** — Lieferketten-Bezug ESG
- **umweltrecht-compliance-schulung** — Mitarbeiter-Schulung
- **datenschutzrecht ki-verordnung-compliance** — wenn KI-Tools verwendet

## Schritt 12 — Bericht-Bausteine

### Nachhaltigkeits-Bericht-Architektur
...
### Pflichten externe Prüfung

- Vorerst limited assurance
- Ab 2028 reasonable assurance geplant

## Ausgabe

- `esg-pruefung-{az}.md` mit CSRD-Bezug Taxonomie-Klassifikation SFDR-Bezug
- Greenwashing-Risiko-Bewertung jeder Werbe-Aussage
- Substantiierungs-Dokumentations-Anforderung
- Bei Vorwurf: Verteidigungs-Strategie und Schriftsatz-Bausteine
...
**Fokus:** Prüffeld für klimaklagen verbandsklage umwrg: prüft Normtext, Nutzerangaben, Fristen, Belege und verifizierte Rechtsprechung mit Gericht, Datum, Aktenzeichen und frei prüfbarer Quelle.
...
- Klage-Konstellation (Verband Bürger Konzern als Beklagter)
- Streitgegenstand (Behörden-Maßnahme Bauleitplanung Genehmigung Klimaziel)
- Bisheriger Behörden-Verlauf
- Beteiligung im Verwaltungsverfahren (vorbringende Stellungnahme)
- Anerkannte Umwelt-Verbände-Mitgliedschaft

## Schritt 1 — Klage-Konstellationen
...
- UmwRG-Klage Umweltverband gegen Anlagen-Genehmigung mit hoher CO2-Emission
- Verfahrensrechtliche Mängel UVP-Pflicht-Entscheidung
- Materiell-rechtliche Mängel BImSchG-Vorsorge

### Typ 4 — Klage Bürger gegen Konzern (Privatrecht)

- BGH-Linie Klimaklage Lliuya / RWE noch offen
- Verfassungs-rechtliche Drittwirkung
- § 1004 BGB Eigentumsstörung
- § 823 BGB Gesundheits-Verletzung

## Schritt 2 — UmwRG-Klagebefugnis

### § 2 UmwRG Klagebefugnis Vereinigung

- **Anerkennung** nach § 3 UmwRG (BfN-Liste oder Land-Anerkennung)
- **Tätigkeitsbereich** umfasst den Klage-Gegenstand
- **Beteiligungs-Möglichkeit** im Verfahren gegeben
- **Drei-Jahres-Bestand**

### § 1 UmwRG Klagegegenstände

- Entscheidungen über UVP-Pflicht
- UVP-pflichtige Vorhaben
- BImSchG-Genehmigungen
- Wasser-rechtliche Erlaubnisse
- BNatSchG-Maßnahmen
- Pläne und Programme mit Umweltprüfung
- Verwaltungsakte gegen Privatpersonen mit Umweltbezug
...
- **Verfassungs-konforme Auslegung** umweltrechtlicher Normen
- **Vorsorge-Grundsatz § 5 Abs. 1 Nr. 2 BImSchG** wird klimaschutz-relevant
- **Genehmigungs-Voraussetzungen** mit Klima-Bezug
- **Bauleitplanung** § 1 Abs. 5 BauGB klimaschutz-konform

## Schritt 4 — UVP-Pflicht-Prüfung

### UVPG-Vorprüfung

- Allgemeine Vorprüfung § 7 Abs. 1 UVPG
- Standortbezogene Vorprüfung § 7 Abs. 2 UVPG
- UVP-Pflicht bei "erheblichen nachteiligen Umweltauswirkungen"
- Klima-Auswirkungen sind erheblich

### UVP-Bericht

- Inhalt § 16 UVPG
- Alternativen-Prüfung § 16 Abs. 1 Nr. 6
- Klima-Wirkungs-Kapitel zwingend
...
### Vorsorge-Grundsatz BImSchG § 5 Abs. 1 Nr. 2

- Klima-Vorsorge als Vorsorge-Inhalt
- BVerwG-Linie zu integrierter Betrachtung
- Stand der Technik plus Klima

### TEHG-Bezug

- Genehmigung muss CO2-Emissions-Ziele unterstützen
- ETS-Zuteilungs-Regelung mitberücksichtigen

### Bauleitplanung § 1 Abs. 5 BauGB

- Klimaschutz als Planungs-Belang
- Abwägungs-Gebot § 1 Abs. 7 BauGB

### FFH-Verträglichkeitsprüfung § 34 BNatSchG

- Bei Schutzgebieten zwingende Prüfung
- Klima-Bezug bei klima-sensitiven Lebensraumtypen

## Schritt 6 — Aarhus-Konvention
...
- Beschwerde gegen Staaten möglich
- Deutsche Aarhus-Compliance Bericht

## Schritt 7 — Prozessuale Aspekte

### Klage-Art

- Anfechtungs-Klage gegen Genehmigung
- Verpflichtungs-Klage auf Einschreiten
- Feststellungs-Klage zur Pflicht-Bestimmung

### Eilantrag § 80 Abs. 5 VwGO

- Wenn Genehmigung sofortige Vollziehung
- Eilbedürftigkeit klima-relevanter Vorhaben

### Zuständigkeit

- VG am Behörden-Sitz
- OVG/VGH bei großen Vorhaben § 48 VwGO erste Instanz Landes-Verkehrs-Wege

### Streitwert

- Auffangwert EUR 5000 bei Umweltverbänden
- Bei wirtschaftlicher Bedeutung höher
- GKG § 52 Abs. 1, 2

### Verzögerungsrüge § 198 GVG

- Bei überlangen Klima-Verfahren

## Schritt 8 — Beweismittel

### Sachverständigen-Gutachten

- Klimawissenschaftliche Gutachten (IPCC-Methodik)
...
- UVP-Berichte
- Behörden-Akten
- Internationale Verträge (Pariser Abkommen)
...
## Schritt 9 — Verteidigung (Konzern/Behörde)

### Argumente

- **Klima-Bezug nicht hinreichend konkret** in Klage
- **Politische Frage-Lehre** bei genereller Klimapolitik
- **Verbandskompetenz** prüfen
- **Materiell-rechtliche Erfüllung** Klima-Vorgaben (CO2-Audit Stand der Technik)

### Beweis-Gegenangebote

- Eigene Sachverständige
- Compliance-Dokumentation
- ETS-Erfüllungs-Nachweis

## Schritt 10 — Internationale Linien
...
- Bezirksgericht Den Haag 26.5.2021 — Unternehmens-Pflicht zur Reduktion
- Berufung läuft
...
## Schritt 11 — ESG-Verzahnung

### Greenwashing-Kombination

- Wenn Konzern Klima-Behauptung in Werbung
- Verbands-Klage UWG mit Klima-Bezug
- Bundeskartellamt-Verfahren bereits gegen Greenwashing
...
- Klagebefugnis nach § 2 UmwRG
- BVerfG-Klimabeschluss als Auslegungs-Maßstab
- UVP-Mangel
- Materielle Vorsorge-Pflicht Klima
- Aarhus-Konvention

## Ausgabe

- `klimaklage-{az}.md` mit Strategie und Antrag
- Verbandsklage-Voraussetzungen-Prüfung
- BVerfG-Klimabeschluss-Argumentation
- Sachverständigen-Beweisangebot
- Frist im Fristenbuch (Klage-Frist ein Monat ab Bescheid-Zugang)
- Aarhus-Bezug
