...
Diese Quellenkarte sichert für **Umweltrecht** jede tragende Aussage ab: Norm, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor Ausgabe verifiziert.

## Tragende Normen (live prüfen)

- **BImSchG, BNatSchG, WHG, BBodSchG** — amtlichen Stand vor tragender Aussage prüfen
- **UVPG** — amtlichen Stand vor tragender Aussage prüfen

## Zuständige Spruchkörper und Behörden

- Umweltbehörden Länder
- BfN
- UBA
...
- UVP-Portal (uvp-verbund.de)
- bverwg.de (4./7./9. Senat)
