...
description: "Voluntary Petition Voting Tabulation: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Voluntary Petition Voting Tabulation

## Arbeitsbereich

Dieser Skill bündelt 2 sachlich verwandte Arbeitsschritte rund um **Voluntary Petition Voting Tabulation** im Plugin Us Bankruptcy Code. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Us Bankruptcy Code gilt für **Voluntary Petition Voting Tabulation**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `voluntary-petition-intake`

**Fokus:** Organisiert voluntary filing, petition package, schedules, statements, certificates, filing authority and first-day timeline.

# Voluntary Petition Intake

## Fachkern: Voluntary Petition Intake
- **Spezialgegenstand:** Voluntary Petition Intake wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
...
Dieser Skill macht aus dem Thema **Voluntary Petition Intake** eine belastbare Arbeitsroute: erst Rolle und Ziel, dann Code-Anker, Tatsachen, Dokumente, Risiken, offene US-Counsel-Fragen und verwertbarer Output. Er ist kein Ersatz für zugelassenen US-Counsel, aber er soll die deutsche Kanzlei, Rechtsabteilung oder den Verlag so vorbereiten, dass US-Counsel sofort mit einer geordneten Akte weiterarbeiten kann.
...
- Wer authorisiert filing?
- Welche chapter and court?
- Welche schedules and emergency documents?


## Workflow

1. Corporate authority prüfen.
2. Petition package checklist bauen.
3. Immediate post-filing duties erfassen.


## Output

- Voluntary filing checklist
- Board resolution issue list
- First-day calendar
...
## 2. `voting-tabulation-1126`

**Fokus:** Prueft acceptance, impaired classes, ballots, designation, numerosity/amount tests and solicitation problems.

# Voting and Tabulation § 1126

## Fachkern: Voting and Tabulation § 1126
- **Spezialgegenstand:** Voting and Tabulation § 1126 wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
- **Normen-/Quellenanker:** Title 11 U.S. Code, Federal Rules of Bankruptcy Procedure, Chapter 7/11/13/15, automatic stay, DIP financing, claims, plan, avoidance, discharge und U.S.-Court-Docket.
- **Entscheidende Weiche:** Bestimme Chapter, Estate Property, Stay-Wirkung, Creditor-Klasse, Court-Order-Bedarf, Timeline und Schnittstelle zu deutschen Assets.
- **Lösungsoutput:** Erzeuge eine fallbezogene Matrix `Norm / Tatbestand / Beleg / Risiko / Gegenargument / nächster Schritt` und benenne passende Anschluss-Skills nur, wenn sie wirklich eine Vertiefung lösen.
...
Dieser Skill macht aus dem Thema **Voting and Tabulation § 1126** eine belastbare Arbeitsroute: erst Rolle und Ziel, dann Code-Anker, Tatsachen, Dokumente, Risiken, offene US-Counsel-Fragen und verwertbarer Output. Er ist kein Ersatz für zugelassenen US-Counsel, aber er soll die deutsche Kanzlei, Rechtsabteilung oder den Verlag so vorbereiten, dass US-Counsel sofort mit einer geordneten Akte weiterarbeiten kann.

## Code- und Quellenanker

- 11 U.S.C. § 1126
- Bankruptcy Rules solicitation/tabulation
- Ballot procedures order
...
- Which classes vote?
- Ballots valid and timely?
- Insider or bad-faith votes?


## Workflow

1. Voting record collect.
2. Acceptance tests calculate.
3. Designation or objection issues.


## Output

- Voting report checklist
- Tabulation issue memo
- Ballot defect list
