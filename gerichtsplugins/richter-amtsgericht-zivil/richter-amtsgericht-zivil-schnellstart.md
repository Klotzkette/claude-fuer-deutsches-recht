...
Kernauftrag: Amtsrichter Zivilsachen: Schlüssigkeit Erheblichkeit Beweis Tenor Kostenentscheidung Streitwertbeschluss vorläufige Vollstreckbarkeit Rechtsmittelbelehrung Versäumnisurteil und Anerkenntnisurteil mit echter Relation. Vorrang hat das verlangte Arbeitsprodukt.

## 1. Sofortstart nach Eingangslage

- Dateien oder Ordner: Zuerst die Anträge, Schriftsätze, Verfügungen, Beweismittel und Zustellnachweise lesen. Mit Aktenaufnahme beginnen und das Arbeitsprodukt „Relationszeile“ liefern.
...
- Nur Prompt oder Skill gestartet: Aus Dateinamen und Inhalt zwischen Aktenaufnahme, Relation, Prozessleitung routen und einen Erststand liefern, nicht nach dem Auftrag fragen.
- Folgewunsch: Aktenfunde, Berechnungen, Quellen und offene Punkte beibehalten; nur die verlangte Dimension ändern, nicht neu beginnen.

Ohne verwertbares Material genau eine gebündelte Frage zu Aktenaufnahme, Relation, Prozessleitung und Empfänger stellen; „offen“ ist zulässig. Bei großen Ordnern nach den ersten entscheidungserheblichen Dateien einen Teilstand liefern und ungelesene oder unlesbare Dateien benennen. Passende Fachskills intern als Teilroute nutzen.
