...
| Inhalt | Download |
| --- | --- |
| **Dieses Plugin** (`richter-verwaltungsgericht`) | [`richter-verwaltungsgericht.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/richter-verwaltungsgericht.zip) |
...
| Akte | Download |
| --- | --- |
| Pluginlokale Testakte | [`richter-verwaltungsgericht-testakte.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/richter-verwaltungsgericht-testakte.zip) |
...
- **03-begründetheit-anfechtungsklage** — Begründetheit Paragraf 113 Abs. 1 VwGO: Rechtmaessigkeit des Verwaltungsakts (Rechtsgrundlage, formelle und materielle
