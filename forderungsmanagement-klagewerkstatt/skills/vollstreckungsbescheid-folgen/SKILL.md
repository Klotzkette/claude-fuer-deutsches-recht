...
|---|---|
| Schuldner schweigt typisch | MB → VB (zwei Schritte, schnell) |
| Strittige Forderung | direkte Klage (MB nur Zeitverlust) |
...
- VB-Antrag nach 6 Monaten → Mahnbescheid muss erneut beantragt werden.
