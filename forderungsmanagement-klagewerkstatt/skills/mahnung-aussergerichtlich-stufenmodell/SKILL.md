...
### Stufe 1: Zahlungserinnerung (optional, kostenfrei)
...
| Methode | Beweiswert | Kosten |
|---|---|---|
| Einfacher Brief | gering, Zugang muss bewiesen werden | minimal |
| Einschreiben (Standard) | mittel, kein Inhaltsnachweis | 2,75 EUR |
