---
name: umweltschutzverband-verbandsklage-umv-vwgo-normenkontrolle
description: "UMV Vwgo Normenkontrolle: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# UMV Vwgo Normenkontrolle

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **UMV Vwgo Normenkontrolle** im Plugin Umweltschutzverband / Verbandsklage. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `umv-017-gutachterfragen-formulieren` | Umweltschutzverband Verbandsklage: Gutachterfragen formulieren. Gutachterfragen formulieren im Fachgebiet Umweltschutzverband Verbandsklage als geführten Arbeitsgang mit Fragen, Dokumentenlogik und Ausgabeformat bearbeiten. |

## Arbeitsweg

Im Plugin Umweltschutzverband / Verbandsklage gilt für **UMV Vwgo Normenkontrolle**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
47 Vwgo Normenkontrolle wird nicht als abstraktes Schema beantwortet, sondern als Arbeitsgang im Bereich Umweltverbandsklage und Umweltrechtsschutz: erst Zuständigkeit und Normpfad, dann Tatsachen und Belege, dann Fristen und taktische Option, danach ein verwertbarer Output.
...
Eilrechtsschutz Gegen Vollzug wird nicht als abstraktes Schema beantwortet, sondern als Arbeitsgang im Bereich Umweltverbandsklage und Umweltrechtsschutz: erst Zuständigkeit und Normpfad, dann Tatsachen und Belege, dann Fristen und taktische Option, danach ein verwertbarer Output.
...
Aktenauswertung Behoerdenordner wird nicht als abstraktes Schema beantwortet, sondern als Arbeitsgang im Bereich Umweltverbandsklage und Umweltrechtsschutz: erst Zuständigkeit und Normpfad, dann Tatsachen und Belege, dann Fristen und taktische Option, danach ein verwertbarer Output.
...
Gutachterfragen Formulieren wird nicht als abstraktes Schema beantwortet, sondern als Arbeitsgang im Bereich Umweltverbandsklage und Umweltrechtsschutz: erst Zuständigkeit und Normpfad, dann Tatsachen und Belege, dann Fristen und taktische Option, danach ein verwertbarer Output.
