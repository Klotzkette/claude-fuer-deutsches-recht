...
description: "IT Saas Laufzeit Survival M A: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **IT Saas Laufzeit Survival M A** im Plugin NDA-Abgleich. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin NDA-Abgleich gilt für **IT Saas Laufzeit Survival M A**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `nda-it-saas-vendor`

**Fokus:** NDA fuer SaaS-/IT-Vendor-Pitches: Cloud-Hosting, Datentrennung, Subprozessoren, Audit-Rechte, Penetration-Testing-Erlaubnis. Empfehlung: nicht-exklusive Lizenz fuer Test-Daten, klare Loeschpflicht nach Pitch.

# NDA mit IT-/SaaS-Vendor

## Spezialwissen: NDA mit IT-/SaaS-Vendor
- **Spezialgegenstand:** NDA mit IT-/SaaS-Vendor / nda it saas vendor. Der Skill löst diese konkrete Lage und darf nicht in allgemeines Routing ausweichen.
- **Normen-/Quellenanker:** NDA, IT.
...
## 2. `nda-laufzeit-und-survival`

**Fokus:** Laufzeit und Survival der Geheimhaltungspflicht: Festlaufzeit, automatische Verlaengerung, Survival 2/3/5 Jahre nach Vertragsende. Bei Geschaeftsgeheimnissen i. S. GeschGehG ist Survival 'so lange die Information Geschaeftsgeheimnis ist' moeglich. Empfehlungen je Rolle.

# NDA: Laufzeit/Survival

## Spezialwissen: NDA: Laufzeit/Survival
- **Spezialgegenstand:** NDA: Laufzeit/Survival / nda laufzeit und survival. Der Skill löst diese konkrete Lage und darf nicht in allgemeines Routing ausweichen.
...
## 3. `nda-m-und-a-clean-team-spezial`

**Fokus:** Spezialfall NDA fuer M-and-A und Clean-Team-Arrangements: Datenraum, Sondervertraulichkeit Wettbewerbsdaten, Kartellrecht. Pruefraster fuer Antitrust-Counsel.

# NDA: M-and-A Clean-Team

## Spezialwissen: NDA: M-and-A Clean-Team
- **Spezialgegenstand:** NDA: M-and-A Clean-Team / nda m und a clean team spezial. Der Skill löst diese konkrete Lage und darf nicht in allgemeines Routing ausweichen.
