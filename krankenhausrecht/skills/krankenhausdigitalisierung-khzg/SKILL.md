...
description: "Krankenhausdigitalisierung Khzg: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Krankenhausdigitalisierung Khzg

## Arbeitsbereich

Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Krankenhausdigitalisierung Khzg** im Plugin Krankenhausrecht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `krankenhaushygiene-ifsg-landesrecht` | Krankenhaushygiene zwischen IfSG, KRINKO-Empfehlungen und Landeshygieneverordnungen: Hygieneplan, MRE, Meldewege, Ausbruchsmanagement, Aufsichtsdialog mit Gesundheitsamt. |

## Arbeitsweg

Im Plugin Krankenhausrecht gilt für **Krankenhausdigitalisierung Khzg**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
**Fokus:** Krankenhausdigitalisierung KHZG IT-Sicherheit: prüft die einschlägigen Voraussetzungen, Dokumente, Risiken und Ausnahmen. Norm-/Quellenanker: KHG, KHEntgG, BPflV, SGB V, KHVVG/Reformstand, G-BA-Richtlinien, Landeskrankenhausrecht, MD-Prüfregeln, IfSG, MPDG/MDR.
...
## 2. `krankenhausfinanzierungsgesetz-khg-grundstruktur`

**Fokus:** Grundstruktur des KHG nach Reform 2025: duale Finanzierung, Landesplanung, Investitionsfoerderung, Leistungsgruppen und Bund-Laender-Aufgabenteilung im Ueberblick.
...
## 3. `krankenhaushygiene-ifsg-landesrecht`

**Fokus:** Krankenhaushygiene zwischen IfSG, KRINKO-Empfehlungen und Landeshygieneverordnungen: Hygieneplan, MRE, Meldewege, Ausbruchsmanagement, Aufsichtsdialog mit Gesundheitsamt.
...
- Drohen Bussgeld, Schliessung Bereich, MD-Pruefung mit Konsequenz?
...
| Lage | Massnahme | Eskalation |
|---|---|---|
| Routinepruefung Gesundheitsamt | Hygieneplan vorlegen | i. d. R. ok |
| MRE-Cluster | KRINKO-Massnahmen, Surveillance | Meldung GA |
| Nosokomialer Ausbruch | § 6 IfSG-Meldung, Untersuchungsteam, Massnahmen | Ggf. Bereichsschliessung |
...
- Hygienefachkraft (HFK)-Vollkraefte-Schluessel je Bettenzahl (Landes-Hygieneverordnungen).
- Ausbruchsmeldung sofort, dokumentiert; Eintraege ins Infektionsschutzgesetz-Meldewesen ueber GA.
...
> An das Gesundheitsamt [Ort]. Wir melden gemaess § 6 Abs. 3 IfSG einen nosokomialen Ausbruch [Erreger] in [Bereich]. Erste Faelle: [Daten]. Massnahmen: Kohortenpflege, Personalscreening, Sanierung. Ansprechpartner Hygiene: …
