...
description: "Für Icsid Quellenkarte: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Diese Quellenkarte sichert für **Fachanwalt Internationales Wirtschaftsrecht** jede tragende Aussage ab: Norm, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor Ausgabe verifiziert.

## Tragende Normen (live prüfen)

- **Rom I/II VO** — amtlichen Stand vor tragender Aussage prüfen
- **CISG** — amtlichen Stand vor tragender Aussage prüfen
- **ICC Incoterms** — amtlichen Stand vor tragender Aussage prüfen
- **ICSID/UNCITRAL** — amtlichen Stand vor tragender Aussage prüfen

## Zuständige Spruchkörper und Behörden

- Schiedsgerichte (DIS, ICC)
...
- Schiedsklage-Fristen je Regelwerk
- CISG-Mängelrüge angemessen
