...
1. **Semesterübergabe:** Nachfolgende Studierende müssen den Stand des Mandats vollständig nachvollziehen können (`/rechtsberatungsstelle:semester-handoff`).
...
- Fristen aus dem Beschluss/Urteil sofort in `/rechtsberatungsstelle:deadlines` eintragen.
...
- Log für Semesterübergabe exportieren → `/rechtsberatungsstelle:semester-handoff` aufrufen.
...
- **Offene Fristen nicht weitergegeben:** Beim Semesterwechsel sind nicht übergebene Fristen das größte Haftungsrisiko. Das Log ist die Grundlage für `/rechtsberatungsstelle:semester-handoff`.
