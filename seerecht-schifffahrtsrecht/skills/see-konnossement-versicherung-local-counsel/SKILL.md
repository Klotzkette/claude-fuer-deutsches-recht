---
name: see-konnossement-versicherung-local-counsel
description: "SEE Konnossement Versicherung Local Counsel: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# SEE Konnossement Versicherung Local Counsel

## Arbeitsbereich

Dieser Skill bündelt 5 sachlich verwandte Arbeitsschritte rund um **SEE Konnossement Versicherung Local Counsel** im Plugin Seerecht Schifffahrtsrecht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `see-108-konnossement-closing-planen` | Konnossement: Closing eines Konnossements-Transaktion (Bill of Lading)-Kaufs oder einer Finanzierung planen: Eigentumsuebergang (SchRG § 2); Hypothekenloesung (SchRG § 19); simultane Zahlung und Eintragung; Zertifikats-Ummeldung. Output: Closing-Checkliste und Zeitplan. |
| `see-109-konnossement-klagepfad-waehlen` | Konnossement: Glaeubiger oder Reeder waehlt Klagepfad bei Streit um Konnossements-Transaktion (Bill of Lading): Zwangsversteigerung (ZPO §§ 864-871); Arrest; einvernehmlicher Verkauf; Insolvenzantrag. Rangfolge und Erloesprognose. Output: Klagepfad-Analyse und Erloesprognose. |
| `see-110-konnossement-risiko-memo-schreiben` | Konnossement: Gesamtrisikobewertung fuer Verfrachter; Ablader; Konnossementsinhaber; finanzierende Bank bei Konnossements-Transaktion (Bill of Lading): Kreditausfall; Hypothekenrang; Schiffsglaeubigerrechte; Wrackpflicht; Insolvenzrisiko; Handlungsoptionen. HGB §§ 513-525 Konnossement; HGB §§ 498-511 Verfrachter-Haftung; Hague-Visby Rules. Output: Risiko-Memo und Empfehlungsmatrix. |

## Arbeitsweg

Im Plugin Seerecht Schifffahrtsrecht gilt für **SEE Konnossement Versicherung Local Counsel**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
## Mandantenfall
Ein Konnossements-Transaktion (Bill of Lading) erleidet Kollisionsschäden; P&I-Club und H&M-Versicherer werden koordiniert informiert. Ein Reeder verzögert die Schadensmeldung; Versicherer beruft sich auf VVG § 28 Obliegenheitsverletzung. Eine Bank aktiviert MII-Police nach Totalverlust eines hypothekenbelasteten Konnossements-Transaktion (Bill of Lading).
...
## Output
Meldecheckliste (P&I/H&M/MII) und Fristenübersicht für Konnossements-Transaktion (Bill of Lading).
...
## Mandantenfall
Ein Konnossements-Transaktion (Bill of Lading) liegt in einem ausländischen Hafen; lokaler Arrest ist erforderlich. Eine Hypothekenbank braucht Auskunft zur Vollstreckbarkeit ihrer deutschen Sicherheit im Ausland. Ein P&I-Club braucht nach Unfall lokale Rechtsvertretung für das Konnossements-Transaktion (Bill of Lading).

## Erste Schritte
1. Local Counsel auswaehlen: Empfehlung durch P&I-Club-Korrespondenten oder Netzwerk.
2. Briefing erstellen: Konnossements-Transaktion (Bill of Lading)-Daten (IMO-Nummer; Flagge); Sachverhalt; deutsches Recht.
...
- Hat Local Counsel Erfahrung mit Seerecht und Konnossement?
...
## Output
Local-Counsel-Briefing für Konnossements-Transaktion (Bill of Lading) und Prioritätenliste.
...
## Mandantenfall
Der Kauf eines Konnossements-Transaktion (Bill of Lading) soll abgeschlossen werden; Hypotheken sind abzulösen. Ein Käufer besteht auf lastenfreier Lieferung mit gültiger Klasse und MLC-Zertifikat. Eine Bank koordiniert das Closing bei syndizierten Finanzierungen.
...
## Output
Closing-Checkliste und Zeitplan mit Abhängigkeiten für Konnossements-Transaktion (Bill of Lading).
...
## Mandantenfall
Eine Bank bereitet den Vorstand auf potenzielle Kreditausfälle in der Konnossement-Flotte vor. Ein Finanzinvestor prüft den Kauf eines Kreditportfolios mit Konnossement-Hypotheken. Ein Syndikat benötigt ein gemeinsames Risikodokument für alle Banken.

## Erste Schritte
1. Konnossement-Daten zusammenfassen: IMO-Nummer; Flagge; Alter; Schiffswert; Kreditvaluta.
...
## Output
Risiko-Memo (Exekutivfassung) und Empfehlungsmatrix für Konnossements-Transaktion (Bill of Lading).
