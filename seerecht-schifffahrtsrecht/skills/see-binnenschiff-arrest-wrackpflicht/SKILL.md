...
| `see-086-binnenschiff-versicherung-melden` | Binnenschiff: Schadensereignis an Binnenmotorgueterschiff; Tanker oder Fahrgastschiff melden: P&I-Club-Meldepflicht; H&M-Police-Meldung; Mortgagee Interest Insurance (MII) aktivieren. VVG §§ 28-30 Obliegenheiten; DTV-Klauseln Kasko; IGP&I Club Rules. Output: Meldecheckliste und Fristenuebersicht. |
| `see-087-binnenschiff-local-counsel-instruieren` | Binnenschiff: Auslaendischen Anwalt fuer Arrest; Vollstreckung oder Registerfragen bei Binnenmotorgueterschiff; Tanker oder Fahrgastschiff im Ausland instruieren. ISAC 1952; EuGVVO 2012; lokales Seepfandrecht; P&I-Korrespondenten. Output: Local-Counsel-Briefing und Prioritaetenliste. |
| `see-088-binnenschiff-closing-planen` | Binnenschiff: Closing eines Binnenmotorgueterschiff; Tanker oder Fahrgastschiff-Kaufs oder einer Finanzierung planen: Eigentumsuebergang (SchRG § 2); Hypothekenloesung (SchRG § 19); simultane Zahlung und Eintragung; Zertifikats-Ummeldung. Output: Closing-Checkliste und Zeitplan. |
...
## Output
Arrestantrags-Baustein (ZPO § 920) und Vollziehungs-Zeitplan für Binnenmotorgueterschiff; Tanker oder Fahrgastschiff.
...
## Mandantenfall
Ein Binnenmotorgueterschiff; Tanker oder Fahrgastschiff sinkt in deutschen Gewässern; WSA ordnet Beseitigung an; Eigentümer fragt nach Haftung. Die finanzierende Bank fragt, ob sie als Hypothekengläubigerin haftet. Ein Reeder ist insolvent; Behörde will Kosten beim letzten Eigentümer eintreiben.

## Erste Schritte
1. WRC 2007 / WSG Anwendbarkeit pruefen: Binnenmotorgueterschiff; Tanker oder Fahrgastschiff ab 300 BRZ in deutschen Gewaessern.
...
## Prüfraster
- Ist der Eigentuemer des Binnenmotorgueterschiff; Tanker oder Fahrgastschiff bekannt und zahlungsfaehig?
...
- Bestehen Umweltschadensrisiken (Bunkeröl/Chemikalien) beim Binnenmotorgueterschiff; Tanker oder Fahrgastschiff?
...
- Bei Binnenmotorgueterschiff; Tanker oder Fahrgastschiff unter Auslandsflagge kommen Flaggenstaat-Pflichten hinzu.

## Output
WRC-Pflichtenanalyse und Kostenrisiko-Vermerk für Binnenmotorgueterschiff; Tanker oder Fahrgastschiff.
...
## Mandantenfall
Ein Binnenmotorgueterschiff; Tanker oder Fahrgastschiff erleidet Kollisionsschäden; P&I-Club und H&M-Versicherer werden koordiniert informiert. Ein Reeder verzögert die Schadensmeldung; Versicherer beruft sich auf VVG § 28 Obliegenheitsverletzung. Eine Bank aktiviert MII-Police nach Totalverlust eines hypothekenbelasteten Binnenmotorgueterschiff; Tanker oder Fahrgastschiff.
...
## Output
Meldecheckliste (P&I/H&M/MII) und Fristenübersicht für Binnenmotorgueterschiff; Tanker oder Fahrgastschiff.
...
## Mandantenfall
Ein Binnenmotorgueterschiff; Tanker oder Fahrgastschiff liegt in einem ausländischen Hafen; lokaler Arrest ist erforderlich. Eine Hypothekenbank braucht Auskunft zur Vollstreckbarkeit ihrer deutschen Sicherheit im Ausland. Ein P&I-Club braucht nach Unfall lokale Rechtsvertretung für das Binnenmotorgueterschiff; Tanker oder Fahrgastschiff.

## Erste Schritte
1. Local Counsel auswaehlen: Empfehlung durch P&I-Club-Korrespondenten oder Netzwerk.
2. Briefing erstellen: Binnenmotorgueterschiff; Tanker oder Fahrgastschiff-Daten (IMO-Nummer; Flagge); Sachverhalt; deutsches Recht.
...
- Hat Local Counsel Erfahrung mit Seerecht und Binnenschiff?
...
## Output
Local-Counsel-Briefing für Binnenmotorgueterschiff; Tanker oder Fahrgastschiff und Prioritätenliste.
...
4. Eigentumsuebergang (SchRG § 2) und Hypothekenloesung gleichzeitig fuer Binnenmotorgueterschiff; Tanker oder Fahrgastschiff.
...
- Sind alle Zertifikate fuer Binnenmotorgueterschiff; Tanker oder Fahrgastschiff auf neuen Eigentuemer vorbereitet?
