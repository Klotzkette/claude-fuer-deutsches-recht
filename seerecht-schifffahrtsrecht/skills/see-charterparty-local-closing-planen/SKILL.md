---
name: see-charterparty-local-closing-planen
description: "SEE Charterparty Local Closing Planen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# SEE Charterparty Local Closing Planen

## Arbeitsbereich

Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **SEE Charterparty Local Closing Planen** im Plugin Seerecht Schifffahrtsrecht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `see-119-charterparty-klagepfad-waehlen` | Charterparty: Glaeubiger oder Reeder waehlt Klagepfad bei Streit um Gechartertes Seeschiff unter Charterparty: Zwangsversteigerung (ZPO §§ 864-871); Arrest; einvernehmlicher Verkauf; Insolvenzantrag. Rangfolge und Erloesprognose. Output: Klagepfad-Analyse und Erloesprognose. |

## Arbeitsweg

Im Plugin Seerecht Schifffahrtsrecht gilt für **SEE Charterparty Local Closing Planen**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
## Mandantenfall
Ein Gechartertes Seeschiff unter Charterparty liegt in einem ausländischen Hafen; lokaler Arrest ist erforderlich. Eine Hypothekenbank braucht Auskunft zur Vollstreckbarkeit ihrer deutschen Sicherheit im Ausland. Ein P&I-Club braucht nach Unfall lokale Rechtsvertretung für das Gechartertes Seeschiff unter Charterparty.

## Erste Schritte
1. Local Counsel auswaehlen: Empfehlung durch P&I-Club-Korrespondenten oder Netzwerk.
2. Briefing erstellen: Gechartertes Seeschiff unter Charterparty-Daten (IMO-Nummer; Flagge); Sachverhalt; deutsches Recht.
...
- Hat Local Counsel Erfahrung mit Seerecht und Charterparty?
...
## Mandantenfall
Der Kauf eines Gechartertes Seeschiff unter Charterparty soll abgeschlossen werden; Hypotheken sind abzulösen. Ein Käufer besteht auf lastenfreier Lieferung mit gültiger Klasse und MLC-Zertifikat. Eine Bank koordiniert das Closing bei syndizierten Finanzierungen.
...
4. Eigentumsuebergang (SchRG § 2) und Hypothekenloesung gleichzeitig fuer Gechartertes Seeschiff unter Charterparty.
...
- Sind alle Zertifikate fuer Gechartertes Seeschiff unter Charterparty auf neuen Eigentuemer vorbereitet?
...
## Output
Closing-Checkliste und Zeitplan mit Abhängigkeiten für Gechartertes Seeschiff unter Charterparty.
...
## Mandantenfall
Eine Bank will nach Kreditausfall aus der Hypothek am Gechartertes Seeschiff unter Charterparty vollstrecken. Mehrere Gläubiger streiten um den Versteigerungserlös des Gechartertes Seeschiff unter Charterparty. Ein Reeder prüft, ob ein freiwilliger Verkauf günstiger ist als die Zwangsversteigerung.

## Erste Schritte
1. Schiffswert des Gechartertes Seeschiff unter Charterparty ermitteln: aktuelles Schätzgutachten beschaffen.
...
## Prüfraster
- Uebersteigt Schiffswert des Gechartertes Seeschiff unter Charterparty die Kreditvaluta?
...
## Output
Klagepfad-Analyse und Erlösprognose (Tabelle Kosten vs. Erlös) für Gechartertes Seeschiff unter Charterparty.
