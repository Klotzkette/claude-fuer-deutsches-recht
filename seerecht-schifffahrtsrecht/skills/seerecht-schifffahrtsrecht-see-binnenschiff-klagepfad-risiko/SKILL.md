...
description: "SEE Binnenschiff Klagepfad Risiko: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# SEE Binnenschiff Klagepfad Risiko

## Arbeitsbereich

Dieser Skill bündelt 5 sachlich verwandte Arbeitsschritte rund um **SEE Binnenschiff Klagepfad Risiko** im Plugin Seerecht Schifffahrtsrecht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
## Mandantenfall
Eine Bank will nach Kreditausfall aus der Hypothek am Binnenmotorgueterschiff; Tanker oder Fahrgastschiff vollstrecken. Mehrere Gläubiger streiten um den Versteigerungserlös des Binnenmotorgueterschiff; Tanker oder Fahrgastschiff. Ein Reeder prüft, ob ein freiwilliger Verkauf günstiger ist als die Zwangsversteigerung.

## Erste Schritte
1. Schiffswert des Binnenmotorgueterschiff; Tanker oder Fahrgastschiff ermitteln: aktuelles Schätzgutachten beschaffen.
...
## Prüfraster
- Uebersteigt Schiffswert des Binnenmotorgueterschiff; Tanker oder Fahrgastschiff die Kreditvaluta?
...
## Output
Klagepfad-Analyse und Erlösprognose (Tabelle Kosten vs. Erlös) für Binnenmotorgueterschiff; Tanker oder Fahrgastschiff.
...
## Rechtsrahmen
- BinSchG §§ 1-133; SchRG §§ 1-75 fuer eingetragene Binnenschiffe; BinSchRegO; InsO §§ 49-51 Absonderung; WSG §§ 1-12 Wrackpflicht; ZPO §§ 864-871 Zwangsversteigerung.

## Prüfraster
- Ist aktueller Schiffswert fuer Binnenmotorgueterschiff; Tanker oder Fahrgastschiff dokumentiert?
...
## Typische Fallstricke
- Schiffswertgutachten fuer Binnenmotorgueterschiff; Tanker oder Fahrgastschiff veraltet; Marktpreise schwanken stark.
...
## Output
Risiko-Memo (Exekutivfassung) und Empfehlungsmatrix für Binnenmotorgueterschiff; Tanker oder Fahrgastschiff.
...
## Mandantenfall
Eine finanzierende Bank prueft den Seeschiffsregister; typisch auslaendische Flagge (Bahamas/Malta) vor Auszahlung eines Kredits fuer ein Kreuzfahrtschiff oder grosses Fahrgastschiff. Ein Investor will Eigentuemerstellung und Lastenfreiheit bestaetigt haben. Ein Insolvenzverwalter erstellt die Glaeubigerliste fuer die Masse.

## Erste Schritte
1. Aktuellen Registerauszug (Seeschiffsregister; typisch auslaendische Flagge (Bahamas/Malta)) beim zustaendigen Gericht beschaffen.
...
## Output
Registerprüfprotokoll mit Abteilungsübersicht und Rangkarte für Kreuzfahrtschiff oder grosses Fahrgastschiff.
...
## Mandantenfall
Eine Bank bestellt eine Hypothek auf ein Kreuzfahrtschiff oder grosses Fahrgastschiff als Sicherheit fuer einen Schiffskredit. Ein Reeder sucht Zwischenfinanzierung und bietet sein Kreuzfahrtschiff oder grosses Fahrgastschiff als Sicherheit an. Eine Bestandshypothek soll auf eine neue Kredittranche erstreckt werden.
...
## Output
Arrestantrags-Baustein (ZPO § 920) und Vollziehungs-Zeitplan für Kreuzfahrtschiff oder grosses Fahrgastschiff.
