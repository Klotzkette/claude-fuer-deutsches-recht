...
4. Eigentumsuebergang (SchRG § 2) und Hypothekenloesung gleichzeitig fuer Offshore-Versorgungsschiff (PSV/AHTS) oder Bohrinsel-Tender.
...
- Sind alle Zertifikate fuer Offshore-Versorgungsschiff (PSV/AHTS) oder Bohrinsel-Tender auf neuen Eigentuemer vorbereitet?
...
## Erste Schritte
1. Schiffswert des Offshore-Versorgungsschiff (PSV/AHTS) oder Bohrinsel-Tender ermitteln: aktuelles Schätzgutachten beschaffen.
...
## Prüfraster
- Uebersteigt Schiffswert des Offshore-Versorgungsschiff (PSV/AHTS) oder Bohrinsel-Tender die Kreditvaluta?
...
## Erste Schritte
1. Offshore-Schiff-Daten zusammenfassen: IMO-Nummer; Flagge; Alter; Schiffswert; Kreditvaluta.
...
## Rechtsrahmen
- HGB §§ 476 ff.; MODU-Code IMO; SchRG §§ 8-75; OSPAR-Konvention Nordsee; InsO §§ 49-51 Absonderung; WSG §§ 1-12 Wrackpflicht; ZPO §§ 864-871 Zwangsversteigerung.

## Prüfraster
- Ist aktueller Schiffswert fuer Offshore-Versorgungsschiff (PSV/AHTS) oder Bohrinsel-Tender dokumentiert?
...
## Typische Fallstricke
- Schiffswertgutachten fuer Offshore-Versorgungsschiff (PSV/AHTS) oder Bohrinsel-Tender veraltet; Marktpreise schwanken stark.
...
- Voreintragungspflicht: Veräußerer muss im Binnenschiffsregister (AG Duisburg-Ruhrort) eingetragen sein.
- Bei Binnenmotorgueterschiff; Tanker oder Fahrgastschiff unter Auslandsflagge gilt Lex registri des Flaggenstaats.

## Output
Registerprüfprotokoll mit Abteilungsübersicht und Rangkarte für Binnenmotorgueterschiff; Tanker oder Fahrgastschiff.
...
## Mandantenfall
Eine Bank bestellt eine Hypothek auf ein Binnenmotorgueterschiff; Tanker oder Fahrgastschiff als Sicherheit fuer einen Schiffskredit. Ein Reeder sucht Zwischenfinanzierung und bietet sein Binnenmotorgueterschiff; Tanker oder Fahrgastschiff als Sicherheit an. Eine Bestandshypothek soll auf eine neue Kredittranche erstreckt werden.
...
## Rechtsrahmen
- BinSchG §§ 1-133; SchRG §§ 1-75 fuer eingetragene Binnenschiffe; BinSchRegO; SchRG § 31 Zubehoer-Mithaftung; SchRG § 75 Hoechstbetragshypothek; SchRegO §§ 13-19. ADN-Gefahrgut Binnenwasserstrassen; RheinSchPersV; CESNI-Standards.
