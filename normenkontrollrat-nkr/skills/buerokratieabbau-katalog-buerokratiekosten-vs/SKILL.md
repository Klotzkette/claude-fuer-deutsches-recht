...
description: "Buerokratieabbau Katalog Buerokratiekosten VS: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
Im Plugin Normenkontrollrat (NKR) gilt für **Buerokratieabbau Katalog Buerokratiekosten VS**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Rueckfrage nur wenn unklar: *"Soll der Vorschlag in einer aktuellen Stellungnahme empfohlen werden oder als Gegenrechnung dienen?"*

## Rechtlicher und methodischer Rahmen

- **NKRG** § 4, § 7
- **Leitfaden BMI / NKR**
- **One-in-one-out-Beschluss der Bundesregierung 2015**
- **EU Better Regulation REFIT**
- **NKR-Jahresbericht** (jeweils aktuelle Ausgabe) — Best-Practice-Kapitel

## Buerokratieabbau-Katalog (zwoelf Standardmuster)
...
Daten nicht erneut erheben, sondern aus bestehenden Registern uebernehmen (Handelsregister, Steuerregister, Sozialversicherung).

### Muster 4 — Stichproben statt Vollkontrolle

Statt jeder Fall: risikobasierte Stichprobe.

### Muster 5 — Anzeige statt Genehmigung

Statt Genehmigungsvorbehalt: Anzeige plus nachtraegliche Kontrolle.

### Muster 6 — Digitalisierung

Antrag, Bescheid, Zustellung digital — mit Standards XOEV / FIM.

### Muster 7 — Selbsterklaerung statt Nachweis

Vertrauensbasiertes Verfahren mit Sanktion bei Missbrauch.

### Muster 8 — Verzicht auf Doppelpflichten

Pflichten, die parallel zu EU-Vorgaben bestehen, harmonisieren.

### Muster 9 — Jaehrlich statt monatlich
...
### Muster 11 — Aufhebung redundanter Vorschriften

Alte Normen, die durch neuere ersetzt sind, ausdruecklich aufheben.

### Muster 12 — Befristung / Sunset
...
| Muster | Aufwandsreduktion (typisch) | Wirksamkeits-Verlust |
|---|---|---|
| Schwellenwert | hoch | gering bei Risikobasis |
| Once-Only | sehr hoch | keiner |
| Stichprobe | mittel-hoch | gering |
| Anzeige statt Genehmigung | hoch | mittel |
| Digitalisierung | hoch | keiner |
| Frequenzreduktion | mittel-hoch | gering bei Event-Pflicht |
...
### Gegenrechnung One-in-one-out (Beispiel-Verbuchung)

> "Im Rahmen der ressortinternen One-in-one-out-Bilanz wird die durch dieses Vorhaben entstehende Belastung von [X] Mio EUR p.a. wie folgt ausgeglichen:
> - Aufhebung der jaehrlichen Berichtspflicht nach [Norm]: -[A] Mio EUR p.a.
> - Reduktion der Frequenz der Meldung nach [Norm] von monatlich auf jaehrlich: -[B] Mio EUR p.a.
> - Schwellenwert-Einfuehrung in [Norm]: -[C] Mio EUR p.a.
> Saldo: 0 EUR p.a."
