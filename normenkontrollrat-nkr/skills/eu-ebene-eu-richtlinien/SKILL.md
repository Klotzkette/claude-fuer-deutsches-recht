...
description: "EU Ebene EU Richtlinien: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# EU Ebene EU Richtlinien

## Arbeitsbereich

Dieser Skill bündelt 2 sachlich verwandte Arbeitsschritte rund um **EU Ebene EU Richtlinien** im Plugin Normenkontrollrat (NKR). Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Normenkontrollrat (NKR) gilt für **EU Ebene EU Richtlinien**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
- Vorhaben adressiert ein REFIT-Thema
- Frage nach Vergleich mit europaeischen Better-Regulation-Standards

Rueckfrage nur wenn unklar: *"Handelt es sich um Umsetzung einer Richtlinie, Durchfuehrung einer Verordnung oder rein nationale Regelung mit EU-Bezug?"*
