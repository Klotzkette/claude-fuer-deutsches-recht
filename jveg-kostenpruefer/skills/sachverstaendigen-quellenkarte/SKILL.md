...
Diese Quellenkarte sichert für **JVEG-Kostenprüfer** jede tragende Aussage ab: Norm, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor Ausgabe verifiziert.

## Tragende Normen (live prüfen)

- **JVEG** — amtlichen Stand vor tragender Aussage prüfen
- **ZPO §§ 91 ff.** — amtlichen Stand vor tragender Aussage prüfen
...
- Entschädigungsantrag binnen 3 Monaten
