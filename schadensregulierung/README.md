...
> Sichte den ausgewählten Ordner intern, ohne seine Inhalte ungefragt aufzulisten. Lies die für den Auftrag tragenden Unterlagen; ergänze die Lektüre gezielt bei offenen Belegfragen. Beginne mit folgendem Arbeitsschritt: den nächsten Entwurf aus Ihrer Rolle als Unternehmen oder regulierender Versicherer, mit belegtem Ereignis, gefährdeten Belegen und getrenntem Deckungsstand. Wenn bereits ein konkretes Dokument verlangt ist, beginne unmittelbar damit. Frage gezielt nach entscheidenden offenen Punkten und arbeite an den unabhängigen Teilen weiter. Verarbeite die Antwort im bestehenden Entwurf; weitere Rückfragen nur bei neuen entscheidenden Lücken.
...
| --- | --- | --- | --- |
| [Fahrzeugschaden nach Umsetzung aus einer Berliner Busspur](../testakten/schadensregulierung-abschleppschaden-busspur-berlin/README.md) | [Gesamt-PDF](../testakten/schadensregulierung-abschleppschaden-busspur-berlin/gesamt-pdf/schadensregulierung-abschleppschaden-busspur-berlin_gesamt.pdf) | [`testakte-schadensregulierung-abschleppschaden-busspur-berlin.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/testakte-schadensregulierung-abschleppschaden-busspur-berlin.zip) | [`testakte-schadensregulierung-abschleppschaden-busspur-berlin-einzelpdfs.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/testakte-schadensregulierung-abschleppschaden-busspur-berlin-einzelpdfs.zip) |
...
Für Rechtsabteilung, Anwalt und regulierenden Haftpflichtversicherer. Zehn Skills führen vom ersten Hinweis auf einen Schaden über Beweissicherung und Deckungsprüfung bis zur begründeten Zahlung, Teilregulierung, Ablehnung oder Übergabe an den Prozessvertreter. Personen-, Sach-, Betriebs- und Produktfälle sind ebenso möglich wie U-Bahn-Vorfälle und Schäden an abgeschleppten Fahrzeugen. Eigene Schäden des Unternehmens werden getrennt erfasst; sie verwandeln den Vorgang nicht ungefragt in eine Klägerstrategie.
...
## 2. Zehn klar abgegrenzte Aufgaben
...
| Der Haftpflichtversicherer bearbeitet den Schaden selbst | [Haftpflichtschaden regulieren](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/haftpflichtschaden-regulieren/SKILL.md) | Besichtigung, Deckungsstand, interne Vorlage und getrennter Außenbrief |
| Auto bei Umsetzung aus Busspur oder Haltestelle beschädigt | [Abschleppschaden prüfen](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/abschleppschaden-pruefen/SKILL.md) | Auftraggeber, Obhutskette, Vorschaden, Reparatur und Versicherungsweg |
...
Für den Versicherer: „Wir bearbeiten den Haftpflichtfall für unseren Versicherungsnehmer. Bereiten Sie aus dem Ordner die Besichtigung und die nächste Antwort vor. Halten Sie Deckung und interne Reserve vom Außenanschreiben getrennt.“ Beim Abschleppschaden genügt als Zusatz die eigene Rolle; ein neues Interview ist nicht nötig, wenn Auftrag und Fahrzeugdaten bereits vorliegen.
...
Beim Abschleppen bleiben Anordnung, Gebühren und Ausführungsschaden getrennt. Ein Parkverstoß schließt einen Ersatzanspruch nicht automatisch aus. Ein behördlicher Auftrag kann den Anspruch gegen den Verwaltungsträger lenken; nicht immer ist das Abschleppunternehmen der richtige Außenanspruchsgegner. Betriebshaftpflicht, Kfz-Haftpflicht und Kasko sind keine austauschbaren Deckungen.

## 4. Zwei Berliner Vorgänge
...
Die [Akte Fahrzeugschaden nach Umsetzung aus einer Busspur](../testakten/schadensregulierung-abschleppschaden-busspur-berlin/README.md) enthält fünfzehn Unterlagen mit Auftragsjournal, Fahrerbericht, getrennten Fahrzeugbefunden, Werkstattangebot und aktiver Versichererkorrespondenz. Die Besichtigung steht noch aus; Fotos und Vertragsseiten, die erst angefordert wurden, werden nicht als vorhanden ausgegeben. Auch diese Akte gibt es in allen drei Downloadformaten ohne vorgegebene Lösung.

## 5. English Summary

This compact claims-handling workflow serves companies, their lawyers and liability insurers. Ten focused skills cover intake, evidence, liability, insurance, active insurer handling, towing damage, loss assessment, transferred claims, correspondence and settlement/payment control. It is not limited to transport incidents. The workshop and short prompt work independently of the installed plugin. Two Berlin case files cover an underground incident and vehicle damage after towing from a bus lane, each in combined PDF, individual-PDF ZIP and original-format ZIP versions. No message, settlement or payment is executed automatically.
...
| --- | --- |
| 1. Einstieg und Fallrouting | [`schadenfall-aufnehmen`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/schadenfall-aufnehmen/SKILL.md), [`versicherung-einschalten`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/versicherung-einschalten/SKILL.md) |
...
| 3. Prüfung, Anspruch und Subsumtion | [`abschleppschaden-pruefen`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/abschleppschaden-pruefen/SKILL.md), [`haftungsweg-bestimmen`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/haftungsweg-bestimmen/SKILL.md), [`regress-und-anspruchsuebergang`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/regress-und-anspruchsuebergang/SKILL.md), [`schadenpositionen-pruefen`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/schadenpositionen-pruefen/SKILL.md) |
| 4. Gestaltung, Strategie und Verhandlung | [`haftpflichtschaden-regulieren`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/haftpflichtschaden-regulieren/SKILL.md), [`vergleich-und-zahlung-abschliessen`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/vergleich-und-zahlung-abschliessen/SKILL.md) |
| 6. Ergebnis, Schreiben und Kommunikation | [`regulierung-korrespondieren`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/regulierung-korrespondieren/SKILL.md) |
...
| [`regress-und-anspruchsuebergang`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/regress-und-anspruchsuebergang/SKILL.md) | Ordnet Schadenforderungen zwischen Geschädigtem, Krankenkasse, Arbeitgeber und Sachversicherer zu. Prüft sachlich und zeitlich entsprechende Leistungen, Anspruchsübergänge und Rückgriff gegen weitere Verantwortliche; verhindert Doppelzah... | [MD herunterladen / Download MD](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/regress-und-anspruchsuebergang/SKILL.md) |
| [`regulierung-korrespondieren`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/regulierung-korrespondieren/SKILL.md) | Formuliert Eingangsbestätigungen, Belegnachforderungen, Zwischenbescheide, Teilregulierungen und begründete Ablehnungen für Unternehmen oder regulierende Haftpflichtversicherer. Trennt Außenbrief und interne Freigabe, ohne verdeckte Aner... | [MD herunterladen / Download MD](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/regulierung-korrespondieren/SKILL.md) |
| [`schadenfall-aufnehmen`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/schadenfall-aufnehmen/SKILL.md) | Beginnt die Schadenabwicklung für Unternehmen, Anspruchsgegner oder regulierende Haftpflichtversicherer aus Meldung und Aktenordner. Ordnet Rolle, Belegverlust und nächsten Entwurf zu; unterscheidet allgemeine Personen- und Sachschäden,... | [MD herunterladen / Download MD](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=schadensregulierung/skills/schadenfall-aufnehmen/SKILL.md) |
