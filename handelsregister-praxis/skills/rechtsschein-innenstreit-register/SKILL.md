...
description: "Rechtsschein Innenstreit Register: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Rechtsschein Innenstreit Register

## Arbeitsbereich

Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Rechtsschein Innenstreit Register** im Plugin Handelsregister Praxis. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Handelsregister Praxis gilt für **Rechtsschein Innenstreit Register**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `rechtsschein-und-innenstreit`

**Fokus:** Trennt materielles Gesellschaftsrecht, Registerlage, Vertretungsmacht und Gutglaubensschutz.

# Innenstreit trotz Registerschein

## Fachlicher Zuschnitt

Trennt materielles Gesellschaftsrecht, Registerlage, Vertretungsmacht und Gutglaubensschutz.
...
## 2. `register-mandantenbrief`

**Fokus:** Erstellt klare Mandantenupdates: Stand, Risiko, To-dos, Fristen, nächste Entscheidung.

# Mandantenbrief Registerstand

## Fachlicher Zuschnitt

Erstellt klare Mandantenupdates: Stand, Risiko, To-dos, Fristen, nächste Entscheidung.
...
## 3. `register-qualitaetsgate-vor-einreichung`

**Fokus:** Checkliste vor dem Absenden: Urkunden, Beschlüsse, Listen, Unterschriften, Kapital, Namen, Daten, Registerblatt.

# Quality Gate vor Einreichung

## Fachlicher Zuschnitt

Checkliste vor dem Absenden: Urkunden, Beschlüsse, Listen, Unterschriften, Kapital, Namen, Daten, Registerblatt.
