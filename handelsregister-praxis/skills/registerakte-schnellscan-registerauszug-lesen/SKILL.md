...
description: "Registerakte Schnellscan Registerauszug Lesen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Registerakte Schnellscan Registerauszug Lesen

## Arbeitsbereich

Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Registerakte Schnellscan Registerauszug Lesen** im Plugin Handelsregister Praxis. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Handelsregister Praxis gilt für **Registerakte Schnellscan Registerauszug Lesen**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `registerakte-schnellscan-und-vollzugskarte`

**Fokus:** Erstellt eine Vollzugskarte aus Satzung, Beschluss, Anmeldung, Liste, Notarvermerk, Gerichtsschreiben und Fristenlog.

# Registerakte in 10 Minuten sortieren

## Fachlicher Zuschnitt

Erstellt eine Vollzugskarte aus Satzung, Beschluss, Anmeldung, Liste, Notarvermerk, Gerichtsschreiben und Fristenlog.
...
## 2. `registerauszug-lesen`

**Fokus:** Erklärt Abteilungen/Spalten, Historie, Vertretung, Kapital, Firma, Prokura, Insolvenz und Bekanntmachungen.

# Handelsregisterauszug lesen

## Fachlicher Zuschnitt

Erklärt Abteilungen/Spalten, Historie, Vertretung, Kapital, Firma, Prokura, Insolvenz und Bekanntmachungen.
...
## 3. `registerbeweis-im-prozess`

**Fokus:** Bereitet Registerauszüge, Bekanntmachungen und Nachweise prozesstauglich auf.

# Registerbeweis im Zivilprozess

## Fachlicher Zuschnitt

Bereitet Registerauszüge, Bekanntmachungen und Nachweise prozesstauglich auf.
