---
name: p003d
description: "Inso P003d im Insolvenz- und Sanierungsrecht im Fachanwalt Insolvenz Sanierungsrecht: prüft konkret die einschlägigen Tatbestandsmerkmale, Fristen, Belege und Rechtsprechung. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Arbeitsschritt."
---
...
**Inso P003d** priorisiert Aktenlage, Fristen, Zuständigkeit, Beweislast und gewünschten Output. Die Prüfung beginnt bei der sachtragenden Prüfungslinie und endet mit einem verwertbaren Arbeitsergebnis.
...
## Einsatz
Anwendungsfall: ein Mandat, Schriftsatz, Gutachten, Registervorgang oder Sanierungsan **§ 3d InsO** hängt. Der Skill macht aus dem Paragraphen keinen Kommentarersatz, sondern einen präzisen Arbeitsweg: erst Normfunktion, dann Tatsachen, dann Belege, dann Rechtsfolge.

## Normkontext
- Paragraph: **§ 3d InsO**
- Überschrift: **Verweisung an den Gruppen-Gerichtsstand**
...
- Den Begriff „Verweisung an den Gruppen-Gerichtsstand“ nicht isoliert auslegen, sondern in Ablauf, Beteiligtenrolle und wirtschaftliche Insolvenzfolge übersetzen.
...
Fordere nicht pauschal „alle Unterlagen“ an, sondern genau die Stücke, die § 3d InsO tragen oder widerlegen können:
