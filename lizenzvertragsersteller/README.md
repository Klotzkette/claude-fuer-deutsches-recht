...
Automatisch generierte Komplett-Liste aller 33 Skills in diesem Plugin. Jeder Skillname öffnet die zugehörige `SKILL.md`; Beschreibungen stammen aus deren `description`-Feld.

| Skill | Beschreibung |
| --- | --- |
| [`datenschutz-dsgvo-im-lizenzvertrag`](skills/datenschutz-dsgvo-im-lizenzvertrag/SKILL.md) | Wenn es um Datenschutz — DSGVO im Lizenzvertrag in Lizenzvertragsersteller geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| [`klausel-haftung-gewaehrleistung-indemnification`](skills/klausel-haftung-gewaehrleistung-indemnification/SKILL.md) | Wenn es um Klausel Haftung, Gewaehrleistung, Indemnification in Lizenzvertragsersteller geht: ordnet Sachverhalt, Norm, Beweislast, Gegenargumente und nächsten Schritt; liefert ein direkt nutzbares Arbeitsprodukt mit Prüfpunkten, Risiken... |
...
| [`klausel-verbesserungen-grant-back`](skills/klausel-verbesserungen-grant-back/SKILL.md) | Wenn es um Klausel Verbesserungen (Grant-Back) in Lizenzvertragsersteller geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`klausel-verguetung-pauschale-royalty-tiered`](skills/klausel-verguetung-pauschale-royalty-tiered/SKILL.md) | Wenn es um Klausel Vergütung — Pauschale, Royalty, Tiered in Lizenzvertragsersteller geht: ordnet Sachverhalt, Norm, Beweislast, Gegenargumente und nächsten Schritt; liefert eine Berechnungstabelle mit Schwellen, Annahmen und Kontrollfra... |
| [`klausel-vertragsdauer-kuendigung-rueckwirkung`](skills/klausel-vertragsdauer-kuendigung-rueckwirkung/SKILL.md) | Wenn es um Klausel Vertragsdauer und Kuendigung in Lizenzvertragsersteller geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| [`lizenz-gebrauchsmuster-gebrmg`](skills/lizenz-gebrauchsmuster-gebrmg/SKILL.md) | Wenn es um Lizenz Gebrauchsmuster (GebrMG) in Lizenzvertragsersteller geht: ordnet Sachverhalt, Norm, Beweislast, Gegenargumente und nächsten Schritt; liefert eine Verhandlungs- oder Eskalationslinie mit Optionen. |
...
| [`steuern-quellensteuer-und-dba-lizenz`](skills/steuern-quellensteuer-und-dba-lizenz/SKILL.md) | Wenn es um Steuern und Quellensteuer — Lizenz in Lizenzvertragsersteller geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`transaktionsstruktur-visualisieren-ascii`](skills/transaktionsstruktur-visualisieren-ascii/SKILL.md) | Wenn es um Transaktionsstruktur visualisieren — ASCII in Lizenzvertragsersteller geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
