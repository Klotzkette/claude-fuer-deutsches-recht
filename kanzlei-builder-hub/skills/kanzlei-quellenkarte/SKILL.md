...
Diese Quellenkarte sichert für **Kanzlei-Builder-Hub (Plugins/Skills)** jede tragende Aussage ab: Norm, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor Ausgabe verifiziert.

## Tragende Normen (live prüfen)

- **BRAO § 43e KI-Einsatz** — amtlichen Stand vor tragender Aussage prüfen
