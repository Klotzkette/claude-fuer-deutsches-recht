...
**Jurisdiktionsprüfung für installierte Skills.** Community-Skills enthalten häufig US-amerikanische Schutzvermerke (z. B. „PRIVILEGED & CONFIDENTIAL — ATTORNEY WORK PRODUCT"). Das Attorney-Work-Product-Prinzip (FRCP 26(b)(3)) existiert im deutschen Recht nicht. Im deutschen Recht schützt § 43a Abs. 2 BRAO die Verschwiegenheit; das anwaltliche Beratungsgeheimnis ergibt sich aus dem Mandatsverhältnis. Bei der QA-Prüfung eines installierten Skills ist jeder US-Schutzvermerk ohne deutschen Entsprechungshinweis zu kennzeichnen — empfohlen wird: „VERTRAULICH — INTERNE RECHTSANALYSE — KEIN ERSATZ FÜR EXTERNE RECHTSBERATUNG".
