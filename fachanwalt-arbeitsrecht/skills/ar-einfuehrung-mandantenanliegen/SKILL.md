...
description: "Für Ar Einführung Mandantenanliegen: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
2. **Wie ist die Frist?** Gibt es eine laufende 3-Wochen-Klagefrist (Paragraf 4 KSchG) oder AGG-Frist (Paragraf 15 Abs. 4 AGG: 2 Monate)?
...
### 1. Kündigung
- **Einschlägig:** Paragrafen 1, 4, 7, 23 KSchG; Paragraf 623 BGB (Schriftform); Paragraf 102 BetrVG (BR-Anhörung)
- **Kritische Frist:** 3 Wochen ab Zugang der schriftlichen Kündigung (Paragraf 4 KSchG) — Versäumnis = Paragraf 7 KSchG-Fiktion
- **Sofortmaßnahme:** Zugangsdatum sichern, Schriftform prüfen, KSchG-Anwendbarkeit prüfen (Paragraf 23 KSchG > 10 VZÄ, Paragraf 1 KSchG > 6 Monate), Betriebsratsprotokolle anfordern
- **Routing:** → `fachanwalt-arbeitsrecht-kuendigungsschutzklage`

### 2. Abfindung
- **Einschlägig:** Paragrafen 9, 10 KSchG (Auflösungsantrag); Paragraf 1a KSchG (Klageverzicht); BAG-Faustformel 0,5 × Monatsgehalt × Beschäftigungsjahre
- **Sperrzeit:** Paragraf 159 SGB III bei Aufhebungsvertrag auf Arbeitnehmerinitiative
- **Routing:** → `ar-abfindungs-rechner-modular`, `fachanwalt-arbeitsrecht-aufhebungsvertrag-sperrzeit`

### 3. Zeugnis
- **Einschlägig:** Paragraf 109 GewO (Anspruch auf qualifiziertes Zeugnis); Wohlwollenspflicht des Arbeitgebers (BAG-Linie); Zeugnisformulierungen (Codierungen)
...
### 4. Befristung
- **Einschlägig:** Paragrafen 14–22 TzBfG; Paragraf 17 TzBfG (3-Wochen-Entfristungsklage!); BAG zu sachgrundloser Befristung (Paragraf 14 Abs. 2 TzBfG: max. 2 Jahre, max. 3 Verlängerungen)
- **Kritische Frist:** 3 Wochen nach vereinbartem Ende (Paragraf 17 TzBfG) für Entfristungsklage
- **Routing:** → `fachanwalt-arbeitsrecht-befristung-tzbfg`

### 5. Maßregelungsverbot Paragraf 612a BGB
- **Einschlägig:** Paragraf 612a BGB; Beweislastverteilung; enger Zusammenhang zwischen rechtmäßiger Ausübung von Rechten und Benachteiligung
...
- **Einschlägig:** Paragrafen 1–22 AGG; Paragraf 22 AGG (Beweislastumkehr bei Indizien); Paragraf 15 AGG (Schadensersatz, Entschädigung)
- **Kritische Frist:** Paragraf 15 Abs. 4 AGG: 2 Monate ab Kenntnis der Benachteiligung (Ausschlussfrist!)
...
### 7. Lohn / Vergütung
- **Einschlägig:** Paragrafen 611a, 614, 615 BGB; MiLoG (Mindestlohn, aktuellen Satz live prüfen); Annahmeverzug Paragraf 615 BGB; Ausschlussfristen im Arbeitsvertrag prüfen
...
### 8. Urlaub
- **Einschlägig:** Paragrafen 1–13 BUrlG; Paragraf 7 BUrlG (Übertragung, Verfall); BAG: kein Verfall ohne Hinweis des Arbeitgebers (EuGH-Konformität); Urlaubsabgeltung Paragraf 7 Abs. 4 BUrlG; BAG 9 AZR 104/24: kein Urlaubsverzicht durch Prozessvergleich
- **Routing:** → `spezial-urlaub-livequellen-und-rechtsprechungscheck`

### 9. Betriebsrat und Mitbestimmung
- **Einschlägig:** BetrVG Paragrafen 87 (echtes Mitbestimmungsrecht), 99 (personelle Einzelmaßnahmen), 102 (Anhörung Kündigung), 111 ff. (Betriebsänderung, Interessenausgleich, Sozialplan)
...
|---|---|---|
| 3 Wochen Kündigungsschutzklage | Paragraf 4 KSchG | Paragraf 7 KSchG-Fiktion: Kündigung gilt als wirksam |
| 3 Wochen Entfristungsklage | Paragraf 17 TzBfG | Befristung gilt als wirksam |
| 2 Monate AGG-Geltendmachung | Paragraf 15 Abs. 4 AGG | Anspruchsverlust |
| Ausschlussfristen Vertrag/TV | Je nach Klausel | Anspruchsverlust |
| 2 Wochen außerordentliche Kündigung | Paragraf 626 Abs. 2 BGB | Fristablauf für Arbeitgeber |
