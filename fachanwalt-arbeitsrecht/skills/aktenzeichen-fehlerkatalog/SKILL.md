...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Fachanwalt Arbeitsrecht** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.
...
### 3. Falsche Zuständigkeit adressiert (richtig: Arbeitsgericht (1. Instanz))

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: Arbeitsgericht (1. Instanz))
...
### 4. Beweismittel nicht gesichert (Zugangs-Nachweis Kündigung)

- **Symptom:** Beweismittel nicht gesichert (Zugangs-Nachweis Kündigung)
...
### 5. Schlüsseldokument fehlt oder veraltet (Arbeitsvertrag)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Arbeitsvertrag)
