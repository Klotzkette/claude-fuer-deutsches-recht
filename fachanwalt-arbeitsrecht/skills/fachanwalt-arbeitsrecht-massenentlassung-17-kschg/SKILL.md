...
description: "Massenentlassung Anzeige § 17 KSchG Schwellenwerte 5/25/30 Beschaeftigte. Konsultation Betriebsrat 2 Wochen. Anzeige Bundesagentur fuer Arbeit. Anzeigepflicht-Verletzung Unwirksamkeit aller Kuendigungen EuGH C-188/03. Sozialplan Interessenausgleich. Workflow AG-Strategie Verfahrensgang."
---
...
1. Anzahl Beschaeftigter im Betrieb (BAG-Definition Betriebsbegriff)?
2. Geplante Entlassungs-Zahl?
3. Zeitraum (innerhalb 30 Tagen)?
4. Betriebsrat vorhanden?
5. Insolvenz im Hintergrund?
6. Sozialplan-Pflicht (§ 112 BetrVG)?

## 2) Schwellenwerte § 17 I KSchG

| Betriebsgroesse | Anzeigepflicht ab |
|---|---|
| > 20 - < 60 AN | **mehr als 5** Entlassungen |
| 60 - < 500 AN | **10 %** oder **mehr als 25** |
| ≥ 500 AN | **mindestens 30** Entlassungen |

Maßgeblich: Entlassungen **innerhalb 30 Tagen**.

## 3) Konsultations-Verfahren § 17 II KSchG
...
- Bei BR-Pflichtbetrieb (> 20 AN) und Massenentlassung: zwingend
- Ausgleich wirtschaftlicher Nachteile
- Inhalt: Abfindungs-Formel, Outplacement, Qualifizierung
- Bei Streit: Einigungsstelle (§ 112 II BetrVG)

### Interessenausgleich

- Auch bei Massenentlassung: AG muss IA versuchen
- Bei Scheitern: Einigungsstellen-Verfahren
- IA ist nicht zwingend (BAG NJW 2007, 1296)
- Bei Versuch-Verweigerung: **Nachteilsausgleich § 113 BetrVG** an alle entlassenen AN
...
- Sozialplan-Volumen kalkulieren (typisch 1-3 Brutto-Monatsgehaelter pro Jahr)
- Kommunikationsplan

### Phase 2 — Konsultation BR

- Schriftliche Information
- **Mindestens 2 Wochen** Beratung
- Protokoll Stellungnahme
...
- EuGH, Urt. v. 27.1.2005 — C-188/03 (Junk)
- EuGH, Urt. v. 16.7.2009 — C-12/08 (Mono Car)
