...
Falls `~/.claude/plugins/config/claude-fuer-deutsches-recht/company-profile.md` nicht existiert oder Platzhalter enthält, zunächst diese fünf Fragen stellen:
...
> - `/gewerblicher-rechtsschutz:portfolio` – Schutzrechtsfristen prüfen
> - Alle anderen Skills
>
> **Nächster empfohlener Schritt:** Führen Sie `/gewerblicher-rechtsschutz:portfolio` aus, um Ihre eingetragenen Schutzrechte und fällige Fristen zu prüfen.
