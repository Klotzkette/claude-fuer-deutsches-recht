...
Rechtsstand 10. September 2026: Die Governance-Routen unterscheiden geltende Betriebs- und Transparenzpflichten von späteren Hochrisikopflichten. Kompetenzmaßnahmen, Bias-Prüfung, Freigabe und Behördenkontakt greifen auf denselben datierten Rechtsstand zurück. [Rechtsstandkarte lesen](./references/digitaler-omnibus-2026.md) · <a href="https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=ki-governance/references/digitaler-omnibus-2026.md" download>MD herunterladen</a>.
...
| [`ki-rote-linien-art-5-pruefen`](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=ki-governance/skills/ki-rote-linien-art-5-pruefen/SKILL.md) | Prüft verbotene Systempraktiken anhand von Zweck, tatsächlicher Verwendung und Ausnahmen. Trennt bestehende Verbote von den neuen Inhaltsverboten ab Dezember 2026 und erstellt einen begründeten Stopp-, Änderungs- oder Freigabevermerk. | [MD herunterladen / Download MD](https://klotzkette.github.io/claude-fuer-deutsches-recht/download.html?path=ki-governance/skills/ki-rote-linien-art-5-pruefen/SKILL.md) |
