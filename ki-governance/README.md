...
| Skill | Beschreibung |
| --- | --- |
| `case-dpia-drift` | Case Tatbestand Beweis Und Belege, Dpia Risikoampel Und Gegenargumente, Drift Verhandlung Vergleich Und Eskalation: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbare... |
| `dsgvo-governance-inventar` | Dsgvo Erstpruefung Und Mandatsziel, Governance Compliance Dokumentation Und Akte, Inventar Dokumentenmatrix Und Lueckenliste: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten... |
| `gpai-modelle-ki-anbieter-arbeitsrecht` | Gpai Modelle Systemic Risk, Ki Anbieter Prüfung, Ki Arbeitsrecht Mitbestimmung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `inventar-kontrollen-konformitaetsbewertung` | Ki Inventar Governance Und Kontrollen, Konformitaetsbewertung Red Team Und Qualitaetskontrolle, Marketing Mandantenkommunikation Entscheidungsvorlage: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage... |
| `ki-folgenabschaetzung-ki-governance-mandat` | Ki Folgenabschaetzung, Ki Governance Anpassen, Ki Governance Mandat Arbeitsbereich: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `ki-governance-anschluss-router` | Allgemein, Anschluss Skills Router, Chronologie Und Belegmatrix, ...: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `ki-governance-fristen-risikoampel-mandantenkommunikation` | Fristen Und Risikoampel, Mandantenkommunikation, Redteam Qualitygate: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `ki-governance-output-waehlen` | Output wählen: prüft Normen, Belege, Risiken, Gegenargumente und erzeugt ein verwertbares Arbeitsergebnis. |
...
| `ki-inventar-marketing-werbung-rote-linien` | Ki Inventar, Ki Marketing Und Werbung, Ki Rote Linien Art 5 Prüfen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `kig-konformitaetsbewertung-risikobewertung` | Kig Konformitaetsbewertung Spezial, Kig Risikobewertung Hochrisiko Leitfaden, Regulierungs Luecken Analyse: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `review-richtlinie` | Prüfung Internationaler Bezug Und Schnittstellen, Review Schriftsatz Brief Und Memo Bausteine, Richtlinie Zahlen Schwellen Und Berechnung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert... |
| `richtlinien-monitor-vorlage-anbieter` | Richtlinien Monitor, Richtlinien Vorlage, Anbieter Mehrparteien Konflikt Und Interessen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `rollen-rasci-hochrisiko-anhang-incident` | Ki Governance Rollen Rasci, Ki Hochrisiko Anhang Iii Prüfen, Ki Incident Management Art 73: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `rollenmodell-use-case-vendor` | Rollenmodell Formular Portal Und Einreichung, Use Case Risk Classification, Vendor Behörden Gericht Und Registerweg: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbar... |
| `triage-haftung-versicherung-anwendungsfall` | Triage Fristen Form Und Zustaendigkeit, Ki Haftung Und Versicherung, Anwendungsfall Triage: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `vo-pflichtenpyramide-kig-ai-kig-foundation` | Ki Vo Pflichtenpyramide Einfuehrung, Kig Ai Act Rollenmodell Bauleiter, Kig Foundation Model Anbieterpflichten Spezial: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belast... |
| `werbung-beweislast` | Werbung Beweislast Und Darlegungslast: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
