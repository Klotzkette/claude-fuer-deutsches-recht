...
description: "Gewerblichen Markenanmeldung Markeng: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Gewerblichen Markenanmeldung Markeng** im Plugin Fachanwalt Gewerblicher Rechtsschutz. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Fachanwalt Gewerblicher Rechtsschutz gilt für **Gewerblichen Markenanmeldung Markeng**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
- Waren und Dienstleistungen in **45 Klassen** (Nizza-Abkommen).
- Korrekte Klassenzuordnung entscheidend für Schutzbereich.
- Zu enge Klassenwahl → Lücken im Schutz.
- Zu breite Klassenwahl → Benutzungspflicht schwer zu erfüllen.

**Hilfsmittel:** [dpma.de/marken/markenanmeldung/klassifikation](https://www.dpma.de/marken/markenanmeldung/klassifikation/); EUIPO-TMClass: [tmclass.tmdn.org](https://tmclass.tmdn.org).

## Anmeldeakte – Pflichtbestandteile
...
- Produktfotos mit Marke.
- Kataloge, Werbemittel, Verpackungen.
- Online-Screenshots mit Zeitstempel (URL, Datum).
- Umsatzdaten je Klasse.
...
| Thema | Dokumentation |
|---|---|
| Anmeldestrategie | Welche Zeichen, Klassen, Territorien; warum? |
