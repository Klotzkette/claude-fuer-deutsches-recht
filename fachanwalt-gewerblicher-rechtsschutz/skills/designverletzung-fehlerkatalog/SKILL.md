...
description: "Für Designverletzung Fehlerkatalog: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Fachanwalt Gewerblicher Rechtsschutz** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (Widerspruch Marke 3 Mon.)

- **Symptom:** Frist falsch berechnet oder übersehen (Widerspruch Marke 3 Mon.)
...
### 2. Parallelfrist vergessen (UWG Verjährung 6 Mon. § 11)

- **Symptom:** Parallelfrist vergessen (UWG Verjährung 6 Mon. § 11)
...
### 3. Falsche Zuständigkeit adressiert (richtig: DPMA)

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: DPMA)
...
### 4. Beweismittel nicht gesichert (Benutzungsnachweis)

- **Symptom:** Beweismittel nicht gesichert (Benutzungsnachweis)
...
### 5. Schlüsseldokument fehlt oder veraltet (Registerauszug)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Registerauszug)
...
### 6. Normzitat ohne Fassungsprüfung (MarkenG, PatG, DesignG, GebrMG)

- **Symptom:** Normzitat ohne Fassungsprüfung (MarkenG, PatG, DesignG, GebrMG)
