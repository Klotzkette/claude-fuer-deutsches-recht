...
Es gilt die [Zitierweise](../../references/zitierweise.md). Nutzen Sie die [phasebezogenen Quellen](../../references/hoai-7-fachquellen.md) und gezielt die [allgemeinen Fachquellen](../../references/fachquellen.md). HOAI Anlage 10 Nummer 10.1, Paragraf 34 HOAI und Paragraf 650p BGB sind Ausgangspunkte, keine Vollmacht. Tragende Normen, historische Fassung und Vergaberegeln live amtlich prüfen; Abrufdatum und Anwendbarkeit unterscheiden. Keine DIN-/ATV-Texte rekonstruieren, keine sachfremden oder erfundenen BGH-Anker. Abruflücken konkret offenlegen.
