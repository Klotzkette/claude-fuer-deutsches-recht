...
| --- | --- | --- | --- |
| Eingang | Dokumenteninventur und Dateitypen | BGB Paragraf 126, Paragraf 126a und Paragraf 126b | Dokumentenregister mit maßgeblicher Fassung |
...
| Vollständigkeit | Versionen und Diskrepanzen | Bearbeiter für Version, Fundstelle, Rechenweg und Übergabe; offene oder widersprüchliche Originaldaten werden nicht stillschweigend harmonisiert | Anlagen- und Fehlteilliste mit Verantwortlichem |
...
10.3. Kritischer Arbeitspunkt: Bearbeite zuerst Dokumenteninventur und Dateitypen; Inhalt und technische Umsetzung werden gemeinsam geprüft.
...
| --- | --- | --- |
| Dokumenteninventur und Dateitypen | Erfasse jede Datei mit Originalname, Dokumenttyp, Datum, Beteiligten, Version, Lesbarkeit, Unterschrift und Fundort; trenne Duplikat, Vorfassung, Anlage und leere oder beschädigte Datei. | aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis |
| Versionen und Diskrepanzen | Vergleiche Namen, Daten, Beträge, Quoten, Laufzeiten, Aktenzeichen und Vertragsverweise über alle Dokumente; führe jede Abweichung mit beiden Fundstellen, Bedeutung, Klärungsweg und Verantwortlichem. | aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis |
| Unterschrift und Vertretungsmacht | Prüfe für jede Urkunde Unterzeichner, Vertretungsregel, Vollmacht oder Registerstand, Signaturart, Datum, Vollständigkeit und Gegenzeichnung und markiere den konkreten Wirksamkeits- oder Beweisbedarf. | aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis |
| Zugang und Zustellung | Ordne jede empfangsbedürftige Erklärung nach Absender, Empfänger, Übermittlungsweg, Empfangsmöglichkeit, Zugangsnachweis, Bestreiten und daraus ausgelöster Frist; trenne sicheren Befund und offene Beweisfrage. | aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis |
| Fristen- und Terminsteuerung | Leite jede Frist aus Dokument, Ereignis und Rechtsgrund ab; dokumentiere Beginn, Ende, Vorfrist, Zeitzone, Zustellungsbeleg, Verantwortlichen, Vertretung, Sofortmaßnahme und Erledigungsnachweis. | aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis |
| Vertrags- und Verpflichtungslandkarte | Führe Parteien, Gegenstand, Laufzeit, Kündigung, Vergütung, Sicherheiten, Zustimmungen, Abhängigkeiten, Änderungen, Unterschriftsstand und Fundstelle je Vertrag und leite daraus die Bearbeitungsreihenfolge ab. | aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis |
| Beteiligungs- und Finanzierungsstände | Gleiche Beteiligungsstände, Kapitalmaßnahmen, Wandlungen, Optionen, Finanzierungsinstrumente, Sicherheiten und Rangabreden stichtagsbezogen mit den jeweiligen Urkunden und Registern ab. | aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis |
| Fehlende Unterlagen beschaffen | Formuliere aus jeder materiellen Lücke eine Aufgabe mit Dokument, Zweck, möglichem Inhaber, Anfrageweg, Frist, Ersatzbeleg, Verantwortlichem und Folge bei Nichterhalt. | aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis |
| Priorität und Statusampel | Verdichte jeden Befund in belegte Tatsache, offene Frage, Risiko, Entscheidung, Aufgabe und nächsten Termin; eine Farbe ohne Fundstelle und Handlungsauftrag genügt nicht. | aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis |

## 16. Fachspezifische Praxisrouten

Diese Routen stammen aus den konkreten Arbeitsthemen dieses Plugins. Wähle die sachnächste Route, liefere deren ersten verwertbaren Baustein sofort und vertiefe nur die Punkte, die das Ergebnis tatsächlich ändern.

### 16.1. Dokumenteninventur und Dateitypen

Bearbeitungsauftrag: Erfasse jede Datei mit Originalname, Dokumenttyp, Datum, Beteiligten, Version, Lesbarkeit, Unterschrift und Fundort; trenne Duplikat, Vorfassung, Anlage und leere oder beschädigte Datei.
Lieferstück: aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis.

### 16.2. Versionen und Diskrepanzen

Bearbeitungsauftrag: Vergleiche Namen, Daten, Beträge, Quoten, Laufzeiten, Aktenzeichen und Vertragsverweise über alle Dokumente; führe jede Abweichung mit beiden Fundstellen, Bedeutung, Klärungsweg und Verantwortlichem.
Lieferstück: aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis.

### 16.3. Unterschrift und Vertretungsmacht

Bearbeitungsauftrag: Prüfe für jede Urkunde Unterzeichner, Vertretungsregel, Vollmacht oder Registerstand, Signaturart, Datum, Vollständigkeit und Gegenzeichnung und markiere den konkreten Wirksamkeits- oder Beweisbedarf.
Lieferstück: aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis.

### 16.4. Zugang und Zustellung

Bearbeitungsauftrag: Ordne jede empfangsbedürftige Erklärung nach Absender, Empfänger, Übermittlungsweg, Empfangsmöglichkeit, Zugangsnachweis, Bestreiten und daraus ausgelöster Frist; trenne sicheren Befund und offene Beweisfrage.
Lieferstück: aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis.

### 16.5. Fristen- und Terminsteuerung

Bearbeitungsauftrag: Leite jede Frist aus Dokument, Ereignis und Rechtsgrund ab; dokumentiere Beginn, Ende, Vorfrist, Zeitzone, Zustellungsbeleg, Verantwortlichen, Vertretung, Sofortmaßnahme und Erledigungsnachweis.
Lieferstück: aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis.

### 16.6. Vertrags- und Verpflichtungslandkarte

Bearbeitungsauftrag: Führe Parteien, Gegenstand, Laufzeit, Kündigung, Vergütung, Sicherheiten, Zustimmungen, Abhängigkeiten, Änderungen, Unterschriftsstand und Fundstelle je Vertrag und leite daraus die Bearbeitungsreihenfolge ab.
Lieferstück: aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis.

### 16.7. Beteiligungs- und Finanzierungsstände

Bearbeitungsauftrag: Gleiche Beteiligungsstände, Kapitalmaßnahmen, Wandlungen, Optionen, Finanzierungsinstrumente, Sicherheiten und Rangabreden stichtagsbezogen mit den jeweiligen Urkunden und Registern ab.
Lieferstück: aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis.

### 16.8. Fehlende Unterlagen beschaffen

Bearbeitungsauftrag: Formuliere aus jeder materiellen Lücke eine Aufgabe mit Dokument, Zweck, möglichem Inhaber, Anfrageweg, Frist, Ersatzbeleg, Verantwortlichem und Folge bei Nichterhalt.
Lieferstück: aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis.

### 16.9. Priorität und Statusampel

Bearbeitungsauftrag: Verdichte jeden Befund in belegte Tatsache, offene Frage, Risiko, Entscheidung, Aufgabe und nächsten Termin; eine Farbe ohne Fundstelle und Handlungsauftrag genügt nicht.
Lieferstück: aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis.

### 16.10. Verantwortung und Eskalation

Bearbeitungsauftrag: Ordne jeder Aufgabe Bearbeiter, Freigeber, Stellvertretung, Fälligkeit, Abhängigkeit, Eskalationsdatum, Kommunikationsweg und Abschlussbeleg zu.
Lieferstück: aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis.

### 16.11. Fundstellen und stabile Verknüpfungen

Bearbeitungsauftrag: Verknüpfe jede Trackerzeile mit stabiler lokaler Fundstelle oder DMS-Ziel, prüfe Zugriffsrecht und Dateibestand und kennzeichne fehlende Unterlagen als Beschaffungsbedarf statt mit einem scheinbaren Link.
Lieferstück: aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis.

### 16.12. Übergabe und laufende Aktualisierung

Bearbeitungsauftrag: Erstelle eine Übergabenotiz mit Mandatsziel, Aktenstand, kritischen Fristen, offenen Entscheidungen, wichtigsten Fundstellen, Ansprechpartnern, nächsten fünf Handlungen und eindeutigem Bearbeitungsbesitz; führe danach ein Änderungsprotokoll.
Lieferstück: aktualisierbarer Akten-Tracker mit Originalfundstelle, gesichertem Befund, offener Frage, Priorität, Verantwortlichem, Termin, Abhängigkeit und Erledigungsnachweis.
