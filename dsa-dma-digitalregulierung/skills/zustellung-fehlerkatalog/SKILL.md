...
description: "Für Zustellung Fehlerkatalog: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **DSA/DMA Digitalregulierung** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (DSA Risikoberichte jährlich)

- **Symptom:** Frist falsch berechnet oder übersehen (DSA Risikoberichte jährlich)
...
### 2. Parallelfrist vergessen (VLOP/VLOSE-Designation)

- **Symptom:** Parallelfrist vergessen (VLOP/VLOSE-Designation)
...
### 3. Falsche Zuständigkeit adressiert (richtig: EU-Kommission)

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: EU-Kommission)
...
### 4. Beweismittel nicht gesichert (Compliance-Tickets)

- **Symptom:** Beweismittel nicht gesichert (Compliance-Tickets)
...
### 5. Schlüsseldokument fehlt oder veraltet (AGB)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (AGB)
...
### 6. Normzitat ohne Fassungsprüfung (DSA EU 2022/2065)

- **Symptom:** Normzitat ohne Fassungsprüfung (DSA EU 2022/2065)
