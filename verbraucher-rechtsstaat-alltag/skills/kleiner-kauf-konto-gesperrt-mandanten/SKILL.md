...
description: "Kleiner Kauf Konto Gesperrt Mandanten: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Kleiner Kauf Konto Gesperrt Mandanten

## Arbeitsbereich

Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Kleiner Kauf Konto Gesperrt Mandanten** im Plugin Verbraucher Rechtsstaat Alltag. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `mandanten-oder-beteiligtenkommunikation` | Beteiligtenkommunikation: erklärt übersetzt das Ergebnis in klare, taktisch sichere Kommunikation in einfacher, aber richtiger Sprache; sortiert Dokumente, Fristen, Risiken und nächste Schritte ohne unnötige Preisgabe persönlicher Daten. |

## Arbeitsweg

Im Plugin Verbraucher Rechtsstaat Alltag gilt für **Kleiner Kauf Konto Gesperrt Mandanten**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
## Fachkern: Kleiner Kauf und Mängelrechte
- **Spezialgegenstand:** Kleiner Kauf und Mängelrechte. Die Prüfung setzt bei der konkreten Sachfrage an und endet mit einem verwertbaren Arbeitsergebnis.
...
Dieser Abschnitt bearbeitet **Fachkern: Kleiner Kauf und Mängelrechte** im Bereich **Verbraucher im Rechtsstaat Alltag**. Er ordnet die konkrete Lage, sichere Tatsachen, offene Fragen, Risiken, Quellen und den nächsten verwertbaren Schritt.

**Fokus:** Nacherfüllung, Rücktritt, Minderung, Schadensersatz und Beweisproblem
...
## Fachkern: Konto gesperrt durch Bank
- **Spezialgegenstand:** Konto gesperrt durch Bank. Die Prüfung setzt bei der konkreten Sachfrage an und endet mit einem verwertbaren Arbeitsergebnis.
- **Normen-/Quellenanker:** BGB-Verbraucherrecht, VwVfG/VwGO, ZPO/Mahnverfahren, SGB-Schnittstellen, Datenschutz, Widerruf, Gewährleistung, Fristen und Zuständigkeit.
- **Entscheidende Weiche:** Dokument zuerst verstehen: Rolle, Frist, Anspruch, Behörde/Gegner, Belege, Risiko der freiwilligen Auskunft und nächster sicherer Schritt.
- **Arbeitsprodukt:** Erzeuge eine konkrete Prüf- oder Entscheidungsmatrix mit Norm, Tatbestand, Beleg, Einwand, Risikoampel und nächstem Schritt; Anschluss-Skills nur bei echter Vertiefung nennen.
...
Dieser Abschnitt bearbeitet **Fachkern: Konto gesperrt durch Bank** im Bereich **Verbraucher im Rechtsstaat Alltag**. Er ordnet die konkrete Lage, sichere Tatsachen, offene Fragen, Risiken, Quellen und den nächsten verwertbaren Schritt.

**Fokus:** Kontosperre, Geldwäscheprüfung, Pfändung, P-Konto und Existenzsicherung.
...
- **Normen- und Quellenanker:** ZKG, GwG, AGB-Banken, Pfändungsschutzkonto, BaFin-Beschwerde und Eilrechtsschutz live prüfen.
...
- GwG-Sperren und Pfändungen haben andere Logik.
- Existenzminimum und laufende Zahlungen sofort sichern.
- Keine unklaren Herkunftserklärungen ohne Belege.

## Arbeitsprodukte

Erzeuge Sofortanfrage, Unterlagenpaket, P-Konto-Check, BaFin-Beschwerde und Eilstrategie.
...
Dieser Abschnitt bearbeitet **Fachkern: Beteiligtenkommunikation** im Bereich **Verbraucher im Rechtsstaat Alltag**. Er ordnet die konkrete Lage, sichere Tatsachen, offene Fragen, Risiken, Quellen und den nächsten verwertbaren Schritt.
