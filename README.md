...
Alternativ: über die Claude-Desktop-GUI unter **Customize → Skills** → ZIP aus dem [Release v7.0.0](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/tag/v7.0.0) hochladen. Schritt-für-Schritt unter [Schnellstart](#schnellstart) und [Für Einsteiger](#für-einsteiger-schritt-für-schritt-anleitung).
