...
|---|---|
| **Plugins** | 100 |
| **Skills (SKILL.md)** | 2244 — [Gesamtuebersicht](./SKILLS.md) |
| **Testakten** | 49 |
| **Fachanwalts-/-anwältinnen-Profile** | 24 |
| **Letzter Release** | `v17.5.1` — [latest auf GitHub](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest) |
...
- **Mechanik-Prüfer:** `subsumtions-pruefer` (generischer Subsumtions-Workflow DE + EU), `bereicherungs-und-anfechtungsrecht-pruefer` (§§ 812 ff. BGB + AnfG + InsO-Anfechtung einschließlich KI-Schuldnerakten-Screening, § 135 InsO und Verteidigung), `ki-vo-ai-act-pruefer` (Verordnung (EU) 2024/1689 mit Anbieter/Betreiber-Entscheidungsbaum, Art. 5/6/25/51 ff.).
