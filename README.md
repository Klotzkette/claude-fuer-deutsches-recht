...
| Dreizehn vollständige Akten | [Akten und drei Downloadformen je Fall](./bauwirtschaft/README.md): Gesamt-PDF, Einzel-PDF-ZIP und ZIP mit Originalformaten. |

English: [Bauwirtschaft](./bauwirtschaft/README.md) provides 29 construction-industry workflows, including one skill for each of the nine HOAI building-planning phases. Each phase also has its own standalone workshop and practice file. Four broader project cases remain available, making thirteen cases in total. Prompts and practice files are separate downloads; qualified professionals remain responsible for technical assessment and approval.
...
| **Skills** | 22431 | Eng abgegrenzte Arbeitsabläufe; die Detailseiten führen jeden Skill mit Kurzbeschreibung und einzelnem Markdown-Download auf. | [Skill-Gesamtübersicht](./SKILLS.md) · [Detailseiten je Plugin](./skills-index/) |
...
| **Plugin-Version / Arbeitsstand** | `v445.6.0` — [latest Release auf GitHub](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest) |
