...
description: "Oeffentlich Rechtliche Parallel Konkurrenz: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **Oeffentlich Rechtliche Parallel Konkurrenz** im Plugin Bereicherungs- und Anfechtungsrecht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Bereicherungs- und Anfechtungsrecht gilt für **Oeffentlich Rechtliche Parallel Konkurrenz**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
## 2. `parallel-und-konkurrenz-pruefung`

**Fokus:** Bereicherungsrecht und Anfechtungsrecht gleichzeitig prüfen: Anspruchskonkurrenzen und gegenseitige Beeinflussung aller drei Regelungskreise. Normen: §§ 812 ff. BGB, AnfG, §§ 129 ff. InsO. Prüfraster: Parallelität, Subsidiarität, wechselseitige Auswirkungen. Output: Konkurrenzmatrix mit Handlungsempfehlung. Abgrenzung: nicht Einzelprüfung je Regelungskreis.
...
## 4. `rechtsgrund-und-behaltensgrund-pruefen`

**Fokus:** Bereicherungsrechtliche Kernfrage prüfen: nicht nur Zufluss, sondern Rechtsgrund und Behaltensgrund. Normen: §§ 812 ff. BGB. Output: Behaltensgrund-Matrix mit Darlegungslast und Verteidigungsrisiken.

# Rechtsgrund und Behaltensgrund prüfen

## Triage — kläre zuerst

1. Welcher Vermögensvorteil steht im Streit: Geld, Sache, Forderung, Befreiung, Nutzung, Lizenzwert oder ersparte Ausgabe?
...
Das Bereicherungsrecht fragt nicht nur, ob ein Gegenstand von A nach B gelangt ist. Es fragt, ob B im Ergebnis einen zurechenbaren Vermögensvorteil hat, den die Rechtsordnung B nicht behalten lässt. Deshalb werden drei Ebenen sauber getrennt:
...
Prüfe, wodurch der Vorteil in das Vermögen des Empfängers gelangt ist:
...
- Wirksamer Vertrag oder gesetzlicher Anspruch.
