...
description: "Ideas Facts Imports Exports Infringement: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Ideas Facts Imports Exports Infringement

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **Ideas Facts Imports Exports Infringement** im Plugin Us Copyright Registrierung Verlag. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Us Copyright Registrierung Verlag gilt für **Ideas Facts Imports Exports Infringement**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
## Fachkern: Ideas, Facts, Merger und Scenes a Faire
- **Spezialgegenstand:** Ideas, Facts, Merger und Scenes a Faire. Die Prüfung setzt bei der konkreten Sachfrage an und endet mit einem verwertbaren Arbeitsergebnis.
...
- Fair-use and infringement interface
...
- Welche Elemente sind angeblich übernommen?
- Sind Ausdruck und Idee sinnvoll trennbar?
- Gibt es nur unvermeidbare oder genretypische Bausteine?


## Workflow

1. Elemente atomisieren.
2. Unprotectable material ausklammern.
3. Substantial-similarity-Frage vorbereiten.


## Output

- Protectability filter
- Unprotectable-elements table
- Pleading risk note
...
## Fachkern: Importation und Exportation §§ 602-603
- **Spezialgegenstand:** Importation und Exportation §§ 602-603. Die Prüfung setzt bei der konkreten Sachfrage an und endet mit einem verwertbaren Arbeitsergebnis.
- **Normen-/Quellenanker:** Title 17 U.S.C., Copyright Office Compendium, eCO-Verfahren, deposit/best edition, DMCA, fair use, termination, work made for hire und international treaties.
- **Entscheidende Weiche:** Werkart, Autor/Rechteinhaber, Veröffentlichung, Deposit, Claim/Exclusion, Registrierungsdatum, Enforcement-Ziel und US-Prozessnutzen trennen.
- **Arbeitsprodukt:** Erzeuge eine konkrete Prüf- oder Entscheidungsmatrix mit Norm, Tatbestand, Beleg, Einwand, Risikoampel und nächstem Schritt; Anschluss-Skills nur bei echter Vertiefung nennen.
...
- 17 U.S.C. §§ 602, 603
- CBP IPR enforcement resources
- First-sale interface
...
- Wo wurden Kopien hergestellt und erworben?
- US-import oder export?
- Gibt es authorization und first-sale defense?


## Workflow

1. Supply chain erfassen.
2. Import right und distribution trennen.
3. CBP/Customs route prüfen.


## Output

- Importation memo
- CBP action checklist
- Gray-market risk table
...
- Wer ist legal/beneficial owner?
- Welche Rechte verletzt?
...
## Fachkern: Injunction und Impoundment
- **Spezialgegenstand:** Injunction und Impoundment. Die Prüfung setzt bei der konkreten Sachfrage an und endet mit einem verwertbaren Arbeitsergebnis.
- **Normen-/Quellenanker:** Title 17 U.S.C., Copyright Office Compendium, eCO-Verfahren, deposit/best edition, DMCA, fair use, termination, work made for hire und international treaties.
- **Entscheidende Weiche:** Werkart, Autor/Rechteinhaber, Veröffentlichung, Deposit, Claim/Exclusion, Registrierungsdatum, Enforcement-Ziel und US-Prozessnutzen trennen.
- **Arbeitsprodukt:** Erzeuge eine konkrete Prüf- oder Entscheidungsmatrix mit Norm, Tatbestand, Beleg, Einwand, Risikoampel und nächstem Schritt; Anschluss-Skills nur bei echter Vertiefung nennen.
...
- 17 U.S.C. §§ 502, 503
- Federal equitable standards live prüfen
...
- Welche Nutzung muss sofort stoppen?
- Welche Kopien/Materialien sind betroffen?
- Gibt es irreparable harm evidence?


## Workflow

1. Remedy scope konkretisieren.
2. Evidence for injunction sammeln.
3. Overbreadth und bond issues markieren.


## Output

- Injunction memo
- Impoundment item list
- Draft order issues
