#!/usr/bin/env python3
"""Prüft das Bauwirtschaftspaket und die getrennte Auslieferung seiner vier Akten."""
...
class BauwirtschaftTests(unittest.TestCase):
    ...
    def test_twenty_independent_skills_with_reviewed_routes(self):
    ...
    def test_four_distinct_cases_and_native_documents(self):
        ...
        for slug in sorted(CASES):
            with self.subTest(case=slug):
                ...
                minimum = 35 if "hoai-buergerhaus" in slug else 24
                ...
                self.assertGreaterEqual(sum(path.suffix.lower() == ".png" for path, _ in sources), 2)
