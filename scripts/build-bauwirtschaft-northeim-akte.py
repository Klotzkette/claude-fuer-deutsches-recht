...
def main():
    ...
    pdf('02_bekanntmachung.pdf',CITY,'Auftragsbekanntmachung Los 430','29.07.2026',[[
        ...
        ('8 Vertragsbedingungen','Vertragsbestandteile sind die VOB/B Ausgabe 2016 und die einschlägigen ATV der VOB/C Ausgabe 2019 einschließlich Ergänzungsband 2023. Ausführungsbeginn 02.11.2026, Fertigstellung einschließlich Inbetriebnahme 30.04.2027. Die erste Wartung erfolgt zwölf Monate nach Abnahme. Abrechnung nach aufgemessenen Mengen und Einheitspreisen. Monatliche Abschlagszahlungen werden binnen 21 Kalendertagen nach Zugang der prüfbaren Aufstellung fällig. Die Schlusszahlung wird nach Prüfung und Feststellung fällig, spätestens innerhalb von 30 Kalendertagen nach Zugang der Schlussrechnung; im Übrigen gilt Paragraf 16 VOB/B. Keine Vorauszahlung, keine Vertragsstrafe und keine Sicherheitsleistung. Die besonderen Vertragsbedingungen einschließlich Arbeitsentgelt- und Unterauftragnehmerpflichten stehen in den Vergabeunterlagen.'),
    ...
    docx('03_vergabeunterlagen.docx',CITY,'Vergabeunterlagen und Vertragsbedingungen','29.07.2026',[
        ...
        ('PAGE',''),
        ('7 Vertragsgrundlagen, Ausführung und Abnahme','Vertragsbestandteile sind die VOB/B Ausgabe 2016 und die einschlägigen ATV der VOB/C Ausgabe 2019 einschließlich Ergänzungsband 2023. Für Widersprüche gilt die Rangfolge des Paragrafen 1 Absatz 2 VOB/B. Die nachfolgenden projektbezogenen Festlegungen ergänzen diese Vertragsbedingungen.\n\nDie Ausführung beginnt am 02.11.2026 und muss am 30.04.2027 einschließlich Messung und Inbetriebnahme abgeschlossen sein. Innerhalb von zehn Arbeitstagen nach Zuschlag ist ein abgestimmter Montageablaufplan vorzulegen. Ausführungszeichnungen und Einbaumaße sind vor Bestellung der Geräte freizugeben. Eine Freigabe ersetzt nicht die Verantwortung für die angebotene Beschaffenheit. Die Stadt verlangt eine förmliche Abnahme nach Paragraf 12 Absatz 4 VOB/B. Dabei werden die Funktion, die Bestandsunterlagen und die Einweisung geprüft; unwesentliche Mängel berechtigen nicht zur Abnahmeverweigerung. Für Mängelansprüche gilt Paragraf 13 VOB/B.'),
        ('8 Vergütung und Vertragsabwicklung','Abrechnung und Vergütungsanpassungen richten sich nach Paragrafen 2 und 14 VOB/B. Ein unbedingter Nachlass gilt für alle Positionen. Änderungen und zusätzliche Leistungen richten sich nach Paragrafen 1 und 2 VOB/B; Anordnungen der Stadt und die Vergütungsabstimmung werden dokumentiert.\n\nAbschlags- und Schlussrechnungen sind mit Positionsnachweis und Aufmaß elektronisch an die Vergabestelle zu richten. Monatliche Abschlagszahlungen werden binnen 21 Kalendertagen nach Zugang der prüfbaren Aufstellung fällig. Die Schlusszahlung wird nach Prüfung und Feststellung fällig, spätestens innerhalb von 30 Kalendertagen nach Zugang der Schlussrechnung; im Übrigen gilt Paragraf 16 VOB/B. Vorauszahlungen, Sicherheiten und Vertragsstrafen werden nicht vereinbart. Die erste Wartung ist bereits im angebotenen Gesamtpreis enthalten und wird nach deren Durchführung abgerechnet.'),
        ('9 Personal und Unterauftragnehmer','Der Auftragnehmer verpflichtet sich, die für seine Beschäftigten jeweils verbindlichen gesetzlichen und allgemeinverbindlichen tariflichen Mindestarbeitsbedingungen einzuhalten und diese Pflicht an eingesetzte Unterauftragnehmer weiterzugeben. Die angebotene Bauleitung muss während der Montage erreichbar sein. Ein Wechsel ist mit einer mindestens gleich erfahrenen Person rechtzeitig anzuzeigen. Der Auftragnehmer koordiniert seine Arbeiten mit den übrigen Gewerken, schützt benachbarte Bauteile und beseitigt eigene Abfälle. Für vom Auftraggeber bereitgestellte Anschlüsse und Flächen werden keine Umlagen erhoben. Behinderungen sind der Stadt nach Paragraf 6 Absatz 1 VOB/B unverzüglich schriftlich anzuzeigen; die Bauleitung erhält eine Kopie.')], 'Ausgegeben durch Mara Seidel, Zentrale Vergabestelle.')
