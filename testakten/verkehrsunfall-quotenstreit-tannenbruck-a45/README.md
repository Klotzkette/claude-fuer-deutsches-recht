# Akte: Verkehrsunfall Tannenbruck — A45 Quotenstreit, OWi, Fahrerlaubnis-Entzug, MPU
...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei) | PDF | [`gesamt-pdf/verkehrsunfall-quotenstreit-tannenbruck-a45_gesamt.pdf`](gesamt-pdf/verkehrsunfall-quotenstreit-tannenbruck-a45_gesamt.pdf) |
...
Arbeitsakte zum Plugin `fachanwalt-verkehrsrecht`.

---

## Kurzbild

- Verkehrsunfall am **12.01.2026** auf der **BAB A45** (Sauerlandlinie) bei Ausfahrt Lüdenscheid-Nord Richtung Hagen.
- Mandant **Holger Tannenbruck** (52), Außendienstmitarbeiter Klimatechnik Tannenbruck GmbH Lüdenscheid, fuhr mit VW Passat Variant (Dienstfahrzeug, MK-TK 2214) bei Schneeregen und Glätte mit **102 km/h** (gemessen) in einer **80-km/h-Baustellenzone** auf Mittelfahrspur.
- Vorausfahrender Sattelzug (Spedition Niermann, Fahrer Tomasz Wieczorek) verlangsamte von 72 auf 42 km/h — Auffahrunfall.
- **Schwerverletzte:** Beifahrerin Helga Vornberg (74, Schwiegermutter) — HWS-Distorsion Grad II + Querfortsatzfraktur LWK 3, 15 Tage stationär + 28 Tage Reha.
- **Sachschaden:** Passat wirtschaftlicher Totalschaden 24.700 EUR, Sattelzug ca. 4.200 EUR.
- Polizei stellte **Atemalkohol 1,0 ‰**, Blutprobe **0,98 ‰ BAK** (Uniklinik Essen) fest.
- **Quotenstreit:** HUK-Coburg (Tannenbruck-Versicherung) hält an 100 % Tannenbruck fest; Allianz (Niermann-Versicherung) bot 50/50; SV-Gutachten Rennsteig empfiehlt 70–80 / 20–30; Verhandlungsposition RA Hoffmann: **75/25**.
- **Strafverfahren:** StA Hagen 83 Js 7411/26 — Verdacht § 315c StGB (ggf. § 316 StGB) — Ermittlungsverfahren.
- **OWi:** AG Lüdenscheid 40 OWi-83 Js 7411/26 — Bußgeld 102 EUR (Geschwindigkeitsüberschreitung 19 km/h nach Toleranz) — Einspruch eingelegt.
- **Fahrerlaubnis-Entzug:** Vorläufig nach § 111a StPO (AG Hagen Gs 112/26 vom 12.01.2026) — Tannenbruck braucht Führerschein für Beruf.
- **MPU-Vorbereitung:** DEKRA Essen (Dipl.-Psych. Rehkopf), AA-Gruppe, Suchtberatung SKF, Haaranalyse EtG ab Januar 2026 — Abstinenz nachgewiesen.
- **Täter-Opfer-Ausgleich:** Waage e.V. Hagen, erfolgreich 02.04.2026.
- **Verteidiger:** RA Sebastian Hoffmann, Fachanwalt für Verkehrsrecht, Kanzlei Hoffmann Verkehrsrecht Lüdenscheid.
...
|---|---|---|
| `bussgeld-einspruch-pruefen` | 05, 06 | Bußgeldbescheid auf formelle und materielle Mängel, Einspruch mit Beweisanträgen |
| `fachanwalt-verkehrsrecht-bussgeldbescheid-pruefen` | 05, 06, 22 | Messmethode ESO, Beschilderung, Baustellenzone, OWi-Strategie |
| `fachanwalt-verkehrsrecht-fahrerlaubnis-entzug` | 13, 16, 17, 18 | § 111a StPO, § 69 StGB Regelvermutung, Sperrfrist, FeV-Verwaltungsverfahren |
| `fachanwalt-verkehrsrecht-mpu-vorbereitung` | 16, 17, 18, 20 | MPU-Struktur (medizinisch + psychotechnisch + psychologisch), Abstinenz-Nachweis EtG, CDT/GGT-Verlauf |
| `fachanwalt-verkehr-autonom-1d-stvg` | 09, 12, 14 | § 17 StVG Betriebsgefahr, Haftungsabwägung, Auffahrunfall-Rechtsprechung BGH |
| Strafrecht Verkehr (§ 315c/§ 316 StGB) | 04, 08, 09, 20 | Abgrenzung 315c vs. 316, konkrete Gefährdung, SV-Gutachten-Verwertung, TOA |
| Schadensrecht Auffahrunfall | 10, 11, 12, 14, 15 | Quotenstreit, § 115 VVG, § 81 VVG Leistungskürzung, Schmerzensgeld, Aktentisch-Berechnung |
| Täter-Opfer-Ausgleich | 19 | § 46a StGB, Waage e.V., Strafzumessungsrelevanz |
| Sachverständigengutachten Unfallrekonstruktion | 09 | EDR-Daten, Tachographen-Auswertung, Reaktionszeitanalyse, Haftungsquoten-Prognose |
| Fristenmanagement | 22 | Vollständige Fristenübersicht über alle vier parallelen Verfahrensstränge |
...
| Datei | Inhalt |
|---|---|
| [`docx/einspruch_bussgeld_tannenbruck.docx`](docx/einspruch_bussgeld_tannenbruck.docx) | Einspruchsschreiben gegen Bußgeldbescheid, Az. 40 OWi-83 Js 7411/26 (nicht eingereicht — Entwurf) |
| [`docx/klageschrift_schmerzensgeld_vornberg_lg_hagen.docx`](docx/klageschrift_schmerzensgeld_vornberg_lg_hagen.docx) | Klageerwiderung Schmerzensgeld Vornberg, LG Hagen (Entwurf) |
| [`docx/mpu_vorbereitungs_memorandum_tannenbruck.docx`](docx/mpu_vorbereitungs_memorandum_tannenbruck.docx) | MPU-Vorbereitungs-Memorandum, Maßnahmenplan, Prognose (vertraulich) |

### XLSX

| Datei | Inhalt |
|---|---|
| [`xlsx/quotentabelle_haftungsanteile.xlsx`](xlsx/quotentabelle_haftungsanteile.xlsx) | Haftungsquoten-Vergleich (alle Positionen), Schadensberechnung 75/25, Rückgriffsrisiko |
| [`xlsx/schadensaufstellung_tannenbruck.xlsx`](xlsx/schadensaufstellung_tannenbruck.xlsx) | Gesamtschadensaufstellung Fahrzeug/Regress, Nutzungsausfall-Berechnung (Blatt 2) |

### E-Mails (.eml)

| Datei | Inhalt |
|---|---|
| [`eml/2026-01-15_tannenbruck_an_hoffmann_erstanfrage.eml`](eml/2026-01-15_tannenbruck_an_hoffmann_erstanfrage.eml) | Erstanfrage Tannenbruck an Kanzlei, 15.01.2026 |
...
| Datei | Inhalt |
|---|---|
| [`pdfs/bussgeld_bescheid_auszug_ag_luedenscheid.pdf`](pdfs/bussgeld_bescheid_auszug_ag_luedenscheid.pdf) | Bußgeldbescheid-Auszug KPB Märkischer Kreis, Az. 40 OWi-83 Js 7411/26, 102 EUR |
| [`pdfs/vorlaeufige_entziehungsverfuegung_111a_stpo.pdf`](pdfs/vorlaeufige_entziehungsverfuegung_111a_stpo.pdf) | Vorläufige Fahrerlaubnis-Entziehung AG Hagen Gs 112/26, § 111a StPO |

### Fotos (.jpg)

| Datei | Inhalt |
|---|---|
| [`jpg/unfallskizze_a45_km874.jpg`](jpg/unfallskizze_a45_km874.jpg) | Schematische Unfallskizze A45 km 87,4 (Spur- und Fahrzeugpositionen, Kollisionsstelle, Zeuge) |
| [`jpg/fahrzeugschaden_passat_front.jpg`](jpg/fahrzeugschaden_passat_front.jpg) | Fahrzeugschaden VW Passat Variant MK-TK 2214 — Frontcrash, Airbags (Beweissicherung schematisch) |
| [`jpg/streckenkarte_a45_ausfahrt_luedenscheid_nord.jpg`](jpg/streckenkarte_a45_ausfahrt_luedenscheid_nord.jpg) | Streckenkarte A45 mit Baustellenzone, Messanlage km 86,2, Unfallstelle km 87,4, Ausfahrt |
...
|---|---|
| Strafverfahren § 315c/316 StGB (StA Hagen 83 Js 7411/26) | Ermittlung abgeschlossen; Stellungnahmefrist 20.05.2026 |
| OWi Geschwindigkeit (AG Lüdenscheid 40 OWi-83 Js 7411/26) | Einspruch eingelegt 10.02.2026; Hauptverhandlung ausstehend |
| Fahrerlaubnis-Entziehung (AG Hagen Gs 112/26 + MK VK-2026-0412) | Vorläufig entzogen seit 12.01.2026; MPU-Vorbereitung läuft |
| Zivilrecht Allianz ./. HUK-Coburg/Tannenbruck (LG Hagen 4 O 211/26) | Klageerwiderung eingereicht; Güterichtertermin 27.05.2026 |
| Zivilrecht Vornberg ./. HUK-Coburg/Tannenbruck (LG Hagen, erwartet) | TOA abgeschlossen; Klage Vornberg erwartet |
