# Akte: Digitales Stalking und Kontaktverbot Hannover
...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei) | PDF | [`gesamt-pdf/strafrecht-stalking-digitales-kontaktverbot-hannover_gesamt.pdf`](gesamt-pdf/strafrecht-stalking-digitales-kontaktverbot-hannover_gesamt.pdf) |
...
Nach der Trennung erhielt Clara Wienholt täglich Nachrichten über wechselnde Profile. Inhalte waren zunächst bittend, später kontrollierend und drohend. Mehrfach stand Tobias Mertens vor ihrer Arbeitsstelle. Eine Werkstatt fand unter dem hinteren Stoßfänger ihres Fahrzeugs einen kleinen GPS-Tracker mit Prepaid-SIM. Mertens bestreitet den Einbau und spricht von Zufallskontakten.

Die Plattformdaten sind noch nicht vollständig. Screenshots zeigen aber ein Profilfoto aus einem früheren gemeinsamen Urlaub, das öffentlich nicht verfügbar war. Die SIM-Karte im Tracker wurde bar gekauft; Funkzellendaten zeigen regelmäßige Verbindungen im Umfeld der Wohnung und des Arbeitsplatzes. Die Geschädigte hat ihre Arbeitszeiten geändert und schläft seit Mai bei ihrer Schwester.
...
Staatsanwaltschaft: Staatsanwaltschaft Hannover, 312 Js 5020/26
...
| Datum | Vorgang |
| --- | --- |
| 04.04.2026 | Trennung nach dreijähriger Beziehung |
| 18.04.2026 | erste Serie anonymer Nachrichten über zwei Profile |
| 07.05.2026 | Werkstatt findet GPS-Tracker am Fahrzeug |
| 09.05.2026 | polizeiliche Gefährderansprache |
...
│   └── 05_sta_zwischennachricht_plattformdaten_2026-07-22.eml Zwischennachricht der Staatsanwaltschaft: Erinnerungsfrist, Zeugin Kessler, GPS-Sender in Untersuchung
├── whatsapp/
...
- Nachstellung nach Paragraf 238 StGB
- Verstoß gegen Kontaktverbot als Folgerisiko
- Daten- und Kommunikationsspuren als Beweiskern
...
`fachanwalt-strafrecht`, `fachanwalt-familienrecht`, `staatsanwaltschaft-praxis-einstieg`
