...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei) | PDF | [`gesamt-pdf/bgb-bt-holzofen-lieferkette-buergschaft-goa-delikt_gesamt.pdf`](gesamt-pdf/bgb-bt-holzofen-lieferkette-buergschaft-goa-delikt_gesamt.pdf) |
...
Plugin: `bgb-bt-pruefer`, ergänzend `bgb-at-pruefer`, `bereicherungs-und-anfechtungsrecht-pruefer`, `methodenlehre-buergerliches-recht`

## Überblick

Die Akte bündelt mehrere zivilrechtliche Störungen rund um die Bestellung, Lieferung und Montage eines wasserführenden Holzofens in einem Altbau in Lübeck. Der Fall enthält Kaufrecht, Werkvertrag, Bürgschaft, Geschäftsführung ohne Auftrag, Delikt, Bereicherung, Verjährung und Beweisprobleme. Die Unterlagen sind absichtlich fragmentarisch: Rechnung, Bürgschaftserklärung, Chat, Mängelanzeige, Versicherer-Mail, Nachbarhilfe, Ersatzteilbestellung und eine unklare Abnahme.

## Beteiligte

| Person/Unternehmen | Rolle |
| --- | --- |
| Klara Windmöller | Eigentümerin Altbau, Bestellerin |
| Ofenhaus Backstein GmbH | Verkäuferin und Montagekoordinatorin |
| Hinnerk Brandt | selbstständiger Monteur/Subunternehmer |
| Bankhaus Nordtor eG | Bürgin aus kurzer Kreditlinie |
| Nachbarin Adelheid Krumm | griff nach Wasseraustritt ein |
| Provinzial Nord | Gebäudeversicherer |

## Kernfragen

1. Kauf- oder Werkvertrag oder gemischter Vertrag?
2. Sachmangel, Montagefehler, fehlende Anleitung oder falsche Dimensionierung?
3. Abnahme/Fälligkeit und Rücktritt/Minderung/Schadensersatz.
4. Bürgschaft der Bank: Form, Sicherungszweck, Einreden.
5. GoA durch Nachbarin Krumm bei Notabschaltung und Schlüsseldienst.
6. Deliktische Haftung wegen Brandschaden und Verkehrssicherung.
7. Bereicherungsrechtliche Rückabwicklung bei nichtigem Nachtrag.
...
| `23_abschrift_notizzettel_krumm.docx` | Abschrift des handschriftlichen Notizzettels der Nachbarin zu Wasseraustritt, Schlüsseldienst und Brandabend |
