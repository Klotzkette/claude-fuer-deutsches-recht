...
| Partei | Sitz | Funktion im Verfahren |
|---|---|---|
| Brezelmann Discount KG | Wurstgasse 4, 97980 Bad Mergentheim | Hauptverletzer DE; Filialen in Crailsheim + Tauberbischofsheim |
| Donauzon Marketplace GmbH | Erdbeerallee 88, 80807 München / Tour Trintignant, Luxembourg | Online-Marktplatz-Betreiberin (Host) |
| UAB klotzkettie | Vilniaus g. 47, LT-01402 Vilnius | Lieferkette / EUIPO-Anmelderin |
| Klotzkettie LLC | Wilmington, DE | US-Konkurrenz-Markenanmelderin |
| A&K Boulevard Boutique LLC | 874 Madison Avenue, New York, NY 10075 | US-Händler |

### Beteiligte Institutionen / Sachverständige

| Person / Institution | Rolle |
|---|---|
| Spürnase-Couture GmbH (Karla Kalt-Bandel), Frankfurt | Marken-Detektei, Beobachtung DE |
| Pinkerton Consulting & Investigations (J. Caruso), Jericho NY | Überwachung US |
| Mlle Hortense Périgord, Atelier des Senteurs, Grasse | Sachverständige Olfaktorik/Duftmarke |
| Prof. Dr.-Ing. Hieronymus Tastenberger, TU Darmstadt | Sachverständiger Textilhaptik |
| RA Dr. Lorenzo Maletti, Milano | Sequester (LG Frankfurt-Bestellung) |
| Niccolò Sartori, Ufficiale Giudiziario, Tribunale di Firenze | Gerichtsvollzieher IT |

---

## Was geschah – Chronologie
...
| 14.03.2026 | Handschriftliche Fax-Notiz Comtesse aus Capri; WhatsApp-Korrespondenz |
| 17.03.2026 | Transatlantische Koordination Steinacker ↔ Whitman III (22:48 MEZ) |
| 24.03.2026 | TTAB Notice of Opposition 91/289.412 ./. Klotzkettie LLC (NYC) |
| 09.04.2026 | Cease & Desist Brief Whitman Brennan → A&K Boulevard Boutique LLC |
| 10.04.2026 | Klageerwiderung Donauzon (DSA-Argumentation) |
| 16.04.2026 | BPatG-Verhandlung 25 W (pat) 88/26 (Soundmarke) |
| 22.04.2026 | USPTO Office Action § 2(d) auf Serial 97/884.117 |
| 28.04.2026 | BGH-Beschluss I ZB 14/26 (Soundmarke: Rückverweisung an BPatG) |
| 04.–17.05.2026 | Pinkerton-Überwachung NYC (A&K Boulevard Boutique) |
| 08.05.2026 | EUIPO Widerspruchsabteilung: Zwischenentscheidung (Teilerfolg Kl. 18, 25, 35) |
| 11.06.2026 | LG Frankfurt Hauptverhandlung: Protokoll, Schriftsatz-Nachlass |
| 27.07.2026 | LG-Urteil (Soundmarke: teilweise abgewiesen; Rest: bestätigt) |
| 04.08.2026 | OLG-Berufungsschrift 6 W 47/26 |
...
| Frage | Antwort |
|---|---|
| Markenportfolio | 18 Schutzrechte (DE/EU/US/IR): Wort-, Bild-, 3D-Form-, Sound-, Duft-, Haptik-, Positions-, Zertifizierungsmarken |
| Verletzungshandlungen | Anbieten + Vertreiben von K°°-Waren (T-Shirts, Halstücher, Handtaschen-Imitate, Parfumflakons) |
| Zentrale Verletzer-Klausel | § 14 Abs. 2 Nr. 1, 2, 3 MarkenG; Art. 9 Abs. 2 lit. a, b, c UMV |
| Erschöpfungseinwand Brezelmann | Haltlos: kein autorisierter EWR-Vertrieb; selektives Vertriebssystem (EuGH C-230/16 Coty) |
| Donauzon (DSA) | Art. 6 DSA / Art. 14 E-Commerce-RL — Plattformhaftung nur bei aktiver Rolle (EuGH C-324/09 L'Oréal/eBay) |
| Soundmarke | BGH I ZB 14/26: Unterscheidungskraft nicht ausreichend geprüft → Rückverweisung BPatG |
| Duftmarke | Sieckmann-Kriterien (EuGH C-273/00) nur mit kombinierter GC-MS + sensorischer Darstellung erfüllbar; Risiko ~40 % |
| Haptikmarke | Louboutin-Logik (EuGH C-163/16); konfokal-mikroskopische 3D-Profilkarte als Darstellungsmittel |
| TTAB USA | § 2(d)-Opposition + § 43(c)-Dilution; US common law rights seit 1958 |
| Gesamtstreitwert geschätzt | ≈ EUR 12.900.000 (DE + EUIPO + USPTO + SDNY) |
...
| `Mail_Mandantin_Comtesse_an_Kanzlei.pdf` | PDF | 5 E-Mails (Comtesse ↔ Dr. Steinacker-von Tarsis, Jan.–März 2026, chronologisch) | Mehrsprachig (FR/DE/IT); emotionale Mandantin; WhatsApp-Referenz |
| `Detektivbericht_Spuernase_Couture_2026-03-09.pdf` | PDF | Endbericht SPC-2026-K-0044: Beobachtungslogbuch (3 Filialen + Lager), Testkaufsquittungen, Online-Screenshots | Bandaufnahme SPC-AUD-3; 42h Beobachtungszeit |
...
| `Cease_and_Desist_NY_Whitman_Brennan_2026-04-09.pdf` | PDF | C&D-Brief Whitman Brennan → A&K Boulevard Boutique LLC (Aaron Kalman), Madison Avenue NYC | 5 Schutzrechte zitiert; Pinkerton-Ermittlung Grundlage; SDNY-Klageandrohung |
| `Mail_transatlantisch_DE_US_Steinacker_Whitman.pdf` | PDF | 3 E-Mails München ↔ New York (17.–19.03.2026): Koordination eV, EUIPO, TTAB, Pinkerton, BGH | Zeitzonen-Problem (CET vs. EDT); humoristischer Einschlag |
...
- Welche Anspruchsgrundlagen greifen? (§ 14 Abs. 2 Nr. 1, 2, 3 MarkenG; Art. 9 UMV; Lanham Act § 32, § 43)
- Wie verteilen sich die Zuständigkeiten auf die Kanzleien DE/US/IT?

### 2. Unkonventionelle Markentypen

Der Skill soll über Standard-Wort- und Bildmarken hinausgehen und erkennen:
- **Soundmarken:** Sieckmann-Anforderungen (EuGH C-273/00), Sonogramm-Darstellung, BGH I ZB 14/26
- **Duftmarken:** GC-MS-Analyse als Darstellungsmittel; Risikobewertung Sieckmann
- **Haptikmarken:** Louboutin-Logik (EuGH C-163/16); Konfokal-Mikroskopie als Reliefkarte
- **Positionsmarken:** Ähnlich Louboutin — Platzierung als markentaugliches Zeichen
- **Garantie-/Zertifizierungsmarken:** § 106a MarkenG, Anti-KI-Branding

### 3. Parallelverfahren in mehreren Jurisdiktionen koordinieren

- **DE:** LG Frankfurt → OLG Frankfurt → BGH (Instanzzug)
- **EU:** EUIPO Widerspruchsabteilung → EUIPO BoA
- **DE (Registerrecht):** DPMA → BPatG → BGH
- **US:** USPTO (Markenanmeldung + Office Action) → TTAB (Opposition) → SDNY (Klageentwurf) + CBP (Recordation)
- **IT:** Tribunale di Firenze (Cautelare ante causam)

Der Skill soll erkennen, welche Verfahren sich gegenseitig beeinflussen (z.B. BGH I ZB 14/26 und OLG-Berufung; EUIPO-Entscheidung und DPMA-Löschung).

### 4. Haftung von Online-Marktplätzen (DSA/E-Commerce-RL)

Aus der Donauzon-Klageerwiderung ist die DSA-Verteidigung zu analysieren:
- Art. 6 DSA (Hosting-Haftungsprivileg)
- EuGH C-324/09 L'Oréal/eBay — aktive Rolle als Haftungsgrund
- Notice-and-Takedown-Compliance (84 %-Nachweis vs. 77 %-Behauptung Klägerin)
- DSA Art. 16 Notice: formale Anforderungen

### 5. Erschöpfungslehre im Markenschutz

Der Erschöpfungseinwand (Brezelmann-Fax) ist korrekt zu entkräften:
- § 24 MarkenG / Art. 15 UMV — Erschöpfung nur bei EWR-Vertrieb mit Zustimmung der Markeninhaberin
- Selektives Vertriebssystem: EuGH C-230/16 (Coty Germany/Akzente), EuGH C-439/09 (Pierre Fabre)
- Graumarkt-Argument: Fehlende Herkunftsnachweise aus Turin = kein Erschöpfungsnachweis

### 6. US-Markenrecht und transatlantische Koordination

Der Skill soll Grundkenntnisse US-Markenrecht demonstrieren:
- Lanham Act §§ 32, 43 (Infringement, Unfair Competition, Dilution)
- § 2(d)-Verfahren beim USPTO (Office Action + Response Deadline)
- TTAB-Verfahren (Opposition, Notice, Discovery)
- CBP Recordation als Grenzsicherungsmaßnahme
- Madrid Protocol: IR-Designation als alternativer Registrierungsweg

### 7. Mandantenmanagement bei schwieriger Mandantschaft

Aus Notiz, WhatsApp und E-Mail-Kette soll der Skill erkennen:
- Emotionale Mandantin → professionelle Beratung trotz chaotischer Kommunikation
- Mehrsprachige Korrespondenz (FR/DE/IT/EN) — Rechtsinhalte extrahieren
- Kostenrahmen-Kommunikation (EUR 690/h Stundensatz — Mandantin hat zugestimmt)

---

## Plugin- und Skill-Empfehlungen

- **`markenrecht-fashion-luxus`** — Hauptskill für diesen Fall; soll Schriftsätze aus dem Aktendossier extrahieren, Markenportfolio analysieren, Verletzungshandlungen qualifizieren und Prozesstaktik in 5+ Jurisdiktionen koordinieren.
- **`office/pdf`** — Für Erstellung eines vollständigen Hauptsache-Klageschriftsatzes, einer EUIPO-Beschwerdeschrift oder einer SDNY-Complaint auf Basis des Akteninhalts.
- **`office/xlsx`** — Für Erweiterung der Kostennote (z.B. Q2/2026, Hochrechnung Gesamtstreitwert, Zinsen).
- **`office/docx`** — Für Erstellung einer Zusammenfassung für die Mandantin (auf Französisch), eines Vergleichsangebots oder einer USPTO-Office-Action-Antwort.
