...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei) | PDF | [`gesamt-pdf/sanierungsgewinn-insolvenzplan-grossbach-druckguss-erfurt-2026_gesamt.pdf`](gesamt-pdf/sanierungsgewinn-insolvenzplan-grossbach-druckguss-erfurt-2026_gesamt.pdf) |
...
- `/steuerrecht-anwalt-und-berater:stb-sanierungsgewinn-3c-iv-estg-verlustreihenfolge`
- `/steuerrecht-anwalt-und-berater:stb-sanierungsgewinn-mandantenwarnung-rechtzeitig`
- `/steuerrecht-anwalt-und-berater:stb-sanierungsgewinn-verlustvortrag-sanity-check`
- `/insolvenzrecht:insol-sanierungsgewinn-3a-estg-im-insolvenzplan`
- `/insolvenzrecht:insol-sanierungsgewinn-7b-gewstg-im-insolvenzplan-paralleltrack`
- `/grosskanzlei-corporate-ma:gk-sanierungsgewinn-3a-estg-praxis-fuer-corporate-ma`
- `/grosskanzlei-corporate-ma:gk-sanierungsgewinn-vorbescheid-und-verbindliche-auskunft`
...
| Komplementärin | Grossbach Verwaltungs-GmbH |
...
| Steuerberater Schuldnerin | StB Dr. Thorsten Engelmeier, Engelmeier & Partner, Erfurt |
...
| AG Erfurt — Planbestätigung | 60 IN 188/26 |
...
├── 21_telefonvermerk_weissbrod_fa_erfurt_2026-07-08.docx
└── 22_email_gewerbesteueramt_zwischennachricht_7b.eml
```

## Quellennachweis (Rechtsnormen und Rechtsprechung)

- § 3a EStG — Steuerfreiheit Sanierungsertrag bei unternehmensbezogener Sanierung: https://dejure.org/gesetze/EStG/3a.html
...
- §§ 217 ff. InsO — Insolvenzplan: https://dejure.org/gesetze/InsO
