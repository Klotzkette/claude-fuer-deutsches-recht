# Dr. Ottilie Mondsee und die verschwundene R-Besoldung
...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei) | PDF | [`gesamt-pdf/beamtenrecht-richterlaufbahn-besoldung-mondsee_gesamt.pdf`](gesamt-pdf/beamtenrecht-richterlaufbahn-besoldung-mondsee_gesamt.pdf) |
...
Die Akte ist als dichtes Mandatskonglomerat angelegt: frühe Mandantennotizen, Auswahlakte, ministerielle Vermerke, E-Mail-Verkehr, Chatnotizen, Tabellen, Word-Memos, Bildanlagen, beA-/beBPo-Fristenlog, Eilantrag, Replik, Beschwerdereserve, Besoldungswiderspruch, BEM-/Amtsarzt-Nebenakte und Vergleichsstrategie laufen nebeneinander. Das Gesamt-PDF umfasst 60 Seiten; der Ordner enthält 73 Einzelstücke.
...
| Technische und anwaltliche Arbeitsmittel | `31` bis `34`, `48` bis `52`, `59` bis `62`, `68` bis `69`, `73` | EML-Korrespondenz, Word-Memos, Excel-Modelle, Aktenlandkarten, Sitzungsvorbereitung, Besoldungs- und Fristenmodell, Saalplan, Fragenkatalog, Mandantinnenmail und `73-handschriftliche-notiz-mondsee-nach-eroerterung.docx`. |
...
`beamtenrecht`, `fachanwalt-verwaltungsrecht`, `verfassungsrecht`, `zitierweise-deutsches-recht`
