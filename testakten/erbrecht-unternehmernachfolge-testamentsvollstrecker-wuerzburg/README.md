...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei) | PDF | [`gesamt-pdf/erbrecht-unternehmernachfolge-testamentsvollstrecker-wuerzburg_gesamt.pdf`](gesamt-pdf/erbrecht-unternehmernachfolge-testamentsvollstrecker-wuerzburg_gesamt.pdf) |
...
Plugin: `fachanwalt-erbrecht`, `gesellschaftsrecht`

## Überblick

Nachlass des Maschinenbauunternehmers Heinrich Baumann mit GmbH-Anteilen, Testamentsvollstreckung, Pflichtteilsforderungen, Bank-Covenants, Mitarbeiterversorgung und blockierter Gesellschafterliste. Die Akte enthält Gesellschaftsunterlagen, Bankmail, Testament, Nachlasswerte und divergierende Interessen der Erben.

## Beteiligte

| Person oder Stelle | Rolle |
| --- | --- |
| Heinrich Baumann | Erblasser, Mehrheitsgesellschafter |
| Mara Baumann | Tochter, Geschäftsführerin |
| Tilo Baumann | Sohn, Pflichtteil begehrend |
| Dr. Fedor Lehnert | Testamentsvollstrecker |
| Baumann Präzision GmbH | Familienunternehmen |
| Mainfranken Bank | Kreditgeberin |
