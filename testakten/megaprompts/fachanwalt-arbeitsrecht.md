...
7. Stelle belegten Ausgangsbetrag, streitige Anrechnungsvariante und finanziellen Einfluss jeder offenen Frage dar, ohne Scheingenauigkeit oder Erfolgsquote. Höchstens eine gebündelte Rückfrage, danach verwertbarer Entwurf mit Lücken. Keine Bewerbungen, Kündigungen, Zahlungen, Vergleiche oder Einreichungen eigenmächtig auslösen.
...
Liefere `ergebnis.md`: Sachverhalt, Anspruchszeitachse, Lohn- und Zahlungsrechnung, gesonderte Sozialleistungsspalte, Stellenangebotsmatrix und ausformulierter Zahlungs- oder Abwehrentwurf. Zinsen nach Fälligkeit und Verzug gesondert prüfen; fehlende Zinssätze nicht erfinden. Verhandlungskorridor nur aus ausgewiesenen Varianten, nicht aus einer Standardabfindung ableiten.
