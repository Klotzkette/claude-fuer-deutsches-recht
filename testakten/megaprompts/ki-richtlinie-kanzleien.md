# Vollprüfung: ki-richtlinie-kanzleien
...
- Fachpfad wählen: zentrale Anker im Ki Richtlinie Kanzleien sind DSGVO. Anhand des Sachverhalts in einen Sach-Cluster routen und den passenden Spezial-Skill aus der Fachlandkarte oben benennen.
...
## Spezialwissen: Pflegt: Erstprüfung, Rollenklärung und Mandatsziel
...
## Skill: `ki-kompetenz-erwerb-plan`

_Erstellt einen schlanken Kompetenzförderplan für Kanzleimitarbeiter nach Artikel 4 neuer Fassung. Verbindet konkrete Werkzeuge, Quellenkontrolle, Vertraulichkeit und Freigaberollen, ohne pauschale Kurs-, Zertifikats- oder Wiederholungspflichten zu erfinden._
...
[Rechtsstandkarte, Abschnitt 1.2](https://github.com/Klotzkette/claude-fuer-deutsches-recht/blob/main/ki-richtlinie-kanzleien/references/digitaler-omnibus-2026.md), Artikel 4 neuer Fassung, Artikel 3 Nummer 56 und Artikel 26 Absatz 2. Paragrafen 43, 43a und 43e BRAO bleiben eigenständige Prüfungen. [Zitierweise](https://github.com/Klotzkette/claude-fuer-deutsches-recht/blob/main/ki-richtlinie-kanzleien/references/zitierweise.md).
...
5. Die [vollständige Fachmodulkarte](https://github.com/Klotzkette/claude-fuer-deutsches-recht/blob/main/ki-richtlinie-kanzleien/skills/start-chronologie-fristen/references/fachmodule.md) wird nur konsultiert, wenn kein eindeutiger Primärskill feststeht oder eine echte Querschnittsfrage verbleibt.
...
## Arbeitsworkflow
1. **Fallbild bilden:** Sachverhalt, Rollen, Zeitachse und Dokumente in eine kurze Matrix bringen.
2. **Rechtsrahmen setzen:** Normen, Zuständigkeiten, Fristen, Formfragen und Verfahrensstand zum Themenfeld **Rechtsabteilungen Kanzlei-KI** prüfen.
3. **Prüfpunkte abarbeiten:** Tatbestandsmerkmale, Beweisfragen, typische Fehler, Gegenargumente und Ermessens- oder Wertungsfragen trennen.
4. **Risiko bewerten:** Grün/Gelb/Rot mit Begründung, Annahmen, fehlenden Belegen und möglichen Alternativwegen ausgeben.
5. **Anschluss bauen:** Passende weitere Skills desselben Plugins vorschlagen, wenn eine Vertiefung, ein Schreiben, eine Tabelle, ein Fristenblatt oder eine Verhandlungsstrategie sinnvoll ist.

## Risikoampel Rechtsabteilung Syndikus-KI-Einsatz
- **Syndikusspezifika:** Syndikusrechtsanwalt nach § 46 BRAO; Schweigepflicht über Unternehmensgeheimnisse (Konkurrentenschutz, Insider-Informationen, M&A-Verhandlungen).
- **Konfliktfeld:** KI-Tools können Unternehmensdaten in Anbieter-Infrastruktur laden — § 17 UWG / § 4 GeschGehG (Geschäftsgeheimnisschutz) plus § 43a BRAO.
- **§ 87 Abs. 1 Nr. 6 BetrVG:** Bei größeren Unternehmen Betriebsratsbeteiligung — KI-Tool, das Verhaltens-/Leistungsdaten erfasst, ist mitbestimmungspflichtig.
- **Compliance-Schnittstelle:** Kartellrecht (z. B. Kommunikation mit Konkurrenz), Geldwäsche (§ 2 GwG), Sanktionsrecht — KI darf keine kritischen Informationen leaken.

## Risikoampel
- **Rot:** KI-Tool für M&A-/Compliance-Beratung ohne AVV, ohne Verschwiegenheits-Verpflichtung, mit US-Cloud ohne DPF/SCC/TIA.
- **Gelb:** KI-Tool freigegeben, aber Schulung der Syndikus-Anwälte fehlt; Betriebsrat nicht beteiligt.
- **Grün:** Tool-Whitelist mit AVV + Mitwirkenden-Verpflichtung § 203 Abs. 4 StGB + Betriebsvereinbarung + dokumentierter Schulungsnachweis.
...
- "Mitarbeiterr hat Auflagen missachtet" — Schulungsnachweis + verpflichtende Kenntnisnahme.
...
6. **Vorbereitung bis 2026**: Rechtzeitig vor dem 2. Dezember 2027 prüfen, welche Systeme betroffen sind, und die erforderliche Dokumentation und Risikobeurteilung erstellen.
...
Die konkrete Ausgestaltung der Hochrisiko-Pflichten durch Durchführungsrechtsakte der EU-Kommission und durch Leitlinien des Europäischen KI-Büros ist bis zum 2. Dezember 2027 zu verfolgen. Ebenso sind BAG- und Landesarbeitsgericht-Entscheidungen zur Zulässigkeit von KI-Systemen im Personalwesen zu beobachten.
