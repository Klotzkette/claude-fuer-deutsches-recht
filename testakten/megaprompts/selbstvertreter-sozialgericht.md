...
Diese Vollprüfung enthält top-8 von 139 Skills (gekürzt für das Arbeitsfenster) des Plugins `selbstvertreter-sozialgericht`.
...
_Schaltet sich ein, wenn in Selbstvertreter Sozialgericht ein juristisches Arbeitsprodukt tragfähig begründet werden muss; verbindet konkrete Aktenfundstellen mit Tatbestandsmerkmal, Beweislast, stärkster Gegenposition und Rechtsfolge._

# Juristischer Argumentationskern - Selbstvertreter Sozialgericht
...
Pluginauftrag: Selbstvertretung vor Sozialbehörden Krankenkassen Pflegekassen BG Versorgungsamt Jobcenter Rente Familienkasse und Sozialgericht: Anhörung Akteneinsicht Mitwirkung Widerspruch Klage Eilantrag Pflegegrad Hilfsmittel Krankengeld EM-Rente GdB Bürgergeld Wohngeld Eingliederungshilfe.
...
Formuliere das Ergebnis für Selbstvertreter Sozialgericht in einem Satz und nenne darin Parteirolle, begehrte oder abzuwehrende Rechtsfolge und den entscheidenden Prüfpunkt. Typische Rechtsfolgen in diesem Arbeitsfeld sind: Widerspruch, Klage, einstweiliger Rechtsschutz, Leistungsbescheid oder Vergleich.
...
3.1.1. Die Widerspruchsfrist — Paragraf 84 SGG: Bearbeite den Fachpunkt im Skill widerspruchsfrist-84-sgg und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.2. Frist verpasst? Wiedereinsetzung nach Paragraf 67 SGG: Bearbeite den Fachpunkt im Skill wiedereinsetzung-frist-67-sgg und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.3. Bafoeg Bescheide Widerspruch: Bearbeite den Fachpunkt im Skill bafoeg-bescheide-widerspruch und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.4. Eilrechtsschutz beim Sozialgericht — Paragraf 86b SGG: Bearbeite den Fachpunkt im Skill eilantrag-86b-sgg-grundlagen und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
...
# Eigenen Sozialgerichtsfall und Verfahrensbedarf einordnen
...
5. Die [vollständige Fachmodulkarte](https://github.com/Klotzkette/claude-fuer-deutsches-recht/blob/main/selbstvertreter-sozialgericht/skills/kaltstart-triage/references/fachmodule.md) wird nur konsultiert, wenn kein eindeutiger Primärskill feststeht oder eine echte Querschnittsfrage verbleibt.
