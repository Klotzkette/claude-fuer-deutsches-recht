...
Diese Vollprüfung enthält top-10 von 80 Skills des Plugins `fachanwalt-verkehrsrecht`.
...
8. **werkstattrechnung-kuerzung-zahlungswege** — Gleicht gekürzte Unfallreparaturrechnungen mit Gutachten, Auftrag und Zahlungen ab und bestimmt für jede Restposition Be…
9. **fachanwalt-verkehrsrecht-regulierungsanforderung** — Für Regulierungsanforderung: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Sc…
10. **fahrerlaubnis-punktesystem-paragraf-4-stvg** — Prüft Maßnahmen des Fahreignungs-Bewertungssystems anhand Tattag, Rechtskraft, Punktestand und Tilgung, rekonstruiert Er…
...
## Skill: `verkehrsprozess-versandmappe-endfertigen`

_Endfertigt Verkehrsunfall-, Kaskoversicherungs-, Fahrerlaubnis- und Bußgeldschriftsätze: trennt Zivil-, Verwaltungs-, Straf- und OWi-Verfahren, liest Polizeiakte, Fotos, Gutachten, Rechnungen und Zustellungen zuerst, prüft Antrag, Haftungsquote, Frist und Schaden und liefert verfahrensgerechte Einzel-PDFs mit fortgeführtem Anlagenkreis und Eingangscheck._

# Verkehrsprozess-Versandmappe endfertigen

## 1. Verfahrensspur trennen

Lies Schriftsatz, Unfallaufnahme, Anhörung oder Bescheid, Zustellung, Fotos, Skizze, Gutachten, Reparaturrechnung, Mietwagen- und Nutzungsausfallbelege. Trenne Zivilprozess, Kasko, Bußgeld, Strafsache und Fahrerlaubnisverfahren; jedes erhält eigene Frist, Formnorm und Versandnachricht.

## 2. Schlusskontrolle

Im Zivilprozess Haftungsgrund, Quote und jede Schadensposition belegen. Im OWi- oder Strafverfahren Messakte, Fahreridentität, Verfahrenshandlung und Rechtsmittelform prüfen. Im Fahrerlaubnisrecht Bescheid, Sofortvollzug, Widerspruch und Eilantrag abstimmen.

## 3. Anlagenproduktion

K/B nur im Zivilprozess fortführen; behördliche und strafprozessuale Aktenbezeichnungen nicht überschreiben. Fotos erhalten Datum und Perspektive, Gutachten bleiben vollständig. Kennzeichen und Gesundheitsangaben nicht unnötig in Dateinamen verwenden.

Liefere je Verfahrensspur Schriftsatz, Einzelanlagen, Fristenblatt, Haftungs- oder Messmatrix, Schadensberechnung, Manifest und Eingangskontrolle. Stoppe bei vermischten Verfahren, fehlender Zustellung, unstimmiger Schadenssumme, nicht zugeordnetem Foto oder falschem elektronischen Formweg.
...
## Skill: `werkstattrechnung-kuerzung-zahlungswege`

_Gleicht gekürzte Unfallreparaturrechnungen mit Gutachten, Auftrag und Zahlungen ab und bestimmt für jede Restposition Beweisbedarf und Zahlungsempfänger. Für konkrete Reparaturabrechnung mit Werkstattrisiko, nicht für fiktiven Totalschaden oder Kaskodeckung._
...
Lies Unfallhergang und Haftungserklärung, Eigentums- oder Berechtigungsnachweis, Reparaturauftrag, Gutachten, Rechnung, Prüfbericht, Abtretungen und sämtliche Zahlungen. Erfasse Reparaturdatum, Vorsteuerabzug, Vorschäden, Auswahl der Werkstatt und erkennbare Preisauffälligkeiten. Entnimm das verlangte Dokument dem vorhandenen Auftrag und frage nur nach fehlenden entscheidenden Belegen, nicht erneut nach bereits beantworteten Angaben.

## 3. Ablauf und Rechenlogik

1. Trenne Anspruchsberechtigten, Werkstatt, Halter, Fahrer und Haftpflichtversicherer. Prüfe Abtretung der Unfallforderung getrennt vom Angebot einer Abtretung möglicher Ansprüche gegen die Werkstatt. Nicht jede Einziehungsermächtigung ist eine Forderungsabtretung.
2. Erfasse je Position Gutachtenansatz, Auftrag, Rechnung netto, Steuer, Brutto, Kürzungsgrund und Beleg. Ordne unfallfremde Arbeiten, Vorschäden, Doppelberechnungen und Preis- oder Arbeitszeiteinwände getrennt ein. Rechnungsstellung allein ersetzt nicht jeden Nachweis.
3. Erstelle zwei getrennte Konten: Schadensersatzsaldo gegen den Schädiger und Werklohnsaldo gegenüber der Werkstatt. Zeige Zahler, Empfänger, Datum und Tilgungszweck. Eine Versicherungszahlung an den Geschädigten tilgt nicht automatisch die Werkstattrechnung; keine Zahlung zweimal abziehen.
4. Prüfe objektive Erforderlichkeit und die subjektbezogenen Grenzen des Werkstattrisikos. Bei unbezahlter Rechnung und Berufung auf dieses Risiko Zahlung an die Werkstatt mit Zug-um-Zug-Angebot passender Werkstattansprüche prüfen. Wer Zahlung an sich verlangt, kann den objektiven Nachweis nicht einfach mit dem Werkstattrisiko ersetzen. Bei Teilzahlung bezahlte und offene Teile gesondert behandeln; bei einem klagenden Zessionar die persönliche Anwendbarkeit der Privilegierung eigens verifizieren.
5. Rechne ersatzfähige Positionen, gegebenenfalls Haftungsquote, anrechenbare Zahlungen und offenen Betrag mit eindeutiger Netto-/Bruttobasis. Umsatzsteuer und Vorsteuerabzug prüfen. Die konkrete Reparatur nicht mit einer günstigeren fiktiven Abrechnung oder einer Totalschadenrechnung vermischen. Unsichere Positionen als Variante, nicht als sichere Forderung ausweisen.
6. Formuliere eine positionsgenaue Erwiderung mit zutreffendem Empfänger und gegebenenfalls Zug-um-Zug-Verknüpfung. Keine Abtretung abschließen, keine Zahlung anweisen und keinen Schriftsatz absenden. Fristdruck führt zur Priorisierung eines Entwurfs, nicht zum Arbeitsabbruch.

### 3.1. Nach einer Zahlungsmitteilung weiterrechnen

Fehlt der Verwendungszweck einer Versicherungszahlung, fordere die konkrete Mitteilung an und halte die betroffene Zuordnung offen. Nach Eingang prüfe Zahler, Empfänger, Datum und Zweck, aktualisiere Schadensersatz- und Werklohnsaldo und passe das Zahlungsbegehren an. Bei späterer Eigenzahlung des Geschädigten den nun bezahlten Teil gesondert berücksichtigen; nicht den alten Empfänger oder eine erledigte Restposition stehen lassen.

Zeigt die Antwort einen weiteren entscheidenden Widerspruch, etwa zwischen Zahlungsmitteilung und Kontoeingang, kläre genau diesen Punkt. Bearbeite die gesicherten Positionen inzwischen vorläufig und stelle nach Klärung die bestellte Regulierungsantwort fertig. Eine angenommene Tilgung darf nicht als bestätigte Tatsache in einer Nachforderung stehen.

## 4. Quellenpflicht

Nach [Paragraf 249 BGB](https://www.gesetze-im-internet.de/bgb/__249.html) und BGH, Urteil vom 16.01.2024, VI ZR 253/22, [Rn. 14–20, 25–28](https://www.bundesgerichtshof.de/SharedDocs/Entscheidungen/DE/Zivilsenate/VI_ZS/2022/VI_ZR_253-22.pdf?__blob=publicationFile&v=1), umfasst das Werkstattrisiko ohne Auswahl- oder Überwachungsverschulden auch tatsächlich nicht ausgeführte Einzelarbeiten, deren Unterbleiben für den Geschädigten nicht erkennbar war. Bei behaupteter Nichtausführung nicht allein deshalb den Anspruch verwerfen. Der Geschädigte muss aber unfallbedingten Schaden und Reparaturbezug beweisen; unfallfremde Arbeiten sind ausgeschlossen.

Bei offener Rechnung und Berufung auf dieses Risiko Zahlung an die Werkstatt Zug um Zug gegen Abtretung der entsprechenden Ansprüche gegen sie verlangen. Der Geschädigte bleibt Gläubiger, die Werkstatt ist nur Zahlungsempfänger. Wer Zahlung an sich fordert, muss Durchführung und objektive Erforderlichkeit beweisen; bei Freistellung die Werklohnverbindlichkeit. Keine automatische Übertragung auf Zessionare. Volltext am 22.09.2026 geprüft; eine später ermittelte Überhöhung begründet nicht rückwirkend Auswahlverschulden.

Die konkrete Anspruchsgrundlage und jüngere Fortentwicklung bei Verwendung amtlich nachprüfen. Gericht, Entscheidungsform, Datum, Aktenzeichen, URL und belegte Passage nennen; die [Zitierweise](https://github.com/Klotzkette/claude-fuer-deutsches-recht/blob/main/fachanwalt-verkehrsrecht/references/zitierweise.md) ist optional ergänzend. Ohne geprüften Volltext keine Randnummer ergänzen. Beleg, Annahme und rechtliche Bewertung getrennt ausweisen.
...
„Die Werkstattrechnung ist teilweise durch den Versicherer bezahlt, im Übrigen offen. Prüfen Sie die gekürzten Verbringungs- und Diagnosekosten und formulieren Sie das Zahlungsbegehren mit dem richtigen Empfänger.“
