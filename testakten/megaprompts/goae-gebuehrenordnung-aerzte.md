# Vollprüfung: goae-gebuehrenordnung-aerzte

## Zusammensetzung

Diese Vollprüfung enthält top-10 von 66 Skills des Plugins `goae-gebuehrenordnung-aerzte`.
...
_Schaltet sich ein, wenn in GOÄ Gebührenordnung Ärzte ein juristisches Arbeitsprodukt tragfähig begründet werden muss; verbindet konkrete Aktenfundstellen mit Tatbestandsmerkmal, Beweislast, stärkster Gegenposition und Rechtsfolge._

# Juristischer Argumentationskern - GOÄ Gebührenordnung Ärzte
...
Pluginauftrag: Super-Plugin zur GOÄ: private Arztrechnungen prüfen, erstellen, begründen, beanstanden und prozessual verwerten.
...
3.1.1. Fälligkeit Verzug Mahnung Honorarklage: Bearbeite den Fachpunkt im Skill faelligkeit-verzug-mahnung-honorarklage und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.2. IGeL Aufklärung Kosteninformation: Bearbeite den Fachpunkt im Skill igel-aufklaerung-klageerwiderung und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.3. Klageerwiderung Honorarprozess: Bearbeite den Fachpunkt im Skill klageerwiderung-honorarprozess und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.4. GOÄ Rechnung aus PDF extrahieren: Bearbeite den Fachpunkt im Skill rechnung-pdf-reform-referentenentwuerfe und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
