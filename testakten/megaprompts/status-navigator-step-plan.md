...
Diese Vollprüfung enthält top-15 von 36 Skills des Plugins `status-navigator-step-plan`.
...
_Schaltet sich ein, wenn in Status Navigator Step Plan ein juristisches Arbeitsprodukt tragfähig begründet werden muss; verbindet konkrete Aktenfundstellen mit Tatbestandsmerkmal, Beweislast, stärkster Gegenposition und Rechtsfolge._

# Juristischer Argumentationskern - Status Navigator Step Plan
...
Pluginauftrag: Status-Navigator und Step-Plan-Macher. Reine Dokumentenverarbeitung mit 35 Skills. Strukturiert disparate Dokumentenlagen in eine mehrseitige Excel-Arbeitsmappe und optional ein Padlet-Shelf mit Reitern Überblick, Vorhanden, Fehlend und Workflow. Keine rechtliche Bewertung.
...
3.1.1. Einstieg: Was haben wir und was muss geschehen: Bearbeite den Fachpunkt im Skill status-navigator-einstieg und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.2. Optionaler Reiter Fristen: Bearbeite den Fachpunkt im Skill excel-reiter-fristen-optional und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.3. Szenario gescheiterte Finanzierung: Bearbeite den Fachpunkt im Skill szenario-faelligstellung-vollstreckung und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.4. Ampelsystem für Status: Bearbeite den Fachpunkt im Skill ampel-system und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
...
4.6. Paragraf 177 BGB ist nur ein Hinweis, kein Befund – Heilung prüfen anwaltlich
