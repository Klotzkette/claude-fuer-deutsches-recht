# Vollprüfung: berufsrecht-anwaelte

## Zusammensetzung

Diese Vollprüfung enthält top-8 von 209 Skills (gekürzt für das Arbeitsfenster) des Plugins `berufsrecht-anwaelte`.

## Inhaltsverzeichnis

1. **juristischer-argumentationskern** — Schaltet sich ein, wenn in Berufsrecht Anwälte ein juristisches Arbeitsprodukt tragfähig begründet werden muss; verbinde…
2. **ai-act-aktenherausgabe-zurueckbehaltung** — Wenn es um europäischer Technikregulierungsrahmen-Transparenz bei Kanzlei-Chatbot, Website und Schriftsatz in Berufsrech…
3. **ki-dienstleister-43e-brao-praxis** — Wenn es um digitale Werkzeuge-Dienstleister nach Paragraf 43e BRAO in der Praxis in Berufsrecht Anwälte geht: ordnet Sac…
4. **it-cloud-kammeraufsicht-ruege** — Wenn es um IT, Cloud, digitale Werkzeuge und Outsourcing in Berufsrecht Anwälte geht: ordnet Sachverhalt, Norm, Beweisla…
5. **ki-output-endkontrolle-und-signatur** — Wenn es um digitale Werkzeuge-Output, anwaltliche Endkontrolle und Signatur in Berufsrecht Anwälte geht: erstellt den pa…
6. **kaltstart-routing** — Wenn es um Allgemeiner Kaltstart und Routing in Berufsrecht Anwälte geht: klärt Rolle, Ziel, Frist, Unterlagen und den p…
7. **quellen-und-rechtsprechungscheck** — Wenn es um Quellen- und Rechtsprechungscheck in Berufsrecht Anwälte geht: ordnet Sachverhalt, Norm, Beweislast, Gegenarg…
8. **anwaelte-geldwaesche-risikoanalyse-kanzlei-rechtsprechungscheck** — Wenn es um Anwaelte Geldwaesche Risikoanalyse Kanzlei Rechtsprechungscheck in Berufsrecht Anwälte geht: zerlegt Ergebnis…

---

## Skill: `juristischer-argumentationskern`

_Schaltet sich ein, wenn in Berufsrecht Anwälte ein juristisches Arbeitsprodukt tragfähig begründet werden muss; verbindet konkrete Aktenfundstellen mit Tatbestandsmerkmal, Beweislast, stärkster Gegenposition und Rechtsfolge._

# Juristischer Argumentationskern - Berufsrecht Anwälte
...
Pluginauftrag: Plugin für anwaltliches Berufsrecht: BRAO, BORA, FAO, beA, Kanzleisitz, Werbung, Interessenkollision, Verschwiegenheit, System-/Cloud-Outsourcing, Schatten-Systeme, Berufsausübungsgesellschaft, Gebühren, Kammeraufsicht und anwaltsgerichtliche Risiken.
...
Formuliere das Ergebnis für Berufsrecht Anwälte in einem Satz und nenne darin Parteirolle, begehrte oder abzuwehrende Rechtsfolge und den entscheidenden Prüfpunkt. Typische Rechtsfolgen in diesem Arbeitsfeld sind: Widerspruch, Anfechtung, Verpflichtung, Eilantrag, Abhilfe oder Bescheidkorrektur.
...
3.1.1. Anwälte: fristversäumnis und wiedereinsetzung - Kammerantwort mit Verfahrensstrategie, Tonlage und Belegplan: Bearbeite den Fachpunkt im Skill fristversaeumnis-und-wiedereinsetzung-kammerantwort und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.2. Anwälte: fristversäumnis und wiedereinsetzung - Organisationspflichten, Prävention, Team-Anweisung und Fristenkontrolle: Bearbeite den Fachpunkt im Skill fristversaeumnis-und-wiedereinsetzung-organisationspfl und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.3. Anwälte: fristversäumnis und wiedereinsetzung - Rechtsprechungscheck, stärkste Gegenansicht und Red-Team-Korrektur: Bearbeite den Fachpunkt im Skill fristversaeumnis-und-wiedereinsetzung-rechtsprechungsc und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.4. Anwälte: fristversäumnis und wiedereinsetzung - Kaltstart mit Faktenmatrix, Risikoampel und fehlenden Unterlagen: Bearbeite den Fachpunkt im Skill fristversaeumnis-wiedereinsetzung und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
...
5.1. Bestimme zuerst den konkreten Streitpunkt in Berufsrecht Anwälte und öffne den dazu in Abschnitt 3.1 verknüpften Fachskill. Ein fachgebietsweiter Leitfall ersetzt keine streitpunktgenaue Recherche.
...
## Skill: `ai-act-aktenherausgabe-zurueckbehaltung`

_Wenn es um europäischer Technikregulierungsrahmen-Transparenz bei Kanzlei-Chatbot, Website und Schriftsatz in Berufsrecht Anwälte geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik._
...
## Skill: `ki-dienstleister-43e-brao-praxis`

_Wenn es um digitale Werkzeuge-Dienstleister nach Paragraf 43e BRAO in der Praxis in Berufsrecht Anwälte geht: ordnet Sachverhalt, Norm, Beweislast, Gegenargumente und nächsten Schritt; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen._
...
_Wenn es um IT, Cloud, digitale Werkzeuge und Outsourcing in Berufsrecht Anwälte geht: ordnet Sachverhalt, Norm, Beweislast, Gegenargumente und nächsten Schritt; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen._
...
## Skill: `ki-output-endkontrolle-und-signatur`

_Wenn es um digitale Werkzeuge-Output, anwaltliche Endkontrolle und Signatur in Berufsrecht Anwälte geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Gegenprüfung mit Fehler-, Beweis- und Fristencheck._
...
_Wenn es um Allgemeiner Kaltstart und Routing in Berufsrecht Anwälte geht: klärt Rolle, Ziel, Frist, Unterlagen und den passenden nächsten Fachskill; liefert ein direkt nutzbares Arbeitsprodukt mit Prüfpunkten, Risiken und nächstem Schritt._
...
_Wenn es um Quellen- und Rechtsprechungscheck in Berufsrecht Anwälte geht: ordnet Sachverhalt, Norm, Beweislast, Gegenargumente und nächsten Schritt; liefert ein direkt nutzbares Arbeitsprodukt mit Prüfpunkten, Risiken und nächstem Schritt._
...
## Skill: `anwaelte-geldwaesche-risikoanalyse-kanzlei-rechtsprechungscheck`

_Wenn es um Anwaelte Geldwaesche Risikoanalyse Kanzlei Rechtsprechungscheck in Berufsrecht Anwälte geht: zerlegt Ergebnis, Frist, Zuständigkeit, Beweislast und Gegenposition; liefert eine Gegenprüfung mit Fehler-, Beweis- und Fristencheck._
...
**Fokus:** geldwaesche risikoanalyse kanzlei; rechtsprechungscheck, stärkste gegenansicht und red-team-korrektur im Berufsrecht der Anwälte
