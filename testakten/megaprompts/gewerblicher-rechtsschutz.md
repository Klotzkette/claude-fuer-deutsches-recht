...
_Schaltet sich ein, wenn in Gewerblicher Rechtsschutz ein juristisches Arbeitsprodukt tragfähig begründet werden muss; verbindet konkrete Aktenfundstellen mit Tatbestandsmerkmal, Beweislast, stärkster Gegenposition und Rechtsfolge._

# Juristischer Argumentationskern - Gewerblicher Rechtsschutz
...
Pluginauftrag: Gewerblicher Rechtsschutz – DPMA/EUIPO-Markenrecherche und -anmeldung, Freedom-to-Operate, Patentscreening, UWG- und Urheberrechts-Abmahnung (Versand und Reaktion), Open-Source-Compliance, IP-Klausel-Review, Schutzrechts-Fristen.
...
3.1.1. EV-Vollzug 005: Ordnungsmittelantrag (Paragraf 890 ZPO) nach Unterlassungstitel: Bearbeite den Fachpunkt im Skill evvollzug-neu-005-ordnungsmittelantrag-vollstreckung-unterlassun und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.2. Gewerblicher Rechtsschutz: beA Zustellung einstweiliger Rechtsschutz Risiken: Bearbeite den Fachpunkt im Skill evvollzug-neu-004-bea-zustellung-einstweiliger-rechtsschutz und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.3. EV-Vollzug 004: beA-Zustellung im Einstweiligen Rechtsschutz – Risiken und Praxis: Bearbeite den Fachpunkt im Skill evvollzug-neu-004-bea-zustellung-einstweiliger-rechtsschutz-risi und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
3.1.4. EV-Vollzug 001: Vollziehungsfrist und Parteizustellung (Paragraf 929 Abs. 2 ZPO): Bearbeite den Fachpunkt im Skill evvollzug-neu-001-einstweilige-verfuegung-vollziehung-frist und führe dessen Norm, Aktenfund, Beweislast, Gegenposition und Rechtsfolge in den Argumentationskern zurück.
...
4.6. Paragraf 929 Abs. 2 ZPO – Vollziehungsfrist: Der Arrestbefehl und die einstweilige Verfügung verlieren ihre Kraft, wenn die Vollziehung nicht binnen eines Monats nach Verkündung bzw
...
## Skill: `verfuegungs-versandmappe-endfertigen`

_Endfertigt Abmahnung, Schutzschrift, einstweilige Verfügung und Hauptsache im gewerblichen Rechtsschutz: fixiert Zeichen, Produkt, Werbung oder Verletzungsform, prüft Dringlichkeit, Antrag und Vollziehung, ordnet Rechtekette, Marktbelege und Screenshots und liefert eine beA- oder registerfertige Versandmappe._

# Verfügungs-Versandmappe endfertigen

## 1. Verletzungsform einfrieren

Lies Entwurf, Schutzrecht oder lauterkeitsrechtliche Grundlage, konkrete Verletzungsform, Abmahnung, Reaktion und Zustellnachweise zuerst. Trenne Schutzschriftregister, Verfügungsantrag, Widerspruch, Abschlussschreiben und Hauptsache. Der Antrag muss mit der gesicherten konkreten Verletzungsform übereinstimmen.

## 2. Eil- und Bestimmtheitskontrolle

1. Kenntniszeitpunkt, fortdauernde Handlung, Abmahnung und gerichtliche Einreichung chronologisch belegen.
2. Aktivlegitimation, Rechtekette, Registerstand, Benutzung und Priorität prüfen.
3. Verbotstenor, Kerntheorie und zulässige Reichweite gegen Produkt, Zeichen, Werbung oder Aussage spiegeln.
4. Glaubhaftmachungsmittel, eidesstattliche Versicherungen und Anlagen vollständig zuordnen.
5. Erlass, Zustellung und Vollziehung mit ZPO Paragraf 929 Absatz 2 als gesonderten Nachlauf planen.

## 3. Anlagen und Registerwege

Ordne Registerauszüge, Schutzrechtsurkunden, Lizenz- und Übertragungskette, Testkauf, Verpackung, Werbung, Screenshots, Markt- und Reichweitenbelege. Screenshots erhalten URL, Datum, Uhrzeit und Kontext. Schutzschriftregister und Gericht sind getrennte Empfänger; für jeden gelten eigener Upload- und Empfangsnachweis.

## 4. Form- und Rechtsanker

- ZPO Paragrafen 935, 936 und 929 bei Antrag, Glaubhaftmachung und Vollziehung gemeinsam kontrollieren.
- MarkenG, UWG, DesignG, PatentG oder GeschGehG nur entsprechend Streitgegenstand und beantragter Rechtsfolge einsetzen.
- Eine Pressemitteilung oder Kanzleiveröffentlichung dient allein als Recherchehinweis. Tragende Aussage, Datum und Aktenzeichen werden vor Verwendung aus Entscheidung oder amtlicher Mitteilung verifiziert.

## 5. Auslieferung

Liefere je Empfänger Hauptdokument, Einzelanlagen, Verletzungsformen- und Dringlichkeitsmatrix, Rechtekettenblatt, Vollziehungsfahrplan, Manifest und Empfangskontrolle. Stoppe bei ungesicherter Verletzungsform, fehlender Aktivlegitimation, offenem Tenor, abgelaufener Dringlichkeit oder verwechseltem Register- und Gerichtsweg.
