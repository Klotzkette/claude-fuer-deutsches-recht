# Akte: Erbstreit Edelmann — Multisig, Pflichtteil, Patchworkfamilie
...
| Datei | Inhalt |
|---|---|
| [`docx/testament_edelmann_09_11_2019.docx`](docx/testament_edelmann_09_11_2019.docx) | Testament-Volltext im Manuskript-Stil (Schreibmaschinen-/Handschriftäquivalent) |
| [`docx/erbscheinsantrag_lg_stuttgart_entwurf.docx`](docx/erbscheinsantrag_lg_stuttgart_entwurf.docx) | Antragsentwurf gemeinschaftlicher Erbschein, AG Stuttgart |
| [`docx/klageschrift_pflichtteilsergaenzung_henrike_constantin.docx`](docx/klageschrift_pflichtteilsergaenzung_henrike_constantin.docx) | Klageschriftentwurf Stufenklage LG Stuttgart |

### Excel-Tabellen (XLSX)

| Datei | Inhalt |
|---|---|
| [`xlsx/nachlassverzeichnis_aktiv_passiv.xlsx`](xlsx/nachlassverzeichnis_aktiv_passiv.xlsx) | Vollständige Aktiva-/Passiva-Aufstellung (2 Sheets) |
| [`xlsx/pflichtteilsberechnung_henrike_marie_theres.xlsx`](xlsx/pflichtteilsberechnung_henrike_marie_theres.xlsx) | Schritt-für-Schritt-Pflichtteilsberechnung mit Formeln |
| [`xlsx/krypto_transaktionen_2021_2025.xlsx`](xlsx/krypto_transaktionen_2021_2025.xlsx) | BTC-Transaktionen, ETH-Transaktionen, Schlüsselmatrix (3 Sheets) |
...
| Datei | Inhalt |
|---|---|
| [`pdfs/notarvermerk_welz_14_06_2023.pdf`](pdfs/notarvermerk_welz_14_06_2023.pdf) | Notarielles Protokoll Dr. Welz auf Notarbriefkopf-Layout |
| [`pdfs/multisig_protokoll_tresor_inventar.pdf`](pdfs/multisig_protokoll_tresor_inventar.pdf) | Tresor-Inventarisierungsprotokoll mit Schlüssel- und Gegenstandsliste |

### Bilder und Diagramme (JPG)

| Datei | Inhalt |
|---|---|
| [`jpg/sonnenbergstrasse_38a_aussenansicht.jpg`](jpg/sonnenbergstrasse_38a_aussenansicht.jpg) | Außenansicht Objekt Sonnenbergstraße 38a (illustrativ) |
| [`jpg/tresor_inhalt_inventarisierung.jpg`](jpg/tresor_inhalt_inventarisierung.jpg) | Tresorinhalt-Inventarisierung; Ledger-Stick, Umschlag, USB, Notizblock |
| [`jpg/multisig_diagramm_5_schluessel.jpg`](jpg/multisig_diagramm_5_schluessel.jpg) | Diagramm: 3-of-5-Multisig-Schlüsselverteilung, Status je Schlüssel |

---

## Beteiligte

**Mandantin:** Dr. Henrike Edelmann (Internistin, Konstanz); Tochter des Erblassers aus 1. Ehe.
**Kanzlei:** Klotzkette Rechtsanwaltsgesellschaft mbH, Berlin; RAin Sabine Steinkamp, FAErbR.
**Erblasser:** Prof. Dr. Reinhard Edelmann (†12.03.2025), em. Professor Vermögensgeschichte.
**Witwe:** Marlies Edelmann-Praun, vertreten durch RA Dr. Joachim Strecker, Stuttgart (Kanzlei Strecker & Hoffmann).
**Sohn:** Constantin Edelmann, Berlin; ausgeschlagen (Wirksamkeit fraglich); ohne anwaltliche Vertretung bekannt.
**Tochter:** Marie-Theres Edelmann-Berlepsch, Hamburg; vertreten durch Dr. Klaus Pellegrini, Hamburg.
**Sachverständige:** Dipl.-Ing. Ralf Bender (Immobilien), Petra Wandke (Blockchain/IT).
**Nachlassgericht:** AG Stuttgart, Abt. 24 — Nachlassgericht, Az. 24 VI 213/25.
