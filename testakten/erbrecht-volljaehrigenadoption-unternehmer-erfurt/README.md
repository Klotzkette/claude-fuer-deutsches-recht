...
| Datei | Inhalt |
| --- | --- |
| `01_mandatsnotiz_leibliche_tochter.md` | Erstkontakt, Beteiligte, Ziel |
| `02_adoptionsbeschluss_und_beziehung.md` | Volljährigenadoption, Beziehungsdarstellung |
| `03_testament_und_gesellschaft.md` | Unternehmertestament, GmbH-Anteile, Nachfolge |
| `04_pflichtteil_und_auskunft.md` | Pflichtteil, Auskunft, Bewertung |
