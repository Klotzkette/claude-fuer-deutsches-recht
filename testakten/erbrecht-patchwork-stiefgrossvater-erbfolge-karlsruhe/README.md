...
| Datei | Inhalt |
| --- | --- |
| `01_familienstammbaum_und_zeitstrahl.md` | Beziehungen, Ehen, Scheidungen, Todesfälle |
| `02_testamente_und_scheidungen.md` | Frühere Verfügungen und Scheidungsklauseln |
| `03_nachlass_armin.md` | Vermögen Armin, Ehe mit Fiona, Streit um Ehegattenerbrecht |
