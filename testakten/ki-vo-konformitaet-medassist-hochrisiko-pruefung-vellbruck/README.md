...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei) | PDF | [`gesamt-pdf/ki-vo-konformitaet-medassist-hochrisiko-pruefung-vellbruck_gesamt.pdf`](gesamt-pdf/ki-vo-konformitaet-medassist-hochrisiko-pruefung-vellbruck_gesamt.pdf) |
...
| Datei | Typ | Inhalt |
|---|---|---|
| [`gutachten-konformitaetspruefung-medassist-v4.docx`](gutachten-konformitaetspruefung-medassist-v4.docx) | DOCX | Vollgutachten Konformitätsprüfung (60-Seiten-Stil, mehrteilig) |
| [`vertraulichkeitserklaerung-pruefauftrag.docx`](vertraulichkeitserklaerung-pruefauftrag.docx) | DOCX | NDA / Vertraulichkeitserklärung Prüfauftrag |
| [`protokoll-ki-vo-workshop.docx`](protokoll-ki-vo-workshop.docx) | DOCX | Workshop-Protokoll KI-VO-Compliance (intern) |
| [`pflichten-checkliste-art-9-bis-15.xlsx`](pflichten-checkliste-art-9-bis-15.xlsx) | XLSX | Anforderungscheckliste Art. 9–15, Status, Befund, Maßnahme |
| [`prueftiefe-matrix.xlsx`](prueftiefe-matrix.xlsx) | XLSX | Modul-Prüftiefenmatrix, Datensatz, Training, Robustheit |
| [`email-vellbruck-an-medassist-pruefumfang.eml`](email-vellbruck-an-medassist-pruefumfang.eml) | EML | E-Mail: Vellbruck → MedAssist, Prüfumfang |
| [`email-medassist-cto-an-vellbruck-trainingsdaten.eml`](email-medassist-cto-an-vellbruck-trainingsdaten.eml) | EML | E-Mail: CTO Krishnamurthy → Vellbruck, Trainingsdaten |
...
| [`risikomatrix-heatmap.jpg`](risikomatrix-heatmap.jpg) | JPG | Risikomatrix-Heatmap (Eintrittswahrscheinlichkeit × Schwere) |
| [`screenshot-eu-datenbank-eintrag.jpg`](screenshot-eu-datenbank-eintrag.jpg) | JPG | Screenshot EU-KI-Datenbank EUID-Eintrag (Prototyp) |
