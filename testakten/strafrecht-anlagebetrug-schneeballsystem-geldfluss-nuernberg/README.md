# Testakte: Anlagebetrug Schneeballsystem — Geldflussanalyse Frankenland Kapitalpartner GmbH (Nürnberg)
...
Wirtschaftsstrafsache der Staatsanwaltschaft Nürnberg-Fürth (507 Js 2214/26) gegen den Geschäftsführer der Frankenland Kapitalpartner GmbH. Das Unternehmen warb von Februar 2023 bis Februar 2026 bei 61 Anlegern insgesamt 4.200.000,00 EUR für angebliche Photovoltaik-Projektbeteiligungen mit 8 Prozent Ausschüttung pro Jahr ein. Nach der Strafanzeige eines Anlegers, dessen Kapitalrückzahlung ausblieb, folgten Durchsuchung, Vermögensarrest, zwei Beschuldigtenvernehmungen mit wechselnder Einlassung, die Aussage der Vertriebsleiterin und ein Anklageentwurf der Staatsanwaltschaft, der an einer entscheidenden Stelle bewusst offen geblieben ist.

Kern der Akte ist die Geldflussanalyse: Der polizeiliche Auswertevermerk liefert nur Jahressummen und benennt selbst, was noch fehlt — die monatsgenaue Datierung des Kipppunkts, ab dem keine Projektinvestitionen mehr erfolgten und Auszahlungen an Anleger nur noch aus Neueinlagen bedient werden konnten. Diese Feinauswertung muss die Bearbeitung aus der Monatsübersicht des Geschäftskontos und der Anlegerliste selbst leisten und dabei die Einlassungen des Beschuldigten sowie die interne E-Mail an das Vertriebsteam an der so rekonstruierten Aktenlage messen. Prüfschwerpunkte sind daneben die Betrugsdogmatik beim Schneeballsystem (Täuschung, Schaden bereits bei Einzahlung, Gewerbsmäßigkeit, § 264a StGB) und die Vermögensabschöpffung.

## Beteiligte

| Rolle | Person / Stelle |
| --- | --- |
| Beschuldigter | Robert Zellinger, Geschäftsführer der Frankenland Kapitalpartner GmbH, Nürnberg (HRB 41277, AG Nürnberg) |
| Anzeigeerstatter | Dr. Heinz Kronawitter, Erlangen (Anlage 150.000,00 EUR) |
| Anzeigenvertreter | Rechtsanwalt Dr. Simon Vetterlein, Erlangen |
| Vertriebsleiterin (Zeugin) | Sandra Meckel, Fürth |
| Vermittler | Jürgen Plaschke, Carola Wiedenbrück |
| Verteidiger | Rechtsanwalt Dr. Matthias Grundhöfer, Nürnberg |
| Staatsanwaltschaft | StA Nürnberg-Fürth, StAin Dr. Falkner, 507 Js 2214/26 |
...
```
strafrecht-anlagebetrug-schneeballsystem-geldfluss-nuernberg/
├── 01_strafanzeige_kronawitter_2026-02-16.docx                        — Strafanzeige des Anlegervertreters mit Anregung der Kontenbeiziehung
├── 02_vermerk_kripo_uebernahme_2026-02-24.docx                        — Übernahmevermerk K 25 mit Registerabfragen und ersten Maßnahmen
├── 03_verfuegung_sta_einleitung_2026-03-02.docx                       — Einleitungsverfügung der StA: Bankauskunft, Durchsuchungsantrag, Prüfauftrag Geldfluss
├── 04_durchsuchungsbeschluss_ag_nuernberg_2026-03-24.docx             — Durchsuchungsbeschluss des AG Nürnberg für Geschäftsräume und Wohnung
├── 05_durchsuchungsbericht_2026-04-14.docx                            — Vollzugsbericht mit Spontanäußerung des Beschuldigten und Arrestvollziehung
├── 06_sicherstellungsverzeichnis_2026-04-14.docx                      — Asservatenübersicht der Durchsuchung einschließlich Serverabbild und Privatunterlagen
...
├── 15_abschrift_notizzettel_asservat_a09_2026-05-13.md                — Abschrift eines im Kontoauszugsordner aufgefundenen handschriftlichen Zettels mit Monatszahlen
├── eml/
