# Akte: Scheidung Wagenknecht / Luetzelberg — Patchwork, Wechselmodell-Streit, Zugewinn
...
- Eheschließung 12.08.2008, Trennungsdatum 14.11.2024 (Auszug Ehemann Theo Wagenknecht); Scheidungsantrag geplant Januar 2026.
- Drei Kinder: Mara (15, Gymnasium), Jonas (12, IGS), Lina (9, Grundschule) — alle bei Mandantin Vera in der gemeinsamen Immobilie in Hannover-Linden.
- Anlass der Trennung: Vera entdeckt Affäre Theos mit einer Studentin (Sommer 2024).
...
| 05 | [`05_kommunikation_theo_und_studentin.md`](05_kommunikation_theo_und_studentin.md) | Affäre, Nachrichtenauswertung, Mandatsrelevanz |
...
| 15 | [`15_trennungsunterhalt_theo_gegen_vera.md`](15_trennungsunterhalt_theo_gegen_vera.md) | § 1361 BGB, 3/7-Methode, Erwerbsobliegenheit Theo |
...
| Datei | Inhalt |
|---|---|
| [`docx/scheidungsantrag_entwurf_vera_wagenknecht.docx`](docx/scheidungsantrag_entwurf_vera_wagenknecht.docx) | Scheidungsantragsentwurf (Entwurf, nicht eingereicht) |
...
| Datei | Inhalt |
|---|---|
| [`emails/2024-11-19_vera_an_kanzlei_erstanfrage.eml`](emails/2024-11-19_vera_an_kanzlei_erstanfrage.eml) | Erstanfrage Vera an Kanzlei, 19.11.2024 |
...
| [`emails/2025-04-30_theo_anwalt_an_kanzlei_wechselmodell.eml`](emails/2025-04-30_theo_anwalt_an_kanzlei_wechselmodell.eml) | RAin Ganzhorn: Wechselmodell, SBGG-Verweigerung, Trennungsunterhalt |
...
| [`jpg/holzwerkstatt_theo_bothfeld.jpg`](jpg/holzwerkstatt_theo_bothfeld.jpg) | Holzwerkstatt Innenansicht (Referenzfoto) |
...
| Cochemer-Verfahren | Termin 1 April 2025 ✓; Termin 2 von Theo abgesagt; Termin 3 ausstehend |
...
| Zugewinnausgleich | Gutachten liegen vor (Büro, Immobilie); Theos Unterlagen ausstehend |
