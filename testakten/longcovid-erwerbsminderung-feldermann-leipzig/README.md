...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei) | PDF | [`gesamt-pdf/longcovid-erwerbsminderung-feldermann-leipzig_gesamt.pdf`](gesamt-pdf/longcovid-erwerbsminderung-feldermann-leipzig_gesamt.pdf) |
...
| Eilantrag KdU (SG Leipzig) | **S 7 AS 188/26 ER** |
...
| 23 | `23_mahnung_vermieter_guenther_2026-03-16.docx` | Schriftliche Mahnung des Vermieters mit Rückstandsaufstellung, Fristsetzung 31.03.2026 und Ratenangebot |
...
| Datei | Inhalt |
|---|---|
| `eml/01_akteneinsicht_drv_anforderung.eml` | Anforderung Akteneinsicht DRV (18.02.2026) |
...
| Datei | Inhalt |
|---|---|
| `jpg/01_aktivitaetsdiagramm_pem_feldermann.jpg` | Aktivitätsdiagramm PEM (Energiepegel + Crashes, Aug 2025 – Jan 2026) |
| `jpg/02_organigramm_verfahren_feldermann.jpg` | Organigramm Verfahrenslandschaft (alle 5 Verfahren + Querverbindungen) |
| `jpg/03_kanzleibesuch_wartebereich_illustration.jpg` | Illustration Wartebereich Kanzlei (Kanzleibesuch 17.02.2026) |
...
- BSG, Beschl. v. 07.11.2011 – B 4 AS 156/11 R (Anordnungsgrund Wohnungsverlust)
- S3-Leitlinie Post-COVID/Long-COVID (AWMF 020-027, Dezember 2023)
