...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei) | PDF | [`gesamt-pdf/aml-gueterhandel-teilzahlungen-maschinenhandel-ulm_gesamt.pdf`](gesamt-pdf/aml-gueterhandel-teilzahlungen-maschinenhandel-ulm_gesamt.pdf) |
| Akten-ZIP (alle Einzeldateien) | ZIP | [testakte-aml-gueterhandel-teilzahlungen-maschinenhandel-ulm.zip](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/testakte-aml-gueterhandel-teilzahlungen-maschinenhandel-ulm.zip) |
| Einzel-PDF-ZIP (jede Unterlage als eigene PDF) | ZIP | [testakte-aml-gueterhandel-teilzahlungen-maschinenhandel-ulm-einzelpdfs.zip](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/testakte-aml-gueterhandel-teilzahlungen-maschinenhandel-ulm-einzelpdfs.zip) |
...
- [03_buchhaltung.eml](03_buchhaltung.eml)
- [04_bankumsatz.txt](04_bankumsatz.txt)
- [05_rueckzahlung.eml](05_rueckzahlung.eml)
- [06_kundenantwort.eml](06_kundenantwort.eml)
