...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei) | PDF | [`gesamt-pdf/bereicherung-dreiecksverhaeltnis-doppelverkauf-oldtimer-bischof-bonn_gesamt.pdf`](gesamt-pdf/bereicherung-dreiecksverhaeltnis-doppelverkauf-oldtimer-bischof-bonn_gesamt.pdf) |
...
**AZ:** LG Bonn 16 O 211/26, AG Hamburg 67 IN 88/26, LG Bonn 4 O 188/26
...
```
bereicherung-dreiecksverhaeltnis-doppelverkauf-oldtimer-bischof-bonn/
├── README.md                           (diese Datei)
│
├── 01_sachverhaltsueberblick.docx        (Gesamtueberblick + Chronologie)
├── 02_doppelverkauf-kaufvertraege.docx   (Kaufvertragsanalyse, beide Kaufvertraege)
├── 03_leistungskondiktion-pruefschema.docx  (Vollstaendiges Pruefschema Paragraf 812)
├── 04_dreiecksverhaeltnis-schmiedeknecht.docx  (Angewiesene Zahlung 78.000 EUR)
├── 05_insolvenzanfechtung-paragraf-130-inso.docx  (Kongruente Deckung)
├── 06_insolvenzanfechtung-paragraf-133-inso.docx  (Vorsatzanfechtung)
├── 07_insolvenzanfechtung-rechtfolgen.docx        (Paragrafen 143, 144 InsO)
├── 08_anfg-anfechtung-sportwagen-uebertragung.docx  (Paragrafen 3, 4 AnfG)
├── 09_saldotheorie-zweikondiktionentheorie.docx   (Rueckabwicklung)
├── 10_paragraf-818-wertersatz-brandschaden.docx   (Brand und Wertersatz)
├── 11_paragraf-817-beiderseitiger-verstoss.docx   (Ausschluss Kondiktionspflicht)
├── 12_verjährung-bereicherungsansprüche.docx      (Verjährungsfristen alle Klagen)
├── 13_paragraf-133-inso-vorsatz-vertiefte-pruefung.docx  (Vertiefung BGH-Massstab)
├── 14_eingriffskondiktion-nutzungsherausgabe.docx (Paragraf 812 Abs. 1 S. 1 2. Alt.)
├── 15_unmoeglichkeit-paragraf-275-bgb.docx        (Unmöglichkeit und Folgen)
├── 16_paragraf-119-anfechtung-anweisung.docx      (Irrtumsanfechtung Anweisung)
├── 17_bgh-grundsaetze-bereicherungsausgleich-dreieck.docx  (BGH-Systematik)
├── 18_anfechtungsklage-drosselberg-prozessual.docx  (Prozessrecht InsO)
├── 19_anfg-klage-helena-renkert-prozessual.docx   (Prozessrecht AnfG)
...
│   ├── anfechtungsklage-inso-drosselberg.docx
│   └── anfg-klage-helena-renkert.docx
│
├── xlsx/
│   ├── bereicherungs-zuordnungsmatrix-sportwagen.xlsx
│   └── fristen-wertberechnung-saldotheorie.xlsx
│
├── eml/
│   ├── bagheri-aichholz-rueckforderung.eml
│   ├── drosselberg-anfechtung.eml
│   ├── helena-renkert-benachrichtigung.eml
│   └── schmiedeknecht-werkstatt-anfrage.eml
│
├── pdfs/
│   ├── kaufvertrag-mercedes-300sl-redacted.pdf
│   └── insolvenzeroeffnungsbeschluss-ag-hamburg-redacted.pdf
│
└── jpg/
    ├── mercedes-300sl-gullwing.jpg
    ├── dreiecksverhaeltnis-schema.jpg
    └── insolvenzanfechtung-zeitstrahl.jpg
```
...
| Paragraf 818 Abs. 3 BGB (Wegfall Bereicherung) | 04, 10 |
| Verjährung (Paragraf 195 BGB) | 12 |
...
| Paragraf 15 AnfG (Verjährung) | 12 |
...
| Paragraf 122 BGB (Vertrauensschaden) | 16 |
| Paragraf 326 BGB (Gefahr bei Unmöglichkeit) | 15 |
| Paragraf 446 BGB (Gefahrtragung) | 10 |
...
- Paragrafen 3, 4, 11 AnfG: https://dejure.org/gesetze/AnfG/3.html
- BGH-Entscheidungen: https://bundesgerichtshof.de
- Rechtsprechungsdatenbank: https://openjur.de
