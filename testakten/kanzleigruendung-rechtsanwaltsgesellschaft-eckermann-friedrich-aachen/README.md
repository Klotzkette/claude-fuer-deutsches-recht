# Akte: Kanzleigründung Eckermann Friedrich Sandhof Rechtsanwaltsgesellschaft mbH — Aachen
...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei) | PDF | [`gesamt-pdf/kanzleigruendung-rechtsanwaltsgesellschaft-eckermann-friedrich-aachen_gesamt.pdf`](gesamt-pdf/kanzleigruendung-rechtsanwaltsgesellschaft-eckermann-friedrich-aachen_gesamt.pdf) |
...
- Drei erfahrene Aachener Anwälte gründen die **Eckermann Friedrich Sandhof Rechtsanwaltsgesellschaft mbH** (Kurzname: EFS Recht) mit Sitz in der Pontstraße 88, 52062 Aachen.
...
- IT: beA (§ 31a BRAO) vollständig eingerichtet; Kanzleisoftware RA-Micro (Netzwerklizenz für 20 AP); DSGVO-konform.

---

## Was diese Akte demonstriert

| Skill/Thema | Aktenstücke | Demonstration |
|---|---|---|
| Rechtsformwahl Anwaltskanzlei | 03 | PartG mbB, RA-GmbH, RA-AG — Vergleich und Empfehlung |
| Gesellschaftsvertrag und Gewinnverteilung | 04 | Lockstep vs. Geistlich-Modell, Hybridmodell EFS |
| Berufshaftpflicht §§ 51, 59j BRAO | 05, 20 | Mindestversicherung, Anbietervergleich, Polizze |
| Betriebsübergang § 613a BGB | 06, 16 | 12 Mitarbeiter, 3 Vorgängerkanzleien, Unterrichtungsschreiben |
| Berufsrecht BRAO/BORA | 01, 07, 08 | Interessenkollision, Verschwiegenheit, Mandantenüberleitung |
| RAK-Zulassung § 59h/59n BRAO | 08 | Antrag, Nachforderung, Bescheid Az. RAC 2026/00188 |
| Datenschutz DSGVO Art. 6, 35 | 07, 13, 15 | Mandantenüberleitung, DSFA, beA, GwG |
| Steuerliche Strukturierung | 09 | KSt, GewSt, GF-Gehälter, Thesaurierung, vGA-Risiko |
| Gewerbemiete | 10 | Pontstraße 88, Indexklausel, Schönheitsreparaturen BGH |
| Markenrecht | 11 | DPMA-Anmeldung, UM-Kollision EUIPO, Verwechslungsgefahr |
| Domainrecht / Cybersquatting | 12 | DENIC-Dispute, Abmahnung, BGH ambiente.de, BGB § 826 |
| IT-Recht und beA | 13, 18 | beA-Pflicht, RA-Micro vs. AnNoText, DSGVO-AVV |
| GwG / AML | 15 | Risikobewertung, Sorgfaltspflichten, FIU-Meldepflicht |
| Arbeitsrecht (intern) | 16, 17 | Übernahmearbeitsverträge, Patensystem, Einarbeitungsplan |
| Corporate Design | 14 | Markenidentität, Website, beA-Signatur, § 37b BRAO |
| Corporate Governance | 19 | Geschäftsführungsordnung, Ressorts, Gesellschafterversammlung |
| Chronologie | 21 | Vollständiger Zeitstrahl Gründungsprozess |
| Kanzleieröffnung | 22 | Eröffnungsempfang, erste Mandate, Statusbericht |
...
| Datei | Inhalt |
|---|---|
| [`docx/gesellschaftsvertrag_efs_rechtsanwaltsgesellschaft_mbh.docx`](docx/gesellschaftsvertrag_efs_rechtsanwaltsgesellschaft_mbh.docx) | Vollständiger Gesellschaftsvertrag §§ 1–10 (beurkundet 28.03.2026) |
| [`docx/zulassungsantrag_rak_aachen_par59n.docx`](docx/zulassungsantrag_rak_aachen_par59n.docx) | Zulassungsantrag bei der RAK Aachen gemäß § 59h BRAO i.V.m. § 59n BRAO |
| [`docx/betriebsuebernahme_par613a_mitarbeiterinfo.docx`](docx/betriebsuebernahme_par613a_mitarbeiterinfo.docx) | Unterrichtungsschreiben § 613a Abs. 5 BGB an alle 12 Mitarbeiter |

### XLSX

| Datei | Inhalt |
|---|---|
| [`xlsx/kanzlei_planungsmatrix_18_aufgaben.xlsx`](xlsx/kanzlei_planungsmatrix_18_aufgaben.xlsx) | Planungsmatrix 18 Aufgaben — Rechtsbasis, Verantwortlichkeit, Fristen, Status |
| [`xlsx/kostenkalkulation_kanzleigruendung_efs.xlsx`](xlsx/kostenkalkulation_kanzleigruendung_efs.xlsx) | Kostenkalkulation Gründung (EUR 88.611 einmalig) und laufender Betrieb (EUR 1.084.634/Jahr) |

### E-Mails (.eml)

| Datei | Inhalt |
|---|---|
| [`emails/2026-02-14_eckermann_an_partner_gruendungsidee.eml`](emails/2026-02-14_eckermann_an_partner_gruendungsidee.eml) | Dr. Eckermann: Startsignal Gründungsidee an Friedrich und Sandhof |
| [`emails/2026-03-08_rak_aachen_zulassungsverfahren.eml`](emails/2026-03-08_rak_aachen_zulassungsverfahren.eml) | RAK Aachen: Eingangsbestätigung und Antworten auf Voranfragen |
...
| Datei | Inhalt |
|---|---|
| [`pdfs/zulassungsbescheid_rak_aachen_188_redacted.pdf`](pdfs/zulassungsbescheid_rak_aachen_188_redacted.pdf) | Zulassungsbescheid RAK Aachen Az. RAC 2026/00188 (Scan, geschwärzt) |
| [`pdfs/markenamtsbescheid_uma_efs_recht_redacted.pdf`](pdfs/markenamtsbescheid_uma_efs_recht_redacted.pdf) | DPMA-Amtsbescheid Marke 30 2026 123 456 "EFS RECHT" (Scan, geschwärzt) |

### Bilder (JPG)

| Datei | Inhalt |
|---|---|
| [`jpg/corporate_design_efs_logo.jpg`](jpg/corporate_design_efs_logo.jpg) | Corporate Design EFS Recht — Logo mit Anthrazit/Gold-Farbwelt |
| [`jpg/kanzleifoto_pontstrasse_88_aachen.jpg`](jpg/kanzleifoto_pontstrasse_88_aachen.jpg) | Kanzleifoto Pontstraße 88 Aachen — Gründerzeitgebäude [Testbild] |
| [`jpg/gruendungs_workflow_diagramm.jpg`](jpg/gruendungs_workflow_diagramm.jpg) | Gründungs-Workflow Diagramm — 6 Phasen von Rechtsformwahl bis Eröffnung |

---

## Beteiligte

| Person | Funktion | Kanzlei / Behörde |
|---|---|---|
| Dr. Hilke Eckermann | Gründerin, GF, FA Sozialrecht | EFS Rechtsanwaltsgesellschaft mbH, Aachen |
| Dr. Matthias Friedrich | Gründer, GF, FA Arbeitsrecht | EFS Rechtsanwaltsgesellschaft mbH, Aachen |
| Dr. Volker Sandhof | Gründer, GF, FA Steuerrecht, StB | EFS Rechtsanwaltsgesellschaft mbH, Aachen |
| RA Monika Hellwig | Beraterin Gründungsmandat | Hellwig & Partner, Köln |
| Notar Dr. Hermann Küppers | Beurkundung Gesellschaftsvertrag | Notariat Aachen-Süd, Aachen |
| Klara Bäumler | Zulassungssachbearbeiterin | Rechtsanwaltskammer Aachen |
| RA Burkhard Steins | Präsident | Rechtsanwaltskammer Aachen |
| Prof. Dr. Werner Kallenbrunner | Externer Steuerberater | Steuerberaterkanzlei, Köln |
| RA Gerhild Brecker | Vertr. EFS Kanzlei Stuttgart | Brecker IP Recht, Stuttgart |
| Domains4Fun GmbH | Cybersquatter (efs-recht.de) | Berlin |
| Klaus-Heinrich Bremer | Firmenkundenbetreuer | Allianz Versicherungs-AG, Köln |
| Hans-Jürgen Dörsam | Vermieter Pontstraße 88 | Gewerbe-Immobilien Aachen Dörsam GmbH |

---

## Wichtige Aktenzeichen und Registernummern

| Aktenzeichen/Nummer | Bedeutung |
|---|---|
| KBH-2026-001-EFS | Internes Aktenzeichen Kanzlei Hellwig & Partner |
| HRB 28877 | Handelsregister Amtsgericht Aachen (EFS-GmbH) |
| RAC 2026/00188 | Zulassungsbescheid Rechtsanwaltskammer Aachen |
| RAC-GmbH-00043 | Registernummer EFS-GmbH im Anwaltsregister RAK Aachen |
| 30 2026 123 456 | DPMA-Markenanmeldung "EFS RECHT" |
| UM 018-188-466 | Unionsmarke "EFS KANZLEI" (EFS Kanzlei Stuttgart, EUIPO) |
| 10-12-345678-9 | Allianz Berufshaftpflichtpolizze EFS-GmbH |
...
- **§§ 59c–59l BRAO** — Rechtsanwaltsgesellschaft mbH (RA-GmbH): Voraussetzungen, Zulassung, Gesellschafterstruktur, Haftpflicht
- **§§ 59m–59q BRAO** — Rechtsanwalts-Aktiengesellschaft
- **§ 59n BRAO** — Berufsausübungsgesellschaft allgemein
- **§ 59h BRAO** — Zulassung Rechtsanwaltsgesellschaft mbH
- **§ 59j BRAO** — Berufshaftpflichtversicherung RA-GmbH (Mindest EUR 2,5 Mio.)
- **§ 51 BRAO** — Berufshaftpflichtversicherung Einzelanwalt (Mindest EUR 1 Mio.)
- **§ 43a BRAO** — Grundpflichten (Verschwiegenheit, Unabhängigkeit)
- **§ 31 BRAO** — Anwaltsregister
- **§ 31a BRAO** — beA Nutzungspflicht
- **§ 31b BRAO** — Gesellschafts-beA
- **§ 37b BRAO** — Pflichtangaben auf Schriftverkehr
- **§ 46 BRAO** — Angestellte Rechtsanwälte
- **§ 56 BRAO** — Anzeigepflicht

[dejure.org/gesetze/BRAO](https://dejure.org/gesetze/BRAO)

### BORA (Berufsordnung für Rechtsanwälte)

- **§ 3 BORA** — Interessenkollision
- **§§ 15, 16 BORA** — Kanzleiwechsel

[dejure.org/gesetze/BORA](https://dejure.org/gesetze/BORA)

### GmbHG

- **§§ 2, 5, 11, 13 GmbHG** — Gründung, Stammkapital, Entstehung, Haftungsbeschränkung
- **§§ 35, 43, 46, 49 GmbHG** — Geschäftsführung, Gesellschafterversammlung

[dejure.org/gesetze/GmbHG](https://dejure.org/gesetze/GmbHG)

### PartGG

- **§ 8 Abs. 4 PartGG** — Partnerschaftsgesellschaft mit beschränkter Berufshaftung (PartG mbB)

[dejure.org/gesetze/PartGG](https://dejure.org/gesetze/PartGG)

### BGB

- **§ 613a BGB** — Betriebsübergang (Rechte und Pflichten, Unterrichtungspflicht, Widerspruchsrecht)
- **§ 826 BGB** — Sittenwidrige Schädigung (Cybersquatting)
- **§§ 557b, 578 BGB** — Mietrecht (Indexmiete, Gewerbemiete)

[dejure.org/gesetze/BGB](https://dejure.org/gesetze/BGB)

### MarkenG

- **§§ 4, 8 MarkenG** — Markenentstehung, absolute Schutzhindernisse
- **§ 9 MarkenG** — Relative Schutzhindernisse, Verwechslungsgefahr
- **§ 15 MarkenG** — Schutz geschäftlicher Bezeichnungen (Domain)
- **§ 42 MarkenG** — Widerspruchsverfahren

[dejure.org/gesetze/MarkenG](https://dejure.org/gesetze/MarkenG)

### GwG (Geldwäschegesetz)

- **§ 2 GwG** — Verpflichtete (Rechtsanwälte)
- **§§ 4–6 GwG** — Risikomanagement, interne Sicherungsmaßnahmen
- **§ 10 GwG** — Allgemeine Sorgfaltspflichten
- **§ 43 GwG** — Meldepflicht (FIU)

[dejure.org/gesetze/GwG](https://dejure.org/gesetze/GwG)

### Sonstige

- **DSGVO Art. 6, 13, 14, 28, 30, 35** — Datenschutz-Grundverordnung
- **FAO § 15** — Fortbildungspflicht Fachanwälte
- **BetrAVG § 1a** — Betriebliche Altersversorgung, Entgeltumwandlung
- **StBerG § 49, § 67** — Steuerberater in GmbH, Berufshaftpflicht StB
- **KStG § 8 Abs. 3** — Verdeckte Gewinnausschüttung
- **GewStG §§ 2, 7** — Gewerbesteuer
- **EStG §§ 15, 18** — Gewerbliche und freiberufliche Einkünfte
- **UWG § 4 Nr. 4** — Gezielte Mitbewerber-Behinderung (Cybersquatting)
- **HGB §§ 267, 325, 326** — Rechnungslegung, Offenlegungspflicht

[dejure.org/gesetze/DSGVO](https://dejure.org/gesetze/DSGVO) | [dejure.org/gesetze/FAO](https://dejure.org/gesetze/FAO)

---

## Rechtsprechungshinweise

- BGH, Urt. v. 17.05.2001, I ZR 251/99 (ambiente.de) — Domain als Kennzeichen, Cybersquatting: [bundesgerichtshof.de](https://www.bundesgerichtshof.de)
- BGH, Urt. v. 29.01.2001, II ZR 331/00 — Treuepflichten in Anwalts-GmbH: [bundesgerichtshof.de](https://www.bundesgerichtshof.de)
- BGH, Urt. v. 05.04.2006, VIII ZR 178/05 — Schönheitsreparaturen, starre Klauseln unwirksam: [bundesgerichtshof.de](https://www.bundesgerichtshof.de)
- EuGH, C-120/04 (THOMSON LIFE/Medion) — Verwechslungsgefahr bei Zusammensetzungen: [openjur.de](https://openjur.de)
- BAG, Urt. v. 22.05.1997, 8 AZR 101/96 — Betriebsübergang Kanzlei: [openjur.de](https://openjur.de)
- BAG, Urt. v. 16.05.2007, 8 AZR 693/06 — Betriebsteilübergang: [openjur.de](https://openjur.de)
- BFH, Urt. v. 10.07.1996, I R 138/93 — GmbH und Freiberuflichkeit (Gewerbesteuerpflicht): [bundesgerichtshof.de](https://www.bundesgerichtshof.de)

---

## Quellen und Datenbanken

- BRAO, BORA, PartGG, GmbHG, BGB, MarkenG, GwG, DSGVO: [dejure.org](https://dejure.org)
- BGH-Urteile: [bundesgerichtshof.de](https://www.bundesgerichtshof.de)
- Oberlandesgerichte und weitere Entscheidungen: [openjur.de](https://openjur.de)
- EUIPO-Markenrecherche (UM 018-188-466): [euipo.europa.eu/eSearch](https://euipo.europa.eu/eSearch)
