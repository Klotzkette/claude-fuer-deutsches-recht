# Akte: CMR-Transportschaden Pharma Kühlkette / Schwarmstedt Logistik GmbH — Kühlkettenbruch, Art. 29 CMR, Versicherungsstreit, Embargo
...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei) | PDF | [`gesamt-pdf/cmr-transportschaden-pharma-kuehlkette-spedition-schwarmstedt_gesamt.pdf`](gesamt-pdf/cmr-transportschaden-pharma-kuehlkette-spedition-schwarmstedt_gesamt.pdf) |
...
Arbeitsakte zum Plugin `fachanwalt-transport-speditionsrecht`.
...
- Kernstreit CMR: Haftungshöchstgrenze Art. 23 Abs. 3 CMR (8,33 SZR/kg × 348 kg ≈ 3.603 EUR) vs. Haftungsdurchbrechung Art. 29 CMR (grobes Verschulden — Verfahren LG Hannover 9 O 244/26).
- Versicherungsstreit: Helvetia Versicherungen lehnt Deckung wegen angeblicher 72h-Obliegenheitsverletzung ab (Police 74-SL-8832-2024); Klage LG Hamburg 327 O 88/26.
...
|---|---|---|
| CMR-Grundhaftung Art. 17 | 01, 03, 13 | Frachtführerhaftung, Übernahme bis Ablieferung, Exkulpationsmöglichkeiten |
| CMR-Haftungshöchstgrenze Art. 23 Abs. 3 | 03, 16 | 8,33 SZR/kg, SZR-Umrechnung, Haftungsmaximum |
| Art. 29 CMR — grobes Verschulden | 03, 13, 15 | Leichtfertigkeit, Bewusstseinskomponente, Beweislast |
| Art. 34, 37 CMR — Frachtführerkette und Regress | 02, 06 | Hauptfrachtführerhaftung, Innenregress Subunternehmer |
| § 435 HGB / Art. 29 CMR Parallelregelung | 18 | Haftungsdurchbrechung national vs. international |
| §§ 407, 425, 431 HGB — Frachtrecht national | 10, 18 | Nationale Haftungsgrundlagen, Absenderhaftung § 414 HGB |
| ADR-Gefahrgutrecht | 01, 12 | ADR-Zertifizierung, UN 3245 Klasse 9, Fahrzeugausrüstung |
| GDP — Good Distribution Practice | 12 | VO (EU) 2017/1569, Kühlkette, Subunternehmer-Qualifizierung |
| GüKG — Gewerblicher Güterverkehr | 07 | § 1 Abs. 1 GüKG, § 7a GüKG Auftraggeberpflichten, EU-Lizenz |
| VO (EG) 561/2006 — Lenk- und Ruhezeiten | 07, 17 | Lenkzeitverstoß Art. 7, Tachographauswertung, Beweissicherung |
| VVG — Versicherungsvertrag | 05 | § 28 VVG Obliegenheitsverletzung, 72h-Meldefrist, AGB-Kontrolle |
...
| Datei | Inhalt |
|---|---|
| [`docx/klageerwiderung_lg_hannover_9o244_26.docx`](docx/klageerwiderung_lg_hannover_9o244_26.docx) | Klageerwiderung LG Hannover 9 O 244/26 — Hauptsache CMR-Kühlkettenbruch (Beklagte: Schwarmstedt) |
| [`docx/klageschrift_lg_hamburg_327o88_26.docx`](docx/klageschrift_lg_hamburg_327o88_26.docx) | Klageschrift LG Hamburg 327 O 88/26 — Klage Schwarmstedt gegen Helvetia Versicherungen AG |
| [`docx/einspruchsschriftsatz_owi_ag_hannover.docx`](docx/einspruchsschriftsatz_owi_ag_hannover.docx) | Einspruchsbegründung AG Hannover OWi 31a OWi 4188 Js 7711/26 — BALM-Bussgeld |

### XLSX — Berechnungstabellen

| Datei | Inhalt |
|---|---|
| [`xlsx/cmr_haftungsberechnung_szr.xlsx`](xlsx/cmr_haftungsberechnung_szr.xlsx) | CMR-Haftungsberechnung Art. 23 Abs. 3 CMR; SZR-Szenarien; Art. 24/26-Vergleich |
| [`xlsx/temperaturlogger_auswertung_datatrack.xlsx`](xlsx/temperaturlogger_auswertung_datatrack.xlsx) | Temperaturlogger-Protokoll DataTrack 4000; Zeitreihe 12.–14. Januar 2026; Überschreitungsanalyse |
...
| Datei | Inhalt |
|---|---|
| [`pdfs/cmr_frachtbrief_original_redacted.pdf`](pdfs/cmr_frachtbrief_original_redacted.pdf) | CMR-Frachtbrief Nr. CMR-2026-DE-001-0018 (Kopie, personenbezogene Daten geschwärzt) |
| [`pdfs/temperaturlogger_protokoll_datatrack4000.pdf`](pdfs/temperaturlogger_protokoll_datatrack4000.pdf) | Temperaturlogger-Protokoll DataTrack 4000 (Loggernr. DT4-2025-7783), 12.–14. Januar 2026 |

### Fotos

| Datei | Inhalt |
|---|---|
| [`jpg/kuehlauflieger_schmitz_cargobull.jpg`](jpg/kuehlauflieger_schmitz_cargobull.jpg) | Referenzfoto: Sattelzug mit Schmitz Cargobull Kühlauflieger (GDP-Transport) |
| [`jpg/temperaturkurve_diagramm.jpg`](jpg/temperaturkurve_diagramm.jpg) | Temperaturkurve-Diagramm DataTrack 4000; kritische Phase 03:00–04:30 Uhr |
| [`jpg/adr_klebung_gefahrgutkennzeichnung.jpg`](jpg/adr_klebung_gefahrgutkennzeichnung.jpg) | Referenzfoto: ADR-Klebung UN 3245, Klasse 9-Raute, Kühlauflieger |

---

## Verfahrensstand

**Stichtag dieser Akte: 08. Mai 2026**
**Mandatsannahme: 14. März 2026**

| Verfahrensstrang | Aktenzeichen | Status |
|---|---|---|
| CMR-Hauptsache (MediVita vs. Schwarmstedt) | LG Hannover 9 O 244/26 | Klageerwiderung bis 15.05.2026 |
| Versicherungsklage (Schwarmstedt vs. Helvetia) | LG Hamburg 327 O 88/26 | Klage eingereicht 15.03.2026 |
