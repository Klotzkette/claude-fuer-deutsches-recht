# Akte: Drafting-Werkstatt — Asset-Deal / SPV / Grundstück Volkenrath Energie SE (Share-Deal und Pivot)
...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei, 586 KB) | PDF | [`gesamt-pdf/drafting-werkstatt-asset-deal-spv-grundstueck-volkenrath-energie-share-deal-und-pivot-anwaltsschreiben_gesamt.pdf`](gesamt-pdf/drafting-werkstatt-asset-deal-spv-grundstueck-volkenrath-energie-share-deal-und-pivot-anwaltsschreiben_gesamt.pdf) |
...
## Transaktionsstruktur und Konflikte
...
| Strang | Thema | Normen |
|---|---|---|
| 1 | Representations & Warranties — Knowledge Qualifier | BGB § 311, 453 |
...
### Aktenzeichen-Sammelmappe

| Referenz | Inhalt |
|---|---|
| MR-2026-DR-0717 | Kanzlei-AZ Roosendaal Birkenhainer Partners mbB |
| UR-Nr. 188/26 | Notarurkunde Dr. Birkenhainer |
| BKartA B 8-188/26 | Vorabstimmung Bundeskartellamt |
| FA Berlin-Mitte, VB-GrESt-2026-0412 | Verbindliche Auskunft Finanzamt zur GrESt-Frage |
...
| Schriftsatz-Strukturierung | 15 | Kopfzeile, Antrag, Begründung, Unterschrift |
| Anwaltsschreiben Finanzamt | 16 | VB-Antrag GrESt, Sachverhaltsdarstellung |
| Disclosure Schedules | 17 | Aufbau, Verweistechnik, Qualifizierung |
| Closing Checklist | 18 | Closing Conditions, Notartermin, Registrierung |
| Notartermin-Vorbereitung | 19 | Beurkundungsablauf, Vollmachtskette, Checkliste |
| Go / No-Go-Memo Mandant | 20 | Risikomatrix, Empfehlung, Handlungsoptionen |
| Finale Revision vor Signing | 21 | Last-Minute-Check, Defined Terms, Querverweise |
| Post-Signing Housekeeping | 22 | Closing-Memo, Aktenablage, Folgefristen |
...
| Datei | Inhalt |
|---|---|
| [`docx/spa-draft-4-final.docx`](docx/spa-draft-4-final.docx) | Share Purchase Agreement — Draft 4 / Final (vor Signing) |
| [`docx/anwaltsschreiben-bka-anmeldung.docx`](docx/anwaltsschreiben-bka-anmeldung.docx) | Anwaltsschreiben an BKartA, GWB § 39 Anmeldung |
| [`docx/redline-spa-v3-vs-v4.docx`](docx/redline-spa-v3-vs-v4.docx) | Redline SPA v3 gegen v4 (Track Changes Gegenseite) |

### XLSX

| Datei | Inhalt |
|---|---|
| [`xlsx/disclosure-schedule-uebersicht.xlsx`](xlsx/disclosure-schedule-uebersicht.xlsx) | Disclosure Schedule Übersicht: Qualifizierungen je Warranty |
| [`xlsx/klausel-vergleichsmatrix-v1-v4.xlsx`](xlsx/klausel-vergleichsmatrix-v1-v4.xlsx) | Klausel-Vergleichsmatrix: Schlüsselklauseln in SPA v1–v4 |
...
| Datei | Inhalt |
|---|---|
| [`pdfs/spa-final-deckblatt.pdf`](pdfs/spa-final-deckblatt.pdf) | SPA Final — Deckblatt und Inhaltsverzeichnis (Signing-Exemplar) |
| [`pdfs/verbindliche-auskunft-fa-berlin-mitte-cover.pdf`](pdfs/verbindliche-auskunft-fa-berlin-mitte-cover.pdf) | FA Berlin-Mitte: Cover verbindliche Auskunft GrESt (VB-GrESt-2026-0412) |

### Fotos

| Datei | Inhalt |
|---|---|
| [`jpg/volkenrath-solarpark-luftbild.jpg`](jpg/volkenrath-solarpark-luftbild.jpg) | Solarpark Eppendorf 18 ha — Luftbild (Referenzfoto) |
| [`jpg/notarbuero-birkenhainer-empfang.jpg`](jpg/notarbuero-birkenhainer-empfang.jpg) | Notarbüro Dr. Birkenhainer — Empfangsbereich (Referenzfoto) |
| [`jpg/redline-screenshot-word.jpg`](jpg/redline-screenshot-word.jpg) | Screenshot Word Track Changes: SPA v3 vs. v4 (Referenzfoto) |
...
| SPA Draft 4 / Final | Verhandlungsstand Oktober 2026 |
...
Mitarbeiterin: **Senior Associate Dr. (iur.) Mira Pohlmann**
