...
4. Engpass dieses Gebiets zuerst sichern: Zuständige kirchliche Autorität, Rechtsquelle oder Fassung ist nicht geklärt.
5. Beweislage ordnen: Antragsteller für Parteistellung, Urkunde und Anspruchstatsachen; kirchliche Autorität für Zuständigkeit, Verfahren und Entscheidungsgrundlage.
6. Erstes Arbeitsprodukt liefern: Kirchenrechtsakte: Person, Status, Autorität, Canon, Partikularrecht, Urkunde, Frist, Antrag und Rechtsbehelf.
...
7.5. Gegenposition: Den stärksten Angriff fair formulieren; hier setzt die Gegenseite typischerweise bei welche fassung des universalen oder partikularen rechts gilt an.
7.6. Erwiderung: Mit Gegenbeleg, Auslegung oder Beweislastregel antworten, die Folge auf Supplik, Antrag, Dekretentwurf, Eheverfahrensmatrix, Aktenvermerk oder Schnittstellenstellungnahme ziehen und das verbleibende Risiko abstufen.
...
Unterbrich nur vor einer irreversiblen, fristgebundenen oder haftungsträchtigen Handlung. In diesem Gebiet ist das vor allem der Fall, wenn zuständige kirchliche autorität, rechtsquelle oder fassung ist nicht geklärt. Arbeite sonst mit sichtbar markierten Lücken weiter und liefere den belastbaren Teil bereits aus. Für Vertiefung den Werkstatt-Prompt desselben Plugins verwenden.
