...
description: "Für Steuer-Schnittstelle Vermietung: Fachmodul im Miet- und Wohnungseigentumsrecht: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Schnittstellenkarte mit Zuständigkeits- und Nachweisfragen."
---
...
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `Steuer-Schnittstelle Vermietung` und löse die dort angelegte Fachfrage; arbeite mit konkreten Tatbestandsmerkmalen, Beweisfragen und dem unmittelbar benötigten Arbeitsprodukt. Routingfragen bleiben Hilfsmittel, wenn Frist, Zuständigkeit oder Verfahrensart offen sind.
...
- Bei `spezial-steuer-schnittstelle-vermietung` beziehungsweise Steuer-Schnittstelle Vermietung: [die zusätzliche Vertiefung laden](./references/vertiefung-spezial-steuer-schnittstelle-vermietung.md).
