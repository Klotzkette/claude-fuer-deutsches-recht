...
description: "Für Grundsteuer-Umlage: Fachmodul im Miet- und Wohnungseigentumsrecht: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Schnittstellenkarte mit Zuständigkeits- und Nachweisfragen."
---
...
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `Grundsteuer-Umlage` und löse die dort angelegte Fachfrage; arbeite mit konkreten Tatbestandsmerkmalen, Beweisfragen und dem unmittelbar benötigten Arbeitsprodukt. Routingfragen bleiben Hilfsmittel, wenn Frist, Zuständigkeit oder Verfahrensart offen sind.
...
- Bei `spezial-grundsteuer-umlage` beziehungsweise Grundsteuer-Umlage: [die zusätzliche Vertiefung laden](./references/vertiefung-spezial-grundsteuer-umlage.md).
