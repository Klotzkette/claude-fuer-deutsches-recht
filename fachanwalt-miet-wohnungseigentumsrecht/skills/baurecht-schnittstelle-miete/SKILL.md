...
description: "Für Baurecht-Schnittstelle: Fachmodul im Miet- und Wohnungseigentumsrecht: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `Baurecht-Schnittstelle` und löse die dort angelegte Fachfrage; arbeite mit konkreten Tatbestandsmerkmalen, Beweisfragen und dem unmittelbar benötigten Arbeitsprodukt. Routingfragen bleiben Hilfsmittel, wenn Frist, Zuständigkeit oder Verfahrensart offen sind.
...
- Bei `spezial-baurecht-schnittstelle-miete` beziehungsweise Baurecht-Schnittstelle: [die zusätzliche Vertiefung laden](./references/vertiefung-spezial-baurecht-schnittstelle-miete.md).
