...
**Baurecht Schnittstelle Belegeinsicht** führt durch die falltragenden Prüfungslinien: Baurecht-Schnittstelle, Belegeinsicht Betriebskosten, Berliner Räumung. Starte mit der Linie, die Frist, Zuständigkeit, Beweislast oder den gewünschten Output tatsächlich entscheidet; weitere Linien werden nur herangezogen, wenn sie denselben Arbeitsstrang schärfen.
## Prüfungslinien
...
## Aufgabe
Dieses Fachmodul bearbeitet im Plugin `fachanwalt-miet-wohnungseigentumsrecht`: prüft Nutzungsuntersagung, Mangel, Genehmigung, Zweckentfremdung.
...
## 2. `spezial-belegeinsicht-betriebskosten`
...
Dieser Skill organisiert die Belegeinsicht so, dass daraus verwertbare Einwendungen oder eine belastbare Verteidigung der Abrechnung entstehen. Es geht nicht nur um "bitte Belege senden", sondern um die Frage, welche Unterlagen für welche Position nötig sind.
...
## Aufgabe
Dieses Fachmodul bearbeitet im Plugin `fachanwalt-miet-wohnungseigentumsrecht`: klärt Auftrag, Vermieterpfandrecht, Kosten, Einlagerung und Haftungsrisiko.
...
## 5. `spezial-betriebskosten-formell`
