...
description: "Für Dealroom Quellenkarte: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Diese Quellenkarte sichert für **Gesellschaftsrecht in legal English** jede tragende Aussage ab: Norm, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor Ausgabe verifiziert.

## Tragende Normen (live prüfen)

- **UK Companies Act 2006** — amtlichen Stand vor tragender Aussage prüfen
- **Delaware GCL** — amtlichen Stand vor tragender Aussage prüfen
- **MBCA (US)** — amtlichen Stand vor tragender Aussage prüfen
...
- UK confirmation statement annual
- US 10-K/10-Q
