...
- EuGH zu Anti-Diskriminierungsrichtlinien (Rahmenrichtlinie und allgemeine Gleichbehandlungsrichtlinie) — std. Rspr., Az verifizieren.
- BVerwG zu Auswahlverfahren und Diskriminierung — std. Rspr., Az verifizieren.
