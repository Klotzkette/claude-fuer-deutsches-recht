...
| --- | --- |
| Verlagsredaktion (`verlagsredaktion`, dieses Plugin) | [verlagsredaktion.zip](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/verlagsredaktion.zip) |
