...
description: "Lektorat Struktur Manuskriptaufnahme: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Lektorat Struktur Manuskriptaufnahme

## Arbeitsbereich

Dieser Skill bündelt 5 sachlich verwandte Arbeitsschritte rund um **Lektorat Struktur Manuskriptaufnahme** im Plugin Verlagsredaktion. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Verlagsredaktion gilt für **Lektorat Struktur Manuskriptaufnahme**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `lektorat-struktur-redaktion`

**Fokus:** Redigiert Struktur, Argumentationsgang, Gliederung, Kuerzung, Redundanzen, Widersprueche und Lesefuehrung von Verlagsmanuskripten.

# Lektorat, Struktur und Redaktion

## Prüfprogramm

1. Zielgruppe und Format.
2. These und Nutzen.
3. Gliederungslogik.
4. Wiederholungen.
5. Widersprüche.
6. fehlende Übergänge.
...
## 2. `manuskriptaufnahme-materialinventar`

**Fokus:** Nimmt Manuskripte und Begleitmaterial auf, erstellt ein Materialinventar, trennt Autor:innenmaterial, Fremdquelle, Redaktionstext, Luecken und Rechtefragen.

# Manuskriptaufnahme und Materialinventar

## Ziel

Vor jeder Bearbeitung muss klar sein, welches Material existiert, woher es kommt und wofür es verwendet werden darf.
...
- Lückenliste.
- Rechteampel.
- Vorschlag für Bearbeitungsreihenfolge.
...
## 3. `marketing-presse-social`

**Fokus:** Erstellt Verlagstexte fuer Vorschau, Newsletter, Presse, Website und Social Media aus Manuskript, Zielgruppe und Produktnutzen.
...
Bei Zitaten nie echte Aussagen erfinden. Platzhalter verwenden und Freigabe anfordern.
...
## 4. `metadaten-seo-klappentext`

**Fokus:** Erstellt Titelvarianten, Untertitel, Abstract, Schlagworte, Klappentext, Webteaser, Kurzbeschreibung und Metadaten aus Manuskriptmaterial.
...
- Nutzenargumente.
- Webteaser.
- Backcover-/Katalogtext.

## Regel

Marketing darf zuspitzen, aber nicht fachlich übertreiben.
...
## 5. `produktionsuebergabe-checkliste`

**Fokus:** Erstellt die Uebergabe an Herstellung, Satz, Online, Marketing, Vertrieb und Archiv mit Dateien, Freigaben, Rechten, Metadaten und offenen Punkten.

# Produktionsübergabe

## Checkliste

- finale Manuskriptdatei.
- Abbildungen separat.
- Tabellen.
- Rechtefreigaben.
- Autor:innenfreigabe.
