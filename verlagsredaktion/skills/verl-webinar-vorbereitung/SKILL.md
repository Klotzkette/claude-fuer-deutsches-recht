...
description: "Verl Webinar Vorbereitung: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Verl Webinar Vorbereitung

## Arbeitsbereich

Dieser Skill bündelt 5 sachlich verwandte Arbeitsschritte rund um **Verl Webinar Vorbereitung** im Plugin Verlagsredaktion. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
## Spezialwissen: Verl: Zeitschriftenartikel
- **Spezialgegenstand:** Verl: Zeitschriftenartikel / verl zeitschriftenartikel leitfaden. Der Skill löst diese konkrete Lage und darf nicht in allgemeines Routing ausweichen.
...
| Modus | Zweck |
| --- | --- |
| A Rohmanuskript | Aus Diktat, Folien, Notizen, Transkript und E-Mails eine erste Fassung bauen. |
| B Edition | Vorhandene Fassung strukturieren, kürzen, glätten, Widersprüche markieren. |
| C Update | Bestehenden Beitrag für neue Rechtslage, neue Entscheidung oder neue Auflage aktualisieren. |
| D Rettung | Sehr spätes, fragmentarisches Material in eine veröffentlichungsfähige Arbeitsfassung bringen. |
