---
name: auslandszeiten-eu-ohne
description: "Auslandszeiten EU Ohne: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Auslandszeiten EU Ohne

## Arbeitsbereich

Dieser Skill bündelt 2 sachlich verwandte Arbeitsschritte rund um **Auslandszeiten EU Ohne** im Plugin Rentenpruefer. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Rentenpruefer gilt für **Auslandszeiten EU Ohne**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `auslandszeiten-eu-ewr-schweiz`

**Fokus:** Auslandszeiten in EU, EWR und Schweiz: Koordinierung, pro-rata-Berechnung, Antragstellung über den Wohnsitzstaat und Doppelzeiten.

# auslandszeiten-eu-ewr-schweiz

## Aufgabe

Erklärt die europäische Rentenkoordination ohne falsche Einheitsrente.
...
Staaten, Zeiträume, Träger, Wohnsitz, Nachweise, parallele deutsche Zeiten.
...
Staatenmatrix, Anfrageplan und Erwartungsmanagement.
...
## 2. `auslandszeiten-ohne-abkommen-beweisstrategie`

**Fokus:** Auslandszeiten ohne Sozialversicherungsabkommen: Beweisführung, ausländische Renten, deutsche Wartezeiten, Übersetzungen und realistische Grenzen.

# auslandszeiten-ohne-abkommen-beweisstrategie

## Aufgabe

Verhindert, dass vertragslose Zeiten falsch als deutsche Rentenmonate verkauft werden.
...
Beweis- und Erwartungsmatrix mit Alternativen.
