---
name: space-raumstation-miet-orbit-slot
description: "Space Raumstation Miet Orbit Slot: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Space Raumstation Miet Orbit Slot

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **Space Raumstation Miet Orbit Slot** im Plugin Weltraumrecht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `space-075-satellitenabschaltung-deorbit-und-end-of-life-plan` | End-of-Life-Planung für Satelliten – Deorbit-Pflicht, IADC 25-Jahres-Regel, Passivierung. |
| `space-076-konstellation-und-lichtverschmutzung-astronomie-einwen` | Lichtverschmutzung durch Mega-Konstellationen – Astronomie-Einwendungen, Rechtslage, Abhilfe. |

## Arbeitsweg

Im Plugin Weltraumrecht gilt für **Space Raumstation Miet Orbit Slot**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Das Rechtsgebiet berührt folgende Kernthemen: Orbit Slot Verwertung, Frequenzprioritätsrecht, ITU-Streit. Relevante Normen: ITU Radio Regs, BNetzA TKG, Cape-Town-Convention.
...
Das Rechtsgebiet berührt folgende Kernthemen: Deorbit Pflicht, IADC 25-Jahres-Regel, EOL-Plan, Passivierung. Relevante Normen: IADC Guidelines, UNCOPUOS LTS, OST Art. IX, EU SST.
...
Dieser Skill bearbeitet das Thema **Konstellation und Lichtverschmutzung: Astronomie-Einwendungen** im Bereich Weltraumrecht und Raumfahrtrecht. Er strukturiert die praktische Lage, identifiziert einschlägige Normen des internationalen, europäischen und deutschen Rechts und liefert verwertbare Ergebnisse für Betreiber, Behörden, Investoren, Kanzleien und Compliance-Beauftragte.

## Thematischer Schwerpunkt

Das Rechtsgebiet berührt folgende Kernthemen: Lichtverschmutzung Satellitenkonstellation, Astronomie, Nachbarrecht. Relevante Normen: OST Art. I, UNCOPUOS Dark Sky, IAU Guidelines.
