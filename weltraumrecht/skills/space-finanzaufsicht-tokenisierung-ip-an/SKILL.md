...
description: "Space Finanzaufsicht Tokenisierung IP AN: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Space Finanzaufsicht Tokenisierung IP AN

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **Space Finanzaufsicht Tokenisierung IP AN** im Plugin Weltraumrecht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `space-083-universitaet-industrie-spin-off-raumfahrt` | Raumfahrt-Spin-off aus Universität – IP-Übertragung, Beteiligungsvereinbarungen, BAFA. |
| `space-085-beschlagnahme-oder-pfaendung-von-satellitenrechten` | Pfändung und Beschlagnahme von Satelliten und Frequenzrechten – Vollstreckungsrecht, Staatlichkeit. |

## Arbeitsweg

Im Plugin Weltraumrecht gilt für **Space Finanzaufsicht Tokenisierung IP AN**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Dieser Skill bearbeitet das Thema **Finanzaufsicht: Tokenisierung von Satellitenerträgen** im Bereich Weltraumrecht und Raumfahrtrecht. Er strukturiert die praktische Lage, identifiziert einschlägige Normen des internationalen, europäischen und deutschen Rechts und liefert verwertbare Ergebnisse für Betreiber, Behörden, Investoren, Kanzleien und Compliance-Beauftragte.

## Thematischer Schwerpunkt

Das Rechtsgebiet berührt folgende Kernthemen: Tokenisierung Satellitenerträge, Kryptowertpapier, BaFin MiCAR. Relevante Normen: MiCAR (EU) 2023/1114, KWG, WpHG, BaFin.
...
Dieser Skill bearbeitet das Thema **IP an Weltraumerfindungen an Bord** im Bereich Weltraumrecht und Raumfahrtrecht. Er strukturiert die praktische Lage, identifiziert einschlägige Normen des internationalen, europäischen und deutschen Rechts und liefert verwertbare Ergebnisse für Betreiber, Behörden, Investoren, Kanzleien und Compliance-Beauftragte.

## Thematischer Schwerpunkt

Das Rechtsgebiet berührt folgende Kernthemen: Patent Weltraumerfindung, Jurisdiktion an Bord, ArbNErfG. Relevante Normen: PatG, ArbNErfG, OST Art. VIII, ISS IGA Art. 21.
...
Das Rechtsgebiet berührt folgende Kernthemen: Uni-Industrie Spin-off Raumfahrt, IP-Transfer, Beteiligung. Relevante Normen: ArbNErfG, UrhG, GmbHG, BAFA-Exportkontrolle.
...
Dieser Skill bearbeitet das Thema **Beschlagnahme oder Pfändung von Satellitenrechten** im Bereich Weltraumrecht und Raumfahrtrecht. Er strukturiert die praktische Lage, identifiziert einschlägige Normen des internationalen, europäischen und deutschen Rechts und liefert verwertbare Ergebnisse für Betreiber, Behörden, Investoren, Kanzleien und Compliance-Beauftragte.

## Thematischer Schwerpunkt

Das Rechtsgebiet berührt folgende Kernthemen: Pfändung Satellitenrechte, Frequenzlizenz, Zwangsvollstreckung. Relevante Normen: ZPO §§ 857, 828 ff., TKG, OST Art. VIII.
