...
| `space-066-drohnen-und-high-altitude-platform-abgrenzung` | Drohnen und HAPS – Abgrenzung Luftrecht/Weltraumrecht, Zulassung, Frequenzen. |
| `space-067-ballonmission-stratosphaere-genehmigung` | Stratosphären-Ballonmissionen – Luftraumgenehmigung, Gefahrgut, Grenzüberschreitung, Datenrecht. |
...
Das Rechtsgebiet berührt folgende Kernthemen: OSS Satellit, GPL-Copyleft, ITAR Open Source, Software-Lizenz. Relevante Normen: GPL v2/v3, LGPL, Apache 2.0, ITAR § 120.11.
...
Dieser Skill bearbeitet das Thema **KI an Bord: Autonomie und AI Act-Schnittstelle** im Bereich Weltraumrecht und Raumfahrtrecht. Er strukturiert die praktische Lage, identifiziert einschlägige Normen des internationalen, europäischen und deutschen Rechts und liefert verwertbare Ergebnisse für Betreiber, Behörden, Investoren, Kanzleien und Compliance-Beauftragte.

## Thematischer Schwerpunkt

Das Rechtsgebiet berührt folgende Kernthemen: KI Satellit, EU AI Act, Autonomie, Hochrisiko-KI. Relevante Normen: EU AI Act, DSGVO, Produkthaftungsrecht, OST.
...
Dieser Skill bearbeitet das Thema **Drohnen und High-Altitude-Platform: Abgrenzung** im Bereich Weltraumrecht und Raumfahrtrecht. Er strukturiert die praktische Lage, identifiziert einschlägige Normen des internationalen, europäischen und deutschen Rechts und liefert verwertbare Ergebnisse für Betreiber, Behörden, Investoren, Kanzleien und Compliance-Beauftragte.

## Thematischer Schwerpunkt

Das Rechtsgebiet berührt folgende Kernthemen: HAPS Drohnen Abgrenzung, Luftrecht Weltraumrecht, ICAO Annex. Relevante Normen: LuftVG, LuftVO, ICAO Annex 2, ITU Radio Regs.
...
Dieser Skill bearbeitet das Thema **Ballonmission Stratosphäre: Genehmigung** im Bereich Weltraumrecht und Raumfahrtrecht. Er strukturiert die praktische Lage, identifiziert einschlägige Normen des internationalen, europäischen und deutschen Rechts und liefert verwertbare Ergebnisse für Betreiber, Behörden, Investoren, Kanzleien und Compliance-Beauftragte.

## Thematischer Schwerpunkt

Das Rechtsgebiet berührt folgende Kernthemen: Ballonmission Genehmigung, Stratosphäre, LBA, Gefahrgutrecht. Relevante Normen: LuftVG, LuftVO, ICAO, IMDG, DSGVO.
