...
description: "Für Schnittstelle Fehlerkatalog: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Fachanwalt Verkehrsrecht** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (§ 67 OWiG Einspruch 2 Wochen)

- **Symptom:** Frist falsch berechnet oder übersehen (§ 67 OWiG Einspruch 2 Wochen)
...
### 2. Parallelfrist vergessen (Strafbefehl 2 Wochen § 410 StPO)

- **Symptom:** Parallelfrist vergessen (Strafbefehl 2 Wochen § 410 StPO)
...
### 3. Falsche Zuständigkeit adressiert (richtig: AG (Bußgeld + Straf))

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: AG (Bußgeld + Straf))
...
### 6. Normzitat ohne Fassungsprüfung (StGB §§ 142, 315c, 316)

- **Symptom:** Normzitat ohne Fassungsprüfung (StGB §§ 142, 315c, 316)
