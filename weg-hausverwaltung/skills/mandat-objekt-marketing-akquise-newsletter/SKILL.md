...
description: "Mandat Objekt Marketing Akquise Newsletter: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Mandat Objekt Marketing Akquise Newsletter** im Plugin WEG / Hausverwaltung. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin WEG / Hausverwaltung gilt für **Mandat Objekt Marketing Akquise Newsletter**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
**Fokus:** Erfasst eine WEG-/Hausverwaltungsakte (Stand 05/2026): Objekt, Rollen, Teilungserklärung, Gemeinschaftsordnung, Verwaltervertrag, Beschlusssammlung, Abrechnungen, Vermögensbericht, Angebote, Fristen, Risiken und nächsten Workflow. Identifiziert Fristen aus § 45 WEG, § 556 BGB sowie GEG-/CO2KostAufG-Schnittstellen.
...
**Fokus:** Akquise neuer WEG-Verwaltungsmandate (Stand 06/2026): Pitch-Bestandteile, Honorarmatrix, Verwaltervertrag nach § 26 WEG, Uebernahme-Uebergabe-Checkliste und Wettbewerbsgrenzen. BGH V ZR 251/21 zur Sondervergütung.

# Marketing: Akquise neuer WEG-Verwaltungsmandate

## Fachlicher Kern — Miet- und WEG-Recht
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `Marketing: Akquise neuer WEG-Verwaltungsmandate` und löse die dort angelegte Fachfrage; keine Flucht in allgemeines Routing, außer eine echte Frist oder Zuständigkeit ist unklar.
- **Normenradar:** BGB §§ 535 ff., 536, 543, 546a, 548, 556, 556a, 558 ff., 573 ff.; BetrKV; HeizkostenV; WEG §§ 18, 19, 20, 23, 24, 28, 44, 45; GEG; CO2KostAufG.
- **Verifizierte Anker:** BGH, Urteil vom 20.01.2016 - VIII ZR 93/15 (formelle Betriebskostenabrechnung); BGH, Urteil vom 15.12.2021 - VIII ZR 66/20 (Belegeinsicht Originale/Kopien); BGH, Urteil vom 14.02.2025 - V ZR 128/23 (§ 16 Abs. 2 Satz 2 WEG, Rücklagen/Kostenverteilung); BGH, Urteil vom 14.02.2025 - V ZR 86/24 (§ 20 WEG, bauliche Veränderung, Vorbefassung/Beschlussersetzung).
- **Arbeitsmodus:** Immer erst Verhältnis Miete/WEG/Gewerbe/Verwaltung trennen, dann Frist, Beschlusskompetenz, Umlagefähigkeit, Belege, Gebrauchsnachteil und Kostenfolge prüfen.
- **Outputpflicht:** Abrechnungsprüftabelle, Beschlussvorschlag, Anfechtungs-/Beschlussersetzungsskizze, Mietermail, Vermieterschreiben oder Verwalter-To-do-Liste.
...
Neue WEG-Mandate werden über unterschiedliche Kanäle gewonnen. Der Skill strukturiert den Akquiseprozess von der Erstansprache bis zum unterschriebenen Verwaltervertrag, liefert ein Pitch-Gerüst und deckt die rechtlichen Grenzen bei Vergütungsversprechen und Übernahme-Logistik ab.

## Akquise-Kanäle und Erstgespräch

- **Bauträger-Erstverwaltung:** Frühzeitiger Kontakt beim Bau, Erstverwalterbestellung im Teilungsplan (§ 30 WEG) oder durch Beschluss der ersten Versammlung. Risiko: Loyalitätskonflikte Bauträger/GdWE im Gewährleistungsfall.
- **Beiratsanfrage bei Unzufriedenheit:** Häufig ausgelöst durch Protokoll-Mängel, Jahresabrechnungs-Verzögerungen oder Haftungsfälle. Diskretion gegenüber amtierendem Verwalter geboten.
- **Empfehlungen:** Steuerberater, WEG-Anwälte, Makler, Notare.
- **Plattformen:** ImmobilienScout24-Verwalterverzeichnis, VDIV-Mitgliederliste, regionaler Maklerverband.
- **Erstgespräch-Leitfaden:** Mandatsgröße (Einheiten, Gewerbeanteil), Rücklagenstand, offene Mängel/Rechtsstreitigkeiten, IT-Affinität Eigentümer, aktuelle Probleme.

## Pitch-Bestandteile (10-Folien-Gerüst)

1. Profil und Referenzen (ähnliche Objekte, Zertifizierungen IHK/VDIV)
2. IT-Stack und Eigentümerportal (Casavi, Etg24 etc.)
3. Versammlungs-Logistik (Hybrid, Protokoll-Turnaround)
4. Fee-Modell: Grundvergütung pro Einheit/Monat, Sonderhonorare (Eigentümerversammlung, Baumaßnahmen, gerichtliche Tätigkeiten)
5. Versicherungsschutz Verwalterhaftpflicht (Deckungssumme, Anbieter)
6. Krisenmanagement (Wasserschaden, Zwangsverwaltung, Erbfall)
7. Personalkapazität je Einheit (Richtwert: 1 Vollzeit-MA ca. 250-400 Einheiten)
8. Übernahme-Timeline (Stichtag-Bilanz, Übergabe-Protokoll)
9. Muster-Leistungsverzeichnis für Verwaltervertrag
10. Nächste Schritte / Angebotsdokument
...
- Erstaufnahme neues Mandat → `mandat-objekt-triage`
- Wirtschaftsplan für neues Mandat → `wirtschaftsplan-jahresabrechnung-28-weg`
- Eigentümerversammlung nach Übernahme → `eigentuemerversammlung-vorbereiten`
...
## 3. `marketing-newsletter-eigentuemerkommunikation`

**Fokus:** Eigentuemerinfo vs. E-Mail-Werbung klar trennen (Stand 06/2026): § 7 UWG Double-Opt-In, Einwilligungspflicht, Versicherungswerbung nach § 34d GewO, DSGVO Art. 6. BGH VI ZR 225/17 zu unerlaubter E-Mail-Werbung.

# Marketing: Newsletter und Eigentümerkommunikation

## Fachlicher Kern — Miet- und WEG-Recht
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `Marketing: Newsletter und Eigentümerkommunikation` und löse die dort angelegte Fachfrage; keine Flucht in allgemeines Routing, außer eine echte Frist oder Zuständigkeit ist unklar.
- **Normenradar:** BGB §§ 535 ff., 536, 543, 546a, 548, 556, 556a, 558 ff., 573 ff.; BetrKV; HeizkostenV; WEG §§ 18, 19, 20, 23, 24, 28, 44, 45; GEG; CO2KostAufG.
- **Verifizierte Anker:** BGH, Urteil vom 20.01.2016 - VIII ZR 93/15 (formelle Betriebskostenabrechnung); BGH, Urteil vom 15.12.2021 - VIII ZR 66/20 (Belegeinsicht Originale/Kopien); BGH, Urteil vom 14.02.2025 - V ZR 128/23 (§ 16 Abs. 2 Satz 2 WEG, Rücklagen/Kostenverteilung); BGH, Urteil vom 14.02.2025 - V ZR 86/24 (§ 20 WEG, bauliche Veränderung, Vorbefassung/Beschlussersetzung).
- **Arbeitsmodus:** Immer erst Verhältnis Miete/WEG/Gewerbe/Verwaltung trennen, dann Frist, Beschlusskompetenz, Umlagefähigkeit, Belege, Gebrauchsnachteil und Kostenfolge prüfen.
- **Outputpflicht:** Abrechnungsprüftabelle, Beschlussvorschlag, Anfechtungs-/Beschlussersetzungsskizze, Mietermail, Vermieterschreiben oder Verwalter-To-do-Liste.
