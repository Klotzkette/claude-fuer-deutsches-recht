...
description: "Auction Authority Monitoring Bank Consents: bündelt 7 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
Dieser Skill bündelt 7 sachlich verwandte Arbeitsschritte rund um **Auction Authority Monitoring Bank Consents** im Plugin Großkanzlei Corporate / M&A. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Großkanzlei Corporate / M&A gilt für **Auction Authority Monitoring Bank Consents**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
| Material | Transaktionsphase, Bieteranzahl, Bid-Stufe, gewuenschte Binding/Non-Binding-Angebote, Zeitplan, besondere Anforderungen. |
| Frist | Signing, Closing, Q&A, Filing, Board, Beurkundung, Angebotsfrist, CP-Deadline oder keine Eile erkennbar. |
| Ziel-Output | Process Letter, Bid Checklist, Compliance-Hinweise, Q&A-Regeln und Bieter-To-do-Liste. |
...
| Frist | Signing, Closing, Q&A, Filing, Board, Beurkundung, Angebotsfrist, CP-Deadline oder keine Eile erkennbar. |
| Ziel-Output | Authority Matrix, Beschlussliste, Vollmachtsbedarf, Signing-Rollenplan und Register-/Notar-Check. |
...
| Deal-Perspektive | Buy-side, Sell-side, Target, Vorstand/Geschaeftsfuehrung, Bank, Investor, W&I-Versicherer oder Local Counsel. |
| Phase | Screening, NDA, Term Sheet, Datenraum, DD, SPA/APA, Signing, Closing, PMI, Streit oder Post-Mortem. |
| Material | Loan Agreements, Schuldschein, Sicherheiten, Konzernwechsel, Covenants, Konsortialstruktur. |
| Frist | Signing, Closing, Q&A, Filing, Board, Beurkundung, Angebotsfrist, CP-Deadline oder keine Eile erkennbar. |
| Ziel-Output | Consent-Matrix, Waiver-Plan, CP-Formulierungen, Lender-Kommunikation und Red Flags. |
...
| Deal-Perspektive | Buy-side, Sell-side, Target, Vorstand/Geschaeftsfuehrung, Bank, Investor, W&I-Versicherer oder Local Counsel. |
| Phase | Screening, NDA, Term Sheet, Datenraum, DD, SPA/APA, Signing, Closing, PMI, Streit oder Post-Mortem. |
| Material | Prozessphase, Bieterkreis, Datenraumplattform, Q&A-Modus, Clean-Room-Setup, Kommunikationswege. |
| Frist | Signing, Closing, Q&A, Filing, Board, Beurkundung, Angebotsfrist, CP-Deadline oder keine Eile erkennbar. |
| Ziel-Output | Bieterregeln, Datenraumprotokoll, Q&A-Routing, No-Contact-Regeln und Verfahrenskalender. |
