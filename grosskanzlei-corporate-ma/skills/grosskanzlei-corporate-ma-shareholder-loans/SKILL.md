...
description: "Shareholder Loans: bündelt 7 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
Dieser Skill bündelt 7 sachlich verwandte Arbeitsschritte rund um **Shareholder Loans** im Plugin Großkanzlei Corporate / M&A. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `grosskanzlei-corporate-ma-specific-indemnities-risk-transfer` | Specific Indemnities und Risk Transfer Skill: entwickelt Sonderfreistellungen, Escrow, W&I-Schnittstellen, Tax Deeds und Risikoallokation fuer erkannte Findings. |
...
| `grosskanzlei-corporate-ma-tabellen-und-matrix-factory` | Tabellen- und Matrix-Fabrik fuer M&A: baut DD-Grids, Risk Heatmaps, Issue Lists, CP-Tracker, Authority-Matrizen, Disclosure-Schedules und Registerabgleich als direkt nutzbare Tabellen. |

## Arbeitsweg

Im Plugin Großkanzlei Corporate / M&A gilt für **Shareholder Loans**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
## Fachkern: Sector Regulatory DD
- **Spezialgegenstand:** Sector Regulatory DD; der Skill muss die konkrete Fachfrage tragen und nicht nur in einen allgemeinen Startdialog zurückfallen.
...
## Einsatz
Target ist Bank, Zahlungsdienst, Energie, Telekom, Healthcare, Versicherer, Infrastruktur, Plattform oder sonst reguliert.
...
| Material | Branche, Erlaubnisse, Aufsichtsbehoerde, Gruppenstruktur, Transaktionsschritte, Managementwechsel. |
| Frist | Signing, Closing, Q&A, Filing, Board, Beurkundung, Angebotsfrist, CP-Deadline oder keine Eile erkennbar. |
| Ziel-Output | Regulatory-DD-Map, CPs, Filing-Liste, Risk Notes, Behoerdenstrategie und Closing-Hindernisse. |
...
## Fachkern: Shareholder Loans Subordination
- **Spezialgegenstand:** Shareholder Loans Subordination; der Skill muss die konkrete Fachfrage tragen und nicht nur in einen allgemeinen Startdialog zurückfallen.
- **Normen-/Quellenanker:** GmbHG, AktG, HGB, UmwG, WpHG/MAR, GWB/FKVO, AWG/AWV, LMA-Finanzierung, Beirats-/Organregeln, SPA/SHA/Term-Sheet-Praxis.
- **Entscheidende Weiche:** Dealphase, Mandantenrolle, CP/Consent, Haftung, Disclosure, Signing/Closing, Notar/Register, Beirat/Organ und Verhandlungstaktik trennen.
- **Arbeitsprodukt:** Liefere eine fallbezogene `Norm / Tatsache / Beleg / Wertung / Gegenargument / nächster Schritt`-Matrix und einen direkt nutzbaren Textbaustein, wenn der Nutzer einen Entwurf braucht.
...
## Einsatz
Gesellschafterdarlehen oder konzerninterne Finanzierungen beeinflussen Kaufpreis, Garantien oder Insolvenzrisiken.
...
| Deal-Perspektive | Buy-side, Sell-side, Target, Vorstand/Geschaeftsfuehrung, Bank, Investor, W&I-Versicherer oder Local Counsel. |
| Phase | Screening, NDA, Term Sheet, Datenraum, DD, SPA/APA, Signing, Closing, PMI, Streit oder Post-Mortem. |
| Material | Darlehensvertraege, Salden, Sicherheiten, Rangruecktritte, Gesellschafterstatus, Krisezeitraum. |
| Frist | Signing, Closing, Q&A, Filing, Board, Beurkundung, Angebotsfrist, CP-Deadline oder keine Eile erkennbar. |
| Ziel-Output | Finanzierungs-Matrix, Risikoanalyse, SPA-Klauselbedarf, Tax-/Insolvency-Hinweise und offene Fragen. |
...
## Fachkern: Signing Closing Room Manager
- **Spezialgegenstand:** Signing Closing Room Manager; der Skill muss die konkrete Fachfrage tragen und nicht nur in einen allgemeinen Startdialog zurückfallen.
- **Normen-/Quellenanker:** GmbHG, AktG, HGB, UmwG, WpHG/MAR, GWB/FKVO, AWG/AWV, LMA-Finanzierung, Beirats-/Organregeln, SPA/SHA/Term-Sheet-Praxis.
- **Entscheidende Weiche:** Dealphase, Mandantenrolle, CP/Consent, Haftung, Disclosure, Signing/Closing, Notar/Register, Beirat/Organ und Verhandlungstaktik trennen.
- **Arbeitsprodukt:** Liefere eine fallbezogene `Norm / Tatsache / Beleg / Wertung / Gegenargument / nächster Schritt`-Matrix und einen direkt nutzbaren Textbaustein, wenn der Nutzer einen Entwurf braucht.
...
## Einsatz
Signing oder Closing steht unmittelbar bevor und die Dokumenten-/Unterschriftenlage muss sitzen.
...
| Deal-Perspektive | Buy-side, Sell-side, Target, Vorstand/Geschaeftsfuehrung, Bank, Investor, W&I-Versicherer oder Local Counsel. |
| Phase | Screening, NDA, Term Sheet, Datenraum, DD, SPA/APA, Signing, Closing, PMI, Streit oder Post-Mortem. |
| Material | Dokumentenliste, Parteien, Unterschriftsmodus, CP-Status, Notar/Bank/Behoerden, Closing-Zeitplan. |
| Frist | Signing, Closing, Q&A, Filing, Board, Beurkundung, Angebotsfrist, CP-Deadline oder keine Eile erkennbar. |
| Ziel-Output | Closing Room Board, Deliverables Register, Unterschriftenplan, Funds Flow und Closing Agenda. |
...
## Fachkern: Specific Indemnities Risk Transfer
- **Spezialgegenstand:** Specific Indemnities Risk Transfer; der Skill muss die konkrete Fachfrage tragen und nicht nur in einen allgemeinen Startdialog zurückfallen.
- **Normen-/Quellenanker:** GmbHG, AktG, HGB, UmwG, WpHG/MAR, GWB/FKVO, AWG/AWV, LMA-Finanzierung, Beirats-/Organregeln, SPA/SHA/Term-Sheet-Praxis.
- **Entscheidende Weiche:** Dealphase, Mandantenrolle, CP/Consent, Haftung, Disclosure, Signing/Closing, Notar/Register, Beirat/Organ und Verhandlungstaktik trennen.
- **Arbeitsprodukt:** Liefere eine fallbezogene `Norm / Tatsache / Beleg / Wertung / Gegenargument / nächster Schritt`-Matrix und einen direkt nutzbaren Textbaustein, wenn der Nutzer einen Entwurf braucht.
...
## Einsatz
Ein DD-Finding ist zu konkret fuer eine allgemeine Garantie und braucht eine eigenstaendige Risikoloesung.
...
| Deal-Perspektive | Buy-side, Sell-side, Target, Vorstand/Geschaeftsfuehrung, Bank, Investor, W&I-Versicherer oder Local Counsel. |
| Phase | Screening, NDA, Term Sheet, Datenraum, DD, SPA/APA, Signing, Closing, PMI, Streit oder Post-Mortem. |
| Material | Finding, Schadensszenario, Eintrittswahrscheinlichkeit, Betrag, Versicherung, Verhandlungsmacht. |
| Frist | Signing, Closing, Q&A, Filing, Board, Beurkundung, Angebotsfrist, CP-Deadline oder keine Eile erkennbar. |
| Ziel-Output | Indemnity-Entwurf, Trigger, Cap/Duration, Mitigation, Evidence, W&I-Check und Fallback. |
...
## Fachkern: Deal-PMO und Steps Plan
- **Spezialgegenstand:** Deal-PMO und Steps Plan; der Skill muss die konkrete Fachfrage tragen und nicht nur in einen allgemeinen Startdialog zurückfallen.
- **Normen-/Quellenanker:** GmbHG, AktG, HGB, UmwG, WpHG/MAR, GWB/FKVO, AWG/AWV, LMA-Finanzierung, Beirats-/Organregeln, SPA/SHA/Term-Sheet-Praxis.
- **Entscheidende Weiche:** Dealphase, Mandantenrolle, CP/Consent, Haftung, Disclosure, Signing/Closing, Notar/Register, Beirat/Organ und Verhandlungstaktik trennen.
- **Arbeitsprodukt:** Liefere eine fallbezogene `Norm / Tatsache / Beleg / Wertung / Gegenargument / nächster Schritt`-Matrix und einen direkt nutzbaren Textbaustein, wenn der Nutzer einen Entwurf braucht.
...
## Wann wird dieser Skill aufgerufen
Typische Auslöser:
- "Ich habe hier Deal-PMO und Steps Plan und brauche einen belastbaren nächsten Schritt."
- "Bitte prüfe das für ein M&A-Mandat aus Sicht von Buy-side, Sell-side oder Target."
- "Mach daraus eine Partner-/Mandantenunterlage mit Risiken, Annahmen und offenen Punkten."
- "Welche Dokumente, Registerauszüge, Freigaben oder Fristen fehlen noch?"
...
| Deal-Perspektive | Buy-side, Sell-side, Target, Vorstand/Geschaeftsfuehrung, Bank, Investor, W&I-Versicherer oder Local Counsel. |
| Phase | Screening, NDA, Term Sheet, Datenraum, DD, SPA/APA, Signing, Closing, PMI, Streit oder Post-Mortem. |
| Material | Dokumenttyp, Ziel der Tabelle, Spaltenwunsch, Materiality, Risikoskala, Format (Markdown, Excel-faehig, Board, CSV-Logik). |
| Frist | Signing, Closing, Q&A, Filing, Board, Beurkundung, Angebotsfrist, CP-Deadline oder keine Eile erkennbar. |
| Ziel-Output | Praezise Tabelle mit Status, Quelle, Rechtsfolge, Risiko, Owner, Frist, Entscheidung und Follow-up-Frage. |
