---
name: vdg-flugportal-beweisplan-umsetzung
description: "VDG Flugportal Beweisplan Umsetzung: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# VDG Flugportal Beweisplan Umsetzung

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **VDG Flugportal Beweisplan Umsetzung** im Plugin Verbraucherschutzverband Durchsetzung. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Verbraucherschutzverband Durchsetzung gilt für **VDG Flugportal Beweisplan Umsetzung**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Flugportal Beweisplan Erstellen wird nicht als abstraktes Schema beantwortet, sondern als Arbeitsgang im Bereich Verbandsdurchsetzung im Verbraucherschutz: erst Zuständigkeit und Normpfad, dann Tatsachen und Belege, dann Fristen und taktische Option, danach ein verwertbarer Output.
...
Flugportal Vergleich Pruefen wird nicht als abstraktes Schema beantwortet, sondern als Arbeitsgang im Bereich Verbandsdurchsetzung im Verbraucherschutz: erst Zuständigkeit und Normpfad, dann Tatsachen und Belege, dann Fristen und taktische Option, danach ein verwertbarer Output.
...
Flugportal Umsetzung Ueberwachen wird nicht als abstraktes Schema beantwortet, sondern als Arbeitsgang im Bereich Verbandsdurchsetzung im Verbraucherschutz: erst Zuständigkeit und Normpfad, dann Tatsachen und Belege, dann Fristen und taktische Option, danach ein verwertbarer Output.
...
Dieser Skill führt Verbraucherzentralen, qualifizierte Einrichtungen und mandatierte Kanzleien durch Bankentgelt-Serienfälle, in denen Verbraucher Gebühren zurückverlangen, die nur über Schweigen oder Weiternutzung eingeführt worden sein sollen.
...
- Musterfeststellungs-/Abhilfeklagen-Prüfvermerk.
- Registertext mit klarer Anspruchsbeschreibung.
- Betroffenenformular mit Entgeltmatrix.
- Verjährungs- und Vergleichsampel.
- Medienlinie, die nicht mehr verspricht als die Anspruchsgruppen tragen.
