...
1. Zustand von `~/.claude/plugins/config/claude-fuer-legal/produktrecht/CLAUDE.md` prüfen.
2. Das Cold-Start-Interview unten durchführen.
...
6. `~/.claude/plugins/config/claude-fuer-legal/produktrecht/CLAUDE.md` schreiben (übergeordnete Verzeichnisse bei Bedarf erstellen). Kalibrierungstabelle zur Bestätigung zeigen.
...
# Cold-Start-Interview: Produktrecht
...
`~/.claude/plugins/config/claude-fuer-legal/produktrecht/CLAUDE.md` lesen:
...
Nach `~/.claude/plugins/config/claude-fuer-legal/company-profile.md` suchen.
...
> **`produktrecht` ist für Personen die Produktlaunches, Werbeaussagen und Feature-Risiken prüfen – die rechtliche Seite des Shippens.** Nicht Ihr Bereich? `/kanzlei-builder-hub:related-skills-surfacer`.
>
...
>
> Schnell oder vollständig? (Jederzeit aufrüsten mit `/cold-start-interview --full`.)
...
**Risikoappetit:** *(speist `/launch-review` und `/is-this-a-problem`)*
...
**Was hält Sie nachts wach?** *(speist `/launch-review`)*
...
**Was ist Ihr Framework?** *(speist `/launch-review`)*
...
*(speist `/marketing-claims-review` – Substanziierungsstandard und vergleichende Werbehaltung)*
...
*Erstellt durch Cold-Start am [DATUM]. Direkt bearbeitbar.*
...
[etc. – ihre Kategorien wenn vorhanden; Sieben-Kategorien-Framework aus `references/launch-review-framework-de.md` anbieten wenn nicht]
...
>
> - **Rechtlicher Review eines Produktlaunchs** – z. B. „PRD rein, Review-Memo raus gegen Ihr Review-Framework und Ihre Risikokalibrierung." Probieren: `/produktrecht:launch-review`
> - **Schnelle Triage einer Slack-Frage** – z. B. „'Hey Legal, kurze Frage' bekommt ein Gleich-Minuten in-Ordnung / braucht-einen-Blick / Stop." Probieren: `/produktrecht:is-this-a-problem`
> - **Werbeaussagen-Prüfung** – z. B. „Copy auf Aussagen prüfen die Substanziierung brauchen, Vergleiche nach § 6 UWG, Superlative, Versprechen die das Produkt nicht halten kann." Probieren: `/produktrecht:marketing-claims-review`
...
**Mein Vorschlag für das erste:** Führen Sie `/is-this-a-problem` für eine PM-Frage aus die Sie bereits beantwortet haben – sehen Sie ob die Antwort Ihrer Kalibrierung entspricht.
