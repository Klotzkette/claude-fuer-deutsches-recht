...
description: "Für Software Quellenkarte: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Diese Quellenkarte sichert für **Produktrecht (ProdSG/CE)** jede tragende Aussage ab: Norm, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor Ausgabe verifiziert.

## Tragende Normen (live prüfen)

- **ProdSG** — amtlichen Stand vor tragender Aussage prüfen
- **GPSR EU 2023/988** — amtlichen Stand vor tragender Aussage prüfen
- **ProdHaftG** — amtlichen Stand vor tragender Aussage prüfen
- **CE-Richtlinien** — amtlichen Stand vor tragender Aussage prüfen

## Zuständige Spruchkörper und Behörden

- Marktüberwachung Länder
- BAuA
- Notified Bodies
...
- RAPEX-Meldung unverzüglich
- Rückrufpflicht unverzüglich
