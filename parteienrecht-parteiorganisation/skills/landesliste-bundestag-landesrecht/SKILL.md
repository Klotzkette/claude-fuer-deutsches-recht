...
description: "Landesliste Bundestag Landesrecht: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Landesliste Bundestag Landesrecht

## Arbeitsbereich

Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Landesliste Bundestag Landesrecht** im Plugin Parteienrecht Parteiorganisation. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
**Fokus:** Begleitet Landeslistenaufstellung: Delegierten-/Mitgliederversammlung, Reihenfolge, geheime Wahl, Unterlagen, Fristen, Landeswahlleiter.
...
## 2. `landesrecht-router`

**Fokus:** Findet das richtige Landeswahl-, Kommunalwahl- und Abgeordnetenrecht je Bundesland und markiert Live-Checks.
...
## 3. `landesverband-ohne-untergliederung`

**Fokus:** Prüft Sonderlage kleiner Parteien ohne Kreisverbände: Satzung, Vorstand, Wahlvorschläge, Delegation.
