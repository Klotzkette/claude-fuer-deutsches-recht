...
description: "Markenrecht 143a Marktmanipulation: bündelt 10 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
**Offizialdelikt.** Antragserfordernis aus Paragraph 144 MarkenG entfaellt. Die StA verfolgt von Amts wegen, sobald Anfangsverdacht der Gewerbsmaessigkeit oder Bandenmaessigkeit besteht.

## Tatbestand und Geltungsbereich

Voraussetzung: Die Tat des Paragraph 143 Abs 1 MarkenG ist erfuellt **und** sie wird gewerbsmaessig oder bandenmaessig begangen.
...
- **Bandenmerkmal bestreiten.** Drei-Personen-Schwelle pruefen. Wer ist Bandenmitglied? Lager-Mitarbeiter, Logistikdienstleister, Buchhalter koennen Beihilfeleister, nicht Bandenmitglieder sein. Bandenabrede setzt Wille zur kuenftigen Begehung weiterer Taten voraus; einmaliges Mittun ohne Absprache kein Bandenmerkmal.
- **Gewerbsmaessigkeit erschuettern.** Wenn Mandant nur einen einzelnen Containerimport beguenstigt hat, ohne Wiederholungsabsicht: keine Gewerbsmaessigkeit. Wichtig: die subjektive Erwerbsabsicht muss nachgewiesen werden; nicht jeder einmalig hohe Umsatz genuegt.
- **Aussteigerregelung pruefen.** Kein Paragraph 31 BtMG-Aequivalent im MarkenG, aber Paragraph 46b StGB (Kronzeugenregelung) bei Bandenkriminalitaet anwendbar, wenn die Tat als Verbrechen einzuordnen ist. Mandant kann durch Aussage gegen Mittaeter Strafmilderung erreichen.
- **Mittaeter vs. Beihilfe trennen.** Untergeordnete Mitwirkende (Fahrer, einfache Lagerhelfer, technische Hilfskraefte) sollten als Gehilfen nach Paragraph 27 StGB eingestuft werden; Strafmilderung nach Paragraph 27 Abs 2 iVm Paragraph 49 Abs 1 StGB; mildere Strafzumessung.
- **Verbrechen-Folgen beachten.** Versuch ist immer strafbar (Paragraph 23 Abs 1 StGB). Anstiftung und Beihilfe weiterhin moeglich. Untersuchungshaft Paragraph 112 StPO wird wegen Wiederholungsgefahr (Paragraph 112a StPO) bei Bandenkriminalitaet hoch wahrscheinlich, sofern keine starke Verteidigungsstrategie greift.

## Trade-off-Matrix

| Pfad A vollumfaengliches Bestreiten | Pfad B Kronzeugenregelung Paragraph 46b StGB | Empfehlung |
| --- | --- | --- |
| Bestreiten Bandenmerkmal, Gewerbsmaessigkeit, Vorsatz; lange HV mit vielen Mitangeklagten, Telekommunikationsueberwachungen, V-Mann-Beweismitteln | Kooperation mit StA; Aussage gegen Bandenchef, Lieferanten, Logistiker; Aufdeckung weiterer Taten | Bei Verbrechensvorwurf und starker Beweislage (Container-Logs, Bankspuren, TKÜ-Ergebnisse): Pfad B bei junger Bandenposition; Pfad A bei untergeordneter Rolle, wo Beihilfe nach Paragraph 27 StGB tragfaehig ist. |

Paragraph 153a StPO ist bei Paragraph 143a MarkenG (Verbrechen) **nicht** anwendbar. Einstellung nach Paragraph 153 StPO ebenfalls nicht. Verstaendigung Paragraph 257c StPO bleibt moeglich, aber das Strafmass beginnt bei drei Monaten Freiheitsstrafe; Aussetzung zur Bewaehrung Paragraph 56 StGB praktisch erreichbar.

## Konkurrenzen

- **Paragraph 143a MarkenG verdraengt** Paragraph 143 MarkenG (Spezialitaet).
- **Paragraph 143a MarkenG und Paragraph 261 StGB Geldwaesche.** Bei systematischer Geldfluss-Verschleierung der Counterfeit-Erloese Tateinheit; Paragraph 261 als selbstaendige Tat moeglich.
...
- **Paragraph 143a MarkenG und Paragraphen 129, 129a StGB.** Bei strukturierten Vereinigungen pruefen, ob kriminelle Vereinigung im Sinne Paragraph 129 StGB vorliegt; mehrgliedrige Bande mit fortbestehender Struktur kann Vereinigungscharakter erreichen.
- **Paragraph 143a MarkenG und Paragraph 108a UrhG.** Bei Doppelverletzung Marke und Urheberrecht (Bootleg mit Marke) Tateinheit; beide gewerblichen Qualifikationen koennen nebeneinander stehen.

## Strafzumessung

Strafrahmen Paragraph 143a Abs 1 MarkenG: drei Monate bis fuenf Jahre Freiheitsstrafe. Aussetzung zur Bewaehrung Paragraph 56 StGB bei Strafe bis zwei Jahre moeglich; bei laengerer Strafe nicht. Zumessungsgesichtspunkte: Umsatz der Bande, Anzahl Beteiligter, Hierarchieposition des Taeters, Schadenshoehe, Verfahrensdauer, Reue, Kooperation.
...
**Hilfsbeweisantrag:** "Es wird beantragt, ein Sachverstaendigengutachten zur Personalstaerke und Tataufteilung der Y-Organisation einzuholen zum Beweis der Tatsache, dass nur zwei Personen die Tatkernhandlungen vornahmen und mein Mandant nicht in den engeren Kreis der Bandenmitglieder gehoerte."
...
## 3. `strafrecht-spezial-mietwucher-5-wistg`
...
- `strafrecht-spezial-mord-211-stgb-mordmerkmale` – Abgrenzung; bei Mord keine Privilegierung.
- `strafrecht-spezial-haeusliche-gewalt-im-strafverfahren` – Affektgenese bei haeuslicher Gewalt.
...
## 5. `strafrecht-spezial-misshandlung-schutzbefohlener-225-stgb`
...
- **Erste Gruppe – taeterbezogen / subjektiv:** Mordlust; zur Befriedigung des Geschlechtstriebs; aus Habgier; sonst aus niedrigen Beweggruenden.
- **Zweite Gruppe – tatbezogen / objektiv-objektivierbar:** heimtueckisch; grausam; mit gemeingefaehrlichen Mitteln.
- **Dritte Gruppe – taeterbezogen / final-subjektiv:** um eine andere Straftat zu ermoeglichen oder zu verdecken.
...
**Verdeckungsabsicht:** Der Taeter toetet, um eine andere von ihm begangene Straftat zu verdecken (vor Strafverfolgung). Voraussetzung: Die Vortat muss in der Vorstellung des Taeters zumindest bedingt vorsaetzlich begangen sein.
...
**Befriedigung des Geschlechtstriebs:** Lustmord; auch Toetung waehrend Vergewaltigung, wenn die Toetung der sexuellen Erregung dient (anders: nur Verdeckungsabsicht).
...
- **Schweigen (§ 136 StPO, § 243 Abs. 5 StPO):** Standard zu Beginn der Hauptverhandlung. Risiko: kein Geststaendnisbonus, keine fakultative Strafrahmenverschiebung nach § 46 StGB.
- **Teileinlassung:** Aeussern nur zu Tatumstaenden, die Mordmerkmale entkraeften (z. B. Streitverlauf vor Tat zur Erschuetterung der Heimtuecke). Risiko: Anschlussvorhalt, Glaubwuerdigkeitsfragen.
- **Vollgestaendnis:** Geststaendnis als Strafmilderungsgrund (§ 46 Abs. 2 StGB) und Voraussetzung der Verstaendigung nach § 257c StPO. Risiko: bei nicht ausraeumbaren Mordmerkmalen bleibt lebenslang.
- **Glaubwuerdigkeit:** Geststaendnis muss konsistent, detailliert und ohne Schutzbehauptungen sein – BGH-Linie verlangt nachvollziehbares Geststaendnis.

## Konkurrenzen

- **§§ 211, 212 StGB:** Mord ist nach staendiger BGH-Rechtsprechung Aufstockungstatbestand (Qualifikation), nicht selbststaendiger Tatbestand. Streitig zur Literatur (delicta sui generis).
...
- `strafrecht-spezial-totschlag-212-stgb` – Auffangtatbestand.
...
- `fachanwalt-strafrecht-einlassung-vorbereiten` – Aussagestrategie.
- `spezial-stgb-risikoampel-und-gegenargumente` – allgemeine StGB-Pruefung.

## Quellen Stand 06/2026

- § 211 StGB Mord (Bundestag / Gesetze im Internet).
- § 212 StGB Totschlag.
...
## 7. `strafrecht-spezial-noetigung-240-stgb`
...
- `strafrecht-spezial-haeusliche-gewalt-im-strafverfahren` – Praxisleitfaden.
- `strafrecht-spezial-raub-249-stgb` – Vorrang bei Wegnahmebezug.
...
## 8. `strafrecht-spezial-npsg-neue-psychoaktive-stoffe`
...
|---|---|
| § 4 Abs. 1 NpSG Grundtatbestand | bis 3 Jahre Freiheitsstrafe oder Geldstrafe |
| § 4 Abs. 2 NpSG Qualifikation | 1 bis 10 Jahre |
| Eigenkonsum, Eigenbesitz | nicht strafbar (anders als BtMG) |
...
| Strategie | Vorteil | Nachteil |
|---|---|---|
| Stoffliche Nicht-Erfassung argumentieren | Tatbestandsverneinung | Hoher Gutachtenaufwand, neue Stoffgruppen schliessen Luecken |
| Eigenkonsum-Verteidigung | § 4 NpSG nicht erfuellt | Funktioniert nur, wenn keine Verkaufsabsicht erkennbar |
| Abgrenzung zu BtMG | Bei BtMG-Erfassung Spezialitaet | Eventuell hoeherer Strafrahmen BtMG |
| Aufklaerungshilfe § 46b StGB | Strafmilderung | Katalogtat erforderlich |
...
**Schriftsatz Stoffliche Erfassung anfechten:**
...
## 9. `strafrecht-spezial-patentrecht-142-patg`
...
| Pfad A vollumfaengliches Bestreiten + Nichtigkeitsklage | Pfad B Lizenzverhandlung + Antragsruecknahme | Empfehlung |
| --- | --- | --- |
| Nichtigkeitsklage Bundespatentgericht; Strafverfahren aussetzen; Risiko 18-24 Monate Verfahrensdauer; hoher Anwaltsaufwand | Lizenzverhandlung mit Patentinhaber; Schadensersatzanerkenntnis; Antragsruecknahme Paragraph 77d StGB; rasche Verfahrenseinstellung Paragraph 170 Abs 2 StPO | Wenn Patent erkennbar angreifbar (Stand der Technik, fehlende erfinderische Taetigkeit): Pfad A. Wenn Patent stabil und Mandant Verletzung nicht bestreitet: Pfad B mit Verteidigung des Schadenssatzes. |
...
§ 252 StGB schliesst die zeitliche Luecke zwischen Diebstahl und Raub. Wenn der Taeter den Diebstahl vollendet hat und **bei oder unmittelbar nach der Tat** auf frischer Tat betroffen wird, dann Gewalt oder qualifizierte Drohung einsetzt, **um sich im Besitz der gestohlenen Sache zu erhalten**, wird die Tat wie Raub bestraft.
...
**Vortat:** Vollendeter Diebstahl. **Beendigung** der Vortat ist nicht erforderlich – die Beendigungsphase ist gerade der typische Anwendungsfall des § 252 StGB. Bei nur versuchtem Diebstahl scheidet § 252 StGB nach staendiger BGH-Rechtsprechung aus; dort gilt § 249 StGB direkt.

**Betroffensein auf frischer Tat:** Der Taeter muss waehrend der Tat oder kurz nach Vollendung wahrgenommen werden. Raeumliche und zeitliche Naehe erforderlich. **Frische Tat** wird angenommen, solange der Taeter sich am Tatort oder in raeumlich-zeitlicher Naehe zur Tatausfuehrung aufhaelt und in Sichtweite oder unmittelbarer Verfolgung steht. Bei laenger andauernder Flucht (z. B. nach mehreren Stunden auf einem anderen Ort) entfaellt das Frische-Tat-Merkmal.

**Gewalt oder Drohung:** Wie bei § 249 StGB. Auch Mit-sich-Reissen, Stoss zur Befreiung, Drohgebaerden mit Waffe.

**Beutesicherungsabsicht:** Der Taeter muss bezwecken, sich im Besitz der gestohlenen Sache zu erhalten. **Streitig:** Bei Mehrfachzwecken (Sicherung der Sache **und** Vermeidung der Strafverfolgung) genuegt nach staendiger BGH-Rechtsprechung, dass die Beutesicherung **mitleitendes Motiv** ist. Wenn die Gewalt **nur** der Strafverfolgungsvermeidung dient, scheidet § 252 StGB aus; dann gegebenenfalls §§ 113, 240 StGB.

**Wer ist Adressat der Gewalt:** Geschaedigter des Diebstahls oder Dritter (Verfolger, Polizeibeamter, Zeuge).

## Praktikertipps der Verteidigung

- **Beutesicherungsabsicht erschuettern:** Wenn die Gewalt erst nach Wegwurf der Beute eingesetzt wird oder erkennbar nur der Strafverfolgungsvermeidung dient, scheidet § 252 StGB aus.
...
- **Schweigen vs. Aussage:** Bei strittiger Beutesicherungsabsicht Aussage des Beschuldigten wichtig.
- **Geststaendnis und TOA:** Bei Ladendiebstahl mit moderater Gewalt oft Bewaehrungsstrafe erzielbar (im minder schweren Fall).
- **Glaubwuerdigkeit:** Aussagen der Geschaedigten und Zeugen zur Zeitachse und Motivlage des Gewalteinsatzes.
...
- **Strafrahmen § 252 iVm § 249 StGB:** Freiheitsstrafe nicht unter einem Jahr (bis 15 Jahre).
- **Minder schwerer Fall § 249 Abs. 2 StGB iVm § 252 StGB:** Freiheitsstrafe von sechs Monaten bis zu fuenf Jahren.
- **§ 250 iVm § 252 StGB:** Bei Qualifikation drei bis 15 Jahre (Abs. 1) bzw. fuenf bis 15 Jahre (Abs. 2).
- **§ 251 iVm § 252 StGB:** Bei Todesfolge lebenslang oder nicht unter zehn Jahren.
- **§ 49 StGB:** Strafrahmenverschiebung bei vertypten Milderungsgruenden.
- **Bewaehrung:** Bei Strafrahmenverschiebung bzw. minder schwerem Fall denkbar (bis zwei Jahre).
...
- `strafrecht-spezial-raub-249-stgb` – Grundtatbestand des Raubes.
- `strafrecht-spezial-schwerer-raub-250-stgb` – Qualifikation iVm § 252 StGB.
- `strafrecht-spezial-raub-mit-todesfolge-251-stgb` – Erfolgsqualifikation iVm § 252 StGB.
- `fachanwalt-strafrecht-einlassung-vorbereiten` – Aussagestrategie.

## Quellen Stand 06/2026

- § 252 StGB raeuberischer Diebstahl (gesetze-im-internet.de).
- § 249 StGB; § 250 StGB; § 251 StGB.
- § 242 StGB Diebstahl.
- § 113 StGB Widerstand gegen Vollstreckungsbeamte.
- BGH staendige Rspr. zum Frische-Tat-Merkmal, zur Beutesicherungsabsicht und zur Abgrenzung § 252 / § 113 StGB (live verifizieren in BGH-Datenbank).
- Verifizierung in amtliche Quellen empfohlen.
