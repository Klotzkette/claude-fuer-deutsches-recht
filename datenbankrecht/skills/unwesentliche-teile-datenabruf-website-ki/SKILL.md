...
- Startup betreibt einen Preisvergleichsdienst und ist unsicher, ob sein automatisierten Abruf kleiner Datenpakete den Kumulations-Tatbestand erfüllt.
...
5. Technische Beweise sichern: API-Logs, Abrufprotokolle, IP-Adressen, User-Agent-Strings, Zeitstempel.
