...
## 3. Leitentscheidungen zur Zeugnisklarheit

### 3.1. BAG, Urteil vom 21.06.2005 - Az. 9 AZR 352/04
...
### 3.2. BAG, Urteil vom 15.11.2011 - Az. 9 AZR 386/10
...
### 3.3. BAG, Urteil vom 11.12.2012 - Az. 9 AZR 227/11
...
## 4. Drei Klarheitsgebote beim Generieren

### 4.1. Kein Widerspruch zwischen Wortlaut und Signalwirkung

Eine Formulierung darf nicht positiv klingen und negativ gemeint sein. Beispiel:
- „Wir hatten an seiner Arbeit nichts auszusetzen“ ist zurückhaltend, aber nicht isoliert Note 4 bis 5.
- Wenn diese Formel generiert wird, muss der Generator auf ihre Negativwirkung hinweisen.

### 4.2. Kein Ironie-Code

Erkennbar nicht ernst gemeintes Über-Lob ist ein unzulässiger Code (LAG Hamm, Beschluss vom 14.11.2016 - Az. 12 Ta 475/16). Gestapelte Superlative ohne Tatsachenkern sind zu vermeiden.
...
### 4.3. Formulierungsspielraum nutzen, aber Grenzen kennen
...
- Ungebräuchliche Wendungen ungeprüft verwenden; individuelle klare Sprache ist jedoch zulässig und nicht auf Standardformeln beschränkt.
