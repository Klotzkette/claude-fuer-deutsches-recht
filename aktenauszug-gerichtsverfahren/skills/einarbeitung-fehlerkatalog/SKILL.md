...
description: "Für Einarbeitung Fehlerkatalog: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Aktenauszüge zivilgerichtlicher Verfahren** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (Akteneinsicht im laufenden Verfahren jederzeit)

- **Symptom:** Frist falsch berechnet oder übersehen (Akteneinsicht im laufenden Verfahren jederzeit)
...
### 2. Parallelfrist vergessen (Sofortige Beschwerde 2 Wochen § 569 ZPO)

- **Symptom:** Parallelfrist vergessen (Sofortige Beschwerde 2 Wochen § 569 ZPO)
...
### 3. Falsche Zuständigkeit adressiert (richtig: AG/LG/OLG)

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: AG/LG/OLG)
...
### 4. Beweismittel nicht gesichert (Urkunden)

- **Symptom:** Beweismittel nicht gesichert (Urkunden)
...
### 5. Schlüsseldokument fehlt oder veraltet (Klageschrift)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Klageschrift)
...
### 6. Normzitat ohne Fassungsprüfung (§ 299 ZPO Akteneinsicht)

- **Symptom:** Normzitat ohne Fassungsprüfung (§ 299 ZPO Akteneinsicht)
