...
```
Gibt es bereits ein Unternehmensprofil unter ~/.claude/plugins/config/claude-fuer-deutsches-recht/company-profile.md?
```
...
- /regulatorisches-recht:reg-feed-watcher – Feeds jetzt prüfen
- /regulatorisches-recht:policy-diff – Diff gegen Ihre Richtlinienbibliothek
- /regulatorisches-recht:gaps – Offene Lücken anzeigen
- /regulatorisches-recht:comments – Konsultationsbeiträge verwalten
- /regulatorisches-recht:policy-redraft – Richtlinienneufassung
```
...
**Eingabe:** `/regulatorisches-recht:cold-start-interview`
