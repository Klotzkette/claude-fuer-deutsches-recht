...
```
~/.claude/plugins/config/claude-fuer-deutsches-recht/regulatorisches-recht/matters/<mandat-slug>/
├── matter.md          # Mandat-Fakten und Übersteuerungen
...
```
Nach Auswahl: Aktives Mandat im Profil setzen. Skills lesen jetzt `matter.md` dieses Mandats.
...
- Nächster empfohlener Schritt (z. B. „Mandat aktiv – starten Sie mit `/regulatorisches-recht:gap-surfacer`")

## Beispiel

**Eingabe:** `/regulatorisches-recht:matter-workspace neu`
...
~/.../matters/mairisk-gap-2025-mandanta/

Aktives Mandat: MaRisk-GAP-2025-MandantA

Nächster Schritt: /regulatorisches-recht:gap-surfacer
```
...
- **Mandantengeheimnis:** Inhalte aus `matter.md` und den mandat-spezifischen Trackern sind vertraulich nach § 43a Abs. 2 BRAO. Nie in gemeinsame Kontexte oder Protokolle exportieren.
