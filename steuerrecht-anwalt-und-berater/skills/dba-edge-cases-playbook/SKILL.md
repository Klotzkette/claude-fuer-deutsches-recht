...
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `DBA-Edge-Case-Playbook` und löse die dort angelegte Fachfrage; arbeite mit konkreten Tatbestandsmerkmalen, Beweisfragen und dem unmittelbar benötigten Arbeitsprodukt. Routingfragen bleiben Hilfsmittel, wenn Frist, Zuständigkeit oder Verfahrensart offen sind.
...
2. **Home-Office:** Arbeitnehmer arbeitet aus Wohnsitzstaat für ausländischen Arbeitgeber; Grenzgänger- oder 183-Tage-Regel wird falsch verkürzt.
3. **Betriebsstätte ohne Schild an der Tür:** Bauausführung, Server, Projektbüro, Vertreter, Lager, Anti-Fragmentierung.
4. **Hybridgesellschaften:** LLC, LLP, CV, Personengesellschaft, Fonds; Qualifikationskonflikt zwischen Deutschland und Quellenstaat.
5. **Immobiliengesellschaft:** Veräußerungsgewinn bei Anteil an grundstücksreicher Gesellschaft.
6. **Pensionen:** gesetzliche Rente, Betriebsrente, öffentlicher Dienst, ausländische Spezialpensionen.
7. **Stock Options/RSU:** Vesting-Zeitraum über mehrere Staaten.
8. **Künstler/Sportler:** Auftrittsstaat, zwischengeschaltete Gesellschaft, Quellensteuer.
9. **Dreieck:** Ansässigkeit Staat A, Zahlung aus Staat B, Betriebsstätte Staat C.
10. **Treaty Shopping:** § 50d Abs. 3 EStG, Beneficial Ownership, PPT/LOB.

## Arbeitsregel

Für jeden Edge-Case eine Tabelle ausgeben:

| Tatsache | DBA-Artikel | nationales Recht | Beleg | Risiko |
| --- | --- | --- | --- | --- |
...
- Streitpunkte.
- Beweise.
- Berechnungs-/Quellensteuerfolge.
- Verfahrensweg.
...
- **Anti-Fragmentierung nach MLI Art. 13 uebersehen** bei aufgeteilten Aktivitaeten.
...
| Edge-Case | DBA-Artikel | Nat. Recht | Beleg | Risiko |
|---|---|---|---|---|
...
| Stock Options | Art. 15 | § 19 EStG | Vesting-Kalender | Vesting-Aufteilung |
| Kuenstler/Sportler | Art. 17 | § 50a EStG | Vertrag, Auftrittsorte | Star-Company-Substanz |
| Dreieck (Staat A, B, C) | Mehrere DBA | § 34c EStG | Steuerbescheide aller Staaten | Mehrfachbesteuerung |
| Treaty Shopping | PPT/LOB | § 50d Abs. 3 EStG | Substanzdokumentation | Entlastung verweigert |
...
## Dreiecksfall (Mustertabelle)

Sachverhalt: Mandant DE-ansaessig, BS in Staat B, Zahlung aus Staat C (Quellensteuer).
