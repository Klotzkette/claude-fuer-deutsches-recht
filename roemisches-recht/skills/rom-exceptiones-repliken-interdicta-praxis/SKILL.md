---
name: rom-exceptiones-repliken-interdicta-praxis
description: "ROM Exceptiones Repliken Interdicta Praxis: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# ROM Exceptiones Repliken Interdicta Praxis

## Arbeitsbereich

Dieser Skill bündelt 8 sachlich verwandte Arbeitsschritte rund um **ROM Exceptiones Repliken Interdicta Praxis** im Plugin Römisches Recht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `rom-056-hereditatis-petitio` | Römisches Recht: Hereditatis petitio (Erbschaftsklage) nach D. 5.3 und Gaius Inst. 4.16 - dingliche Klage des Erben gegen Erbschaftsbesitzer, Haftung des gutgläubigen und bösgläubigen Erbschaftsbesitzers. |
| `rom-057-schenkungen-und-mortisationsfragen` | Römisches Recht: Schenkung (donatio) nach D. 39.5 und donatio mortis causa nach D. 39.6 - Unentgeltlichkeit, lex Cincia (204 v.Chr.), Schenkungsverbot unter Ehegatten (D. 24.1) und Widerruf. |

## Arbeitsweg

Im Plugin Römisches Recht gilt für **ROM Exceptiones Repliken Interdicta Praxis**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Bei fehlendem Testament richtet sich die Erbfolge nach XII Tafeln Tab. V.4: sui heredes (Hauskinder) zuerst, dann agnati proximi (nächste Agnaten), dann die gens. Das prätorische Recht (bonorum possessio sine tabulis) erweiterte den Kreis durch vier Klassen: unde liberi, unde legitimi, unde cognati, unde vir et uxor. Justinian reformierte mit Nov. 118 (543 n.Chr.) grundlegend auf kognatische Erbfolge.

## Kernquellen

- **XII Tafeln Tab. V.4-5**: Urformeln der gesetzlichen Erbfolge
- **Gaius Inst. 3.1**: Sui heredes als erste Klasse
- **D. 38.6.1 (Ulpian)**: Bonorum possessio sine tabulis
- **D. 38.7 (Ulpian)**: Klassen der prätorischen Erbfolge
- **Nov. 118 (Justinian 543 n.Chr.)**: Reform auf kognatisches Prinzip
- **Iust. Inst. 3.1-9**: Intestaterbfolge

## Schlüsselbegriffe

- sui heredes: Hauskinder unter patria potestas beim Tod
- agnati: väterlicheseitige Verwandte (ius civile)
- cognati: blutsverwandte (prätorische und justinianische Erbfolge)
- bonorum possessio sine tabulis: prätorische Erbfolge
- Nov. 118: Reform: vier Klassen nach Blutsverwandtschaft
- ius accrescendi: Anwachsungsrecht unter Miterben

## Typische Streitfragen / Forschungsfragen

1. Agnatische vs. kognatische Erbfolge: historische Entwicklung
2. Bonorum possessio: nur prozessuale Stellung oder echtes Erbrecht?
3. Nov. 118: vollständige Ablösung des ius civile-Erbrechts?
4. Emanzipierte Kinder: Ausschluss oder Einbeziehung?
5. Vergleich: röm. Intestaterbfolge vs. BGB §§ 1924ff.

## Methodik

- D. 38.6-17 (Bonorum possessio)
- Gaius Inst. 3.1-87; Iust. Inst. 3.1-9
- XII Tafeln: Bruns Fontes (archive.org)
- Nov. 118: Schöll-Kroll (archive.org)
- Kaser RP I §§ 350-380

## Output

- Erbfolgetabelle: drei Klassen ius civile
- Schema: vier Klassen prätorische Erbfolge
- Memo: Nov. 118 und ihre Wirkung
- Vergleich röm. Intestaterbfolge vs. BGB

## Quellenregel

XII Tafeln: Bruns Fontes (archive.org). Gaius Inst. 3; D. 38; Nov. 118 (Mommsen-Krüger). Kaser RP I.
