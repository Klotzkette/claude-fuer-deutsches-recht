...
Die exceptio doli ist eine prätorische Einrede gegen Klagen, die auf Arglist beruhen oder deren Durchsetzung arglisting wäre. Gaius Inst. 4.119 unterscheidet die exceptio doli specialis (Arglist beim Vertragsschluss) von der exceptio doli generalis (Arglist bei der Klageerhebung). D. 44.4 enthält die Digestenkasuistik. Die Einrede ist untrennbar mit der bona fides verknüpft.

## Kernquellen

- **Gaius Inst. 4.119**: Exceptio doli specialis vs. generalis
- **D. 44.4.1.1 (Ulpian)**: Exceptio doli - prätorisches Instrument
- **D. 44.4.8 (Ulpian)**: Anwendungsfälle der exceptio doli
- **D. 44.4.4 (Ulpian)**: Exceptio als Gegenmittel des Beklagten
- **Gaius Inst. 4.116-119**: Exceptiones im Formularprozess
- **D. 4.3.1 pr. (Ulpian)**: Actio de dolo (Klage wegen Arglist)

## Schlüsselbegriffe

- exceptio doli specialis: Arglist beim ursprünglichen Geschäftsabschluss
- exceptio doli generalis: Arglist bei der Klageerhebung (nunc dolo malo facit)
- replicatio doli: Gegeneinrede bei arglister Einrede
- actio de dolo: selbständige Klage wegen Arglist (subsidiär)
- dolus malus: arglistige Täuschung oder absichtliche Schädigung
- prätorischer Schutz: Instrument zur Einzelfallgerechtigkeit

## Typische Streitfragen / Forschungsfragen

1. Verhältnis exceptio doli generalis - bona fides: dieselbe Funktion?
2. Exceptio doli als subsidiäres Instrument oder eigenständig?
3. Actio de dolo: subsidiär zur exceptio - wann?
4. Doppelwirkung dolus: Einrede und selbständige Klage
5. Einfluss auf BGB § 826 (vorsätzliche sittenwidrige Schädigung) und § 242

## Methodik

- D. 44.4 (De doli mali et metus exceptione)
- Gaius Inst. 4.116-125
- D. 4.3 (De dolo malo) für die actio de dolo
- Kaser RP I §§ 167-172; Kaser/Hackl Zivilprozessrecht

## Output

- Schema: exceptio doli specialis vs. generalis
- Prozessdiagramm: Klage - exceptio - replicatio
- Anwendungsfälle aus D. 44.4
- Vergleich röm. exceptio doli vs. BGB § 242 und § 826

## Quellenregel

D. 44.4; D. 4.3; Gaius Inst. 4.116-125 (Mommsen-Krüger). Kaser RP I. Kaser/Hackl Zivilprozessrecht.
