---
name: rom-actio-publiciana-interdikte-besitzschutz
description: "ROM Actio Publiciana Interdikte Besitzschutz: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# ROM Actio Publiciana Interdikte Besitzschutz

## Arbeitsbereich

Dieser Skill bündelt 8 sachlich verwandte Arbeitsschritte rund um **ROM Actio Publiciana Interdikte Besitzschutz** im Plugin Römisches Recht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Römisches Recht gilt für **ROM Actio Publiciana Interdikte Besitzschutz**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Die `emptio venditio` ist der Konsensualkontrakt des Kaufs: Einigung über Ware (`merx`) und Preis (`pretium`). D. 18.1.1 pr. (Paulus) erklärt die historische Entstehung aus dem Tausch. Besonderheit: Mit Vertragsabschluss kann die Gefahr des zufälligen Untergangs auf den Käufer übergehen (`periculum est emptoris`, D. 18.6.8 pr., Paulus). Der Verkäufer schuldet Übergabe und Gewährleistung, aber der Kaufvertrag selbst überträgt nicht automatisch Eigentum.
...
- **D. 21.1.1 (Ulpian)**: `edictum aedilicium` und Sachmängelgewährleistung

## Schlüsselbegriffe

- `merx`: Kaufsache, grundsätzlich im Handel
- `pretium certum`: bestimmter Preis in Geld
- `emptio perfecta`: Kauf mit bestimmter Ware und bestimmtem Preis
- `periculum emptoris`: Gefahrtragungsregel nach Perfektion
- `actio empti`: Käuferklage auf Übergabe, Gewährleistung, Interesse
- `actio venditi`: Verkäuferklage auf Kaufpreis
- `actio redhibitoria`: Rückabwicklung wegen verborgenem Mangel, besonders ädilizisch
- `actio quanti minoris`: Minderung wegen verborgenem Mangel

## Trennungsfehler vermeiden

1. **Verpflichtung:** Kaufvertrag prüft Konsens, Ware, Preis, Gefahr, Leistungspflichten.
2. **Verfügung:** Eigentumserwerb separat prüfen, etwa `traditio` mit tauglichem Rechtsgrund, bei älteren Formen auch `mancipatio` oder `in iure cessio`.
3. **Herausgabe:** Eigentümerklage ist `rei vindicatio`, nicht `actio empti`.
4. **Gutgläubige Zwischenlage:** `actio Publiciana` oder bonitarisches Eigentum prüfen.
5. **Eviktion:** Bei Verlust an den wahren Eigentümer Gewährleistung, Sicherungsstipulation oder `actio empti` prüfen.

## Typische Streitfragen

1. Reicht Konsens oder fehlt noch die dingliche Übereignung?
2. Ist der Preis bestimmt genug und wirklich Geldpreis?
3. Wann ist die Ware individualisiert und die Gefahr übergegangen?
4. Liegt ein Rechtsmangel/Eviktion oder ein Sachmangel vor?
5. Gilt ädilizische Mängelhaftung mit `redhibitoria`/`quanti minoris`?
6. Welche moderne Parallele ist zulässig: BGB-Kauf, CISG, ABGB oder bloße Didaktik?

## Beispiel: Pferdekauf

Sachverhalt: A kauft ein Pferd; drei Wochen später lahmt es. Die Krankheit bestand schon beim Kauf, war aber verborgen.

- **Römisch:** ädilizische Mängelklagen prüfen; Rückabwicklung (`actio redhibitoria`) oder Minderung (`actio quanti minoris`) je nach Frist und Mangelbild.
- **Dogmatischer Punkt:** Kauf und Eigentumserwerb getrennt prüfen; Mangelrecht bleibt Kaufrecht.
- **Moderne Anschlussnotiz:** § 434, § 437 BGB nur als Vergleich; nicht in die römische Prüfung hineinziehen.

## Output

- Schema `emptio venditio`
- Trennung Kaufvertrag / Eigentumsübergang / Besitzschutz
- Gefahrtragungsübersicht mit Ausnahmen
- Memo zur Eviktion und Sachmängelhaftung
- Vergleich römischer Kauf vs. BGB-Kauf vs. CISG

## Quellenregel

D. 18-19; D. 21.1; Gaius Inst. 3.139 ff. Primärquellen bevorzugen. Literaturhinweise nur als Hilfsmittel, nicht als nicht überprüfbare Autorität.
