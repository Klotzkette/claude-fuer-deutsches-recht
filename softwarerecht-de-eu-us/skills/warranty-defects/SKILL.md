...
description: "Für Softwaremängel und Gewährleistung: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
## Fachkern: Softwaremängel und Gewährleistung
...
- BGB Kauf/Werk/Miete analog je Vertrag
- Digitale Produkte Recht
...
- Welche Beschaffenheit ist vereinbart: Specs, Doku, Demo, Security, Performance, Kompatibilität?
- Ist der Fehler reproduzierbar und vom Kundenumfeld abhängig?
- Welche Rechte bestehen: Nacherfüllung, Minderung, Rücktritt, Schadensersatz, Service Credits?
- Welche Fristen und Mitwirkungspflichten sind einzuhalten?
...
**Mindest-Output:** Mängelmatrix mit Reproduktion, Ursache, Rechtsfolge und Beweisbedarf.
