...
Bei Verwendung die einschlägige Fassung und Übertragbarkeit erneut prüfen. Optional vertieft die [Repository-Referenz](../../references/zitierweise.md) die Zitierweise; eigenständig gilt: Gericht, Entscheidungsform, Datum, Aktenzeichen und belegte Passage angeben. Bei fehlendem Volltext nur den verifizierten Leitsatz verwenden; keine Randnummer ergänzen. Aktenangaben, verifizierte Quelle und Annahme auseinanderhalten.
