...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Fachanwalt Urheber- und Medienrecht** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (Verjährung 3 Jahre § 102 UrhG)

- **Symptom:** Frist falsch berechnet oder übersehen (Verjährung 3 Jahre § 102 UrhG)
...
### 2. Parallelfrist vergessen (Schutzdauer 70 Jahre p.m.a.)

- **Symptom:** Parallelfrist vergessen (Schutzdauer 70 Jahre p.m.a.)
...
### 3. Falsche Zuständigkeit adressiert (richtig: LG (Verletzung))

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: LG (Verletzung))
...
### 4. Beweismittel nicht gesichert (Werknachweis)

- **Symptom:** Beweismittel nicht gesichert (Werknachweis)
...
### 5. Schlüsseldokument fehlt oder veraltet (Lizenzvertrag)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Lizenzvertrag)
...
### 6. Normzitat ohne Fassungsprüfung (UrhG)
