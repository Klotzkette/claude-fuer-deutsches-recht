...
description: "Verein Dokumentenpaket Politik Social Media: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Verein Dokumentenpaket Politik Social Media

## Arbeitsbereich

Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Verein Dokumentenpaket Politik Social Media** im Plugin Vereinsrecht Vereinsmanager. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Vereinsrecht Vereinsmanager gilt für **Verein Dokumentenpaket Politik Social Media**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `verein-dokumentenpaket`

**Fokus:** Baut aus Auftrag komplette Dokumente: Einladung, Tagesordnung, Beschluss, Protokoll, Rundbrief und Anlagenliste.

# Vereins-Dokumentenpaket

## Aufgabe
Baut aus Auftrag komplette Dokumente: Einladung, Tagesordnung, Beschluss, Protokoll, Rundbrief und Anlagenliste.
...
## 2. `verein-und-politik`

**Fokus:** Warnt bei politischer Betätigung, Gemeinnützigkeit, Neutralität, Veranstaltungen und Parteispendennähe.

# Verein und Politik

## Aufgabe
Warnt bei politischer Betätigung, Gemeinnützigkeit, Neutralität, Veranstaltungen und Parteispendennähe.
...
## 3. `verein-und-social-media`

**Fokus:** Regelt Impressum, Bildrechte, Datenschutz, Adminrechte, Krisenpost und Löschung.

# Social Media im Verein

## Aufgabe
Regelt Impressum, Bildrechte, Datenschutz, Adminrechte, Krisenpost und Löschung.
