...
description: "Klageschrift Anschreiben AN Antrag Bestimmt: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Klageschrift Anschreiben AN Antrag Bestimmt** im Plugin Selbstvertretung vor dem Amtsgericht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Selbstvertretung vor dem Amtsgericht gilt für **Klageschrift Anschreiben AN Antrag Bestimmt**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
- Sie schreiben einen Schriftsatz ans Amtsgericht.
- Sie sind unsicher, wie Sie das Gericht anreden.
- Sie wollen das richtige Aktenzeichen-Format treffen.
...
- **§ 130 ZPO** — Inhalt eines Schriftsatzes.
...
Bei juristischen Personen Firma + Vertreter.

### Schritt 2 — Datum und Ort

Oben rechts oder unter Ihrem Namen:

```
Musterstadt, 27. Mai 2026
```

### Schritt 3 — Empfaenger
...
Bei Bekanntem Aktenzeichen: konkrete Abteilung angeben, z. B. "Abt. C 5".

### Schritt 4 — Betreffzeile mit Aktenzeichen
...
Oder bei konkretem Richter (selten benoetigt):

```
Sehr geehrter Herr Vorsitzender,
```

Im Allgemeinen: "Sehr geehrte Damen und Herren" ist immer korrekt.

### Schritt 6 — Eroeffnungssatz

Erster Schriftsatz (Klage):
...
Tatsachenvortrag, Beweisangebot, Antraege — wie in den anderen Skills beschrieben.
...
### Schritt 10 — Empfaenger-Liste

Bei einem Versand an mehrere (Gericht + Beklagter): Verteiler unten:
...
- **Keine Umgangssprache** ("Der hat mich verarscht" — schreiben Sie es sachlich).
- **Aktenzeichen immer angeben**, sobald Sie es haben — sonst landen Schriftsaetze evtl. nicht in der richtigen Akte.
...
Der Klageantrag ist das **Herzstueck** Ihrer Klage. Er bestimmt, was das Gericht im Erfolgsfall entscheidet. Er muss "bestimmt" sein (§ 253 II Nr. 2 ZPO) — also so konkret, dass aus dem Urteil heraus vollstreckt werden kann. Ein unbestimmter Antrag fuehrt zur Abweisung als unzulaessig.

## Wann brauchen Sie diese Skill?

- Sie formulieren Ihren Klageantrag.
- Sie sind unsicher, was alles in den Antrag muss.
- Sie wollen mehrere Antraege stellen (Hauptantrag + Hilfsantraege).

## Fachbegriffe (kurz erklaert)

- **Bestimmtheit des Antrags**: Antrag muss aus sich heraus klar sein.
- **Zahlungsantrag**: Antrag auf Zahlung eines Geldbetrags.
- **Leistungsklage**: Klage auf ein bestimmtes Tun (zahlen, herausgeben, unterlassen).
- **Feststellungsklage**: Klage auf Feststellung eines Rechtsverhaeltnisses (§ 256 ZPO).
- **Stufenklage**: Klage in Stufen (erst Auskunft, dann Eid, dann Zahlung — § 254 ZPO).
...
Welche Art von Entscheidung wollen Sie?

- **Geld**: Leistungsklage auf Zahlung.
- **Sache**: Leistungsklage auf Herausgabe.
- **Tun/Unterlassen**: Leistungsklage auf Tun oder Unterlassen.
- **Festellung**: Feststellungsklage (z. B. "festgestellt, dass Forderung nicht besteht").
- **Stufenklage**: Auskunft + spaetere Bezifferung (bei nicht-bekannter Anspruchshoehe).

### Schritt 2 — Zahlungsantrag formulieren
...
### Schritt 4 — Unterlassungs-Antrag
...
### Schritt 6 — Hilfsantraege

Wenn Sie Hauptantrag und Hilfsantrag stellen wollen ("falls Hauptantrag nicht durchgeht, dann ...").
...
- "Der Beklagte soll mir geben, was mir zusteht." → Unbestimmter Antrag, unzulaessig.
- "Der Beklagte wird verurteilt, an mich Schadensersatz zu zahlen." → Betrag fehlt.
...
Im Zivilprozess muss jede streitige Tatsache durch ein Beweismittel belegt werden. In der Klageschrift benennen Sie zu jeder erheblichen Tatsache **das Beweismittel**. Diese Skill zeigt die fuenf Beweismittel-Typen der ZPO und wie Sie sie sauber formulieren.

## Wann brauchen Sie diese Skill?

- Sie verfassen Ihre Klage und wollen Beweise korrekt benennen.
- Sie sind unsicher, welche Form ein Beweisantrag hat.
- Sie wollen Praeklusion vermeiden.
...
Welcher Beweis ist am ueberzeugendsten?

- Schriftliches Dokument → Urkunde (Anlage Knr).
- Mensch hat das gesehen / gehoert → Zeuge.
- Sache muss begutachtet werden → Augenschein.
- Sachliche Fachfrage → Sachverstaendiger.
- Sonst keine → Parteivernehmung (selten, schwach).

### Schritt 2 — Urkundenbeweis
...
- **Beweisthema** ergibt sich aus dem Kontext der Tatsache — kann aber auch explizit gestellt werden.

Beispiel mit Beweisthema:
...
### Schritt 4 — Sachverstaendigenbeweis
...
- Bei kleinen Objekten: ins Gericht mitbringen.

Skill `augenscheinsbeweis-371-zpo`.

### Schritt 6 — Parteivernehmung
...
- Setzt Antrag voraus oder Gericht ordnet von Amts wegen an.

Skill `parteivernehmung-445-ff-zpo`.
