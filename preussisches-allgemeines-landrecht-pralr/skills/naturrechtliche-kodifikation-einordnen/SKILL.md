---
name: naturrechtliche-kodifikation-einordnen
description: "Untersucht Naturrecht und Aufklärung im PrALR anhand einer konkreten Regel. Stellt Rationalisierung und ständische Begrenzungen quellengebunden gegenüber."
---

# Naturrechtliche Kodifikation einordnen

## 1. Zweck und Anwendungsfall

Untersucht Naturrecht und Aufklärung im PrALR anhand einer konkreten Regel. Stellt Rationalisierung und ständische Begrenzungen quellengebunden gegenüber.

## 2. Eingaben

Norm oder Entwurf, historische Aussage, Untersuchungsmaßstab und zeitgenössische Begründung. Vorhandenes Material zuerst lesen. Nur eine entscheidende Lücke gebündelt nachfragen; ungesicherte Angaben sichtbar offenlassen.

## 3. Ablauf

### 3.1. Fachprüfung

Normzweck, Redaktionsprogramm und soziale Reichweite trennen. Keine lineare Fortschrittserzählung aus einzelnen Schutzvorschriften ableiten. Begriffe wie Freiheit und Gleichheit am damaligen Normzusammenhang erläutern.
...
- Bei Fragen zu „Naturrecht und Aufklärung“: [Fachmaterial](references/naturrecht-und-aufklaerung.md).
- Bei Fragen zu „Naturrecht und Aufklärung“: [ergänzende Fassung 2](references/pralr-008-naturrecht-und-aufklaerung.md).
...
Eine allgemeine Personenregel wird neben den tatsächlich vorgesehenen Statusausnahmen ausgewertet.
