---
name: historischen-vertragsschluss-pruefen
description: "Prüft Zustandekommen, Bindung und Form eines Vertrags im PrALR. Trennt Formwirksamkeit, Beweisfunktion und besondere Vertragstypen."
---

# Historischen Vertragsschluss und Form prüfen

## 1. Zweck und Anwendungsfall

Prüft Zustandekommen, Bindung und Form eines Vertrags im PrALR. Trennt Formwirksamkeit, Beweisfunktion und besondere Vertragstypen.

## 2. Eingaben

Angebot, Annahme, Parteien, Wert, Urkunde, Vertragstyp und Abschlussdatum. Vorhandenes Material zuerst lesen. Nur eine entscheidende Lücke gebündelt nachfragen; ungesicherte Angaben sichtbar offenlassen.

## 3. Ablauf

### 3.1. Fachprüfung

Erklärung nach Teil 1 Titel 4 und Vertrag nach Titel 5 auseinanderhalten. Wertgrenze und Sonderform aus der damaligen Norm bestimmen. Eine heutige notarielle Form oder römische Erwerbsform nicht unterstellen. Leistungsstörung erst nach gesicherter Bindung behandeln.
...
- Bei Fragen zu „Vertrag und Form“: [Fachmaterial](references/pralr-015-schuldrecht-vertrag-und-form.md).
- Bei Fragen zu „Vertrag und Form“: [ergänzende Fassung 2](references/schuldrecht-vertrag-deliktsrecht.md).
- Bei Fragen zu „Erster Teil Titel 5 Verträge allgemein Form und Auslegung“: [Fachmaterial](references/pralr-neu-008-erster-teil-titel-5-vertraege-allgemein-form.md).
- Bei Fragen zu „Vertragsschluss Konsens Und Form“: [Fachmaterial](references/vertragsschluss-konsens-und-form.md).
...
Bei mündlicher Vereinbarung eines wertvollen Gegenstands Formregel und Beweisbarkeit getrennt feststellen.
