---
name: historische-strafen-und-vollzug-untersuchen
description: "Untersucht Strafarten, Strafzwecke und Vollzug im PrALR-Zeitraum. Trennt gesetzliche Androhung, gerichtliche Verhängung und tatsächliche Vollzugspraxis."
---

# Historische Strafen und Vollzug untersuchen

## 1. Zweck und Anwendungsfall

Untersucht Strafarten, Strafzwecke und Vollzug im PrALR-Zeitraum. Trennt gesetzliche Androhung, gerichtliche Verhängung und tatsächliche Vollzugspraxis.

## 2. Eingaben

Norm, Urteil, Vollzugsakte, Stand der betroffenen Person, Ort und Zeitraum. Vorhandenes Material zuerst lesen. Nur eine entscheidende Lücke gebündelt nachfragen; ungesicherte Angaben sichtbar offenlassen.

## 3. Ablauf

### 3.1. Fachprüfung

Strafandrohung aus dem Gesetz, konkrete Strafe aus dem Urteil und Vollzug aus eigenen Quellen belegen. Abschaffung von Folter, Schand- oder Todesstrafen nicht ohne den jeweiligen Rechtsakt datieren. Keine heutige Strafzumessung aus historischen Zwecken ableiten.
...
- Bei Fragen zu „Strafvollzug“: [Fachmaterial](references/pralr-025-strafvollzug-und-strafzwecke.md).
- Bei Fragen zu „Strafvollzug“: [ergänzende Fassung 2](references/strafvollzug-und-strafzwecke.md).
...
Eine Festungshaft wird nicht allein anhand ihres Namens mit Gefängnisvollzug gleichgesetzt.
