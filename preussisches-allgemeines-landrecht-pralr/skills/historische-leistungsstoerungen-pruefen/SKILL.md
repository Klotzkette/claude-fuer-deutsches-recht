---
name: historische-leistungsstoerungen-pruefen
description: "Prüft Nichterfüllung, Verzögerung und Unmöglichkeit im PrALR. Ordnet Leistungsbefreiung, Gegenleistung und Schaden dem konkreten Vertrag zu."
---

# Historische Leistungsstörungen prüfen

## 1. Zweck und Anwendungsfall

Prüft Nichterfüllung, Verzögerung und Unmöglichkeit im PrALR. Ordnet Leistungsbefreiung, Gegenleistung und Schaden dem konkreten Vertrag zu.

## 2. Eingaben

Leistungspflicht, Fälligkeit, Mahnung, Hindernis, Verschulden, Gefahrtragung und Zeitstand. Vorhandenes Material zuerst lesen. Nur eine entscheidende Lücke gebündelt nachfragen; ungesicherte Angaben sichtbar offenlassen.

## 3. Ablauf

### 3.1. Fachprüfung

Anfängliches Hindernis, späteren Untergang und Verzögerung auseinanderhalten. Rechtsfolge nicht aus lateinischen Schlagwörtern ableiten. Spezialregel des Vertragstyps vor allgemeiner Regel prüfen und jede Frist gesondert belegen.
...
- Bei Fragen zu „Leistungsstoerungen Unmoeglichkeit Verzug“: [Fachmaterial](references/leistungsstoerungen-unmoeglichkeit.md).
...
Beim Verlust verkaufter Ware getrennt prüfen, wer leisten, zahlen oder Schaden ersetzen muss.
