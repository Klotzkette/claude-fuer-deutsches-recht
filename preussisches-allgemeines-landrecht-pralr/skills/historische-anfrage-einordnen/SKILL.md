---
name: historische-anfrage-einordnen
description: "Ordnet einen neuen PrALR-Auftrag nach Quelle, historischer Frage und gewünschtem Ergebnis ein. Führt ohne zusätzlichen Auswahlkatalog zum passenden Fachthema."
---

# Historische Anfrage einordnen

## 1. Zweck und Anwendungsfall

Ordnet einen neuen PrALR-Auftrag nach Quelle, historischer Frage und gewünschtem Ergebnis ein. Führt ohne zusätzlichen Auswahlkatalog zum passenden Fachthema.
...
- Bei Fragen zu „Routing in andere Plugins“: [Fachmaterial](references/anderen-plugins-normnavigator-jede.md).
- Bei Fragen zu „Routing in andere Plugins“: [ergänzende Fassung 2](references/pralr-050-pralr-in-anderen-plugins-routen.md).
- Bei Fragen zu „Kaltstart: Textzeuge und Ziel“: [Fachmaterial](references/kaltstart-textzeuge-und-ziel.md).
- Bei Fragen zu „Kaltstart: Textzeuge und Ziel“: [ergänzende Fassung 2](references/pralr-001-kaltstart-textzeuge-und-ziel.md).
...
Bei einem unbeschrifteten Scan zunächst Ausgabe und Textstelle bestimmen, nicht automatisch ein heutiges Anspruchsgutachten beginnen.
