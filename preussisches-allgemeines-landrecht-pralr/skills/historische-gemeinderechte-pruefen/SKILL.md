---
name: historische-gemeinderechte-pruefen
description: "Untersucht städtische und dörfliche Rechte im PrALR-Kontext. Trennt Bürgerrecht, Gemeindevermögen, Gutsbezirk und spätere Kommunalreformen."
---

# Historische Gemeinderechte prüfen

## 1. Zweck und Anwendungsfall

Untersucht städtische und dörfliche Rechte im PrALR-Kontext. Trennt Bürgerrecht, Gemeindevermögen, Gutsbezirk und spätere Kommunalreformen.

## 2. Eingaben

Gemeindeart, Ort, Bürgerstatus, Statut, Gemeindevermögen und Reformzeitpunkt. Vorhandenes Material zuerst lesen. Nur eine entscheidende Lücke gebündelt nachfragen; ungesicherte Angaben sichtbar offenlassen.

## 3. Ablauf

### 3.1. Fachprüfung

Städtisches Bürgerrecht nicht mit heutiger Staatsangehörigkeit gleichsetzen. Gemeindliche Körperschaft, bäuerliche Nutzungsgemeinschaft und gutsherrliche Befugnisse unterscheiden. Die Anwendbarkeit einer Städte- oder Gemeinheitsteilungsordnung gesondert nachweisen.
...
- Bei Fragen zu „Gemeinderecht“: [Fachmaterial](references/gemeinderecht-und-kommunale-ordnung.md).
- Bei Fragen zu „Gemeinderecht“: [ergänzende Fassung 2](references/pralr-022-gemeinderecht-und-kommunale-ordnung.md).
...
Bei einer Allmendteilung zunächst Beteiligungsrechte und geltende Teilungsordnung feststellen, bevor eine Entschädigung berechnet wird.
