...
- Untersuchungsprinzip (oder modifiziert Beibringungsprinzip).
- Inquisitionscharakter im Strafprozess.
...
- Quellenmatrix.
- Synopse-Tabelle.
- Memo zur europaeischen Abolitionsgeschichte.
