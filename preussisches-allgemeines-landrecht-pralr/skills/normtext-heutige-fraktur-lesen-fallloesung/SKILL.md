...
description: "Normtext Heutige Fraktur Lesen Fallloesung: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Normtext Heutige Fraktur Lesen Fallloesung

## Arbeitsbereich

Dieser Skill bündelt 5 sachlich verwandte Arbeitsschritte rund um **Normtext Heutige Fraktur Lesen Fallloesung** im Plugin Preußisches Allgemeines Landrecht (PrALR). Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Preußisches Allgemeines Landrecht (PrALR) gilt für **Normtext Heutige Fraktur Lesen Fallloesung**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
**Fokus:** PrALR: historische Normtexte verständlich, knapp und ohne Sinnverschiebung in heutiges Deutsch übertragen.

# In heutige Sprache übertragen

## Aufgabe

Übersetze behutsam; archaische Begriffe nicht glätten, sondern bei Bedarf in Klammern erklären.
...
## 2. `pralr-034-fraktur-lesen-und-begriffe-entschluesseln`

**Fokus:** PrALR: Frakturbegriffe, alte Orthographie, lange s, Genugthuung, Versehen und historische Terminologie erklären.

# Begriffe entschlüsseln

## Aufgabe

Erstelle ein Mini-Glossar mit Originalform, heutiger Lesung, Bedeutung, Unsicherheit.
...
## 3. `pralr-035-fallloesung-historischer-sachverhalt`

**Fokus:** PrALR: historische Fälle nach Ort, Jahr, Stand, Rechtsquelle, Anspruch, Einwendung und Vollzug lösen.
...
## 4. `pralr-036-quellenmatrix-erstellen`

**Fokus:** PrALR: Quellenmatrix aus Digitalisat, Edition, OCR, Sekundärhinweis und heutiger Anschlussnorm erstellen.

# Quellenmatrix

## Aufgabe

Ausgabe als Tabelle: Quelle, Jahr, Band, Fundstelle, Lesart, Sicherheit, nächster Prüfschritt.
...
## 5. `pralr-037-aktenvermerk-fuer-gericht-oder-gutachten`

**Fokus:** PrALR: Aktenvermerk, Gutachtenbaustein oder Schriftsatzpassage zu PrALR-Fortwirkung erstellen.

# Aktenvermerk

## Aufgabe

Schreibe kurz, belegbar, mit Geltungsprüfung zuerst und ohne historische Folklore.
