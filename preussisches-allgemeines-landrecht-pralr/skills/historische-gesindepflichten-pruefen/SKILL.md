---
name: historische-gesindepflichten-pruefen
description: "Untersucht Dienstpflichten, Vertragsbeendigung und Misshandlung im historischen Gesinderecht. Behandelt Unterordnung und Gewalt kritisch, ohne sie zu normalisieren."
---

# Historische Gesindepflichten und Misshandlung prüfen

## 1. Zweck und Anwendungsfall

Untersucht Dienstpflichten, Vertragsbeendigung und Misshandlung im historischen Gesinderecht. Behandelt Unterordnung und Gewalt kritisch, ohne sie zu normalisieren.

## 2. Eingaben

Dienstvertrag, Status, beanstandetes Verhalten, Verletzungen, Ort, Zeit und erreichbarer Rechtsweg. Vorhandenes Material zuerst lesen. Nur eine entscheidende Lücke gebündelt nachfragen; ungesicherte Angaben sichtbar offenlassen.

## 3. Ablauf

### 3.1. Fachprüfung

Geschuldete Dienste von behaupteter Disziplinargewalt trennen. Eine historische Befugnis oder Schutzgrenze nur mit konkreter Norm belegen. Vertragliche Entlassung, Entschädigung und strafrechtliche Reaktion sind gesonderte Fragen; spätere Gesindeordnungen nicht rückprojizieren.
...
- Bei Fragen zu „Gesinderecht Dienstvertraege Zuechtigung“: [Fachmaterial](references/gesinderecht-dienstvertraege.md).
...
Bei Misshandlung einer Dienstperson getrennt prüfen, ob Entlassung, Lohnanspruch und gerichtlicher Schutz nach dem damaligen Recht möglich waren.
