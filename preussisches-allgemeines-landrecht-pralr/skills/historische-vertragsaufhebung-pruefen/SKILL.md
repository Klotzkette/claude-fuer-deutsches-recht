---
name: historische-vertragsaufhebung-pruefen
description: "Prüft Aufhebung, Rücktritt und Wandlung im PrALR. Trennt Beendigungsgrund, Erklärung und Rückabwicklung sowie vertragliche und gesetzliche Rechte."
---

# Historische Vertragsaufhebung prüfen

## 1. Zweck und Anwendungsfall

Prüft Aufhebung, Rücktritt und Wandlung im PrALR. Trennt Beendigungsgrund, Erklärung und Rückabwicklung sowie vertragliche und gesetzliche Rechte.

## 2. Eingaben

Vertrag, Aufhebungsvereinbarung oder Störung, Erklärung, erbrachte Leistungen, Fristdaten und Fassung. Vorhandenes Material zuerst lesen. Nur eine entscheidende Lücke gebündelt nachfragen; ungesicherte Angaben sichtbar offenlassen.

## 3. Ablauf

### 3.1. Fachprüfung

Aufhebungsgrund konkret belegen. Mangelbedingte Wandlung nicht mit jeder Vertragslösung gleichsetzen. Rückgabe, Nutzungen, Schaden und mögliche Gegenansprüche gesondert prüfen; moderne Rücktrittsregeln nicht rückwirkend verwenden.
...
- Bei Fragen zu „Vertragsaufhebung Ruecktritt Wandlung“: [Fachmaterial](references/vertragsaufhebung-ruecktritt.md).
...
Nach einem mangelhaften Kauf werden Berechtigung zur Vertragslösung und Folgen bereits erbrachter Leistungen getrennt behandelt.
