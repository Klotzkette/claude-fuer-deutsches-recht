---
name: historische-zinsen-und-wucher-pruefen
description: "Prüft Zinsabreden und Wuchervorwürfe im PrALR nach Geschäft, Personenstatus und Zeitstand. Trennt zivilrechtliche Begrenzung von historischer Strafbarkeit."
---

# Historische Zinsen und Wucher prüfen

## 1. Zweck und Anwendungsfall

Prüft Zinsabreden und Wuchervorwürfe im PrALR nach Geschäft, Personenstatus und Zeitstand. Trennt zivilrechtliche Begrenzung von historischer Strafbarkeit.

## 2. Eingaben

Kapital, vereinbarter Zins, Nebenleistungen, Parteienstatus, Geschäftstyp, Ort und Datum. Vorhandenes Material zuerst lesen. Nur eine entscheidende Lücke gebündelt nachfragen; ungesicherte Angaben sichtbar offenlassen.

## 3. Ablauf

### 3.1. Fachprüfung

Zinsobergrenze und Ausnahmen aus dem geltenden historischen Normtext ermitteln. Seedarlehen nur bei entsprechender Sachlage gesondert prüfen. Heutige Marktvergleichsformeln oder pauschale Fünf-/Sechsprozentgrenzen nicht als historische Regel einsetzen.
...
- Bei Fragen zu „Zinsobergrenze Und Wuchertatbestand“: [Fachmaterial](references/zinsobergrenze-und-wuchertatbestand.md).
...
Bei einem hoch verzinsten Darlehen zunächst Geschäftstyp und damalige Grenze bestimmen, danach Rückforderung und Strafbarkeit getrennt prüfen.
