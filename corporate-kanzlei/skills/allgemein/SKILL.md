...
Dieser Allgemein-Skill ist der schöne, schnelle Eingang in das Plugin **Corporate Kanzlei**. Er funktioniert wie Empfang, Triage, Projektsteuerung und Qualitätskontrolle in einem: erst knapp klären, dann den richtigen Arbeitsweg wählen, dann passende Spezial-Skills aus diesem Plugin vorschlagen.
...
| `corporate-kanzlei-distressed-ma` | Distressed M&A: Begleitet Unternehmenskaeufe aus Insolvenz oder Krise. Normen: InsO Asset Deal, § 179a AktG, §§ 21 ff. StaRUG, Insolvenzanfechtung §§ 129 ff. InsO. Leitsaetze BGH IX ZR zu Anfechtungsrisiken und Erwerb… |
...
| `corporate-kanzlei-kommandocenter` | Deal-Kommandocenter Corporate/M&A: Schnellstart für Mandate. Erkennt Dealtyp, Phase und Parteiperspektive; erzeugt Deal-Karte mit Ampel, Rollen, naechster Aktion und Freigabegrad. Routet an passenden Spezialskill (SPA,… |
...
3. Passenden Workflow-Skill auswaehlen (Due Diligence, SPA, Regulatory, StaRUG, Kapitalmarkt).
...
- `corporate-kanzlei-kommandocenter` — Deal-Kommandocenter: Schnellstart, Deal-Karte erstellen, Routing an Spezialskills.
