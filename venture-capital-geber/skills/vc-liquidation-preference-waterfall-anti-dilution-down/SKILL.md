---
name: vc-liquidation-preference-waterfall-anti-dilution-down
description: "VC Liquidation Preference Waterfall Anti Dilution Down: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# VC Liquidation Preference Waterfall Anti Dilution Down

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **VC Liquidation Preference Waterfall Anti Dilution Down** im Plugin Venture Capital (Geberseite). Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `vc-028-information-rights-reporting` | Baut Informationsrechte, Reporting-Kalender, KPI-Pack, Budget-Updates, consent requests und Sanktionen bei Ausbleiben. |
| `vc-029-protective-provisions-veto` | Prüft Zustimmungsvorbehalte, Reserved Matters, Budget, Hiring, M&A, Debt, IP, Related-Party und Deadlock. |

## Arbeitsweg

Im Plugin Venture Capital (Geberseite) gilt für **VC Liquidation Preference Waterfall Anti Dilution Down**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Rechnet non-participating, participating, multiple, cap und Erlösverteilung über mehrere Runden.

## Arbeitsfokus

Exit-Erlöse realistisch verteilen statt Quote schönreden.
...
Prüft weighted average, full ratchet, pay-to-play, Down-Round-Folgen und Fairness.
...
Baut Informationsrechte, Reporting-Kalender, KPI-Pack, Budget-Updates, consent requests und Sanktionen bei Ausbleiben.

## Arbeitsfokus

Portfolio-Tracking vertraglich absichern.
...
Prüft Zustimmungsvorbehalte, Reserved Matters, Budget, Hiring, M&A, Debt, IP, Related-Party und Deadlock.

## Arbeitsfokus

Kontrolle ohne faktische Geschäftsführung.
