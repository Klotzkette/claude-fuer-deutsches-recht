---
name: vc-series-b-growth-bridge-round-inside-follow-on-reserve-pro
description: "VC Series B Growth Bridge Round Inside Follow ON Reserve PRO: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# VC Series B Growth Bridge Round Inside Follow ON Reserve PRO

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **VC Series B Growth Bridge Round Inside Follow ON Reserve PRO** im Plugin Venture Capital (Geberseite). Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Venture Capital (Geberseite) gilt für **VC Series B Growth Bridge Round Inside Follow ON Reserve PRO**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Prüft größere Runden, Internationalisierung, Venture Debt, Governance, CFIUS/FDI, M&A-Readiness und Secondary-Anteile.

## Arbeitsfokus

Vom Startup-Investment zum institutionellen Growth Deal.
...
Prüft Brückenfinanzierung, Insider-Runde, Runway, Milestones, Downside-Schutz und Fairness gegenüber Altinvestoren.
...
Plant Reserven, pro rata, super pro rata, ownership targets, signal risk und Opportunitätskosten.

## Arbeitsfokus

Nicht im ersten Ticket gewinnen und im Follow-on verlieren.
...
Prüft Bezugsrechte, vertragliche pro-rata-Rechte, super-pro-rata-Spielräume und Informationsrechte.

## Arbeitsfokus

Ownership verteidigen, ohne unzulässig zu blockieren.
