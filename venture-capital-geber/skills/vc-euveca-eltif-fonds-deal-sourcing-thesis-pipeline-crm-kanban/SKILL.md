---
name: vc-euveca-eltif-fonds-deal-sourcing-thesis-pipeline-crm-kanban
description: "VC Euveca Eltif Fonds Deal Sourcing Thesis Pipeline CRM Kanban: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# VC Euveca Eltif Fonds Deal Sourcing Thesis Pipeline CRM Kanban

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **VC Euveca Eltif Fonds Deal Sourcing Thesis Pipeline CRM Kanban** im Plugin Venture Capital (Geberseite). Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Venture Capital (Geberseite) gilt für **VC Euveca Eltif Fonds Deal Sourcing Thesis Pipeline CRM Kanban**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Ordnet EuVECA- und ELTIF-Optionen als regulierte VC-/Private-Markets-Hüllen ein und grenzt sie von Direkt- und SPV-Investments ab.
...
Hilft, Branchenfokus, Dealquellen, Gründerprofile, Warm Intros, Events, Scouts und Ausschlusskriterien zu bauen.

## Arbeitsfokus

Aus Zufallsdeals eine These machen.
...
Baut ein VC-Tracking-System mit Status, Fristen, Reminder, Verantwortlichen, Investor-Updates und Follow-on-Signalen.

## Arbeitsfokus

Ablenkung und Vergessen durch strukturierte Wiedervorlagen vermeiden.
...
Liest Founder Updates, extrahiert KPIs, Zusagen, Risiken, offene Requests, Stimmungen und nächste Investorhandlung.

## Arbeitsfokus

Jedes Update in Recap, Aufgaben und Warnsignale übersetzen.
