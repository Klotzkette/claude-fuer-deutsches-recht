...
description: "Modulhandbuch Bindung Modulpruefung: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Modulhandbuch Bindung Modulpruefung

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **Modulhandbuch Bindung Modulpruefung** im Plugin Pruefungsrecht Hochschule. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.

## Prüffelder

| Prüffeld | Fokus |
| --- | --- |
| `modulhandbuch-bindung` | Prüft Modulhandbuch, Prüfungsordnung, Lernziele, Prüfungsform und Vertrauensschutz. |
| `modulpruefung-und-teilleistungen` | Prüft Modulprüfung und Teilleistungen. |
| `muendliche-atmosphaere-druck` | Prüft unsachliche Atmosphäre, Unterbrechungen, Voreingenommenheit und Protokollbeweis. |
| `muendliche-pruefung-protokoll` | Prüft mündliche Prüfungen und Protokolle. |

## Arbeitsweg

Im Plugin Pruefungsrecht Hochschule gilt für **Modulhandbuch Bindung Modulpruefung**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `modulhandbuch-bindung`

**Fokus:** Prüft Modulhandbuch, Prüfungsordnung, Lernziele, Prüfungsform und Vertrauensschutz.
...
- **Konkreter Auftrag:** Prüft Modulhandbuch, Prüfungsordnung, Lernziele, Prüfungsform und Vertrauensschutz.
- **Erste Trennlinie:** Ist das Problem wirklich Modulhandbuch und Bindungswirkung, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
...
## 2. `modulpruefung-und-teilleistungen`

**Fokus:** Prüft Modulprüfung und Teilleistungen.
...
- **Konkreter Auftrag:** Prüft Modulprüfung und Teilleistungen.
- **Erste Trennlinie:** Ist das Problem wirklich Modulpruefung Und Teilleistungen, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
- **Quellenarbeit:** Suche die aktuelle Landesnorm, Ordnung oder Satzung im Original und notiere Fundstelle, Fassung, Bekanntgabeweg und Geltungszeitpunkt.
- **Aktenarbeit:** Markiere, welches Dokument die entscheidende Tatsache trägt; bloße Schilderungen bekommen eine eigene Unsicherheitsnote.
- **Produkt:** Liefere am Ende nicht nur ein Ergebnis, sondern eine Handlung: Gesprächsfahrplan, Akteneinsicht, Antrag, Widerspruch/Remonstration, Eilrechtsschutz oder interne Entscheidungsvorlage.
...
Erzeuge bevorzugt: Modulmatrix. Am Ende immer drei Zeilen: **Frist**, **fehlende Quelle**, **nächster sicherer Schritt**.

## 3. `muendliche-atmosphaere-druck`

**Fokus:** Prüft unsachliche Atmosphäre, Unterbrechungen, Voreingenommenheit und Protokollbeweis.
...
- **Konkreter Auftrag:** Prüft unsachliche Atmosphäre, Unterbrechungen, Voreingenommenheit und Protokollbeweis.
- **Erste Trennlinie:** Ist das Problem wirklich Mündliche Atmosphäre und Druck, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
- **Quellenarbeit:** Suche die aktuelle Landesnorm, Ordnung oder Satzung im Original und notiere Fundstelle, Fassung, Bekanntgabeweg und Geltungszeitpunkt.
- **Aktenarbeit:** Markiere, welches Dokument die entscheidende Tatsache trägt; bloße Schilderungen bekommen eine eigene Unsicherheitsnote.
- **Produkt:** Liefere am Ende nicht nur ein Ergebnis, sondern eine Handlung: Gesprächsfahrplan, Akteneinsicht, Antrag, Widerspruch/Remonstration, Eilrechtsschutz oder interne Entscheidungsvorlage.
...
## 4. `muendliche-pruefung-protokoll`

**Fokus:** Prüft mündliche Prüfungen und Protokolle.
...
- **Konkreter Auftrag:** Prüft mündliche Prüfungen und Protokolle.
- **Erste Trennlinie:** Ist das Problem wirklich Mündliche Pruefung Protokoll, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
- **Quellenarbeit:** Suche die aktuelle Landesnorm, Ordnung oder Satzung im Original und notiere Fundstelle, Fassung, Bekanntgabeweg und Geltungszeitpunkt.
- **Aktenarbeit:** Markiere, welches Dokument die entscheidende Tatsache trägt; bloße Schilderungen bekommen eine eigene Unsicherheitsnote.
- **Produkt:** Liefere am Ende nicht nur ein Ergebnis, sondern eine Handlung: Gesprächsfahrplan, Akteneinsicht, Antrag, Widerspruch/Remonstration, Eilrechtsschutz oder interne Entscheidungsvorlage.
...
- Primäre Anker: Prüfungsordnung; Verfahrensrecht.
- Landesrecht, aktuelle Satzungen und Prüfungsordnungen immer live aus amtlichen Portalen oder Originaldokumenten prüfen.
- Rechtsprechung nur mit Gericht, Entscheidungsdatum, Aktenzeichen und frei überprüfbarer Quelle nennen.
...
Erzeuge bevorzugt: Mündlichkeitsvermerk. Am Ende immer drei Zeilen: **Frist**, **fehlende Quelle**, **nächster sicherer Schritt**.
