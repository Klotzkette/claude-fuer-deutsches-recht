...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Insolvenzforderungsanmeldung** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (Anmeldefrist im Eröffnungsbeschluss)

- **Symptom:** Frist falsch berechnet oder übersehen (Anmeldefrist im Eröffnungsbeschluss)
...
### 2. Parallelfrist vergessen (Prüfungstermin)

- **Symptom:** Parallelfrist vergessen (Prüfungstermin)
...
### 3. Falsche Zuständigkeit adressiert (richtig: Insolvenzgericht)

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: Insolvenzgericht)
...
### 4. Beweismittel nicht gesichert (Vertrag)

- **Symptom:** Beweismittel nicht gesichert (Vertrag)
...
### 5. Schlüsseldokument fehlt oder veraltet (Eröffnungsbeschluss)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Eröffnungsbeschluss)
...
### 6. Normzitat ohne Fassungsprüfung (§§ 174 ff. InsO)

- **Symptom:** Normzitat ohne Fassungsprüfung (§§ 174 ff. InsO)
