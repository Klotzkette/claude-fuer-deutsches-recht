...
description: "Für Entscheidungsgründe Fehlerkatalog: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Urteilsbauer/Relationsmacher** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (Verkündung)

- **Symptom:** Frist falsch berechnet oder übersehen (Verkündung)
...
### 2. Parallelfrist vergessen (Absetzungsfrist)

- **Symptom:** Parallelfrist vergessen (Absetzungsfrist)
...
### 4. Beweismittel nicht gesichert (Beweisaufnahme-Ergebnis)

- **Symptom:** Beweismittel nicht gesichert (Beweisaufnahme-Ergebnis)
...
### 5. Schlüsseldokument fehlt oder veraltet (Klage)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Klage)
...
### 6. Normzitat ohne Fassungsprüfung (ZPO § 313 Urteilsaufbau)

- **Symptom:** Normzitat ohne Fassungsprüfung (ZPO § 313 Urteilsaufbau)
