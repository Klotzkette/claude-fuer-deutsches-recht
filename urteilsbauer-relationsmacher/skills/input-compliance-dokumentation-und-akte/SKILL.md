...
description: "Für Compliance-Dokumentation und Akte (Urteilsbauer-Eingang): ordnet Akte, Belege und Lücken; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
- Bei `spezial-input-compliance-dokumentation-und-akte` beziehungsweise Input: Compliance-Dokumentation und Aktenvermerk: [die zusätzliche Vertiefung laden](./references/vertiefung-spezial-input-compliance-dokumentation-und-akte.md).
