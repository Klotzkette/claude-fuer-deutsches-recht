...
- Zwei oder mehr Akteure entscheiden gemeinsam über Zwecke und Mittel der Verarbeitung.
...
- Art. 26 Abs. 2 DSGVO: Wesentliche Aspekte der Vereinbarung müssen den Betroffenen zur Verfuegung gestellt werden.
- Art. 26 Abs. 3 DSGVO: Betroffene können unabhaengig von der Vereinbarung ihre Rechte gegenueber jedem Verantwortlichen geltend machen.
...
4. **Transparenz nach Art. 26 Abs. 2 DSGVO.**
 - "Wesentliche Aspekte" der Vereinbarung müssen den Betroffenen zugaenglich gemacht werden.
 - Praxis: Veroeffentlichung in der Datenschutzerklaerung oder als eigenes Dokument auf der Webseite.

5. **Innenregress.**
 - Trotz Gesamtschuld nach Art. 82 Abs. 4 DSGVO können die Parteien intern den Verschuldensanteil regeln.
...
> b) die Erfuellung der Informationspflichten gemäß Art. 13 und 14 DSGVO gegenueber den über Partei A erreichten Betroffenen;
> c) die Bearbeitung von Betroffenenanfragen nach Art. 15 bis 22 DSGVO, die über Partei A eingehen;
> d) die Erfuellung der Meldepflichten gemäß Art. 33 und 34 DSGVO im Hinblick auf Verarbeitungsteile, die Partei A allein steuert.
> (2) Partei B ist verantwortlich für
> a) die Erhebung und Erstuebermittlung der Daten an Partei A;
> b) die Erfuellung der Informationspflichten gemäß Art. 13 und 14 DSGVO gegenueber den über Partei B erreichten Betroffenen;
> c) die Bearbeitung von Betroffenenanfragen nach Art. 15 bis 22 DSGVO, die über Partei B eingehen;
> d) die Erfuellung der Meldepflichten gemäß Art. 33 und 34 DSGVO im Hinblick auf Verarbeitungsteile, die Partei B allein steuert.
> (3) Die Parteien fuehren gemeinsam durch:
> a) die Durchfuehrung einer etwaig erforderlichen DSFA gemäß Art. 35 DSGVO;
> b) die Festlegung der Loeschfristen;
> c) die Festlegung der technischen und organisatorischen Maßnahmen gemäß Art. 32 DSGVO.
>
> § 3 Anlaufstelle für Betroffene
> Anlaufstelle für Anfragen Betroffener ist Partei A. Partei A leitet Anfragen, die in den Verantwortungsbereich von Partei B fallen, unverzueglich an Partei B weiter. Art. 26 Abs. 3 DSGVO bleibt unberuehrt: Betroffene können ihre Rechte gegenueber jeder Partei geltend machen.
>
...
> Anlage 2: Kurzfassung zur Veroeffentlichung gemäß Art. 26 Abs. 2 DSGVO"
