...
| --- | --- | --- | --- |
| Fallkern | AVV im Konzern und in Multi-Party-Konstellationen | Datenschutz-Grundverordnung Artikel 5 | Sofortvermerk mit Ergebnisrichtung, Risiko und nächstem Schritt |
...
| Begründetheit | Datenschutz-Bußgeldverfahren — Verteidigung nach Art. 83 Datenschutz-Grundverordnung | Datenschutz-Grundverordnung Artikel 6 | Tatbestandsmatrix mit Beleg und Gegenargument |
...
10.3. Tatbestandsmerkmal: Arbeite zuerst den entscheidenden Fachpunkt aus, regelmäßig AVV im Konzern und in Multi-Party-Konstellationen.
...
### 16.1. AVV im Konzern und in Multi-Party-Konstellationen

Bearbeitungsauftrag: Es ist abzuklären, ob nicht stattdessen Konzern-BCR (Artikel 47 Datenschutz-Grundverordnung) oder eine Joint-Controller-Vereinbarung (Artikel 26 Datenschutz-Grundverordnung) erforderlich ist. Artikel 28 Datenschutz-Grundverordnung – auch im Konzern keine Privilegierung; jede juristische Person ist eigenständige Verantwortliche. Erwägungsgrund 36 Datenschutz-Grundverordnung – Niederlassung und Verantwortlichkeit im Konzern.
Prüfschritte: Konzernmutter und mehrere Töchter beziehen denselben Cloud-Dienst und sollen unter einem Vertragsschirm liegen; Konzernweite Shared-Service-Center (HR, IT, Payroll) verarbeiten Daten anderer Konzerngesellschaften; Ein Konsortium oder Joint Venture nimmt gemeinsam Dienstleistungen in Anspruch; Erwägungsgrund 48 Datenschutz-Grundverordnung – Berechtigtes Interesse an konzerninternem Datenaustausch für interne Verwaltungszwecke; Artikel 26 Datenschutz-Grundverordnung – Joint Controller, falls gemeinsame Zweckentscheidung.
Lieferstück: Fachvotum zu AVV im Konzern und in Multi-Party-Konstellationen mit Tatbestandsmerkmalen, Aktenfundstellen, Beweislast, stärkster Gegenposition, Risiko und ausformulierter Rechtsfolge.
...
### 16.5. Dsv Sammelklagen Prävention
