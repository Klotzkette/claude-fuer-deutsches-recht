...
description: "Für Verwr Fehlerkatalog: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Fachanwalt Verwaltungsrecht** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (§ 74 VwGO Klagefrist 1 Mon.)

- **Symptom:** Frist falsch berechnet oder übersehen (§ 74 VwGO Klagefrist 1 Mon.)
...
### 2. Parallelfrist vergessen (§ 80 V VwGO eA)

- **Symptom:** Parallelfrist vergessen (§ 80 V VwGO eA)
...
### 3. Falsche Zuständigkeit adressiert (richtig: VG, OVG/VGH, BVerwG)

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: VG, OVG/VGH, BVerwG)
...
### 4. Beweismittel nicht gesichert (Verwaltungsakte)

- **Symptom:** Beweismittel nicht gesichert (Verwaltungsakte)
...
### 5. Schlüsseldokument fehlt oder veraltet (Verwaltungsakt)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Verwaltungsakt)
...
### 6. Normzitat ohne Fassungsprüfung (VwGO)

- **Symptom:** Normzitat ohne Fassungsprüfung (VwGO)
