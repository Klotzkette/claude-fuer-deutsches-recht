...
1. **Rechtsform:** GmbH / UG (schriftliches Verfahren Paragraf 48 Abs. 2 GmbHG) oder AG (Umlaufbeschluss nur für AR Paragraf 108 Abs. 4 AktG und Vorstand)? Bei AG-HV: Praesenz-HV oder virtuelle HV (Paragraf 118a AktG) erforderlich.
2. **Einverstaendnis aller Gesellschafter?** Paragraf 48 Abs. 2 GmbHG setzt nach h.M. voraus, dass alle Gesellschafter dem schriftlichen Verfahren zustimmen (oder der Gesellschaftsvertrag das Verfahren explizit zulaesst). Ist das sichergestellt?
...
4. **Stimmverbot?** Ist ein Gesellschafter von der Abstimmung ausgeschlossen (Paragraf 47 Abs. 4 GmbHG)? Insbesondere bei Eigenbestellung zum Geschäftsführer (str.)
5. **Beurkundungspflicht?** Satzungsaenderung (Paragraf 53 GmbHG), Kapitalerhoehung, Abtretung von Anteilen (Paragraf 15 Abs. 3 GmbHG) — Notar erforderlich?
6. **Handelsregisteranmeldung?** Geschäftsführerwechsel (Paragraf 39 GmbHG), Satzungsaenderung, Kapitalerhoehung erforderlich?
...
3. **Prüf-Checkliste** (Präzision der Formulierung, Anlagen, Gesellschaftsvertrag, Paragraf 47 Abs. 4, Handelsregister).
