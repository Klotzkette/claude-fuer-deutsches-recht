...
description: "Für Tabellarisches Vertragsreview als Prompt-Matrix: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Tatbestands- oder Anspruchsmatrix."
---
...
## Erweiterte Spaltenprompts bei Bedarf

Öffne die [erweiterte Prompt-Bibliothek](references/erweiterte-prompt-und-ausgabevorlagen.md) nur für die im Datenraum tatsächlich betroffenen Spezialgebiete.
...
## Ausgabevorlage bei Bedarf

Verwende für die abschließende Lieferung die [tabellarische Ausgabevorlage](references/erweiterte-prompt-und-ausgabevorlagen.md#2-ausgabevorlage).
