...
description: "Für 765a Fehlerkatalog: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Zwangsvollstreckung** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (Erinnerung § 766 ZPO 2 Wochen)

- **Symptom:** Frist falsch berechnet oder übersehen (Erinnerung § 766 ZPO 2 Wochen)
...
### 2. Parallelfrist vergessen (PfÜB-Zustellung Drittschuldner)

- **Symptom:** Parallelfrist vergessen (PfÜB-Zustellung Drittschuldner)
...
### 3. Falsche Zuständigkeit adressiert (richtig: Vollstreckungsgericht)

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: Vollstreckungsgericht)
...
### 4. Beweismittel nicht gesichert (Titel mit Klausel)

- **Symptom:** Beweismittel nicht gesichert (Titel mit Klausel)
...
### 5. Schlüsseldokument fehlt oder veraltet (Vollstreckungstitel)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Vollstreckungstitel)
...
### 6. Normzitat ohne Fassungsprüfung (ZPO §§ 704-945 (Vollstreckung))

- **Symptom:** Normzitat ohne Fassungsprüfung (ZPO §§ 704-945 (Vollstreckung))
