...
description: >
  Erstes Einrichtungsgespräch: baut das persönliche Lernprofil auf.
  Läuft genau einmal (oder bei --redo). Lade diesen Skill wenn der Nutzer
  das Plugin zum ersten Mal startet, wenn CLAUDE.md noch Platzhalter enthält,
  oder wenn der Nutzer sagt „Neueinrichtung", „neues Profil" oder
...
> „Lernprofil angelegt. Du kannst jetzt alle Skills nutzen. Ich empfehle als nächsten Schritt: `/jurastudium:study-plan` für eine erste Lernplanung."
...
Plugin: Profil angelegt. Empfehle: /jurastudium:study-plan
```

## Risiken / typische Fehler

- **Profil nicht anlegen:** Alle anderen Skills liefern ohne Profil unkalibrierte Outputs. `cold-start-interview` immer zuerst.
...
- **Wenig Material hochladen:** Das Plugin arbeitet besser mit mehr Material. Alte JPA-Klausuren und benotete eigene Arbeiten sind besonders wertvoll für `exam-forecast` und `irac-practice`.
- **Lernstil nicht anpassen:** Drill-Modus ist intensiver und für Examensphase geeignet; Erklärungs-Modus für Grundstudium. Kann jederzeit per `/jurastudium:customize` geändert werden.
