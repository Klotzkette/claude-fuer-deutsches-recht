...
description: "Für Öffentliches Quellenkarte: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt. Fachgebiet: Jurastudium."
---
...
Diese Quellenkarte sichert für **Jurastudium (Klausur, AG, Examen)** jede tragende Aussage ab: Norm, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor Ausgabe verifiziert.

## Tragende Normen (live prüfen)

- **BGB, StGB, GG, ZPO/StPO/VwGO** — amtlichen Stand vor tragender Aussage prüfen
