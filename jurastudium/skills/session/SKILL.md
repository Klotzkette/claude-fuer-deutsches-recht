...
name: session
description: >
  Führt eine fokussierte Lerneinheit mit N Fragen zu einem Rechtsgebiet durch — Karteikarten,
  Klausurfragen im Gutachtenstil oder mündliche Abfrage. Verfolgt die Ergebnisse und aktualisiert
...
- `--karteikarten`: `flashcards`-Skill laden, N Karten im Drill-Modus, priorisiert nach früheren Fehlern + fälligen Karten
- `--klausurfrage`: `gutachtenstil-uebung`-Skill laden (irac-practice), N Kurzklausurfragen im Gutachtenstil generieren, Nutzer schreibt Lösung, Feedback pro Frage
- `--mündlich` (Standard): `socratic-drill`-Skill laden, N Fragen im sokratischen Frage-Antwort-Format, Pushback nach jeder Antwort
...
> „Auf Basis dieser Sitzung empfiehlt sich als nächster Schritt: [konkrete Empfehlung — z. B. ‚Definitionen § 275 BGB mit flashcards vertiefen' oder ‚gutachtenstil-uebung: Klausurfall zu § 286 BGB']."
