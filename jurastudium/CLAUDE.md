...
**Der Gutachtenstil ist die Pflichtform** für alle Klausuren, Fallbearbeitungen und Übungsarbeiten in diesem Plugin. Er unterscheidet sich grundlegend von der US-amerikanischen IRAC-Methode:

| Deutsches Schema | US-Schema (IRAC) |
|---|---|
| **Obersatz** – Rechtsfolge als Hypothese | Issue |
| **Definition** – abstrakte Tatbestandsmerkmale | Rule |
| **Subsumtion** – Anwendung auf den Sachverhalt | Application |
| **Ergebnis** – Bejahung oder Verneinung | Conclusion |

**IRAC ist die US-amerikanische Form** dieses Prüfungsschemas und hat im deutschen Jurastudium keine eigenständige Verwendung. Wenn ein Skill in diesem Plugin „Gutachtenstruktur" nennt, meint er immer: Obersatz – Definition – Subsumtion – Ergebnis.
...
- **Keine Stare-decisis-Logik.** Rechtsprechung ist nicht bindend (Ausnahme: § 31 BVerfGG für BVerfG-Entscheidungen). BGH-Urteile haben erhebliches Gewicht als st. Rspr., sind aber argumentativ angreifbar.
...
- Pre-Trial Discovery existiert nicht. Informationszugang erfolgt über §§ 142, 144 ZPO; § 810 BGB; §§ 242, 666, 259 BGB; Art. 15 DSGVO; Auskunfts- und Stufenklage (§ 254 ZPO).
