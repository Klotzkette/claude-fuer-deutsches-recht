...
Gleiche Quelle wie der [`docket-watcher`](../../litigation-legal/agents/docket-watcher.md)-Agent im litigation-legal-Claude-Code-Plugin – dieses Verzeichnis ist das Managed-Agent-Kochbuch für `POST /v1/agents`.
