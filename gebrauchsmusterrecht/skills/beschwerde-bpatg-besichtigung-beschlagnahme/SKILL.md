...
Im Plugin Gebrauchsmusterrecht gilt für **Beschwerde Bpatg Besichtigung Beschlagnahme**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
**Fokus:** Beschwerde zum Bundespatentgericht im Gebrauchsmusterrecht prüfen: Beschwerdegegenstand, Fristen, Begründung, neue Belege und Kostenrisiko.

# Beschwerde Bpatg

## Wann dieser Skill hilft

DPMA-Entscheidung soll überprüft werden.

## Arbeitsweise

Prüfe Zulässigkeit und Erfolgsaussichten mit sauberer Verfahrenschronologie.
...
## 2. `besichtigung-beschlagnahme-und-beweissicherung`

**Fokus:** Besichtigung, Beschlagnahme und technische Beweissicherung bei Gebrauchsmusterverletzung: Produktzugang, Musterkauf, technische Analyse, Sachverständige, Geheimnisschutz, Chain of Custody und Vorbereitung von Verletzung oder Verteidigung.
