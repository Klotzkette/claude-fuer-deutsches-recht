...
Wenn Sie auch beim LSG verloren haben, gibt es noch das Bundessozialgericht in Kassel. Aber hier gilt: Anwaltszwang und sehr enge Zulassungsschranke.

## In einfacher Sprache

Die dritte und letzte Instanz ist das Bundessozialgericht in Kassel. Hier brauchen Sie einen Anwalt. Es geht nur noch um wichtige Rechtsfragen, nicht um Tatsachen.

## Wann brauchen Sie diese Skill?

- LSG hat gegen Sie entschieden.
- Sie ueberlegen, zum BSG zu gehen.
...
- **§ 160 SGG** — Revision; Zulassungsgruende.
...
Revision ist ein hochspezialisiertes Verfahren. Die Erfolgschance ist statistisch eher gering. Lassen Sie sich vom Anwalt beraten, ob es lohnt.
...
- **Realistische Aussichten** ueberlegen.

## Typische Fehler

- Ohne Anwalt versuchen → unzulaessig
...
- Ein vom Gericht beauftragtes Gutachten ist gegen Sie ausgefallen.
- Sie sind sich sicher, dass das Gutachten falsch ist.
- Sie haben einen besseren Arzt vor Augen.
...
- Hauptgutachten klar fehlerhaft ist
- Sie eine konkrete Diagnose / Leistungs-Beurteilung anders sehen
- Sie einen ueberzeugenden Arzt kennen
- Es um viel Geld geht (EM-Rente lebenslang)

Vorsicht bei:

- Schwacher Aussicht in der Hauptsache
- Wenig Geld (1500 bis 4000 EUR sind viel)
- Aerzten ohne Erfahrung mit Sozialmedizin

### Schritt 2 — Gutachter suchen

- Empfehlung Ihres Haus- oder Facharztes
- Gerichtsmediziner / Sozialmediziner mit Erfahrung
...
- Vom geplanten Gutachter Kostenvoranschlag erbitten.
- Typisch 1.500 bis 4.000 EUR, je nach Umfang.

### Schritt 5 — Vorschuss leisten

Das Gericht setzt einen Vorschuss fest. Diesen ueberweisen Sie an die Gerichtskasse. Erst dann beauftragt das Gericht den Sachverstaendigen.

### Schritt 6 — Gutachten erhalten
...
1. Beim SG telefonisch melden.
2. Schriftliche Entschuldigung mit Beleg.
3. Antrag auf neuen Termin oder Wiedereinsetzung (wenn Urteil schon ergangen ist).
