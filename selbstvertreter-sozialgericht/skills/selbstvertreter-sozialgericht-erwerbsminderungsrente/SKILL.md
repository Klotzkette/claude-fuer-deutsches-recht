...
description: "Erwerbsminderungsrente: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
Dieser Skill bündelt 5 sachlich verwandte Arbeitsschritte rund um **Erwerbsminderungsrente** im Plugin Selbstvertretung vor dem Sozialgericht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Selbstvertretung vor dem Sozialgericht gilt für **Erwerbsminderungsrente**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
### Hausarztberichte
- Laufende Befunde.
- Diagnoseliste mit ICD-10.
- Medikation.

### Facharztberichte
- Orthopaedie Neurologie Psychiatrie Innere.
- Aktuelle Befunde.

### Klinikentlassungsberichte
- Stationaere Aufenthalte.
...
3. Diagnose-Cluster klar?
4. Leistungsbild aus Reha-Bericht?
5. Pflegegrad-Bezug?
...
Manchmal geht es nicht um Geld oder einen Bescheid, sondern um die Frage: Was gilt eigentlich? Bin ich versichert? Habe ich einen bestimmten Status? Die Feststellungsklage klaert solche Fragen.
...
- **§ 55 Abs. 1 SGG** — Feststellung des Bestehens / Nichtbestehens eines Rechtsverhaeltnisses.
...
- Anlage 2 VersMedV: GdB-Tabelle.
- Differenzierung nach Krankheitsbild.

## Typische GdB-Werte

- Diabetes ohne Komplikationen: GdB 20.
- Diabetes mit erheblicher Komplikation: GdB 50.
...
- Bildung des Gesamt-GdB durch Wechselwirkungen.
- Nicht: Addieren der Einzel-GdB.

## Merkzeichen

- G (gehbehindert): GdB-relevante Gehbehinderung.
- aG (aussergewoehnlich gehbehindert): hochgradig.
- B (Begleitung): mit Begleitung im Verkehr.
- H (hilflos): dauerhaft auf Hilfe angewiesen.
- Bl (blind).
- Gl (gehoerlos).
...
3. Mehrere Beeintraechtigungen?
4. Versorgungsmedizinverordnung-Tabelle verglichen?
5. Widerspruch noetig?
