...
description: "Krankenkassen Zahnersatz Ladung Termin: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
Dieser Skill bündelt 5 sachlich verwandte Arbeitsschritte rund um **Krankenkassen Zahnersatz Ladung Termin** im Plugin Selbstvertretung vor dem Sozialgericht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Selbstvertretung vor dem Sozialgericht gilt für **Krankenkassen Zahnersatz Ladung Termin**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
- Sie haben eine Ladung erhalten.
- Sie sind unsicher, was Sie tun sollen.
- Sie ueberlegen, nicht hinzugehen.

## Fachbegriffe (kurz erklaert)

- **Ladung**: Aufforderung des Gerichts, zu einem Termin zu erscheinen.
- **Muendliche Verhandlung**: Termin im Gerichtssaal.
- **Saeumnis**: Wenn Sie nicht erscheinen.
- **Anwesenheitspflicht**: nur bei ausdruecklicher Anordnung; sonst freiwillig.
...
- Ladung selbst
- Personalausweis
- Akten-Mappe mit Bescheid, Widerspruchsbescheid, eigenem Schriftverkehr
- Atteste, Gutachten
- Liste der Aerzte
...
- Beistand (Vertrauensperson, mit Erlaubnis)
...
- Beleg (AU-Bescheinigung) beilegen

### Schritt 6 — Bei Schwierigkeiten

- Schwer mobil: Anfrage nach Video-Verhandlung § 110a SGG
- Sprachprobleme: Dolmetscher anfordern (siehe `dolmetscher-beim-sozialgericht-laien`)
...
- **Notizen mitnehmen**: was Sie sagen wollen, was Sie fragen wollen.
...
- Sie streiten um Pflegegrad, EM-Rente, GdB.
- Sie wurden zu einer aerztlichen Untersuchung geladen.
- Sie haben ein Gutachten bekommen und sind unsicher.
...
- Liste aller Aerzte und Krankenhaeuser zusammenstellen.
- Aktuelle Atteste mitbringen.
- Medikamenten-Liste.
- Pflegeprotokoll (bei Pflegestreit).
- Nicht nuechtern erscheinen, ausser anders angewiesen.
- Bequem anziehen.

### Schritt 2 — Bei der Untersuchung

Wichtig:

- **Schmerzfrei wirken Sie nicht** — beschreiben Sie ehrlich Ihre Beschwerden.
...
Das Gutachten ist meist:

- Anamnese (Krankheitsgeschichte)
- Untersuchungs-Befund
- Diagnose
- Funktionsbewertung (Belastbarkeit, Pflegebedarf, GdB-Bewertung)
- Antwort auf die vom Gericht gestellten Fragen
...
- **Befunde aus eigenen Berichten beruecksichtigt?**
- **Schluss-Folgerungen plausibel?**
- **Funktionsbewertung konkret oder Standardphrasen?**

### Schritt 5 — Auf negatives Gutachten reagieren

Wenn das Gutachten gegen Sie ist:

**Option 1: Schriftlich widersprechen**
...
Wenn Sie kuerzlich eine Reha hatten:

- Reha-Entlassungsbericht hat hohes Gewicht.
...
- "Mir geht es eigentlich nicht so schlecht" → relativ; ehrlich aber konkret
- Notizen vor der Untersuchung vergessen → mitnehmen
