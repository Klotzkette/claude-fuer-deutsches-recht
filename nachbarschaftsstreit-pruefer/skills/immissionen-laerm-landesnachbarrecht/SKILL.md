...
description: "Immissionen Laerm Landesnachbarrecht: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Immissionen Laerm Landesnachbarrecht** im Plugin Nachbarschaftsstreit. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Nachbarschaftsstreit gilt für **Immissionen Laerm Landesnachbarrecht**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Dieser Skill prüft Einwirkungen von einem Grundstück auf das andere. Er trennt Ärger von rechtlich relevanter wesentlicher Beeinträchtigung.

## Kernnorm § 906 BGB

Prüfe:

- Art der Einwirkung: Geräusch, Geruch, Rauch, Ruß, Wärme, Licht, Erschütterung, ähnliche Einwirkung.
- Wesentlichkeit: Dauer, Häufigkeit, Intensität, Tageszeit, Richtwerte.
- Ortsüblichkeit: Wohngebiet, Dorfgebiet, Gewerbe, Saison, Vorbelastung.
- Vermeidbarkeit und Zumutbarkeit von Schutzmaßnahmen.
- Duldung mit Ausgleich in Geld.
- Besondere Leitung: unzulässig.

## Beweise

- Lärm-/Geruchsprotokoll.
- Fotos/Videos mit Uhrzeit.
- Zeugen.
- Messungen nur sinnvoll mit Methodik.
- Behördenvorgänge: Ordnungsamt, Immissionsschutz, Bauamt.
...
- Eskalationsplan: Gespräch, Ordnungsamt, Unterlassung, Klage.
