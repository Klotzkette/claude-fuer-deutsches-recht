...
description: "Notweg Zufahrt Selbsthilfe Eskalationsgrenzen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Notweg Zufahrt Selbsthilfe Eskalationsgrenzen

## Arbeitsbereich

Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Notweg Zufahrt Selbsthilfe Eskalationsgrenzen** im Plugin Nachbarschaftsstreit. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `spezial-aeste-risikoampel-und-gegenargumente` | Aeste: Risikoampel, Gegenargumente und Verteidigungslinien im Plugin nachbarschaftsstreit pruefer; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung. |

## Arbeitsweg

Im Plugin Nachbarschaftsstreit gilt für **Notweg Zufahrt Selbsthilfe Eskalationsgrenzen**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Dieser Skill prüft, ob ein Grundstück eine notwendige Verbindung zum öffentlichen Weg hat oder ob eine bloße Bequemlichkeitszufahrt verlangt wird.

## Prüfung

1. Gibt es eine öffentliche Verbindung?
2. Ist sie zur ordnungsmäßigen Benutzung notwendig?
3. Wurde der Mangel willkürlich selbst verursacht? § 918 BGB.
4. Gibt es Grunddienstbarkeit, Baulast, Vertrag oder Gewohnheitsnutzung?
5. Welche Richtung und welcher Umfang sind erforderlich?
6. Notwegrente.
...
- historische Nutzung.
- Fotos von Zufahrt, Breite, Steigung, Hindernissen.
- Genehmigungen.

## Output

- Notweg-Vermerk.
- Nutzungsumfang: Gehen, Fahren, Rettung, Müll, Lieferverkehr.
- Renten-/Kostenmatrix.
- Entwurf Duldungsverlangen oder Abwehrschreiben.
...
| Ampel | Bedeutung |
|---|---|
| Grün | gesetzliches Selbsthilferecht klar, Frist erfüllt, keine Schutzregel entgegenstehend |
| Gelb | möglich, aber Beweise, Baumschutz, Handwerker, Zugang oder Haftung offen |
| Rot | Betreten/Beschädigen/fällen/schneiden ohne Grundlage; gerichtliche oder behördliche Route nötig |
...
- Fristsetzung.
- Schutzzeiten/Baumschutz/Naturschutz.
...
- **Spezialgegenstand:** Aeste: Risikoampel, Gegenargumente und Verteidigungslinien / aeste risikoampel und gegenargumente. Der Skill löst diese konkrete Lage und darf nicht in allgemeines Routing ausweichen.
