...
- Leistungsort und Umsatzsteuer nach Paragraf 3a UStG, Reisekosten und betriebliche Veranlassung nach EStG, anwendbares Vertragsrecht nach Rom-I-VO und internationale Zuständigkeit nach Brüssel-Ia-VO getrennt bestimmen.
- Bei Zugriff auf personenbezogene Daten außerhalb des EWR Kapitel V DSGVO, Drittland, Zugriffsbefugnisse, Standardvertragsklauseln und ergänzende Schutzmaßnahmen prüfen; bloßer Cloud-Speicherort und tatsächlicher Fernzugriff sind zu unterscheiden.
- Reisebelege, Auftrag, Leistungsort, Datenflüsse, Gerätezugriffe, Währung und Umrechnungskurs in einer Nachweismatrix zusammenführen.
