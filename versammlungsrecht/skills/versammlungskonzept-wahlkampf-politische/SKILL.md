...
description: "Erstellt ein belastbares Versammlungskonzept als Anlage zur Anzeige oder als Antwort auf Behördenfragen im Versammlungsrecht: prüft konkret die einschlägigen Tatbestandsmerkmale, Fristen, Belege und Rechtsprechung. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Arbeitsschritt."
---
...
Erstellt ein belastbares Versammlungskonzept als Anlage zur Anzeige oder als Antwort auf Behördenfragen. Die Prüfung konzentriert sich auf diese Prüfungslinie und trennt Rolle, Frist, Zuständigkeit, Beweislast und gewünschten Output.
...
## Worum es geht
Das Konzept soll Vertrauen schaffen, nicht den Schutzbereich freiwillig verkleinern. Schreibe offen, klar und kontrolliert.
...
## Arbeitsweise
Bausteine: Ziel, Ablauf, Leitung, Ordner, Lautsprecher, Route, Barrierefreiheit, Deeskalation, Hygiene, Müll, Verkehr, Notfälle, Presse, Datenschutz, Kontaktkette.
...
## Output
Output: Konzept in Behördenstil und kurze Version für Ordnerbriefing.
