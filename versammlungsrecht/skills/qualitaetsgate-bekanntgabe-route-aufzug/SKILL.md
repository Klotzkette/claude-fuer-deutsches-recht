...
description: "Qualitaetsgate Bekanntgabe Route Aufzug: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Qualitaetsgate Bekanntgabe Route Aufzug

## Arbeitsbereich

Dieser Skill bündelt 2 sachlich verwandte Arbeitsschritte rund um **Qualitaetsgate Bekanntgabe Route Aufzug** im Plugin Versammlungsrecht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Versammlungsrecht gilt für **Qualitaetsgate Bekanntgabe Route Aufzug**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
**Fokus:** Letzter Check vor öffentlicher Einladung oder Versand der Anzeige.
...
## Arbeitsweise
Keine Einladung veröffentlichen, bevor der Fristanker verstanden ist, außer Eil- oder Spontanfall.
...
## Output
Output: Go/No-Go-Checkliste und sichere nächste Aktion.
...
## 2. `route-aufzug-und-streckenplanung`

**Fokus:** Plant Aufzüge und Routen so, dass Versammlungszweck, Verkehr, Sicherheit und Behördeneinwände gut ausbalanciert sind.

# Route ist Teil der Botschaft

## Worum es geht
Die Versammlung darf grundsätzlich Ort, Zeit und Modalitäten selbst bestimmen. Änderungen brauchen konkrete Gründe und Verhältnismäßigkeit.
...
## Arbeitsweise
Prüfe Engstellen, Rettungswege, ÖPNV, Gegenveranstaltungen, symbolische Orte, Bannmeilen, Baustellen und Alternativrouten, ohne den Zweck zu entkernen.
...
## Output
Output: Routenblatt, Kartenbeschreibung, Alternativmatrix und Argumente gegen bloß bequeme Verlegung.
