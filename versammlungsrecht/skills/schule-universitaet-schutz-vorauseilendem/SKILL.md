...
description: "Schule Universitaet Schutz Vorauseilendem: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Schule Universitaet Schutz Vorauseilendem

## Arbeitsbereich

Dieser Skill bündelt 2 sachlich verwandte Arbeitsschritte rund um **Schule Universitaet Schutz Vorauseilendem** im Plugin Versammlungsrecht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Versammlungsrecht gilt für **Schule Universitaet Schutz Vorauseilendem**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `schule-universitaet-jugendliche`

**Fokus:** Prüft Schüler-, Studierenden-, Hochschul- und Jugendversammlungen samt Aufsicht, Schulrecht und Hausrecht.
...
## Arbeitsweise
Prüfe Minderjährige, Aufsicht, Schuleingriffe, Disziplinarmaßnahmen, Versammlungsleitung und Elternkommunikation.
...
## Output
Output: Rollenkarte und sichere Einladung.
...
## 2. `schutz-vor-vorauseilendem-gehorsam`

**Fokus:** Hilft, berechtigte Behördenbelange zu berücksichtigen, ohne die Versammlung aus Angst selbst zu entkernen.

# Keine Schere im Kopf

## Worum es geht
Trenne rechtliche Notwendigkeit, taktische Klugheit und bloße Behördenbequemlichkeit. Halte den Versammlungszweck als Fixpunkt.
...
## Arbeitsweise
Formuliere Angebote als kooperative milde Mittel, nicht als Anerkennung einer Gefahr oder Verzicht auf Rechte.
...
## Output
Output: Primär-/Hilfspositionsmatrix und nicht-selbstzensierende Formulierungen.
