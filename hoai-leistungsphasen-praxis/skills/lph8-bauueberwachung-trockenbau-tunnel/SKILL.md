...
description: "Lph8 Bauueberwachung Trockenbau Tunnel: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Lph8 Bauueberwachung Trockenbau Tunnel

## Arbeitsbereich

Dieser Skill bündelt 5 sachlich verwandte Arbeitsschritte rund um **Lph8 Bauueberwachung Trockenbau Tunnel** im Plugin HOAI-Leistungsphasen. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
- Grossbaustelle Rechenzentrum Muenchen 24 Monate Bauzeit: 4 Webcam-Standorte Mobotix M73, Zeitraffervideo taeglich automatisch generiert, Bausumme 80 Mio. EUR, Auftraggeber IT-Konzern
- Bruckenneubau Bundesstrasse B27: GoPro HERO11 an Schalwagen befestigt, Betonage-Zeitraffer je Segment, Konflikt-Dokumentation Behinderung
- Klaeranlage Erweiterung: Matterport Pro3 alle 4 Wochen 3D-Scan, Baufortschritt-Vergleich 3D Soll-Ist, 42 Scans gesamt
...
- § 650p BGB, § 650q BGB: Architektenvertrag, Dokumentationspflicht Bauueberwachung
- HOAI 2021 § 34 Anlage 10 LPH 8: Bauueberwachung als Grundleistung, Bautagesbuch und Besondere Leistungen Videodokumentation
...
- SAP PM Meldungsart M2 Videonachweis Schaden: Equipment-Nr Bauabschnitt, Schadenscode aus Videobefund, Zeitstempel Video im Meldungstext als Beweis
- SAP PS Baufortschritt: Vorgangsfortschritt 0-100 Prozent automatisch aus Videoauswertung BuiltSpace, SAP PS Meilenstein aktualisiert
- PlanRadar Video-Anhang: Drohnenvideo oder GoPro-Clip max. 500 MB als Anhang an Meldung, Zeitstempel Verbindung
- BIM360 Document Management: Taeglich-Video-Zusammenschnitte archiviert nach Datum, Zugriff alle Projektbeteiligten
- Workflow: Behinderungsanzeige AN, Videoausschnitt exportiert und an Bauleiter, Begehung T+1, Protokoll Behinderung, SAP PS Mehrkosten-Nachtrag
...
6. Druckpruefung nach DVGW W 400-2 Abschnitt 12: Abschnitte max. 500 m, Vordruckpruefung 30 Minuten, Hauptpruefung 2 Stunden bei 1.5-fachem Betriebsdruck
...
- PE-HD Schweissnaht ohne Witterungsschutz: Wind und Naesse verhindern ordnungsgemaesse Abkuehlung, Bindenahtfehler versagt erst unter Betriebsdruck
- Trinkwasser-Kontamination durch unsaubere Montage: Einbau ohne Handschuhe nach DVGW W 291, gesamter Abschnitt muss nochmals desinfiziert werden
