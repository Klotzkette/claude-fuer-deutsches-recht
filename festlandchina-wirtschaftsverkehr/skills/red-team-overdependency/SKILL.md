...
description: "Für Red-Team: Überabhängigkeit China analysieren und abbauen: prüft Ergebnis, Beweislast und Gegenposition; Ergebnis: Gegenprüfung mit Beweis- und Fristencheck."
---

# Red-Team: Überabhängigkeit China analysieren und abbauen

## Fachkern: Red-Team: Überabhängigkeit China analysieren und abbauen
...
**Fall 1:** Ein Unternehmen fragt nach konkreten Handlungspflichten im Bereich Red Team Overdependency beim Chinageschaeft.

**Fall 2:** Eine Rechtsabteilung benötigt einen Prüfbericht zu Red Team Overdependency für ein laufendes China-Projekt.

**Fall 3:** Ein Vorstand bittet um ein Board-Paper zu Red Team Overdependency im Kontext der De-risking-Strategie.

## Erste Schritte

1. Sachverhalt und Ziel bestimmen: Was soll im Bereich Red Team Overdependency geprüft/erstellt werden?
...
4. Risikoeinschätzung Red Team Overdependency: Kritikalitätsbewertung nach De-risking-Matrix.
...
- Ist Red Team Overdependency-Relevanz für das konkrete Vorhaben gegeben?
...
- Red Team Overdependency-Relevanz unterschätzt: Regulierungsrahmen wird zu spät geprüft.
