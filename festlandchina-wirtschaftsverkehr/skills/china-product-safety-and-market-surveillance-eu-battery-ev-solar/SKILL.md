...
| `chn-033-battery-ev-solar-supply-chain` | Batterie-, EV- und Solarlieferketten aus China: EU-Batterie-VO 2023/1542 Sorgfaltspflichten, Carbon-Footprint-Deklaration, Recycling-Quoten, Solar-Anti-Dumping-Maßnahmen EU, XUAR-Bezug Polysilizium, Critical Raw Materials Act Lithium/Kobalt, LkSG-Risikoanalyse Bergbau. Output: Supply-Chain-Compliance-Paket Batterie/Solar und Risikoampel. |
| `chn-034-machinery-import-and-factory-equipment` | Maschinenbau-Import und Fabrikausrüstung aus China: EU-Maschinenrichtlinie 2023/1230, CE-Pflichten, Sicherheitsabnahme, Verwenderschutz, BAFA-Prüfpflicht bei Dual-Use-Maschinen, LkSG Lieferkettenprüfung Maschinenhersteller CN, Serviceverträge und Ersatzteilversorgung. Output: Import-Compliance-Checkliste Maschinenbau und Vertragsrahmen. |
...
- **Spezialgegenstand:** CE-Kennzeichnung und Produktsicherheit: China-Import-Compliance wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
...
Prüfbericht Product Safety And, Risiko-Ampel, Handlungsempfehlung, ggf. Behördenkorrespondenz-Entwurf.
...
- **Spezialgegenstand:** EU-Marktüberwachung China-Import: Pflichten und Behörden wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
- **Normen-/Quellenanker:** AWG/AWV, EU-Dual-Use, Sanktionen, Zoll/USt, Incoterms, Lieferkette/LkSG/CSDDD, IP-/Know-how-Schutz, Datenschutz/Cybersecurity und lokale China-Compliance live prüfen.
- **Entscheidende Weiche:** Ordne Lieferant, Werk, Datenfluss, Zahlungsweg, Exportgut, politisches Risiko, IP-Leck und Exit-Szenario getrennt.
- **Lösungsoutput:** Erzeuge eine fallbezogene Matrix `Norm / Tatbestand / Beleg / Risiko / Gegenargument / nächster Schritt` und benenne passende Anschluss-Skills nur, wenn sie wirklich eine Vertiefung lösen.
...
Prüfbericht Market Surveillance Eu, Risiko-Ampel, Handlungsempfehlung, ggf. Behördenkorrespondenz-Entwurf.
...
- **Spezialgegenstand:** Batterie/EV/Solar-Lieferkette China: Regulierung und Compliance wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
- **Normen-/Quellenanker:** AWG/AWV, EU-Dual-Use, Sanktionen, Zoll/USt, Incoterms, Lieferkette/LkSG/CSDDD, IP-/Know-how-Schutz, Datenschutz/Cybersecurity und lokale China-Compliance live prüfen.
- **Entscheidende Weiche:** Ordne Lieferant, Werk, Datenfluss, Zahlungsweg, Exportgut, politisches Risiko, IP-Leck und Exit-Szenario getrennt.
- **Lösungsoutput:** Erzeuge eine fallbezogene Matrix `Norm / Tatbestand / Beleg / Risiko / Gegenargument / nächster Schritt` und benenne passende Anschluss-Skills nur, wenn sie wirklich eine Vertiefung lösen.
...
Prüfbericht Battery Ev Solar, Risiko-Ampel, Handlungsempfehlung, ggf. Behördenkorrespondenz-Entwurf.
...
## Fachkern: Maschinenbau-Import China: CE, Dual-Use und Lieferkette
- **Spezialgegenstand:** Maschinenbau-Import China: CE, Dual-Use und Lieferkette wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
- **Normen-/Quellenanker:** AWG/AWV, EU-Dual-Use, Sanktionen, Zoll/USt, Incoterms, Lieferkette/LkSG/CSDDD, IP-/Know-how-Schutz, Datenschutz/Cybersecurity und lokale China-Compliance live prüfen.
- **Entscheidende Weiche:** Ordne Lieferant, Werk, Datenfluss, Zahlungsweg, Exportgut, politisches Risiko, IP-Leck und Exit-Szenario getrennt.
- **Lösungsoutput:** Erzeuge eine fallbezogene Matrix `Norm / Tatbestand / Beleg / Risiko / Gegenargument / nächster Schritt` und benenne passende Anschluss-Skills nur, wenn sie wirklich eine Vertiefung lösen.
...
**Fall 1:** Ein Unternehmen fragt nach konkreten Handlungspflichten im Bereich Machinery Import And Factory Equipment beim Chinageschaeft.

**Fall 2:** Eine Rechtsabteilung benötigt einen Prüfbericht zu Machinery Import And Factory Equipment für ein laufendes China-Projekt.

**Fall 3:** Ein Vorstand bittet um ein Board-Paper zu Machinery Import And Factory Equipment im Kontext der De-risking-Strategie.

## Erste Schritte

1. Sachverhalt und Ziel bestimmen: Was soll im Bereich Machinery Import And Factory Equipment geprüft/erstellt werden?
2. Relevante Normen identifizieren: AWG §§ 55 ff., AWV §§ 55-62a als Ausgangspunkt.
3. Unterlagen sichten: Verträge, Genehmigungen, Behördenschriftverkehr, interne Richtlinien.
4. Risikoeinschätzung Machinery Import And: Kritikalitätsbewertung nach De-risking-Matrix.
5. Maßnahmen priorisieren: Kurzfristige Compliance-Lücken schließen, mittelfristige Strukturmaßnahmen planen.
6. Dokumentation erstellen: Prüfprotokoll, Risikoampel, Handlungsempfehlung.
...
- Ist Machinery Import And-Relevanz für das konkrete Vorhaben gegeben?
- Welche Normen und Behörden sind zuständig?
- Bestehen Genehmigungs- oder Meldepflichten?
- Welche Fristen sind zu beachten?
- Gibt es De-risking- oder Diversifizierungsanforderungen?
...
- Machinery Import And-Relevanz unterschätzt: Regulierungsrahmen wird zu spät geprüft.
- Fristen versäumt: AWV/BAFA-Fristen sind streng und führen zu Bußgeldern.
- Dokumentationslücken: Behörden und Gerichte verlangen lückenlose Aufzeichnungen.
...
Prüfbericht Machinery Import And, Risiko-Ampel, Handlungsempfehlung, ggf. Behördenkorrespondenz-Entwurf.
