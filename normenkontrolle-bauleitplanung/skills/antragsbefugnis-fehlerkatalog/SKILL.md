...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Normenkontrolle Bauleitplanung** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (§ 47 II VwGO 1 Jahr ab Bekanntmachung)

- **Symptom:** Frist falsch berechnet oder übersehen (§ 47 II VwGO 1 Jahr ab Bekanntmachung)
...
### 2. Falsche Zuständigkeit adressiert (richtig: OVG/VGH)

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: OVG/VGH)
...
### 3. Beweismittel nicht gesichert (Abwägungsfehler-Dokumentation)

- **Symptom:** Beweismittel nicht gesichert (Abwägungsfehler-Dokumentation)
...
### 4. Schlüsseldokument fehlt oder veraltet (Bebauungsplan)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Bebauungsplan)
...
### 5. Normzitat ohne Fassungsprüfung (BauGB §§ 1, 2, 10)

- **Symptom:** Normzitat ohne Fassungsprüfung (BauGB §§ 1, 2, 10)
