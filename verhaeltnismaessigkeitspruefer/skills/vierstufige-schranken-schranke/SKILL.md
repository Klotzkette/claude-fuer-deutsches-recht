...
- Art. 20 Abs. 3 GG: Rechtsstaatsprinzip, Gesetzesbindung, Uebermassverbot.
...
Gibt es ein milderes gleich effektives Mittel? **Mildestes Mittel**
...
## Welche Stufe ist das Nadeloehr?

| Fallgruppe | Typisches Nadeloehr |
| --- | --- |
...
| Versammlungsverbote | Erforderlichkeit: Auflage vor Verbot; Angemessenheit bei konkreter Gefahr |
| Ueberwachung | Streubreite, Anlassnaehe und Loesch-/Kontrollsicherungen |
| Eigentum | Lastenverteilung, Uebergang, Ausgleich |
