...
| Frage | Konsequenz |
| --- | --- |
| Wer beherrscht den Traeger? Kommune, Land, Bund, gemischtwirtschaftliche AG/GmbH? | Je staerker oeffentliche Beherrschung, desto näher an Art. 1 Abs. 3 GG. |
| Ist der Ort für allgemeinen Publikumsverkehr geoeffnet? | Kommunikationsgrundrechte gewinnen Gewicht. |
| Geht es um Betriebssicherheit, Flugsicherheit, Kundenlenkung, Rettungswege? | Legitime Zwecke möglich, aber konkretisieren. |
| Gibt es mildere Mittel: Zone, Zeitfenster, Personenzahl, Ordner, Anmeldung? | Pauschales Verbot regelmaessig angreifbar. |
| Ist die Maßnahme inhaltlich neutral? | Inhaltliche Missbilligung ist kein legitimer Zweck. |
