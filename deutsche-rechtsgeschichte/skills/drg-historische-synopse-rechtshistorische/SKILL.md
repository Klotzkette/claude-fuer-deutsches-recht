...
| `drg-066-gegenwartsbezug-ohne-anachronismus` | Deutsche Rechtsgeschichte: Gegenwartsbezug ohne Anachronismus. Methodisches Ruest-zeug um historische Argumente in heutige Rechtsdiskussion einzubringen ohne unzulaessige Zeitspringe. |
| `drg-067-kontinuitaet-und-bruch-pruefen` | Deutsche Rechtsgeschichte: Kontinuitaet und Bruch pruefen. Methodisches Werkzeug um echte Rechtsbrueche (NS-Machtuebernahme 1933 / Kriegsende 1945 / GG 1949 / Wiedervereinigung 1990) von Schein-Bruechen zu unterscheiden. |
| `drg-068-normzweck-historisch-rekonstruieren` | Deutsche Rechtsgeschichte: Normzweck historisch rekonstruieren. Wie man den historischen Regelungszweck einer Norm aus Materialien, Parlamentsdebatten und zeitgenoessischer Literatur erschliesst. |
| `drg-069-materialienarbeit-ohne-blindzitat` | Deutsche Rechtsgeschichte: Materialienarbeit ohne Blindzitat. Korrekte Arbeit mit den Mugdan-Materialien, Reichstagsdebattenprotokollen und parlamentarischen Entwurfsbegruendungen ohne Quellenfiktion. |
...
- **Mugdan, Materialien BGB** (6 Bde., 1899): Motive und Protokolle als Normzweck-Quellen
...
- **BGB-Kommissionen**: Primaaer-Normzweckgeber
- **Bundestagsausschuesse**: Gesetzeszweck-Festlegung in den Ausschussberatungen
- **BGH**: Normzweckrekonstruktion im Zivilrecht
- **BVerfG**: Historisch-genetische Verfassungsauslegung
