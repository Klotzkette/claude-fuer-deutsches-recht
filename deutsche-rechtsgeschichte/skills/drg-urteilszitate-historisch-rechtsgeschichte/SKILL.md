---
name: drg-urteilszitate-historisch-rechtsgeschichte
description: "DRG Urteilszitate Historisch Rechtsgeschichte: bündelt 6 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# DRG Urteilszitate Historisch Rechtsgeschichte

## Arbeitsbereich

Dieser Skill bündelt 6 sachlich verwandte Arbeitsschritte rund um **DRG Urteilszitate Historisch Rechtsgeschichte** im Plugin Deutsche Rechtsgeschichte. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `drg-072-rechtsgeschichte-in-gesetzesbegruendung` | Deutsche Rechtsgeschichte: Rechtsgeschichte in der Gesetzesbegründung. Wie historische Normanalyse in Referentenentwuerfe, Begründungen und parlamentarische Materialien korrekt eingebaut wird. |
| `drg-073-rechtshistorische-timeline` | Deutsche Rechtsgeschichte: Rechtshistorische Timeline erstellen. Methodik zur Erstellung einer chronologischen Darstellung mit Quellenangaben fuer ein konkretes rechtshistorisches Problem. |
| `drg-074-vergleich-brd-ddr-recht` | Deutsche Rechtsgeschichte: Vergleich BRD-DDR-Recht. Parallele Rechtsentwicklung 1949-1990, Systemprinzipien, DDR-ZGB vs. BGB, DDR-Strafrecht vs. StGB und Erbschaft nach Wiedervereinigung. |
| `drg-075-laenderrecht-und-rechtszersplitterung` | Deutsche Rechtsgeschichte: Laenderrecht und Rechtszersplitterung. Partikularrechtliche Vielfalt vor 1900, EGBGB-Uebergangsrecht, fortgeltendes Landesrecht und foederales Privatrecht heute. |

## Arbeitsweg

Im Plugin Deutsche Rechtsgeschichte gilt für **DRG Urteilszitate Historisch Rechtsgeschichte**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
- **BGB (RGBl. 1896, 195)**: Anfangspunkt BGB-Timeline
- **Reichsverfassung 1871 (RGBl. 1871, 63)**: Anfangspunkt Verfassungs-Timeline
- **GG 1949 (BGBl. 1949, 1)**: Meilenstein jeder modernen Timeline
- **Einigungsvertrag 1990 (BGBl. II 1990, 885)**: Meilenstein Wiedervereinigungstimeline

## Akteure und Institutionen

- **Rechtswissenschaft und Didaktik**: Haupt-Nutzer historischer Timelines
- **Justiz und Verwaltung**: Timelines fuer Normhistorie in Bescheiden
- **Rechtsanwaelte**: Timelines fuer Fallfuehrung mit historischem Hintergrund
- **Lehrende**: Timelines fuer Unterricht und Vorlesung

## Typische Streitfragen / Forschungsfragen

1. Auswahl der Timeline-Elemente: Welche Ereignisse sind obligatorisch, welche optional?
2. Quellenpflicht: Muss jedes Element eine Quellenangabe haben?
3. Timeline und Wertung: Sollte eine Timeline neutral sein oder werten?
4. Periodisierung: Wie entscheidet man, wo eine Epoche endet?
5. Digitale Timeline-Tools: Verlaeesslichkeit und Quellenintegration?

## Methodik

- Normtexte: gesetze-im-internet.de, ALEX/OeNB, documentArchiv.de
