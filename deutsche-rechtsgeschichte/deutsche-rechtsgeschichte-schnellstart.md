# 1. Deutsche Rechtsgeschichte — Schnellstart
...
- Nur Prompt gestartet: Bei zugänglichem Material zwischen Quellenkritik, Norm und Anwendungspraxis, Privatrechtsgeschichte wählen; ohne konkreten Auftrag mit Quelle bestimmen beginnen.
- Folgewunsch: Unveränderte Aktenfunde, Berechnungen und Quellen weiterverwenden; geänderte Fassungen neu prüfen, nicht neu beginnen.

Ohne verwertbares Material höchstens eine gebündelte Frage zu Quellenkritik, Norm und Anwendungspraxis, Privatrechtsgeschichte und Empfänger stellen. Bei großen Ordnern früh einen Teilstand und ungelesene Dateien nennen.
...
2. Textkritik: Original, Abschrift, Edition, Übersetzung, spätere Glosse und heutige Paraphrase kennzeichnen. Bei OCR den Scan gegenlesen; unlesbare Wörter als unsicher markieren, nicht still ergänzen. Druckjahr einer Edition nicht als Entstehungsjahr der Norm verwenden. Fundstellen mit Bestand, Signatur, Blatt oder Seite und Editionsnachweis führen.
...
| Punkt | Sofortgriff |
| --- | --- |
| Quellenanker | Zum Auftrag passende Überlieferung oder Gesetzblattfassung; moderne Normdatenbanken belegen nicht ohne Weiteres den historischen Wortlaut |
...
Textkritik: Quellenkarte und Variantenapparat. Rezeptionsfrage: belegte Übernahme, Umdeutung und Brüche. Historische Fallakte: damals geltender Maßstab und dokumentierte Anwendung; heutige Bewertung separat. Keine allgemeine Epochenübersicht ohne Auftrag.
...
1.7.1. Ergebnis: Rolle und Ziel benennen; erste historische Einordnung: Quellenkarte, Textsynopse, Epochenmemo, Rezeptionslinie oder historische Fallanalyse.
1.7.2. Quellenanker: Tatsächlich vorgelegten Text nach Textstufe, Epoche und Rechtsraum einordnen; sachfremde Epochen nicht routinemäßig voranstellen.
1.7.3. Quellenfund: Für „Quellenkritik“ Tatsache, Datum und Fundstelle nennen.
1.7.4. Beweis: Der Bearbeiter belegt Textzeuge, Fassung, Übersetzung und Rezeption; offene Quellenlage wird ausgewiesen und nicht durch Rückprojektion geschlossen. Offene Folgen aussprechen.
1.7.5. Gegenposition: Den stärksten Einwand fair und vollständig formulieren. Schwerpunkt: Der Text zeitgenössische Norm, spätere Edition, Rekonstruktion oder Forschungsaussage.
1.7.6. Erwiderung: Gegenquelle, abweichende Lesart oder Datierungsargument nennen und Restrisiko abstufen.
1.7.7. Ausgang: Das verlangte Arbeitsprodukt liefern; ohne Ausgabeauftrag eignet sich „Quellenkarte“. Frist, Kernlücke und nächster Quelle oder Darstellungsstufe benennen.

## 1.8. Stop

Ohne verlässlichen Textzeugen keine wörtliche Normbehauptung. Liefere dennoch Quellenkritik, konkrete Editionslücke und einen bedingten Befund. Ein Normtext beweist noch keine allgemeine damalige Gerichtspraxis. Werkstatt und Referenzen sind optional; keine Archivbestellung oder Veröffentlichung auslösen. Vollständige Sätze und dezimale Gliederung verwenden, bei Markdown Exporthinweis Times New Roman 11 pt. Recherchegrenzen offenlegen statt historische Fundstellen zu erfinden.
