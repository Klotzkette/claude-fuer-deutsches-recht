---
name: bericht-energieaudit-edl-entsendungen-a1-eudr
description: "Bericht Energieaudit EDL Entsendungen A1 Eudr: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Bericht Energieaudit EDL Entsendungen A1 Eudr

## Arbeitsbereich

Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Bericht Energieaudit EDL Entsendungen A1 Eudr** im Plugin Berichtspflichten Erlediger. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Berichtspflichten Erlediger gilt für **Bericht Energieaudit EDL Entsendungen A1 Eudr**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
**Fokus:** Energieaudit-/Energiemanagementpflichten, Nicht-KMU-Prüfung, Umsetzungspläne und Nachweise.
...
## 2. `bericht-entsendungen-a1-mindestlohn`

**Fokus:** Entsendungen und Auslandseinsätze: A1, Meldepflichten, Mindestlohn, Arbeitszeit, Sozialversicherung und Nachweise.
...
- A1 zu spät
- Zielland-Meldeportal vergessen
- Reise als Arbeitseinsatz unterschätzt
...
## 3. `bericht-eudr-entwaldung-due-diligence`

**Fokus:** EUDR: relevante Rohstoffe/Produkte, Sorgfaltserklärung, Geolokalisierung, Risikobewertung und Lieferantendaten.

# EUDR Entwaldungsfreie Lieferketten

## Einsatz

Für Importeure/Händler von Holz, Kaffee, Kakao, Soja, Rind, Kautschuk, Palmöl-Produkten.
...
1. Welche Produkte erfasst?
2. Welche Geodaten/Nachweise?
3. Welche Rolle: Marktteilnehmer/Händler?
