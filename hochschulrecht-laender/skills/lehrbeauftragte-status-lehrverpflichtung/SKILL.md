...
description: "Lehrbeauftragte Status Lehrverpflichtung: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Lehrbeauftragte Status Lehrverpflichtung

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **Lehrbeauftragte Status Lehrverpflichtung** im Plugin Hochschulrecht Laender. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Hochschulrecht Laender gilt für **Lehrbeauftragte Status Lehrverpflichtung**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `lehrbeauftragte-und-status`

**Fokus:** Prüft Lehrbeauftragte, Honorar und Status.
...
- **Konkreter Auftrag:** Prüft Lehrbeauftragte, Honorar und Status.
- **Erste Trennlinie:** Ist das Problem wirklich Lehrbeauftragte Und Status, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
...
- Primäre Anker: Landeshochschulrecht; SGB IV Schnittstelle.
...
Erzeuge bevorzugt: Lehrauftragscheck. Am Ende immer drei Zeilen: **Frist**, **fehlende Quelle**, **nächster sicherer Schritt**.

## 2. `lehrverpflichtung-deputat`

**Fokus:** Prüft Lehrdeputat, Ermäßigung, Forschungssemester und Kapazitätsfolgen.
...
- **Konkreter Auftrag:** Prüft Lehrdeputat, Ermäßigung, Forschungssemester und Kapazitätsfolgen.
- **Erste Trennlinie:** Ist das Problem wirklich Lehrverpflichtung und Deputat, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
- **Quellenarbeit:** Suche die aktuelle Landesnorm, Ordnung oder Satzung im Original und notiere Fundstelle, Fassung, Bekanntgabeweg und Geltungszeitpunkt.
- **Aktenarbeit:** Markiere, welches Dokument die entscheidende Tatsache trägt; bloße Schilderungen bekommen eine eigene Unsicherheitsnote.
- **Produkt:** Liefere am Ende nicht nur ein Ergebnis, sondern eine Handlung: Gesprächsfahrplan, Akteneinsicht, Antrag, Widerspruch/Remonstration, Eilrechtsschutz oder interne Entscheidungsvorlage.
...
## 3. `nebentaetigkeit-professoren`

**Fokus:** Prüft Anzeige/Genehmigung, Drittmittelnähe, Interessenkonflikte und Abführungspflichten.
...
## 4. `open-access-hochschule`

**Fokus:** Prüft Open-Access-Pflichten, Zweitveröffentlichung, Rechtekette und Drittmittelvorgaben.
...
- **Konkreter Auftrag:** Prüft Open-Access-Pflichten, Zweitveröffentlichung, Rechtekette und Drittmittelvorgaben.
- **Erste Trennlinie:** Ist das Problem wirklich Open Access Hochschule, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
- **Quellenarbeit:** Suche die aktuelle Landesnorm, Ordnung oder Satzung im Original und notiere Fundstelle, Fassung, Bekanntgabeweg und Geltungszeitpunkt.
- **Aktenarbeit:** Markiere, welches Dokument die entscheidende Tatsache trägt; bloße Schilderungen bekommen eine eigene Unsicherheitsnote.
- **Produkt:** Liefere am Ende nicht nur ein Ergebnis, sondern eine Handlung: Gesprächsfahrplan, Akteneinsicht, Antrag, Widerspruch/Remonstration, Eilrechtsschutz oder interne Entscheidungsvorlage.
