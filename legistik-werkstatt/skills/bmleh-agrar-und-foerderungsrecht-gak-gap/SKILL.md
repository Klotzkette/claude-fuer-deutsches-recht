...
description: "Für Agrar- und Förderungsrecht (GAK; GAP) (BMLEH): ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt. Fachgebiet: Legistik-Werkstatt. Route: bmleh-agrar-und-foerderungsrecht-gak-gap."
---

# Agrar- und Förderungsrecht (GAK; GAP) (BMLEH)

> Vierter und tiefster Skill in der Ressort-Kette: Sachfeld-Kompass für das Spezialthema Agrar- und Förderungsrecht (GAK; GAP) im Geschäftsbereich BMLEH. Liefert dem Normgeber Normbestand, Akteure, EU-Bezug und Prüfpunkte für dieses eine Sachfeld.
...
BLE; Länder-Landwirtschaftsministerien; Generaldirektion AGRI; BMEL/BMLEH.
...
Direktzahlungen; Konditionalitaet; OeKo-Regelungen; Förderung im 2. Saeule (ELER); Antragsverfahren.
...
Arbeitsfokus: **Agrar- und Förderungsrecht (GAK; GAP) (BMLEH)**. Prüfe diese Anker am Sachverhalt; ergänze nur Normen, die denselben Output, dieselbe Frist oder dieselbe Beweisfrage tragen:
