...
description: "Für Zivilrecht und BGB-Pflege (BMJV): ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt. Fachgebiet: Legistik-Werkstatt. Route: bmjv-zivilrecht-buergerliches-gesetzbuch."
---

# Zivilrecht und BGB-Pflege (BMJV)

> Vierter und tiefster Skill in der Ressort-Kette: Sachfeld-Kompass für das Spezialthema Zivilrecht und BGB-Pflege im Geschäftsbereich BMJV. Liefert dem Normgeber Normbestand, Akteure, EU-Bezug und Prüfpunkte für dieses eine Sachfeld.
...
Arbeitsfokus: **Zivilrecht und BGB-Pflege (BMJV)**. Prüfe diese Anker am Sachverhalt; ergänze nur Normen, die denselben Output, dieselbe Frist oder dieselbe Beweisfrage tragen:
