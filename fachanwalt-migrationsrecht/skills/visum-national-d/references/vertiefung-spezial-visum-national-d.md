...
Auswahlsignal: Wenn es um Nationales Visum D in Fachanwalt Migrationsrecht geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten.

### Nationales Visum D

#### Aufgabe
Spezialskill im Plugin `fachanwalt-migrationsrecht`. Er bearbeitet: prüft Botschaft, Unterlagen, Zweck, Finanzierung, Remonstrations-/Klageweg.
