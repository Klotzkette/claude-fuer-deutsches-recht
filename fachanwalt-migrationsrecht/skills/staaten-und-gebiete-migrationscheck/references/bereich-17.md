# 1. Staaten- und Gebietskarten: Bereich 17

Suche nach dem exakten Suchbegriff und lies nur den zugehörigen Abschnitt bis zur nächsten Überschrift zweiter Ebene.

## 1.1 staat-zentralafrikanische-republik-migrationscheck

Suchbegriff: `staat-zentralafrikanische-republik-migrationscheck`

Aktivierungskern: Wenn es um Staat Zentralafrikanische Republik Migrationscheck in Fachanwalt Migrationsrecht geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert ein direkt nutzbares Arbeitsprodukt mit Prüfpunkten, Risiken und nächstem Schritt.

### Staaten- und Gebietscheck Zentralafrikanische Republik: migrationsrechtlicher für Herkunfts-, Transit-, Dokumenten-, Visum-, Schutz-, Passbeschaffungs-, Rückführungs- und Aufenthaltstitelfragen mit Live-Quellencheck und optionaler spanischer Erklärung.
...
4. Welche Dokumente aus Zentralafrikanische Republik liegen vor und wie wurden sie beschafft/übersetzt/legalisiert?
...
## 1.2 staat-zypern-migrationscheck

Suchbegriff: `staat-zypern-migrationscheck`

Aktivierungskern: Wenn es um Staat Zypern Migrationscheck in Fachanwalt Migrationsrecht geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert ein direkt nutzbares Arbeitsprodukt mit Prüfpunkten, Risiken und nächstem Schritt.

### Staaten- und Gebietscheck Zypern: migrationsrechtlicher für Herkunfts-, Transit-, Dokumenten-, Visum-, Schutz-, Passbeschaffungs-, Rückführungs- und Aufenthaltstitelfragen mit Live-Quellencheck und optionaler spanischer Erklärung.
...
2. Wo befindet sich die Person jetzt und mit welchem Aufenthaltsstatus?
3. Geht es um Aufenthaltstitel, Blaue Karte EU, Visum, Familiennachzug, Asyl, Dublin/GEAS, Einbürgerung, Passbeschaffung, Abschiebungsabwehr oder Rückkehr?
4. Welche Dokumente aus Zypern liegen vor und wie wurden sie beschafft/übersetzt/legalisiert?
5. Welche aktuelle Länder-, Behörden- oder Sicherheitsquelle trägt das Ergebnis?
