...
description: "Für Subsidiärer Schutz: Fachmodul im Migrationsrecht: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---

# Subsidiärer Schutz: Fachmodul im Migrationsrecht
...
- Bei `spezial-subsidiaerer-schutz` beziehungsweise Subsidiärer Schutz: [die zusätzliche Vertiefung laden](./references/vertiefung-spezial-subsidiaerer-schutz.md).
