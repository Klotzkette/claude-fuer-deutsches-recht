...
description: "Für Chancenkarte Punktesystem: Fachmodul im Migrationsrecht: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
- Bei `spezial-chancenkarte-punktesystem` beziehungsweise Chancenkarte Punktesystem: [die zusätzliche Vertiefung laden](./references/vertiefung-spezial-chancenkarte-punktesystem.md).
