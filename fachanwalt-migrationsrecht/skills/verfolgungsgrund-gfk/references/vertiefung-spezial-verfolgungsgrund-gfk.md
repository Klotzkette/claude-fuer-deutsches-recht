...
Auswahlsignal: Wenn es um GFK-Verfolgungsgrund in Fachanwalt Migrationsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten.

### GFK-Verfolgungsgrund

#### Aufgabe
Spezialskill im Plugin `fachanwalt-migrationsrecht`. Er bearbeitet: prüft Religion, politische Überzeugung, soziale Gruppe, Nationalität und Rasse.
