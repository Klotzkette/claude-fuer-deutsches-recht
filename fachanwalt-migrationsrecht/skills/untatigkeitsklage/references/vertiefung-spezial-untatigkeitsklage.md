...
Auswahlsignal: Wenn es um Untätigkeitsklage in Fachanwalt Migrationsrecht geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten.

### Untätigkeitsklage

#### Aufgabe
Spezialskill im Plugin `fachanwalt-migrationsrecht`. Er bearbeitet: prüft Antrag, Sperrfrist, zureichender Grund, Klageziel.
