...
**Verfolgungsgrund GFK Visum National** führt durch die falltragenden Prüfungslinien: GFK-Verfolgungsgrund, Nationales Visum D, Vulnerable Personen Asyl. Starte mit der Linie, die Frist, Zuständigkeit, Beweislast oder den gewünschten Output tatsächlich entscheidet; weitere Linien werden nur herangezogen, wenn sie denselben Arbeitsstrang schärfen.
## Prüfungslinien
...
## Aufgabe
Dieses Fachmodul bearbeitet im Plugin `fachanwalt-migrationsrecht`: prüft Religion, politische Überzeugung, soziale Gruppe, Nationalität und Rasse.
...
## 2. `spezial-visum-national-d`

**Fokus:** Nationales Visum D: Fachmodul im Migrationsrecht; prüft Botschaft, Unterlagen, Zweck, Finanzierung, Remonstrations-/Klageweg; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.

# Nationales Visum D

## Aufgabe
Dieses Fachmodul bearbeitet im Plugin `fachanwalt-migrationsrecht`: prüft Botschaft, Unterlagen, Zweck, Finanzierung, Remonstrations-/Klageweg.
...
## 3. `spezial-vulnerable-personen-asyl`

**Fokus:** Vulnerable Personen Asyl: Fachmodul im Migrationsrecht; prüft Minderjährige, Krankheit, Trauma, Folteropfer und Verfahrensgarantien; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.

# Vulnerable Personen Asyl

## Aufgabe
Dieses Fachmodul bearbeitet im Plugin `fachanwalt-migrationsrecht`: prüft Minderjährige, Krankheit, Trauma, Folteropfer und Verfahrensgarantien.
...
2. **Rechtsrahmen setzen:** Normen, Zuständigkeiten, Fristen, Formfragen und Verfahrensstand zum Themenfeld **Woche** prüfen.
...
## Aufgabe
Dieses Fachmodul bearbeitet im Plugin `fachanwalt-migrationsrecht`: prüft Verpflichtung, Änderung, Familie, Arbeit, Integration.
