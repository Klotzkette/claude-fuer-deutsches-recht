...
description: "Für Chancen-Aufenthalt: Fachmodul im Migrationsrecht: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
- Bei `spezial-chancenaufenthalt` beziehungsweise Chancen-Aufenthalt: [die zusätzliche Vertiefung laden](./references/vertiefung-spezial-chancenaufenthalt.md).
