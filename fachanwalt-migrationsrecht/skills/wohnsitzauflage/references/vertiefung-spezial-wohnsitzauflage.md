...
Auswahlsignal: Wenn es um Wohnsitzauflage in Fachanwalt Migrationsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten.

### Wohnsitzauflage

#### Aufgabe
Spezialskill im Plugin `fachanwalt-migrationsrecht`. Er bearbeitet: prüft Verpflichtung, Änderung, Familie, Arbeit, Integration.
