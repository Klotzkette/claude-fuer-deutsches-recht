...
description: "Für Datenschutz/Sicherheit: Fachmodul im Migrationsrecht: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
- Bei `spezial-datenschutz-sicherheit-migration` beziehungsweise Datenschutz/Sicherheit: [die zusätzliche Vertiefung laden](./references/vertiefung-spezial-datenschutz-sicherheit-migration.md).
