...
description: "Change Control Dingliche Vorkaufsrechte: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---
...
Dieser Skill bündelt 2 sachlich verwandte Arbeitsschritte rund um **Change Control Dingliche Vorkaufsrechte** im Plugin Erbbaurecht Praxis. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Erbbaurecht Praxis gilt für **Change Control Dingliche Vorkaufsrechte**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `erbbaurecht-change-of-control-bei-erbbauberechtigtem`

**Fokus:** Prüft, ob Anteilsübertragung, Verschmelzung, Formwechsel oder Kontrollwechsel beim Erbbauberechtigten Zustimmungspflichten oder Heimfallrechte auslösen.
...
## 2. `erbbaurecht-dingliche-vorkaufsrechte`

**Fokus:** Prüft vertragliche und dingliche Vorkaufsrechte, Ausübungsfall, Rang und Löschung.

# Vorkaufsrechte im Erbbaurecht

## Fachlicher Zuschnitt

Prüft vertragliche und dingliche Vorkaufsrechte, Ausübungsfall, Rang und Löschung.
