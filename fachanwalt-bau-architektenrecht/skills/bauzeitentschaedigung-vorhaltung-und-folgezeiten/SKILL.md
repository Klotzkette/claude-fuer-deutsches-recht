...
2. Erstelle eine Ereignismatrix: ungestörter Vorgang, notwendiger Plan oder Vorleistung, tatsächliches Hindernis, Beginn, Ende, betroffene Ressourcen und Beleg. Prüfe Eigenbehinderung, Parallelstörung, Puffer und mögliche Umstellung. Die Verlängerung des Gesamtprojekts ist nicht automatisch die Dauer des Annahmeverzugs jedes Gewerks.
