...
- Bei Auflosung Konto (Beschaeftigungsende): einmalige Auszahlung.
- Bei Zusammenballung in einem Jahr: Pruefung Fuenftel-Regelung § 34 EStG (nur bei "Entschaedigung", restriktive Anwendung).
