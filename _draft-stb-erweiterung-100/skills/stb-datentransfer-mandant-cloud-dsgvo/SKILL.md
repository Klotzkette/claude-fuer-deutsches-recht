...
- Berufsverschwiegenheit § 203 StGB ist strafrechtlich verstaerkt — Cloud-Anbieter mit Berufsgeheimnistraeger-Klausel.
- Schrems II hat USA-Cloud kritisiert — EU-Server bevorzugen.
- DSGVO-Bussgelder bis 4 Prozent Jahresumsatz — Compliance unverzichtbar.
- Jaehrliche DSGVO-Pruefung im Team.
- StBVV: DSGVO-Compliance-Beratung ggf. als Zusatzauftrag.
