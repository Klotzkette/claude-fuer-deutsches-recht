...
| Zweig | Werkstudent |
|---|---|
| KV | Beitragsfrei (sofern unter 26 Familienversicherung; sonst studentische KV) |
| PV | Beitragsfrei |
| AV | Beitragsfrei |
| RV | Pflicht (voller Beitrag im Uebergangsbereich gemindert) |

### Phase 4 — Anmeldung und Pruefung

- Immatrikulationsbescheinigung jaehrlich aktualisieren (am besten zu Semesterbeginn).
- SV-Anmeldung mit Personengruppen-Schluessel 106 (Werkstudent).
- Bei Verlust Werkstudent-Status: Personengruppen-Schluessel auf 101 (regulaer) wechseln.
