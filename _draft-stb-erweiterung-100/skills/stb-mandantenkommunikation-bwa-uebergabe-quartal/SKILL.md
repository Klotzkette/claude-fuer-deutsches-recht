...
description: "Quartalsgespraech BWA-Uebergabe. Anwendungsfall systematische Quartalskommunikation mit Mandant Ergebnisbesprechung Steuerthemen Investitionsplanung. Methodik Termin-Vorbereitung Agenda Dokumentation. Output Quartalsgespraechs-Protokoll Massnahmen-Liste."
---
...
- Steuerliche Themen sammeln (vorausgezahlte Steuern, Investitionsabzugsbetrag, etc.).
- Personalfragen erfassen.
- Agenda an Mandant senden (1-2 Tage vorher).

### Phase 2 — Termin (1-2 Stunden)

- Bewirtungsbeleg-Sicherheit (StBVV).
- Teilnehmer: GF, ggf. kfm. Leitung, StB, ggf. Berufstraeger.
- Agenda-Punkte abarbeiten.
...
- Bei Krisensignalen: BWA mit roten Ampeln vorbereitet.
- § 102 StaRUG-Hinweispflicht ausgesprochen.
- Anwalt empfohlen.
...
- `stb-warnschreiben-krisensignale` — Krisenkommunikation.
