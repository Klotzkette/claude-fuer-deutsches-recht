...
- Anmeldung beim ELStAM-Verfahren ueber BZSt.
- Voraussetzungen: AN-Steuer-Id, AG-Steuer-Nr, BSN.
- Standard-Abrufintervall: monatlich vor Lohnabrechnung.
- Bei Aenderungen (Steuerklasse, Kinderfreibetrag): automatische Aktualisierung durch FA.
