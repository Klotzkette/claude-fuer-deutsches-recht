...
- Faktor F = ([2 minus Gesamt-SV-Beitragssatz] geteilt durch [2 minus Pauschal-Minijob-AG-Beitrag]).
- F wird im Lohn-Programm automatisch berechnet.
- Aktualisierung bei Aenderung der Beitragssaetze (jaehrlich).
