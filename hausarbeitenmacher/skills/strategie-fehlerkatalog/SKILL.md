...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Jura-Hausarbeiten** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (Hausarbeits-Abgabefrist)

- **Symptom:** Frist falsch berechnet oder übersehen (Hausarbeits-Abgabefrist)
...
### 2. Parallelfrist vergessen (Zitiernachweise)

- **Symptom:** Parallelfrist vergessen (Zitiernachweise)
...
### 3. Falsche Zuständigkeit adressiert (richtig: Universitäre Prüfungsämter)

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: Universitäre Prüfungsämter)
...
### 4. Schlüsseldokument fehlt oder veraltet (Sachverhalt)
...
### 5. Normzitat ohne Fassungsprüfung (BGB AT/BT, StGB AT/BT, GG)

- **Symptom:** Normzitat ohne Fassungsprüfung (BGB AT/BT, StGB AT/BT, GG)
