...
description: "Für Internationale Fehlerkatalog: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Schnittstellenkarte mit Zuständigkeits- und Nachweisfragen."
---

# Internationale Fehlerkatalog

## Zweck

Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Betriebliche Altersversorgung im Konzern** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (Anpassungsprüfung alle 3 Jahre § 16 BetrAVG)

- **Symptom:** Frist falsch berechnet oder übersehen (Anpassungsprüfung alle 3 Jahre § 16 BetrAVG)
...
### 2. Parallelfrist vergessen (Insolvenzsicherung PSV)

- **Symptom:** Parallelfrist vergessen (Insolvenzsicherung PSV)
...
### 3. Falsche Zuständigkeit adressiert (richtig: BaFin (PSV))

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: BaFin (PSV))
...
### 4. Beweismittel nicht gesichert (Aktuarisches Gutachten)

- **Symptom:** Beweismittel nicht gesichert (Aktuarisches Gutachten)
...
### 5. Schlüsseldokument fehlt oder veraltet (Versorgungsordnung)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Versorgungsordnung)
...
### 6. Normzitat ohne Fassungsprüfung (BetrAVG)

- **Symptom:** Normzitat ohne Fassungsprüfung (BetrAVG)
