...
description: "Bitv Checkout Beweislast Ecommerce: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Bitv Checkout Beweislast Ecommerce

## Arbeitsbereich

Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Bitv Checkout Beweislast Ecommerce** im Plugin Barrierefreiheit Web (BFSG/WCAG). Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
2. **Rechtsrahmen setzen:** Normen, Zuständigkeiten, Fristen, Formfragen und Verfahrensstand zum Themenfeld **BITV 2.0** prüfen.
...
- Audit ohne Geltungsbereichbeschreibung → trägt keine Generalaussage.
- Fehlender Schlichtungsstelle-Hinweis → § 4 Abs. 5 BITV.
- Keine PDF-Konformität trotz BITV § 1 → häufiger Mangel.
- Feedback-Postfach ohne SLA → Nutzerbeschwerden bleiben unbeantwortet.
