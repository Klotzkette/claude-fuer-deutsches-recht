...
## 2. Kritischer Unterschied: Kein Pre-Trial Discovery

> **Pre-Trial Discovery existiert im deutschen Prozessrecht NICHT.**

Das deutsche Zivilprozessrecht beruht auf dem Beibringungsgrundsatz (§§ 282, 283 ZPO). Eine parteiengetriebene, vorgerichtliche Durchsuchung gegnerischer Unterlagen ist unbekannt. Jeder Skill, jede Ausgabe und jedes Memo muss dies berücksichtigen.
...
**Hinweis für Schriftsätze:** Statt „Discovery" immer die konkrete deutsche Norm nennen. Kein Schriftsatz des Plugins wird die Begriffe „Discovery", „Deposition Notice" oder „Request for Production" ohne erklärende Übersetzung verwenden.
...
- **Keine stare decisis**: Urteile sind argumentativ überzeugend, aber nicht bindend (Ausnahme: § 31 BVerfGG für BVerfG-Entscheidungen nach § 31 Abs. 2 BVerfGG).
