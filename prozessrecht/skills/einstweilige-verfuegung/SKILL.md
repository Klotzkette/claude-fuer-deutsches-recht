...
1. **Anspruchsgrundlage**: materiell-rechtlicher Anspruch (z. B. Paragraf 8 UWG, Paragraf 97 UrhG,
...
2. **Prüfung Verfügungsgrund**:
 ...
 (BGH – "Fischdose")
3. **Glaubhaftmachung** (Paragraf 294 ZPO): Eidesstattliche Versicherung des Antragstellers
...
5. **Vollziehung** (Paragraf 929 Abs. 2 ZPO analog): Innerhalb 1 Monat ab Erlass zustellen lassen;
...
7. **Widerspruch des Gegners** (Paragraf 924 ZPO analog): Führt zur mündlichen Verhandlung;
 Gericht hebt Verfügung auf oder bestätigt sie (Paragraf 925 ZPO).
8. **Schutzschrift** (Paragraf 945a ZPO) auf Antragsgegnerseite: Einreichung ins ZSSR
