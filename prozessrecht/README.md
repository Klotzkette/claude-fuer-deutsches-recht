...
## Wichtige Unterschiede zum US-amerikanischen Prozessrecht

> **Kein Pre-Trial Discovery.** Das deutsche Prozessrecht kennt keine parteiengetriebene Discovery. Informationsbeschaffung erfolgt durch:
...
> **Kein Privilege Log.** Stattdessen: Schweigepflicht nach § 43a Abs. 2 BRAO, § 203 StGB; Zeugnisverweigerungsrecht § 383 Abs. 1 Nr. 6 ZPO; Beschlagnahmefreiheit §§ 97, 53 StPO; Editionsverweigerung §§ 142, 383 ZPO.

> **Keine Bindungswirkung von Urteilen** (außer § 31 BVerfGG). Literatur und Kommentare sind tragende Argumentationsquellen.
