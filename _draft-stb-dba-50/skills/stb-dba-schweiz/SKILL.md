...
- **Grenzgaenger (Art. 15a)**: arbeitstaegliche Rueckkehr, **max. 60 Nicht-Rueckkehrtage pro Kalenderjahr** ("schaedliche Tage"). Wohnsitz-Besteuerung mit gleichzeitiger Quellensteuer im Taetigkeitsstaat — der Hoechstsatz ist im DBA Art. 15a normiert (in der Praxis 4,5 Prozent), in Deutschland nach § 34c EStG anrechenbar; **Satz und Berechnungsgrundlage strikt aus dem DBA-Text und der Verstaendigungsvereinbarung uebernehmen**.
