...
### Passive Einkuenfte
- **Dividenden** (Art. 10): nach OECD-MA typ. 5/15 Prozent (Schachtel/Streubesitz); im DBA-USA seit Protokoll 2006 zusaetzlich ein Sondersatz fuer qualifizierte Hochbeteiligungen (in der Literatur oft mit 0 Prozent bei 80-Prozent-Beteiligung beschrieben — **DBA-Text Art. 10 in Verbindung mit Protokoll 2006 und LOB konkret verifizieren**, da der Satz an LOB-Erfuellung und Mindesthaltedauer geknuepft ist).
- **Zinsen** (Art. 11): nach DBA typ. 0 Prozent fuer den Schachtelbereich — **konkret im DBA-Text und Protokoll 2006 verifizieren**.
- **Lizenzgebuehren** (Art. 12): nach DBA typ. 0 Prozent — **konkret verifizieren**; Sonderregelungen fuer kulturelle Werke pruefen.
...
Die LOB-Klausel im DBA-USA (Artikel-Bezeichnung im DBA-Text und Protokoll 2006 konkret verifizieren — die Verortung variiert zwischen DBA-Fassung und Protokoll) ist die zentrale Anti-Missbrauchsregelung. DBA-Schutz nur, wenn ansaessige Person als "qualifizierte Person" gilt:
...
1. **BZSt** fuer US-Empfaenger deutscher Quellen (Kapitalertragsteuer, § 50a-Steuerabzug) — Antrag auf Erstattung oder Freistellungsbescheinigung; Anlage: IRS Form 6166 Ansaessigkeitsbescheinigung.
