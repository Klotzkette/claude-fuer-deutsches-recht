...
description: "Für Erkennt Fehlerkatalog: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Strafrechtliche Aktenaufbereitung** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (Anklage-Erwiderungsfrist)

- **Symptom:** Frist falsch berechnet oder übersehen (Anklage-Erwiderungsfrist)
...
### 2. Parallelfrist vergessen (Beweisantrag bis Schluss der Beweisaufnahme)

- **Symptom:** Parallelfrist vergessen (Beweisantrag bis Schluss der Beweisaufnahme)
...
### 3. Falsche Zuständigkeit adressiert (richtig: Staatsanwaltschaft)

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: Staatsanwaltschaft)
...
### 4. Beweismittel nicht gesichert (Zeugenaussagen)

- **Symptom:** Beweismittel nicht gesichert (Zeugenaussagen)
...
### 5. Schlüsseldokument fehlt oder veraltet (Ermittlungsakte)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Ermittlungsakte)
...
### 6. Normzitat ohne Fassungsprüfung (§§ 147 StPO Akteneinsicht)

- **Symptom:** Normzitat ohne Fassungsprüfung (§§ 147 StPO Akteneinsicht)
