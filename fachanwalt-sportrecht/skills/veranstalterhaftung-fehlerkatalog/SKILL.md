...
description: "Für Veranstalterhaftung Fehlerkatalog: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Fachanwalt Sportrecht** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (Berufung CAS 21 Tage)

- **Symptom:** Frist falsch berechnet oder übersehen (Berufung CAS 21 Tage)
...
### 2. Parallelfrist vergessen (Doping-Anhörung)

- **Symptom:** Parallelfrist vergessen (Doping-Anhörung)
...
### 3. Falsche Zuständigkeit adressiert (richtig: Verbandsschiedsgerichte)

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: Verbandsschiedsgerichte)
...
### 4. Beweismittel nicht gesichert (Spielprotokolle)

- **Symptom:** Beweismittel nicht gesichert (Spielprotokolle)
...
### 5. Schlüsseldokument fehlt oder veraltet (Spielerlizenz)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Spielerlizenz)
...
### 6. Normzitat ohne Fassungsprüfung (Verbandsrecht (DFB, DOSB))

- **Symptom:** Normzitat ohne Fassungsprüfung (Verbandsrecht (DFB, DOSB))
