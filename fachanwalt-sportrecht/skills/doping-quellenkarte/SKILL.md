...
description: "Für Doping Quellenkarte: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Diese Quellenkarte sichert für **Fachanwalt Sportrecht** jede tragende Aussage ab: Norm, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor Ausgabe verifiziert.

## Tragende Normen (live prüfen)

- **Verbandsrecht (DFB, DOSB)** — amtlichen Stand vor tragender Aussage prüfen
- **CAS-Code** — amtlichen Stand vor tragender Aussage prüfen
- **WADA-Code** — amtlichen Stand vor tragender Aussage prüfen
- **BGB §§ 25 ff.** — amtlichen Stand vor tragender Aussage prüfen

## Zuständige Spruchkörper und Behörden

- Verbandsschiedsgerichte
- CAS Lausanne
- Anti-Doping-Agentur
