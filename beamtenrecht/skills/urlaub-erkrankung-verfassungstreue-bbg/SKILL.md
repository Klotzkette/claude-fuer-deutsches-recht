...
description: "Urlaub Erkrankung Verfassungstreue BBG: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Urlaub Erkrankung Verfassungstreue BBG

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **Urlaub Erkrankung Verfassungstreue BBG** im Plugin Beamtenrecht. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Beamten- und Richterdienstrecht gilt für **Urlaub Erkrankung Verfassungstreue BBG**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Erholungsurlaub, Erkrankung, Verfall, Übertragung, Langzeiterkrankung und europarechtliche Linien.

## Arbeitsweise

Ermittle Urlaubsjahr, Belehrung, Erkrankungszeiten, Dienstunfähigkeit, Resturlaub und Rechtsbehelfsfrist.
...
### b) Bewertungssystem
- Mitgliedschaft in einer verfassungsfeindlichen Organisation ist Indiz, fuehrt aber nicht automatisch zum Verlust der Eignung.
- Erforderlich sind aktives Bekenntnis oder Handlungen, die das Bekenntnis ergeben.
- Reine Mitgliedschaft in einer vom Verfassungsschutz beobachteten, aber nicht verbotenen Partei ist im Einzelfall zu wuerdigen.
...
- Normen: § 7 BBG; § 7 BeamtStG; § 33 BeamtStG; § 60 BBG; Art. 33 Abs. 5 GG; Art. 21 GG.
- Rspr.: BVerfG zur Verfassungstreue der Beamten; BVerwG zu Reichsbuerger und Extremismus — nur nach Live-Check mit Gericht, Datum, Aktenzeichen und freier Quelle.
...
Skill fuer Beamte, denen eine Versetzung in eine andere Behoerde oder in ein anderes Statusamt aufgezwungen wird oder die selbst Versetzung beantragen wollen.

## 2. Eingaben

- Versetzungsverfuegung oder -anhoerung
- Anhoerungsantwort des Beamten
...
### b) Anhoerung
- Beamter ist vorher anzuhoeren; Anhoerungsmangel ist Verfahrensfehler, der zur Aufhebung fuehren kann.

### c) Beruecksichtigung persoenlicher Verhaeltnisse
