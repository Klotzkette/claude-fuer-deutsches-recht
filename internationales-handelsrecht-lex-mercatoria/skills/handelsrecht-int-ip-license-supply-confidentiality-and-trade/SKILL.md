...
description: "INT IP License Supply Confidentiality AND Trade: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# INT IP License Supply Confidentiality AND Trade

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **INT IP License Supply Confidentiality AND Trade** im Plugin Internationales Handelsrecht Lex Mercatoria. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
| `ihl-071-audit-rights-supplier` | Internationales Handelsrecht: Audit-Rechte gegenüber Lieferanten. Vertragliche Grundlage, Umfang (Qualität, Umwelt, Menschenrechte, Finanzprüfung), Ankündigung, Datenzugang, Ergebnisverwertung und LkSG-Prüfpflichten bei mittelbaren Zulieferern. |
| `ihl-072-termination-crossborder` | Internationales Handelsrecht: Vertragsbeendigung im grenzüberschreitenden Handel. CISG Art. 26 / 49 / 64 Aufhebungserklärung, PICC Art. 7.3.1-7.3.6 Kündigungsrecht, Rückabwicklung und cross-border Durchsetzung. |

## Arbeitsweg

Im Plugin Internationales Handelsrecht Lex Mercatoria gilt für **INT IP License Supply Confidentiality AND Trade**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.
...
Audit-Rechte in Lieferverträgen ermöglichen dem Auftraggeber die Überprüfung von Qualität, Compliance (Umwelt, Menschenrechte, Exportkontrolle) und finanzieller Lage des Lieferanten. Nach LkSG § 4 sind Risikoanalysen und ggf. direkte Audits für direkte Zulieferer erforderlich. Vertragliche Klauseln müssen Umfang, Vorankündigung und Datenschutz regeln.

## Kernnormen / Kernquellen

- **LkSG § 4 Abs. 1**: Risikoanalyse direkte Zulieferer — Auditpflicht bei erheblichen Risiken
- **LkSG § 5**: Präventivmaßnahmen — vertragliche Sorgfaltspflichten an Lieferanten
- **ISO 19011:2018**: Leitfaden für Managementsystem-Audits
- **SA8000**: Social Accountability Standard für Audits in Lieferkette
- **DSGVO Art. 28 Abs. 3 lit. h**: Prüfungsrecht gegenüber Auftragsverarbeitern
- **§ 19 AktG**: Konzernprüfungsrecht (für Konzernverbund)

## Schlüsselbegriffe

- Vertragliche Audit-Klausel: Mindestankündigung (usually 2-4 Wochen), Umfang, Kosten
- Third-Party-Audit: Beauftragung von SGS, Bureau Veritas als Prüfer (Effizienz und Objektivität)
- Supplier Self-Assessment: Fragebogen als Vorstufe zum physischen Audit
- Shared Audit: mehrere Auftraggeber teilen Auditkosten bei gleichem Lieferanten
- Korrekturmaßnahmenpflicht: CAR (Corrective Action Request) mit Frist und Verfolgung

## Typische Streitfragen / Anwendungsfälle

1. Lieferant verweigert Audit: Kündigungsrecht aus wichtigem Grund?
2. Audit-Ergebnis: Menschenrechtsverletzung gefunden — LkSG-Abhilfepflicht welcher Art?
3. Datenschutz beim Audit: Was darf Prüfer einsehen (Mitarbeiterdaten, Gehaltsunterlagen)?
4. Third-Party-Audit: Haftung des Prüfers bei fehlerhafter Bescheinigung?
5. Kosten: Trägt immer Auftraggeber oder kann Lieferant mitbelastet werden?

## Methodik

- Audit-Klausel-Gestaltung: Ankündigungsfrist 2 Wochen; Umfang (Qualität, ESG, Finance); max. 1x/Jahr
