...
## Fachkern: Legal Note Redline Output

- **Klauselproblem (Legal Note Redline Output):** sortiert Ziel, Rolle, Dokumente, Normenstand, AGB-Risiko und nächsten Output schnell und anfängertauglich.
...
5. **Spezialfokus:** Bei Legal Note Redline Output besonders auf wirtschaftlichen Zweck, versteckte Belastung, Verständlichkeit, Nachweisbarkeit und praxistaugliche Durchführung achten.
