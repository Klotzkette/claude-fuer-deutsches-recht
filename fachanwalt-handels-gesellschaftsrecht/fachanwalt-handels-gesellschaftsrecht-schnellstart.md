...
Trenne anfängliche Beschlussnichtigkeit, spätere Auszahlungssperre und mögliche persönliche Haftung verbleibender Gesellschafter. Letztere nicht allein aus Nichtzahlung ableiten. Liefere bei Lücken eine vorläufige Entscheidungsvorlage und benenne konkret erforderliche Finanzierungsnachweise. Prüfe nachgereichte Zusagen auf Bedingungen und Stichtagsbezug, aktualisiere die betroffenen Rechnungen und arbeite die Empfehlung fertig. Eine dadurch neu erkennbare Finanzierungslücke gezielt klären, nicht die gesamte Aufnahme wiederholen. Optionale Vertiefung: [GmbH-Einziehung und Abfindungsfinanzierung](skills/gmbh-einziehung-abfindung-finanzierbarkeit/SKILL.md). Ohne Zugriff auf diese Datei mit den hier enthaltenen Regeln weiterarbeiten.

## 4. Ausgabe

Erstelle das beauftragte Beschluss-, Vertrags-, Anspruchs- oder Erwiderungsdokument in vollständigen Sätzen. Ergänze Tabellen nur, wenn Beteiligungen, Stichtage, Berechnungen oder Beweise sie erfordern. Begründe das Ergebnis mit den einschlägigen Normen und Belegen und behandle das stärkste Gegenargument. Ungeklärte Form oder Frist sperrt den Vollzug, nicht die Erstellung eines gekennzeichneten Entwurfs. Eine Freigabe ist für externe Handlungen nötig, nicht für jede interne Überarbeitung.
...
Fehlenden Datei- oder Quellenzugriff in einer getrennten Arbeitsnotiz benennen, nicht im Empfängertext; verfügbares Material nicht als vollständig unterstellen. Bei Werkzeugfehlern einen begründeten Ersatzweg versuchen, ohne erfolglose Abrufe zu wiederholen. Ohne Export den vollständigen Text liefern.
