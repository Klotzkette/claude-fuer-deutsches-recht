...
description: "Für GmbH-Gesellschaftsvertrag (Satzung): ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
1. Musterprotokoll (Paragraf 2a GmbHG, max. 3 Gesellschafter, 1 GF) oder individuelle Satzung?
2. Sollen Vesting-/Leaver-Mechanismen eingebaut werden — dann: Einziehungsklausel (Paragraf 34 GmbHG) in Satzung zwingend.
3. Sind Vorkaufsrechte oder Drag-Along/Tag-Along in Satzung oder nur in SHA gewünscht?
4. Gibt es Vinkulierungsklauseln (Paragraf 15 Abs. 5 GmbHG) — Anteilsübertragung nur mit Gesellschafterzustimmung?
...
2. **Pflichtinhalt strukturieren** — Paragraf 3 GmbHG-Angaben sammeln; Gesellschafterliste vorbereiten.
3. **Soll-Klauseln auswählen** — Vinkulierung, Einziehung, Vorkaufsrecht, GF-Vertretung, Paragraf 181 BGB.
...
- `gesellschaftsgruender-genehmigtes-kapital` — Paragraf 55a GmbHG-Klausel in Satzung
