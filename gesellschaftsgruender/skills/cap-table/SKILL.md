---
name: cap-table
description: "Für Cap Table: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
- **Paragraf 40 GmbHG** — Gesellschafterliste; Einreichungspflicht beim Handelsregister bei jeder Änderung; Oeffentlichkeitswirkung
- **Paragraf 16 GmbHG** — Legitimationswirkung der Gesellschafterliste; nur eingetragener Gesellschafter gilt als berechtigt
- **Paragraf 55 GmbHG** — Kapitalerhoehung; Beschluss der Gesellschafterversammlung (Mehrheit 3/4)
- **Paragraf 55a GmbHG** — Genehmigtes Kapital bei GmbH (Satzungsermaechtigung für GF)
- **Paragraf 34 GmbHG** — Einziehung von Geschäftsanteilen; Grundlage für Bad-Leaver-Klauseln
- **Paragraf 15 GmbHG** — Abtretung von Geschäftsanteilen; notarielle Beurkundung zwingend
...
|---|---|---|---|
| 1 | Gesellschafterliste aktuell? | Paragraf 40 GmbHG | Muss jede Anteilsaenderung widerspiegeln |
| 2 | Legitimationswirkung beachtet? | Paragraf 16 GmbHG | Nur Eingetragener gilt als Gesellschafter |
| 3 | Anteilsklassen satzungskonform? | Paragraf 3 GmbHG | Class A/B-Rechte müssen in Satzung verankert sein |
| 4 | Vesting-Rückübertragung notariell geregelt? | Paragraf 15 GmbHG | Formlose Vereinbarung genuegt nicht |
| 5 | Einziehungs-Klausel für Bad Leaver? | Paragraf 34 GmbHG | Nur wenn satzungsmaessig vorgesehen |
| 6 | Liquidation Preference mit Satzung konsistent? | Paragraf 3 GmbHG | SHA-Waterfall bei Widerspruch unwirksam |
| 7 | ESOP-Pool genehmigt? | Paragraf 55a GmbHG | Genehmigtes Kapital oder Beschluss Gesellschafter |

## Schritt-für-Schritt-Workflow

1. **Bestandsaufnahme:** Aktuelle Gesellschafterliste (Paragraf 40 GmbHG) und Satzung lesen; alle Klassen, Nennwerte, Vesting-Status erfassen.
...
- Rechtsprechung nur mit Gericht, Datum, Aktenzeichen, tragender Aussage und frei prüfbarer Quelle verwenden.
- Gesellschafterliste nicht aktualisiert: Haftung GF; gutglaeubiger Erwerb durch Dritte möglich (Paragraf 16 GmbHG)
- Rechtsprechung nur mit Gericht, Datum, Aktenzeichen, tragender Aussage und frei prüfbarer Quelle verwenden.
- ESOP-Optionen ohne Satzungs-/Hauptversammlungsbeschluss: Kapitalerhoehung nicht vollziehbar

## Quellen und Vertiefung

- Paragraf 40 GmbHG (Gesellschafterliste), Paragraf 16 GmbHG (Legitimationswirkung)
- Paragraf 15 GmbHG (Abtretung), Paragraf 34 GmbHG (Einziehung), Paragraf 55 GmbHG (Kapitalerhoehung)
- Rechtsprechung nur mit Gericht, Datum, Aktenzeichen, tragender Aussage und frei prüfbarer Quelle verwenden.
