...
description: "Zeugnis Notenangriff Zeugnisbemerkung Arbeits: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Zeugnis Notenangriff Zeugnisbemerkung Arbeits

## Arbeitsbereich

Dieser Skill bündelt 2 sachlich verwandte Arbeitsschritte rund um **Zeugnis Notenangriff Zeugnisbemerkung Arbeits** im Plugin Schulrecht Laender. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.

## Prüffelder

| Prüffeld | Fokus |
| --- | --- |
| `zeugnis-und-notenangriff` | Prüft Zeugnisnoten und pädagogischen Bewertungsspielraum. |
| `zeugnisbemerkung-arbeits-sozialverhalten` | Prüft Kopfnoten, Bemerkungen, Sozialverhalten und Löschung/Änderung im Zeugnis. |

## Arbeitsweg

Im Plugin Schulrecht Laender gilt für **Zeugnis Notenangriff Zeugnisbemerkung Arbeits**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `zeugnis-und-notenangriff`

**Fokus:** Prüft Zeugnisnoten und pädagogischen Bewertungsspielraum.

# Zeugnis Und Notenangriff

## Fachkern: Zeugnis Und Notenangriff
- **Spezialgegenstand:** Zeugnis Und Notenangriff wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
...
- **Konkreter Auftrag:** Prüft Zeugnisnoten und pädagogischen Bewertungsspielraum.
- **Erste Trennlinie:** Ist das Problem wirklich Zeugnis Und Notenangriff, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
...
## 2. `zeugnisbemerkung-arbeits-sozialverhalten`

**Fokus:** Prüft Kopfnoten, Bemerkungen, Sozialverhalten und Löschung/Änderung im Zeugnis.

# Zeugnisbemerkung Arbeits- und Sozialverhalten

## Fachkern: Zeugnisbemerkung Arbeits- und Sozialverhalten
- **Spezialgegenstand:** Zeugnisbemerkung Arbeits- und Sozialverhalten wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
- **Normen-/Quellenanker:** Schulgesetz des Bundeslands, Schulordnung, VwVfG/VwGO, Grundrechte, Inklusions-/SGB-IX-Schnittstellen, Datenschutz und kommunale Satzung.
- **Entscheidende Weiche:** Bestimme Bundesland, Schulform, Verwaltungsakt/Realakt, Frist, pädagogischen Beurteilungsspielraum, Kindeswohl und gerichtlichen Eilbedarf.
- **Lösungsoutput:** Erzeuge eine fallbezogene Matrix `Norm / Tatbestand / Beleg / Risiko / Gegenargument / nächster Schritt` und benenne passende Anschluss-Skills nur, wenn sie wirklich eine Vertiefung lösen.
