...
description: "Versetzung Nachpruefung Verwaltungsakt: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Versetzung Nachpruefung Verwaltungsakt

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **Versetzung Nachpruefung Verwaltungsakt** im Plugin Schulrecht Laender. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.

## Prüffelder

| Prüffeld | Fokus |
| --- | --- |
| `versetzung-und-nachpruefung` | Prüft Versetzung, Nichtversetzung und Nachprüfung. |
| `verwaltungsakt-oder-realakt-schule` | Ordnet schulische Schreiben rechtlich ein. |
| `waffen-drogen-schule` | Prüft Verdachtsfälle, Durchsuchung, Ordnungsmaßnahme, Polizei und Prävention. |
| `widerspruch-und-eilrechtsschutz-schule` | Baut Widerspruch und Eilantrag im Schulrecht. |

## Arbeitsweg

Im Plugin Schulrecht Laender gilt für **Versetzung Nachpruefung Verwaltungsakt**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `versetzung-und-nachpruefung`

**Fokus:** Prüft Versetzung, Nichtversetzung und Nachprüfung.

# Versetzung Und Nachpruefung

## Fachkern: Versetzung Und Nachpruefung
- **Spezialgegenstand:** Versetzung Und Nachpruefung wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
...
- **Konkreter Auftrag:** Prüft Versetzung, Nichtversetzung und Nachprüfung.
- **Erste Trennlinie:** Ist das Problem wirklich Versetzung Und Nachpruefung, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
...
- Primäre Anker: Landesschulrecht Versetzung.
...
Erzeuge bevorzugt: Versetzungswiderspruch. Am Ende immer drei Zeilen: **Frist**, **fehlende Quelle**, **nächster sicherer Schritt**.

## 2. `verwaltungsakt-oder-realakt-schule`

**Fokus:** Ordnet schulische Schreiben rechtlich ein.

# Verwaltungsakt Oder Realakt Schule

## Fachkern: Verwaltungsakt Oder Realakt Schule
- **Spezialgegenstand:** Verwaltungsakt Oder Realakt Schule wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
- **Normen-/Quellenanker:** Schulgesetz des Bundeslands, Schulordnung, VwVfG/VwGO, Grundrechte, Inklusions-/SGB-IX-Schnittstellen, Datenschutz und kommunale Satzung.
- **Entscheidende Weiche:** Bestimme Bundesland, Schulform, Verwaltungsakt/Realakt, Frist, pädagogischen Beurteilungsspielraum, Kindeswohl und gerichtlichen Eilbedarf.
- **Lösungsoutput:** Erzeuge eine fallbezogene Matrix `Norm / Tatbestand / Beleg / Risiko / Gegenargument / nächster Schritt` und benenne passende Anschluss-Skills nur, wenn sie wirklich eine Vertiefung lösen.
...
- **Konkreter Auftrag:** Ordnet schulische Schreiben rechtlich ein.
- **Erste Trennlinie:** Ist das Problem wirklich Verwaltungsakt Oder Realakt Schule, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
- **Quellenarbeit:** Suche die aktuelle Landesnorm, Ordnung oder Satzung im Original und notiere Fundstelle, Fassung, Bekanntgabeweg und Geltungszeitpunkt.
- **Aktenarbeit:** Markiere, welches Dokument die entscheidende Tatsache trägt; bloße Schilderungen bekommen eine eigene Unsicherheitsnote.
- **Produkt:** Liefere am Ende nicht nur ein Ergebnis, sondern eine Handlung: Gesprächsfahrplan, Akteneinsicht, Antrag, Widerspruch/Remonstration, Eilrechtsschutz oder interne Entscheidungsvorlage.
...
- Primäre Anker: VwVfG/VwGO; Schulrecht.
- Landesrecht, aktuelle Satzungen und Prüfungsordnungen immer live aus amtlichen Portalen oder Originaldokumenten prüfen.
- Rechtsprechung nur mit Gericht, Entscheidungsdatum, Aktenzeichen und frei überprüfbarer Quelle nennen.
...
Erzeuge bevorzugt: Einordnungsmemo. Am Ende immer drei Zeilen: **Frist**, **fehlende Quelle**, **nächster sicherer Schritt**.

## 3. `waffen-drogen-schule`

**Fokus:** Prüft Verdachtsfälle, Durchsuchung, Ordnungsmaßnahme, Polizei und Prävention.

# Waffen, Drogen und Schule

## Fachkern: Waffen, Drogen und Schule
- **Spezialgegenstand:** Waffen, Drogen und Schule wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
- **Normen-/Quellenanker:** Schulgesetz des Bundeslands, Schulordnung, VwVfG/VwGO, Grundrechte, Inklusions-/SGB-IX-Schnittstellen, Datenschutz und kommunale Satzung.
- **Entscheidende Weiche:** Bestimme Bundesland, Schulform, Verwaltungsakt/Realakt, Frist, pädagogischen Beurteilungsspielraum, Kindeswohl und gerichtlichen Eilbedarf.
- **Lösungsoutput:** Erzeuge eine fallbezogene Matrix `Norm / Tatbestand / Beleg / Risiko / Gegenargument / nächster Schritt` und benenne passende Anschluss-Skills nur, wenn sie wirklich eine Vertiefung lösen.
...
- **Konkreter Auftrag:** Prüft Verdachtsfälle, Durchsuchung, Ordnungsmaßnahme, Polizei und Prävention.
- **Erste Trennlinie:** Ist das Problem wirklich Waffen, Drogen und Schule, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
- **Quellenarbeit:** Suche die aktuelle Landesnorm, Ordnung oder Satzung im Original und notiere Fundstelle, Fassung, Bekanntgabeweg und Geltungszeitpunkt.
- **Aktenarbeit:** Markiere, welches Dokument die entscheidende Tatsache trägt; bloße Schilderungen bekommen eine eigene Unsicherheitsnote.
- **Produkt:** Liefere am Ende nicht nur ein Ergebnis, sondern eine Handlung: Gesprächsfahrplan, Akteneinsicht, Antrag, Widerspruch/Remonstration, Eilrechtsschutz oder interne Entscheidungsvorlage.
...
## 4. `widerspruch-und-eilrechtsschutz-schule`

**Fokus:** Baut Widerspruch und Eilantrag im Schulrecht.

# Widerspruch Und Eilrechtsschutz Schule

## Fachkern: Widerspruch Und Eilrechtsschutz Schule
- **Spezialgegenstand:** Widerspruch Und Eilrechtsschutz Schule wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
- **Normen-/Quellenanker:** Schulgesetz des Bundeslands, Schulordnung, VwVfG/VwGO, Grundrechte, Inklusions-/SGB-IX-Schnittstellen, Datenschutz und kommunale Satzung.
- **Entscheidende Weiche:** Bestimme Bundesland, Schulform, Verwaltungsakt/Realakt, Frist, pädagogischen Beurteilungsspielraum, Kindeswohl und gerichtlichen Eilbedarf.
- **Lösungsoutput:** Erzeuge eine fallbezogene Matrix `Norm / Tatbestand / Beleg / Risiko / Gegenargument / nächster Schritt` und benenne passende Anschluss-Skills nur, wenn sie wirklich eine Vertiefung lösen.
