...
description: "Schuelerzeitung Pressefreiheit Schulaufnahme: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Schuelerzeitung Pressefreiheit Schulaufnahme

## Arbeitsbereich

Dieser Skill bündelt 4 sachlich verwandte Arbeitsschritte rund um **Schuelerzeitung Pressefreiheit Schulaufnahme** im Plugin Schulrecht Laender. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.

## Prüffelder

| Prüffeld | Fokus |
| --- | --- |
| `schuelerzeitung-pressefreiheit` | Prüft Schülerzeitung, Meinungsfreiheit, Schulordnung, Vorabkontrolle und Verantwortlichkeit. |
| `schulaufnahme-und-schulbezirk` | Prüft Aufnahme, Schulbezirk, Kapazität und Ablehnung. |
| `schulaufsicht-akteneinsicht-eltern` | Prüft Akteneinsicht, Schulaufsichtsbeschwerde und Informationsrechte. |
| `schulaufsichtsbeschwerde` | Erstellt Schulaufsichtsbeschwerde und Dienstaufsichtsbeschwerde. |

## Arbeitsweg

Im Plugin Schulrecht Laender gilt für **Schuelerzeitung Pressefreiheit Schulaufnahme**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `schuelerzeitung-pressefreiheit`

**Fokus:** Prüft Schülerzeitung, Meinungsfreiheit, Schulordnung, Vorabkontrolle und Verantwortlichkeit.

# Schülerzeitung und Pressefreiheit

## Fachkern: Schülerzeitung und Pressefreiheit
- **Spezialgegenstand:** Schülerzeitung und Pressefreiheit wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
...
- **Konkreter Auftrag:** Prüft Schülerzeitung, Meinungsfreiheit, Schulordnung, Vorabkontrolle und Verantwortlichkeit.
- **Erste Trennlinie:** Ist das Problem wirklich Schülerzeitung und Pressefreiheit, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
...
## 2. `schulaufnahme-und-schulbezirk`

**Fokus:** Prüft Aufnahme, Schulbezirk, Kapazität und Ablehnung.

# Schulaufnahme Und Schulbezirk

## Fachkern: Schulaufnahme Und Schulbezirk
- **Spezialgegenstand:** Schulaufnahme Und Schulbezirk wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
- **Normen-/Quellenanker:** Schulgesetz des Bundeslands, Schulordnung, VwVfG/VwGO, Grundrechte, Inklusions-/SGB-IX-Schnittstellen, Datenschutz und kommunale Satzung.
- **Entscheidende Weiche:** Bestimme Bundesland, Schulform, Verwaltungsakt/Realakt, Frist, pädagogischen Beurteilungsspielraum, Kindeswohl und gerichtlichen Eilbedarf.
- **Lösungsoutput:** Erzeuge eine fallbezogene Matrix `Norm / Tatbestand / Beleg / Risiko / Gegenargument / nächster Schritt` und benenne passende Anschluss-Skills nur, wenn sie wirklich eine Vertiefung lösen.
...
Wohnort, Geschwister, Härtefall, Profilklasse, Kapazität, Losverfahren und Bescheid kontrollieren.
...
- **Konkreter Auftrag:** Prüft Aufnahme, Schulbezirk, Kapazität und Ablehnung.
- **Erste Trennlinie:** Ist das Problem wirklich Schulaufnahme Und Schulbezirk, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
- **Quellenarbeit:** Suche die aktuelle Landesnorm, Ordnung oder Satzung im Original und notiere Fundstelle, Fassung, Bekanntgabeweg und Geltungszeitpunkt.
- **Aktenarbeit:** Markiere, welches Dokument die entscheidende Tatsache trägt; bloße Schilderungen bekommen eine eigene Unsicherheitsnote.
- **Produkt:** Liefere am Ende nicht nur ein Ergebnis, sondern eine Handlung: Gesprächsfahrplan, Akteneinsicht, Antrag, Widerspruch/Remonstration, Eilrechtsschutz oder interne Entscheidungsvorlage.
...
- Primäre Anker: Landesschulrecht; GG Art. 3/6/7; VwGO.
...
Erzeuge bevorzugt: Aufnahme-Check. Am Ende immer drei Zeilen: **Frist**, **fehlende Quelle**, **nächster sicherer Schritt**.

## 3. `schulaufsicht-akteneinsicht-eltern`

**Fokus:** Prüft Akteneinsicht, Schulaufsichtsbeschwerde und Informationsrechte.

# Schulaufsicht und Akteneinsicht der Eltern

## Fachkern: Schulaufsicht und Akteneinsicht der Eltern
- **Spezialgegenstand:** Schulaufsicht und Akteneinsicht der Eltern wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
- **Normen-/Quellenanker:** Schulgesetz des Bundeslands, Schulordnung, VwVfG/VwGO, Grundrechte, Inklusions-/SGB-IX-Schnittstellen, Datenschutz und kommunale Satzung.
- **Entscheidende Weiche:** Bestimme Bundesland, Schulform, Verwaltungsakt/Realakt, Frist, pädagogischen Beurteilungsspielraum, Kindeswohl und gerichtlichen Eilbedarf.
- **Lösungsoutput:** Erzeuge eine fallbezogene Matrix `Norm / Tatbestand / Beleg / Risiko / Gegenargument / nächster Schritt` und benenne passende Anschluss-Skills nur, wenn sie wirklich eine Vertiefung lösen.
...
## 4. `schulaufsichtsbeschwerde`

**Fokus:** Erstellt Schulaufsichtsbeschwerde und Dienstaufsichtsbeschwerde.

# Schulaufsichtsbeschwerde

## Fachkern: Schulaufsichtsbeschwerde
- **Spezialgegenstand:** Schulaufsichtsbeschwerde wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
- **Normen-/Quellenanker:** Schulgesetz des Bundeslands, Schulordnung, VwVfG/VwGO, Grundrechte, Inklusions-/SGB-IX-Schnittstellen, Datenschutz und kommunale Satzung.
- **Entscheidende Weiche:** Bestimme Bundesland, Schulform, Verwaltungsakt/Realakt, Frist, pädagogischen Beurteilungsspielraum, Kindeswohl und gerichtlichen Eilbedarf.
- **Lösungsoutput:** Erzeuge eine fallbezogene Matrix `Norm / Tatbestand / Beleg / Risiko / Gegenargument / nächster Schritt` und benenne passende Anschluss-Skills nur, wenn sie wirklich eine Vertiefung lösen.
...
Ziel klären: Abhilfe, Rechtskontrolle, Dienstpflicht, Gespräch oder Akteneinsicht.

Der Skill arbeitet landes- und satzungsbezogen: Er fragt zuerst nach Bundesland, Einrichtung, konkreter Ordnung, Bescheid, Frist, Verfahrensstand und vorhandenen Unterlagen. Ohne diese Angaben wird keine scheinbar sichere Antwort erzeugt.

## Spezialfokus

- **Konkreter Auftrag:** Erstellt Schulaufsichtsbeschwerde und Dienstaufsichtsbeschwerde.
- **Erste Trennlinie:** Ist das Problem wirklich Schulaufsichtsbeschwerde, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
- **Quellenarbeit:** Suche die aktuelle Landesnorm, Ordnung oder Satzung im Original und notiere Fundstelle, Fassung, Bekanntgabeweg und Geltungszeitpunkt.
- **Aktenarbeit:** Markiere, welches Dokument die entscheidende Tatsache trägt; bloße Schilderungen bekommen eine eigene Unsicherheitsnote.
- **Produkt:** Liefere am Ende nicht nur ein Ergebnis, sondern eine Handlung: Gesprächsfahrplan, Akteneinsicht, Antrag, Widerspruch/Remonstration, Eilrechtsschutz oder interne Entscheidungsvorlage.
...
- Primäre Anker: Landesschulrecht; Verwaltungsorganisation.
- Landesrecht, aktuelle Satzungen und Prüfungsordnungen immer live aus amtlichen Portalen oder Originaldokumenten prüfen.
- Rechtsprechung nur mit Gericht, Entscheidungsdatum, Aktenzeichen und frei überprüfbarer Quelle nennen.
...
Erzeuge bevorzugt: Beschwerdeentwurf. Am Ende immer drei Zeilen: **Frist**, **fehlende Quelle**, **nächster sicherer Schritt**.
