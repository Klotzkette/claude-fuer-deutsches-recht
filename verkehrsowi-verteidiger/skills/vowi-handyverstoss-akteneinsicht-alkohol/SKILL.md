...
description: "Vowi Handyverstoss Akteneinsicht Alkohol: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert."
---

# Vowi Handyverstoss Akteneinsicht Alkohol

## Arbeitsbereich

Dieser Skill bündelt 3 sachlich verwandte Arbeitsschritte rund um **Vowi Handyverstoss Akteneinsicht Alkohol** im Plugin Verkehrs-OWi-Verteidigung. Die Prüffelder bauen aufeinander auf: zuerst das tragende Feld nach der konkreten Aktenlage bestimmen, dann ergänzende Felder nur dort heranziehen, wo dieselbe Akte mehrere Punkte trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei sauber getrennt.
...
Im Plugin Verkehrs-OWi-Verteidigung gilt für **Vowi Handyverstoss Akteneinsicht Alkohol**: zuerst das tragende Prüffeld auswählen, dessen Tatsachen im konkreten Fall wirklich angelegt sind. Ergänzende Prüffelder nur heranziehen, wenn dieselbe Akte sie trägt. Rollen, Fristen, Zuständigkeit, Anspruchs- oder Verfahrensgrundlage, Beweislast und gewünschten Output sauber getrennt halten. Tragende Normen und Fundstellen nach `references/quellenhygiene.md` verifizieren.


## Prüffelder im Detail

## 1. `vowi-handyverstoss-spezial`

**Fokus:** Spezialfall Handy- und Geraeteverstoss § 23 Abs. 1a StVO: erfasste Geraete, Halten, Nutzen, Abgrenzung Sprachsteuerung. Pruefraster fuer Verteidiger.

# VOWi: Handyverstoss

## Spezialwissen: VOWi: Handyverstoss
- **Spezialgegenstand:** VOWi: Handyverstoss / vowi handyverstoss spezial. Der Skill löst diese konkrete Lage und darf nicht in allgemeines Routing ausweichen.
- **Normen-/Quellenanker:** StVO, BGH, BVerfG.
...
## 2. `spezial-akteneinsicht-internationaler-bezug-und-schnittstellen`

**Fokus:** Akteneinsicht: Internationaler Bezug und Schnittstellen im Plugin verkehrsowi verteidiger; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung.
...
## 3. `spezial-alkohol-compliance-dokumentation-und-akte`

**Fokus:** Alkohol: Compliance-Dokumentation und Aktenvermerk im Plugin verkehrsowi verteidiger; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung.
