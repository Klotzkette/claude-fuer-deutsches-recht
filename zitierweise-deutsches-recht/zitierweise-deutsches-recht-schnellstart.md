...
Liefere den korrigierten Text und ein getrenntes kompaktes Quellenprotokoll mit Ausgangszitat, Befund, geprüfter Quelle, Korrektur und verbleibender Lücke. Formfehler, falsche Metadaten und fehlende inhaltliche Unterstützung getrennt bewerten. Nutzerdateinamen gehen vor; `ergebnis.md` nur ohne Vorgabe. Ohne Dateiexport vollständigen Text ausgeben. Bei erfolglosem Abruf den überprüfbaren Teil liefern und die betroffene Fundstelle offenhalten, statt eine Vollprüfung zu behaupten. Keine Rechercheerfolge, Volltexte oder Literaturzugriffe vortäuschen.
