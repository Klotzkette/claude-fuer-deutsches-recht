...
description: "Für Grundrechte Fehlerkatalog: ordnet Norm, Beweislast und Gegenargument; Ergebnis: Prüfprodukt mit Risiko und nächstem Schritt."
---
...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Verfassungsrecht** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (§ 93 BVerfGG 1 Monat Verfassungsbeschwerde)

- **Symptom:** Frist falsch berechnet oder übersehen (§ 93 BVerfGG 1 Monat Verfassungsbeschwerde)
...
### 2. Parallelfrist vergessen (Rechtswegerschöpfung)

- **Symptom:** Parallelfrist vergessen (Rechtswegerschöpfung)
...
### 3. Falsche Zuständigkeit adressiert (richtig: BVerfG)

- **Symptom:** Falsche Zuständigkeit adressiert (richtig: BVerfG)
...
### 4. Beweismittel nicht gesichert (Tragende Erwägungen Vorinstanzen)

- **Symptom:** Beweismittel nicht gesichert (Tragende Erwägungen Vorinstanzen)
...
### 5. Schlüsseldokument fehlt oder veraltet (Letzter fachgerichtl. Beschluss)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Letzter fachgerichtl. Beschluss)
...
### 6. Normzitat ohne Fassungsprüfung (GG)

- **Symptom:** Normzitat ohne Fassungsprüfung (GG)
