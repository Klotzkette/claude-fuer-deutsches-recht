...
| Kompakter Prompt (Schnellstart) | Markdown | <a href="https://raw.githubusercontent.com/Klotzkette/claude-fuer-deutsches-recht/main/kanzlei-allgemein/kanzlei-allgemein-schnellstart.md" download><code>kanzlei-allgemein-schnellstart.md</code></a> |
...
| 7. Kontrolle, Qualität und Gegenprüfung | [`qualitaetsgate-hardening-kanzlei`](skills/qualitaetsgate-hardening-kanzlei/SKILL.md) |
| 8. Spezialmodule und Schnittstellen | [`abwesenheiten-urlaub`](skills/abwesenheiten-urlaub/SKILL.md), [`bea-journal`](skills/bea-journal/SKILL.md), [`bea-versand-pruefen`](skills/bea-versand-pruefen/SKILL.md), [`buchhaltung-konten-kanzlei-erechnung`](skills/buchhaltung-konten-kanzlei-erechnung/SKILL.md), [`erechnung`](skills/erechnung/SKILL.md), [`freundlicher-copilot-kanzlei`](skills/freundlicher-copilot-kanzlei/SKILL.md), [`geburtstage-feiertage-abwesenheiten-urlaub`](skills/geburtstage-feiertage-abwesenheiten-urlaub/SKILL.md), [`integrationen-simulation-kanzlei`](skills/integrationen-simulation-kanzlei/SKILL.md), [`kanzlei-automationen-bea-journal`](skills/kanzlei-automationen-bea-journal/SKILL.md), [`kanzleikalender`](skills/kanzleikalender/SKILL.md), [`kanzleitag-simulation-kanzlei`](skills/kanzleitag-simulation-kanzlei/SKILL.md), [`ki-arbeitsauftrag-mahnwesen-honorar`](skills/ki-arbeitsauftrag-mahnwesen-honorar/SKILL.md), [`kommandocenter`](skills/kommandocenter/SKILL.md), [`lohn-sv-kanzlei-rechnung`](skills/lohn-sv-kanzlei-rechnung/SKILL.md), [`mahnwesen-honorar`](skills/mahnwesen-honorar/SKILL.md), [`postlauf`](skills/postlauf/SKILL.md), [`rechnung`](skills/rechnung/SKILL.md), [`rechnungserstellung-rvg`](skills/rechnungserstellung-rvg/SKILL.md), ... plus 6 weitere |
...
Automatisch generierte Komplett-Liste aller 52 Skills in diesem Plugin. Jeder Skillname öffnet die zugehörige `SKILL.md`; der Direktdownload lädt dieselbe Datei als Markdown. Beschreibungen stammen aus dem jeweiligen `description`-Feld.

| Skill | Beschreibung | Markdown-Download |
| --- | --- | --- |
| [`abwesenheiten-urlaub`](skills/abwesenheiten-urlaub/SKILL.md) | Wenn es um Abwesenheiten, Urlaub, Krankheit in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. | <a href="https://raw.githubusercontent.com/Klotzkette/claude-fuer-deutsches-recht/main/kanzlei-allgemein/skills/abwesenheiten-urlaub/SKILL.md" download><code>SKILL.md</code></a> |
