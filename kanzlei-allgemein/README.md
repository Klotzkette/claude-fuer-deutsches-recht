...
Direktnavigation: [Startseite](../README.md) · [Plugin-Katalog](../README.md#was-ist-drin) · [Skill-Gesamtübersicht](../SKILLS.md) · [Skills dieses Plugins](../skills-index/kanzlei-allgemein.md) · [Plugin-Dateien](.) · [Download-Index](../ASSET_INDEX.md) · [Testakten](../testakten/README.md)
...
| Skill | Beschreibung |
| --- | --- |
| [`abwesenheiten-urlaub`](skills/abwesenheiten-urlaub/SKILL.md) | Wenn es um Abwesenheiten, Urlaub, Krankheit in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| [`aktenbestand-pflege-bea-versand`](skills/aktenbestand-pflege-bea-versand/SKILL.md) | Wenn es um Aktenbestandspflege in Kanzlei-Allgemein geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert ein direkt nutzbares Arbeitsprodukt mit Prüfpunkten, Risiken und nächstem Schritt. |
| [`aktenzeichen`](skills/aktenzeichen/SKILL.md) | Wenn es um Aktenzeichen und Verknüpfungen in Kanzlei-Allgemein geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. |
| [`bea-journal`](skills/bea-journal/SKILL.md) | Wenn es um beA-Nachrichtenjournal und EB-Workflow in Kanzlei-Allgemein geht: zerlegt Ergebnis, Frist, Zuständigkeit, Beweislast und Gegenposition; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`bea-versand-pruefen`](skills/bea-versand-pruefen/SKILL.md) | Prüft einen konkreten elektronischen Gerichtsversand vor und nach dem Absenden: bestimmt Verfahrensordnung, Empfänger und Frist, trennt qualifizierte Signatur vom persönlichen sicheren Übermittlungsweg, kontrolliert Hauptdokument und Anh... |
| [`buchhaltung-konten-kanzlei-erechnung`](skills/buchhaltung-konten-kanzlei-erechnung/SKILL.md) | Wenn es um Kanzlei-Buchhaltung, Konten und Zahlungsabgleich in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`einstieg-routing`](skills/einstieg-routing/SKILL.md) | Wenn es um Einstieg und Routing in Kanzlei-Allgemein geht: klärt Rolle, Ziel, Frist, Unterlagen und den passenden nächsten Fachskill; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`erechnung`](skills/erechnung/SKILL.md) | Wenn es um E-Rechnung, XRechnung, ZUGFeRD und GoBD in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`freundlicher-copilot-kanzlei`](skills/freundlicher-copilot-kanzlei/SKILL.md) | Wenn es um Freundlicher Kanzlei-Copilot in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`fristenbuch-fuehren`](skills/fristenbuch-fuehren/SKILL.md) | Wenn es um Zentrales Fristenbuch der Kanzlei in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`geburtstage-feiertage-abwesenheiten-urlaub`](skills/geburtstage-feiertage-abwesenheiten-urlaub/SKILL.md) | Wenn es um Geburtstage und Feiertage in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`handelsregisterabruf`](skills/handelsregisterabruf/SKILL.md) | Wenn es um Handelsregisterabruf in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| [`kanzleikalender`](skills/kanzleikalender/SKILL.md) | Wenn es um Kanzleikalender und interne Abstimmung in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`kanzleitag-simulation-kanzlei`](skills/kanzleitag-simulation-kanzlei/SKILL.md) | Wenn es um Kanzleitag-Simulation in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| [`kommandocenter`](skills/kommandocenter/SKILL.md) | Wenn es um Kommandocenter in Kanzlei-Allgemein geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`lohn-sv-kanzlei-rechnung`](skills/lohn-sv-kanzlei-rechnung/SKILL.md) | Wenn es um Lohn, Sozialversicherung und Payroll in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`look-feel-mandatsannahme-gwg`](skills/look-feel-mandatsannahme-gwg/SKILL.md) | Wenn es um Look and Feel in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`mahnwesen-honorar`](skills/mahnwesen-honorar/SKILL.md) | Wenn es um Mahnwesen für Kanzleihonorar in Kanzlei-Allgemein geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. |
...
| [`mandantenbrief-vorlagen`](skills/mandantenbrief-vorlagen/SKILL.md) | Wenn es um Mandantenbrief-Vorlagen in Kanzlei-Allgemein geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`mandatsannahme-gwg`](skills/mandatsannahme-gwg/SKILL.md) | Wenn es um Mandatsannahme und Geldwäscheprüfung in Kanzlei-Allgemein geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert einen Einreichungsplan mit Form-, Portal- und Nachweischeck. |
| [`mandatsvereinbarung-postlauf`](skills/mandatsvereinbarung-postlauf/SKILL.md) | Wenn es um Mandatsvereinbarung und Honorarstart in Kanzlei-Allgemein geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. |
| [`monitor-vertragsentwurf`](skills/monitor-vertragsentwurf/SKILL.md) | Wenn es um Fristen- und Action-Monitor in Kanzlei-Allgemein geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`output-versand`](skills/output-versand/SKILL.md) | Wenn es um Output und Versandsteuerung in Kanzlei-Allgemein geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. |
| [`posteingang-ausgang-sekretariats-tagesbrief`](skills/posteingang-ausgang-sekretariats-tagesbrief/SKILL.md) | Wenn es um Posteingang und Postausgang in Kanzlei-Allgemein geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`postlauf`](skills/postlauf/SKILL.md) | Wenn es um Postlauf um 11 Uhr in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`qualitaetsgate-hardening-kanzlei`](skills/qualitaetsgate-hardening-kanzlei/SKILL.md) | Wenn es um Qualitätsgate und Hardening in Kanzlei-Allgemein geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`rechnung`](skills/rechnung/SKILL.md) | Wenn es um Rechnungsvorbereitung und Abschluss in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`rechnungserstellung-rvg`](skills/rechnungserstellung-rvg/SKILL.md) | Wenn es um Rechnungserstellung Honorar (RVG oder Vereinbarung) in Kanzlei-Allgemein geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Berechnungstabelle mit Schwellen, Annahmen und Kontrollfragen. |
| [`schreibcanvas`](skills/schreibcanvas/SKILL.md) | Wenn es um Schreib-Canvas in Kanzlei-Allgemein geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`sekretariats-tagesbrief`](skills/sekretariats-tagesbrief/SKILL.md) | Wenn es um Sekretariats-Tagesbrief in Kanzlei-Allgemein geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`timesheet-aktenzeitung-umgang-ki`](skills/timesheet-aktenzeitung-umgang-ki/SKILL.md) | Wenn es um Timesheet und Aktenzeitung in Kanzlei-Allgemein geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert ein direkt nutzbares Arbeitsprodukt mit Prüfpunkten, Risiken und nächstem Schritt. |
| [`turbo-zeitnarrative`](skills/turbo-zeitnarrative/SKILL.md) | Wenn es um Schriftsatz-Turbo: Klage, Replik, Antrag in Kanzlei-Allgemein geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| [`ustva-buchhaltung-simulation`](skills/ustva-buchhaltung-simulation/SKILL.md) | Wenn es um UStVA, Eingangsrechnungen und Kanzlei-Buchhaltung in Kanzlei-Allgemein geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Dokumentenmatrix mit Nachforderungsliste. |
| [`ustva-simulation`](skills/ustva-simulation/SKILL.md) | Wenn es um UStVA- und ELSTER-Simulation in Kanzlei-Allgemein geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`versand-check-weihnachtskarten`](skills/versand-check-weihnachtskarten/SKILL.md) | Wenn es um Versand-Vor-Check (Pflicht vor jedem Versand) in Kanzlei-Allgemein geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert ein direkt nutzbares Arbeitsprodukt mit Prüfpunkten, Risiken und nächstem Schritt. |
| [`vertragsentwurf`](skills/vertragsentwurf/SKILL.md) | Wenn es um Vertragsentwurf und Vertrags-Canvas in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`weihnachtskarten`](skills/weihnachtskarten/SKILL.md) | Wenn es um Weihnachtskarten Mandantenpflege in Kanzlei-Allgemein geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`workflow-kaltstart-und-routing`](skills/workflow-kaltstart-und-routing/SKILL.md) | Wenn es um Kaltstart und Routing in Kanzlei-Allgemein geht: klärt Rolle, Ziel, Frist, Unterlagen und den passenden nächsten Fachskill; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| [`zeitnarrative`](skills/zeitnarrative/SKILL.md) | Wenn es um Zeitnarrative und Timesheet in Kanzlei-Allgemein geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. |
